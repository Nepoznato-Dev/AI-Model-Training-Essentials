...
- **Rapid Elasticity**: Scale outward and inward rapidly
- **Measured Service**: Resource usage monitored and billed
...
- **Provides**: Virtual machines, storage, networks, operating systems
- **Examples**: AWS EC2, Google Compute Engine, Azure VMs
- **Use Cases**: Lift-and-shift migrations, development environments, high-control needs

#### Platform as a Service (PaaS)
- **Provides**: Development platforms, databases, middleware
- **Examples**: Heroku, Google App Engine, AWS Elastic Beanstalk
- **Use Cases**: Application development, API deployment, microservices

#### Software as a Service (SaaS)
- **Provides**: Complete applications over internet
- **Examples**: Salesforce, Google Workspace, Microsoft 365, Slack
- **Use Cases**: Email, CRM, collaboration, business applications
...
- **Market Share**: ~10%
- **Strengths**: Data analytics, AI/ML, Kubernetes
- **Key Services**:
...
- **Challenges**: Distributed complexity, data consistency, monitoring
...
- **Benefits**: Cost efficiency, reduced operations, rapid deployment
...
- Handle high concurrency with distributed data
...
- **Use Cases**: Static assets, backups, data lakes, archives
...
### File Storage
- **Characteristics**: Shared file systems, NFS/SMB protocols
- **Examples**: AWS EFS, Google Filestore, Azure Files
- **Use Cases**: Content management, shared configs, lift-and-shift

### Archive Storage
- **Characteristics**: Lowest cost, retrieval delays
- **Examples**: S3 Glacier, Azure Archive Storage
- **Use Cases**: Compliance, long-term backups, historical data
...
- **Use Cases**: Analytics, BI, large-scale data analysis
...
- **Customer Responsibility**: Security IN the cloud (data, applications, access)
...
- **Spot Instances**: Bid for unused capacity, can be interrupted
...
- **Spot Usage**: Use for fault-tolerant, flexible workloads
- **Storage Tiers**: Move infrequent data to cheaper tiers
...
- **Availability Zones**: Physically separate data centers within region
...
- **Backup and Restore**: Periodic backups, restore when needed (lowest cost)
...
- **Strategy Selection**: Based on business requirements and budget
