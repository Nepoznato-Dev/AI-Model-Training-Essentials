...
|[embedded_systems_and_iot.md](01_coding_and_technology/embedded_systems_and_iot.md)|微控制器、感測器、RTOS、物聯網協定、邊緣運算 |
...
|去 |`programming_languages/go/`| |鐵鏽|`programming_languages/rust/`|
|打字稿 |`programming_languages/typescript/`| | SQL |`programming_languages/sql/`|
|紅寶石 |`programming_languages/ruby/`| | PHP |`programming_languages/php/`|
|斯威夫特 |`programming_languages/swift/`| |科特林 |`programming_languages/kotlin/`|
|右 |`programming_languages/r/`| |視覺基本 |`programming_languages/visual_basic/`|
|飛鏢 |`programming_languages/dart/`| |斯卡拉 |`programming_languages/scala/`|
|哈斯克爾 |`programming_languages/haskell/`| |茱莉亞 |`programming_languages/julia/`|
|盧阿 |`programming_languages/lua/`| |珀爾|`programming_languages/perl/`|
| Erlang/Elixir |`programming_languages/erlang_and_elixir/`| | OCaml |`programming_languages/ocaml/`|
|序|`programming_languages/prolog/`| | Lisp/Clojure |`programming_languages/lisp_and_clojure/`|
|艾達 |`programming_languages/ada/`| |組裝|`programming_languages/assembly/`|
| MATLAB |`programming_languages/matlab/`| |語言 |`programming_languages/fortran/`|
|科博爾 |`programming_languages/cobol/`| |殼/PowerShell |`programming_languages/shell_and_powershell/`|
|德爾福/帕斯卡|`programming_languages/delphi_object_pascal/`| |刮刮|`programming_languages/scratch/`|
### 02 — 人工智慧與機器學習
|文件 |描述 |
|------|-------------|
...
|[data_ethics_and_privacy.md](03_data_science_and_analytics/data_ethics_and_privacy.md)| GDPR、資料同意、演算法偏差、暗模式、匿名化 |
|[ensemble_methods.md](03_data_science_and_analytics/ensemble_methods.md)| Bagging、Boosting、Stacking、投票、隨機森林、XGBoost |
|[feature_engineering.md](03_data_science_and_analytics/feature_engineering.md)|變換、編碼、特徵選擇、降維 |
|[geospatial_analysis.md](03_data_science_and_analytics/geospatial_analysis.md)|座標系、空間操作、GeoPandas、柵格分析 |
### 04 — 自然科學
|文件 |描述 |
|------|-------------|
...
|文件 |描述 |
|------|-------------|
|[business_and_economics.md](05_business_and_economics/business_and_economics.md)|公司架構、行銷、經濟學、新創公司 |
|[finance_and_investing.md](05_business_and_economics/finance_and_investing.md)|個人理財、投資、市場、退休 |
|[law_and_legal_systems.md](05_business_and_economics/law_and_legal_systems.md)|法律制度、合約、侵權、智慧財產權、就業 |
|[marketing_and_digital_strategy.md](05_business_and_economics/marketing_and_digital_strategy.md)| 4P、數位通路、SEO/SEM、分析、品牌策略 |
|[management_and_project_methodologies.md](05_business_and_economics/management_and_project_methodologies.md)|領導、敏捷/Scrum/看板、OKR、風險管理 |
|[behavioural_economics.md](05_business_and_economics/behavioural_economics.md)|認知偏差、前景理論、啟發法、助推、選擇架構 |
|[game_theory.md](05_business_and_economics/game_theory.md)|納許均衡、囚徒困境、機制設計、拍賣 |
|[intellectual_property_and_innovation.md](05_business_and_economics/intellectual_property_and_innovation.md)|專利、版權、商標、商業機密、開源許可 |
|[organisational_design_and_culture.md](05_business_and_economics/organisational_design_and_culture.md)|組織結構、文化類型、變革管理、團隊動態 |
|[supply_chain_and_operations.md](05_business_and_economics/supply_chain_and_operations.md)|庫存管理、精實製造、物流、牛鞭效應|
### 06 — 人文與藝術
|文件 |描述 |
|------|-------------|
...
|文件 |描述 |
|------|-------------|
|[dictionary.md](07_general_reference/dictionary.md)|全面的單字定義 (A-Z) |
|[general_knowledge.md](07_general_reference/general_knowledge.md)|太陽系、人體、地理、能源 |
|[technology_and_computing.md](07_general_reference/technology_and_computing.md)|運算基礎、網際網路、資料庫、雲端、安全性 |
|[safe_communication.md](07_general_reference/safe_communication.md)|溝通指南和最佳實踐 |
|[learning_science_and_pedagogy.md](07_general_reference/learning_science_and_pedagogy.md)|檢索練習、間隔重複、布魯姆分類法、學習設計 |
|[research_methodology.md](07_general_reference/research_methodology.md)|科學方法、抽樣、有效性、實驗設計、同儕審查 |
|[writing_and_communication.md](07_general_reference/writing_and_communication.md)|金字塔原理、演示、說服、商務寫作 |
### 08 — 未來與趨勢
|文件 |描述 |
|------|-------------|
...
|文件 |描述 |
|------|-------------|
|[ai_llm_failures.md](09_lessons_from_failures/ai_llm_failures.md)|幻覺、偏見、對齊失敗|
|[code_quality_issues.md](09_lessons_from_failures/code_quality_issues.md)|常見的編碼錯誤與反模式 |
|[cognitive_logical_issues.md](09_lessons_from_failures/cognitive_logical_issues.md)|推理錯誤與認知偏差|
|[rag_vector_search.md](09_lessons_from_failures/rag_vector_search.md)| RAG 與向量搜尋陷阱 |
|[security_vulnerabilities.md](09_lessons_from_failures/security_vulnerabilities.md)|常見安全漏洞 |
|[system_reliability.md](09_lessons_from_failures/system_reliability.md)|系統故障與可靠性模式|
|[api_design_and_integration_failures.md](09_lessons_from_failures/api_design_and_integration_failures.md)| API 反模式、重大變更、版本控制失敗、級聯失敗 |
|[data_pipeline_and_etl_failures.md](09_lessons_from_failures/data_pipeline_and_etl_failures.md)|架構漂移、重複資料、驗證差距、管道監控 |
|[ml_project_failures.md](09_lessons_from_failures/ml_project_failures.md)|資料外洩、期望不符、部署失敗、模型衰退 |
### 10 — 快速參考
|文件 |描述 |
|------|-------------|
...
4. 在`01_coding_and_technology/programming_languages/python/`中選擇語言
### 對於軟體開發人員
...
## 重要免責聲明
- **醫療資訊：**`medicine_and_healthcare.md`中的內容僅用於教育目的，不應取代專業醫療建議。
- **法律資訊：**`law_and_legal_systems.md`中的內容僅供參考，不構成法律建議。
- **財務資訊：**`finance_and_investing.md`中的內容具有教育意義，不應被視為財務建議。
- **未來預測：**`08_future_and_trends/`中的內容包含可能更改的推測資訊和預測。
---

## 使用指南
### 對於人工智慧系統
- 所有文件都使用清晰的分層標題（`#` 標題、`##` 部分、`###` 小節）
- 表格用於整個過程中的結構化比較
- 程式碼範例包括語法突出顯示
- 交叉引用使用相對降價鏈接
### 對於人類讀者
...
## 貢獻和元數據
此知識庫中的每個內容檔案（除此`README.md`之外的所有內容）都以 YAML frontmatter 區塊開啟。它遵循[skills](../../skills/skill-creator.md)使用的相同貢獻者追蹤模式，因此作者身份、編輯和評論在兩個集合中保持可追溯。對於一般貢獻工作流程（分叉、分支、拉取請求、檔案放置和命名約定），請參閱根[CONTRIBUTING.md](../../CONTRIBUTING.md)。
### Frontmatter 架構
每個檔案都以此區塊開始（在`---`分隔符號之間），分為五個註解部分：
```yaml
---
# Metadata
...
|---|---|
|`title`|從文件的第一個`#`標題中提取 |
|`description`|一行摘要；主題文件重用本自述文件索引中的條目，程式語言檔案使用產生的描述 |
|`category`/`reviewed_by`|源自父目錄（`01_coding_and_technology`→“編碼與技術”/“編碼與技術知識庫團隊”）|
|`version`|語意版本；每次編輯都會出現碰撞（見下文）|
|`authors`/`contributors`|原作者以及此後編輯過該文件的任何人 |
|`changelog`|僅附加更改列表，最新的在前 |
|`review_date`/`next_review`| 〜6 個月和〜1 年的節奏，反映了技能審查時間表 |
|`tags`|檔名標記加上乾淨的類別關鍵字（例如`coding-and-technology`）|
|`difficulty_level`|按類別設置，並按語言覆蓋（例如 Haskell/Assembly →`advanced`、Scratch →`beginner`）|
|`estimated_reading_time`|依行數計算 |
### 編輯文件
當您變更知識庫檔案時，請保持其 frontmatter 同步：
1. **凹凸`version`** 以下[SemVer](https://semver.org/)：
   - 補丁（`1.0.x`）：拼字錯誤、格式、細微修正
   - 次要 (`1.x.0`)：新部分、擴充內容、新範例
   - 主要 (`x.0.0`): 完全重寫或重組
2. **新增變更日誌條目**（最新的在前）描述您所做的變更：   ```yaml
   changelog:
     - version: "1.1.0"
       date: "2026-08-05"
       author: "Your Name"
     ...
     - version: "1.0.0"
       ...
       changes: "Added YAML frontmatter metadata for contributor tracking"
   ```
3. **將`last_modified`** 更新為更改日期
4. **如果這是您第一次編輯該文件，請將自己加入`contributors`**：   ```yaml
   contributors:
     - name: "Your Name"
...
### 品質檢查表
在提交新的或編輯的知識庫文件之前，請先驗證：
- [ ] YAML frontmatter 完整且有效（所有五個部分都存在，位於`---`分隔符號之間）
- [ ]`title`、`description`、`category`、`version`、`status`已設置
- [ ]`authors`中至少列出了一位作者
- [ ]`changelog`有一個記錄變更的條目（最新的在前）
- [ ]`last_modified`反映今天的日期
- [ ]`tags`包含 3-6 個相關關鍵字以及乾淨類別關鍵字
- [ ]`difficulty_level`已設定（初級/中級/高級）
- [ ]`estimated_reading_time`的內容長度是現實的
- [ ] 正文內容遵循上面的[Usage Guidelines](#usage-guidelines)
- [ ] 沒有損壞的交叉引用
---
