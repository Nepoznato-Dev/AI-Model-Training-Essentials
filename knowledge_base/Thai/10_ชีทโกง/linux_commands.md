# คู่มืออ้างอิงคำสั่ง Linux อย่างรวดเร็ว
...
tee file.txt            # เอาต์พุต to file and screen
```
...
- Test destructive commands without execution flags first
