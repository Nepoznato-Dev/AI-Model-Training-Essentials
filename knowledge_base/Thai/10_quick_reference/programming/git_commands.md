...
# Git คำสั่งอ้างอิงด่วน
คำสั่ง Git ที่จำเป็นสำหรับการควบคุมเวอร์ชัน
---
...
### ขั้นตอนการทำงานของโปรแกรมแก้ไขด่วน```bash
git checkout main
git pull
...
## แป้นพิมพ์ลัด (Git Bash)
| ทางลัด | การกระทำ |
|---------||--------|
| `Ctrl+R`| ประวัติการค้นหาแบบย้อนกลับ |
| `Tab`| เติมข้อความอัตโนมัติ |
| `Ctrl+C`| ยกเลิกคำสั่ง |
| `Ctrl+Z`| ระงับกระบวนการ |
| `fg`| ดำเนินกระบวนการที่ถูกระงับต่อ |
---

## แนวทางปฏิบัติที่ดีที่สุด
✅ **ทำ:**
- เขียนข้อความยืนยันที่ชัดเจนและสื่อความหมาย
- กระทำบ่อยครั้งด้วยการจัดกลุ่มแบบลอจิคัล
- ใช้สาขาสำหรับคุณสมบัติ/การแก้ไข
-ดึงก่อนเริ่มงาน
- รีวิว`git status`บ่อยๆ
❌ **อย่า:**
- ส่งข้อมูลที่ละเอียดอ่อน (คีย์ API, รหัสผ่าน)
- บังคับผลักดันไปยังสาขาที่ใช้ร่วมกัน
- คอมมิตไฟล์ไบนารีขนาดใหญ่
- ละเว้นข้อขัดแย้งในการผสาน
- ทำงานโดยตรงกับ main/master
---
...
*อัปเดตล่าสุด: กรกฎาคม 2569 | คอมไพล์ 2.x*