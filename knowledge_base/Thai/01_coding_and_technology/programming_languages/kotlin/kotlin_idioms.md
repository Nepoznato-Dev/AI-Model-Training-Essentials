...
# Kotlin — รูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุด
คู่มือนี้ครอบคลุมถึงรูปแบบสำนวนและแนวปฏิบัติที่ดีที่สุดในการเขียนโค้ด Kotlin ที่มีสำนวนที่ชัดเจน
---
...
## สรุป
สำนวน Kotlin เน้น: ความปลอดภัยแบบ null, คลาสข้อมูล, ประเภทที่ปิดผนึก, ฟังก์ชันขอบเขต, ฟังก์ชันส่วนขยาย, โครูทีน และโค้ดที่เน้นการแสดงออก ปฏิบัติตามข้อตกลงการเข้ารหัส Kotlin ใช้ ktlint สำหรับการจัดรูปแบบ และ detekt สำหรับการวิเคราะห์แบบคงที่ Kotlin ให้ความสำคัญกับความกระชับและความหมายที่ชัดเจน — เขียนแบบสำเร็จรูปให้น้อยลง ใช้ไลบรารีมาตรฐาน และใช้`val`เป็นค่าเริ่มต้น