...
Erlang ถูกสร้างขึ้นโดย Ericsson ในปี 1986 เพื่อจ่ายไฟให้กับสวิตช์โทรศัพท์ ซึ่งอธิบายว่าทำไมจึงจัดการกับการทำงานพร้อมกัน ความทนทานต่อข้อผิดพลาด และระบบแบบกระจายได้ดีกว่าแทบสิ่งอื่นใด กระบวนการ Erlang มีขนาดเล็ก โดดเดี่ยว และสื่อสารผ่านการส่งข้อความเท่านั้น เมื่อกระบวนการขัดข้อง ผู้บังคับบัญชาจะเริ่มต้นใหม่ ปรัชญา "ปล่อยให้มันพัง" นี้สร้างระบบที่ทำงานได้นานหลายปีโดยไม่มีการหยุดทำงาน
...
## สรุป
Erlang แก้ไขปัญหาที่ภาษาส่วนใหญ่ยังคงประสบปัญหา: ระบบการสร้างที่ไม่เคยล่ม รูปแบบการทำงานพร้อมกัน — กระบวนการที่ไม่ซับซ้อน การส่งข้อความ การควบคุมดูแล "ปล่อยให้มันผิดพลาด" ล้ำหน้ากว่าภาษากระแสหลักที่ค้นพบเพียงภาษากระแสหลักหลายทศวรรษ Elixir นำพลังพิเศษของ Erlang มารวมเข้ากับไวยากรณ์สมัยใหม่พร้อมประสบการณ์นักพัฒนาที่ยอดเยี่ยม หากคุณกำลังสร้างระบบแบบเรียลไทม์ แบบกระจาย หรือทนทานต่อข้อผิดพลาด Erlang/Elixir คุ้มค่ากับการลงทุน เส้นโค้งการเรียนรู้นั้นมีอยู่จริง (การเขียนโปรแกรมเชิงฟังก์ชัน การจับคู่รูปแบบ การคิดตามกระบวนการ) แต่ผลลัพธ์ที่ได้คือซอฟต์แวร์ที่ยังคงอยู่และปรับขนาดได้อย่างคาดเดาได้