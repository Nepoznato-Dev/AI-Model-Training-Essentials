...
-->
# Swift — รูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุด
คู่มือนี้ครอบคลุมถึงรูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุดในการเขียนโค้ด Swift ที่สะอาดตา
---

## ตัวเลือกและความปลอดภัย
```swift
...
## สรุป
สำนวน Swift เน้น: ความปลอดภัย (ทางเลือก, การป้องกัน), ประเภทของค่า (struct), การออกแบบที่เน้นโปรโตคอล, การจับคู่รูปแบบ, async/await และความไม่เปลี่ยนรูป (`let`ตามค่าเริ่มต้น) ปฏิบัติตามแนวทางการออกแบบ Swift API ใช้ SwiftLint สำหรับคุณภาพของโค้ด และใช้ SwiftFormat สำหรับการจัดรูปแบบ Swift ให้ความสำคัญกับความปลอดภัยและการแสดงออก - "ถ้ามันคอมไพล์ก็อาจจะถูกต้อง"