...
## สรุป
ไวยากรณ์ภาษาแอสเซมบลีถูกกำหนดโดยสถาปัตยกรรมโปรเซสเซอร์และแอสเซมเบลอร์ (NASM, GAS, MASM) x86-64 มีรีจิสเตอร์เอนกประสงค์ 16 รีจิสเตอร์ โหมดการกำหนดแอดเดรสหลายโหมด และคำสั่งหลายร้อยคำสั่งซึ่งครอบคลุมการเคลื่อนย้ายข้อมูล เลขคณิต ลอจิก โฟลว์การควบคุม SIMD และการเรียกระบบ ไวยากรณ์ NASM ที่ใช้ในที่นี้เป็นรูปแบบที่ใช้กันทั่วไปมากที่สุดสำหรับการพัฒนา Linux x86-64 การเรียนรู้แอสเซมบลีต้องอาศัยความเข้าใจในรีจิสเตอร์ สแต็ก รูปแบบการเรียก และวิธีแมปโครงสร้างระดับสูงกับคำสั่งของเครื่องจักร