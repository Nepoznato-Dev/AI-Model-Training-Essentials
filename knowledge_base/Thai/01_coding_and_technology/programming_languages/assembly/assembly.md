...
ภาษาแอสเซมบลีไม่ได้ใช้สำหรับการสร้างแอปพลิเคชัน ใช้เมื่อคุณต้องการการควบคุมฮาร์ดแวร์อย่างสมบูรณ์: การเขียนเคอร์เนลของระบบปฏิบัติการ ไดรเวอร์อุปกรณ์ บูตโหลดเดอร์ เฟิร์มแวร์แบบฝัง ส่วนโค้ดที่มีความสำคัญต่อประสิทธิภาพ วิศวกรรมย้อนกลับ และการทำความเข้าใจว่าคอมพิวเตอร์ดำเนินการตามคำสั่งอย่างไร
---
...
| **รายละเอียด** | งานง่ายๆ ต้องใช้คำแนะนำมากมาย | ใช้มาโคร ทำให้ส่วนการประกอบน้อยที่สุด |
| **ไม่มีการพกพา** | ไวยากรณ์ที่แตกต่างกันสำหรับแอสเซมเบลอร์แต่ละตัว (NASM, GAS, MASM) | ใช้อินทรินซิกของคอมไพเลอร์หรือแอสเซมบลีแบบอินไลน์ |
| **ความยากในการดีบัก** | ตรรกะที่ติดตามได้ยากในระดับคำสั่ง | ใช้ดีบักเกอร์ (GDB); เพิ่มความคิดเห็นอย่างเสรี |
---
...
การทำความเข้าใจโหมดการกำหนดแอดเดรสเป็นสิ่งสำคัญสำหรับการเขียนแอสเซมบลีที่มีประสิทธิภาพ แต่ละโหมดจะควบคุมวิธีการระบุตำแหน่งของตัวถูกดำเนินการ
...
| **การจัดตำแหน่งแคช** | ปานกลาง | จัดตำแหน่ง hot loops ให้เป็นขอบเขตขนาด 16/32 ไบต์ |
