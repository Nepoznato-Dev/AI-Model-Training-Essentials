...
- **บทแนะนำการเขียนโปรแกรมที่ดีที่สุด**: ขจัดอุปสรรคด้านไวยากรณ์ทั้งหมด แนวคิดต่างๆ ได้รับการสอนผ่านการปรุงแต่งด้วยภาพ
...
| เครื่องมือ | วิธีใช้ |
|------|-----------|
| **โหมดเต่า** | คลิกขวาที่สไปรท์แล้วเลือก "แสดงการแก้ไขจุดบกพร่อง" เพื่อดูพิกัด |
...
|---------|-------|----------|
| สไปรท์ไม่ตอบสนอง | ไม่มีกิจกรรมหมวกบล็อก | เพิ่ม "เมื่อคลิกธงเขียว" หรือกิจกรรมอื่นๆ |
| โคลนไม่ทำงาน | สร้างโคลนแล้วแต่ไม่แสดง | เพิ่มบล็อก "แสดง" หลัง "เมื่อฉันเริ่มเป็นโคลน" |
| ตัวแปรที่ใช้ร่วมกันระหว่างสไปรท์ | ความสับสนของตัวแปรทั่วโลกและท้องถิ่น | ใช้ตัวเลือก "สำหรับสไปรท์นี้เท่านั้น" |
