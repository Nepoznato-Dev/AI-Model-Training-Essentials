...
---
# MATLAB - การอ้างอิงไวยากรณ์
เอกสารนี้ให้การอ้างอิงไวยากรณ์ที่มีโครงสร้างครอบคลุมสำหรับ MATLAB (R2024+) ช่วยเสริมการอ้างอิง MATLAB หลักโดยมุ่งเน้นไปที่รูปแบบไวยากรณ์ที่ละเอียดถี่ถ้วน การดำเนินการของเมทริกซ์ การวางแผน และสำนวนการคำนวณทางวิทยาศาสตร์
---
...
|----------|-|---------|-------|
| `+``-``*``/``^`| เลขคณิต | `A * B`| เมทริกซ์คูณ |
| `.*``./``.^`| องค์ประกอบที่ชาญฉลาด | `A .* B`| การดำเนินการอาร์เรย์ |
| `'`| ย้าย | `A'`| คอนจูเกตทรานสโพส |
| `.'`| ทรานสโพสแบบไม่คอนจูเกต | `A.'`| |
| `\`| หารซ้าย | `A \ b`| แก้ขวาน = b |
| `/`| หารขวา | `b / A`| แก้ xA = b |
| `==``~=` | ความเท่าเทียมกัน | `A == B`| องค์ประกอบที่ชาญฉลาด |
| `<``>``<=``>=` | การเปรียบเทียบ | `A > 0`| องค์ประกอบที่ชาญฉลาด |
| `&``\|``~`| ตรรกะ (เชิงองค์ประกอบ) | `A & B`| |
| `&&``\|\|` | ลัดวงจร | `a && b`| สเกลาร์เท่านั้น |
| `:`| ทวิภาค/พิสัย | `1:10`| `start:step:stop`|
| `;`| ตัวคั่นแถว / ระงับ | `[1; 2; 3]`| |
| `,`| ตัวคั่นคอลัมน์ | `[1, 2, 3]`| |
---
...
## สรุป
ไวยากรณ์ของ MATLAB เน้นเมทริกซ์เป็นหลัก — ทุกตัวแปรจะเป็นอาร์เรย์ และการดำเนินการได้รับการปรับให้เหมาะสมสำหรับพีชคณิตเชิงเส้น ตัวดำเนินการโคลอน การทำดัชนีแบบลอจิคัล และการดำเนินการแบบเวกเตอร์จะกำจัดการวนซ้ำสำหรับงานตัวเลขส่วนใหญ่ ระบบการลงจุดสร้างตัวเลขคุณภาพสิ่งพิมพ์ด้วยรหัสขั้นต่ำ กล่องเครื่องมือขยาย MATLAB ไปสู่ทุกขอบเขตทางวิศวกรรม ในขณะที่ Python ได้รุกล้ำพื้นที่บางส่วน MATLAB ยังคงเป็นมาตรฐานสำหรับการคำนวณทางวิศวกรรม การสร้างแบบจำลองแบบ Simulink และการสร้างต้นแบบอย่างรวดเร็ว