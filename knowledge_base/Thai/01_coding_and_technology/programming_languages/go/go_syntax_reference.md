...
| `-`| การลบ | `3 - 2`| `1`| |
| `*`| การคูณ | `3 * 2`| `6`| |
| `/`| กอง | `7 / 2`| `3`| การหารจำนวนเต็มสำหรับ ints |
| `%`| ส่วนที่เหลือ | `7 % 2`| `1`| เครื่องหมายตรงกับเงินปันผล |
| `&`| ระดับบิตและ | `5 & 3`| `1`| |
| `\|`| ระดับบิตหรือ | `5 \| 3`| `7`| |
| `^`| Bitwise XOR | `5 ^ 3`| `6`| ส่วนเสริมระดับบิตด้วย (unary) |
| `&^`| ชัดเจนเล็กน้อย (และไม่) | `5 &^ 3`| `4`| ไม่ซ้ำใครที่จะไป |
| `<<`| เลื่อนซ้าย | `5 << 1`| `10`| |
| `>>`| เลื่อนไปทางขวา | `5 >> 1`| `2`| |
### ตัวดำเนินการเปรียบเทียบ
| ตัวดำเนินการ | ชื่อ | ตัวอย่าง | หมายเหตุ |
|----------|-|---------|-------|
| `==`| เท่ากับ | `x == y`| ประเภทที่เปรียบเทียบเท่านั้น |
| `!=`| ไม่เท่ากัน | `x != y`| |
| `<`,`>`,`<=`,`>=`| การสั่งซื้อ | `x >= y`| สตริงเปรียบเทียบพจนานุกรม |
...
## สรุป
ไวยากรณ์ของ Go นั้นตั้งใจให้น้อยที่สุด — ไม่มีการสืบทอด, ไม่มีเมธอดโอเวอร์โหลด, ไม่มีข้อยกเว้น, ไม่มีมาโคร สิ่งที่เหลืออยู่คือชุดโครงสร้างที่สะอาดตาและตั้งฉาก: โครงสร้างและอินเทอร์เฟซสำหรับการเรียบเรียง กอร์รูทีนและช่องทางสำหรับการทำงานพร้อมกัน และการจัดการข้อผิดพลาดที่ชัดเจนเพื่อความน่าเชื่อถือ พลังของภาษาไม่ได้มาจากไวยากรณ์ที่ซับซ้อน แต่มาจากปฏิสัมพันธ์อันงดงามของคำดั้งเดิมที่เรียบง่าย Generics (Go 1.18+) เพิ่มความยืดหยุ่นของประเภทโดยไม่ทำให้ความชัดเจนของคุณลักษณะของ Go ลดลง