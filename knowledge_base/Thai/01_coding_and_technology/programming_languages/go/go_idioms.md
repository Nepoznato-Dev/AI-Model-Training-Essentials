...
-->
# Go - รูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุด
คู่มือนี้ครอบคลุมถึงรูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุดในการเขียนโค้ด Go ที่ดูสะอาดตา
---
...
## สรุป
สำนวน Go เน้น: ความเรียบง่าย การจัดการข้อผิดพลาดที่ชัดเจน อินเทอร์เฟซขนาดเล็ก องค์ประกอบเหนือการสืบทอด กอร์รูทีนพร้อมบริบท และ "ยอมรับอินเทอร์เฟซ โครงสร้างส่งคืน" ปฏิบัติตาม`gofmt`สำหรับการจัดรูปแบบ`golangci-lint`สำหรับ Linting และคู่มือ Go Code Review Comments อย่างเป็นทางการ ชุมชน Go ให้ความสำคัญกับความสามารถในการอ่าน ความเรียบง่าย และ "วิธีการที่ชัดเจนในการดำเนินการ" หลีกเลี่ยงโค้ดที่ชาญฉลาด — โค้ด Go ควรน่าเบื่อและคาดเดาได้