...
-->
# ไป - ข้อผิดพลาดทั่วไปและการต่อต้านรูปแบบ
เอกสารนี้รวบรวมข้อผิดพลาด กับดัก และรูปแบบการต่อต้านที่พบบ่อยที่สุดใน Go แต่ละรายการจะแสดงแนวทางที่ไม่ถูกต้อง อธิบายว่าทำไมจึงล้มเหลว และให้แนวทางแก้ไขที่ถูกต้อง
---

## 1. การจับตัวแปรลูปใน Goroutines
```go
...
## 5. ไม่มีการอ้างอิงตัวชี้เกี่ยวกับวิธีการโครงสร้าง
```go
...
## 7. การต่อต้านรูปแบบ: การส่งคืนตัวแปรที่มีชื่อก่อนกำหนด
```go
...
## 8. ลำดับการวนซ้ำของแผนที่เป็นแบบสุ่ม
```go
...
## 10. ต่อต้านรูปแบบ: มลภาวะต่ออินเทอร์เฟซ
```go
...
## 11. ไม่ได้ใช้`sync.Once`ในการเริ่มต้น
```go
...
## สรุป
ความเรียบง่ายของ Go คือจุดแข็ง แต่ก็มีกับดักที่ละเอียดอ่อน: goroutine รั่วไหลจากช่องที่ไม่มีบัฟเฟอร์, Slice ผนวกซีแมนทิกส์ที่ไม่แก้ไขต้นฉบับ, การโทรที่ถูกเลื่อนออกไปสะสมเป็นลูป และการวนซ้ำแผนที่ที่ตั้งใจสุ่ม สุภาษิต Go ชี้แนะวิธีการ: จัดการกับทุกข้อผิดพลาด ยอมรับอินเทอร์เฟซแต่ส่งคืนโครงสร้าง ใช้ตัวรับตัวชี้สำหรับประเภท mutex และเลือกใช้วิธีพื้นฐานการทำงานพร้อมกัน (`sync.Once`,`errgroup`, การยกเลิกบริบท) มากกว่าการจัดการ goroutine ด้วยตนเอง เขียนโค้ดง่ายๆ ก่อน — Go ให้รางวัลความชัดเจนมากกว่าความฉลาด