...
-->
# Haskell - ข้อผิดพลาดทั่วไปและการต่อต้านรูปแบบ
เอกสารนี้รวบรวมข้อผิดพลาด กับดัก และรูปแบบการต่อต้านที่พบบ่อยที่สุดใน Haskell พร้อมการแก้ไข
---

## 1. รายการที่ไม่มีที่สิ้นสุดและความเกียจคร้านที่น่าประหลาดใจ
```haskell
...
## 5. ไม่ใช้ไวยากรณ์บันทึกอย่างถูกต้อง
```haskell
...
## 7. การต่อต้านรูปแบบ: การใช้`IO`มากเกินไป
```haskell
...
## สรุป
ความบริสุทธิ์และความเกียจคร้านของ Haskell ทำให้เกิดข้อผิดพลาดที่ไม่เหมือนใคร: พื้นที่รั่วจากการประเมินแบบขี้เกียจ ฟังก์ชันบางส่วนที่เสียหายขณะรันไทม์ ความสับสนระหว่างสตริง/ข้อความ/ByteString และการใช้ IO มากเกินไป วิธีของ Haskell คือ: ใช้การประเมินที่เข้มงวดสำหรับตัวสะสม (`foldl'`, BangPatterns ) หลีกเลี่ยงฟังก์ชันบางส่วน (`head`,`read`,`!!`) ใช้`Maybe`/`Either`สำหรับการจัดการข้อผิดพลาด ใช้`Text`สำหรับข้อความ และทำให้ IO น้อยที่สุด ระบบประเภทของคอมไพเลอร์คือพันธมิตรที่ยิ่งใหญ่ที่สุดของคุณ ปล่อยให้มันแนะนำคุณไปสู่ฟังก์ชันที่สมบูรณ์และบริสุทธิ์