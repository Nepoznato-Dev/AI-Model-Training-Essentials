...
-->
# Fortran - รูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุด
คู่มือนี้ครอบคลุมถึงรูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุดในการเขียนโค้ด Fortran (2018+) ที่ทันสมัยและสะอาดตา
---
...
## สรุป
สำนวน Fortran สมัยใหม่เน้น:`implicit none`, การดำเนินการอาร์เรย์ (หลีกเลี่ยงการวนซ้ำ), อาร์เรย์รูปร่างสมมติ, ประเภทที่ได้รับพร้อมกับโพรซีเดอร์ที่ผูกกับประเภท และ`intent`สำหรับอาร์กิวเมนต์ทั้งหมด ติดตาม fprettify เพื่อจัดรูปแบบ Modern Fortran (2018+) พร้อม coarrays และ DO CONCURRENT รองรับการประมวลผลแบบขนานโดยกำเนิด