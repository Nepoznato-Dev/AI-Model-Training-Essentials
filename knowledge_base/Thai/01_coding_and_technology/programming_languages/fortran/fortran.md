...
## ทำไมเรื่อง Fortran ถึงสำคัญ
- **ประสิทธิภาพ HPC**: คอมไพเลอร์ Fortran ผลิตรหัสตัวเลขที่เร็วที่สุดบางส่วน ซึ่งมักจะตรงกันหรือเกิน C/C++ สำหรับการดำเนินการของอาร์เรย์
- **ฐานรหัสเดิม**: ทศวรรษแห่งรหัสทางวิทยาศาสตร์ (แบบจำลองสภาพภูมิอากาศ การจำลองทางฟิสิกส์) เขียนด้วยภาษา Fortran
- **การทำงานของอาร์เรย์**: รองรับอาร์เรย์หลายมิติดั้งเดิมพร้อมไวยากรณ์ที่ออกแบบมาสำหรับการคำนวณทางคณิตศาสตร์
- **เสถียรภาพเชิงตัวเลข**: ภาษาและคอมไพเลอร์ได้รับการปรับให้เหมาะสมสำหรับการคำนวณจุดลอยตัว
- **Coarrays**: รองรับการเขียนโปรแกรมแบบขนานในตัว (Fortran 2008+)
- **ยังคงมีการพัฒนา**: Fortran 2023 เพิ่มคุณสมบัติที่ทันสมัยในขณะที่ยังคงความเข้ากันได้แบบย้อนหลัง
## การแลกเปลี่ยน
...
## พื้นฐานไวยากรณ์ (Modern Fortran)
```fortran
program hello
    implicit none
...
### ประเภทที่ได้รับและขั้นตอนผูกมัดประเภท
```fortran
...
### ขั้นตอนทั่วไปและการโอเวอร์โหลดของผู้ปฏิบัติงาน
```fortran
module vector_ops
    implicit none
...
### OpenMP (การขนานหน่วยความจำที่ใช้ร่วมกัน)
```fortran
...
### MPI (การขนานหน่วยความจำแบบกระจาย)
```fortran
program mpi_example
    use mpi
    implicit none
...
## การทดสอบ
### กรอบการทดสอบ (fortran-test หรือ pFUnit)
```fortran
...
## การทำงานร่วมกัน
### การทำงานร่วมกันของ C (ISO_C_BINDING)
```fortran
module c_interface
...
### การรวม Python (ผ่าน f2py หรือไลบรารี่ที่แชร์)
```fortran
...
## รูปแบบการออกแบบ
### รูปแบบ 1: การเขียนโปรแกรมอาร์เรย์ (หลีกเลี่ยงการวนซ้ำ)
```fortran
...
### รูปแบบ 2: ประเภทที่ได้รับจากพารามิเตอร์
```fortran
...
### รูปแบบ 3: รูปแบบการโทรกลับพร้อมตัวชี้ขั้นตอน
```fortran
module integrator
    implicit none
    abstract interface
...
### ธงการเพิ่มประสิทธิภาพคอมไพเลอร์
```bash
...
### การสร้างเวกเตอร์และหน่วยความจำ
```fortran
...
## เมื่อใดควรใช้ Fortran
| สถานการณ์ | ทำไมต้องฟอร์ทราน | ทางเลือกที่ดีกว่า |
|----------|-----------|-------------------|
| HPC / ซูเปอร์คอมพิวเตอร์ | ปรับให้เหมาะสมเพื่อประสิทธิภาพเชิงตัวเลข | C++ (ด้วยความระมัดระวัง), Julia |
| การจำลองทางวิทยาศาสตร์ | ทศวรรษของรหัสที่ผ่านการตรวจสอบแล้ว | Python (สำหรับการสร้างต้นแบบ), C++ |
| แบบจำลองสภาพภูมิอากาศ/สภาพอากาศ | โค้ดเบสแบบเดิม ประสิทธิภาพ | — |
| ฟิสิกส์เชิงคำนวณ | การดำเนินการอาร์เรย์ดั้งเดิม | Python (NumPy), จูเลีย |
| การสร้างแบบจำลองทางการเงิน (HPC) | ประสิทธิภาพสำหรับการคำนวณขนาดใหญ่ | C++, หลาม |
| การพัฒนาแอพพลิเคชั่นทั่วไป | ไม่เหมาะ | Python, Java, Go |
