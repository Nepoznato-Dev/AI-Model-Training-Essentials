...
# Fortran - การอ้างอิงไวยากรณ์
เอกสารนี้ให้การอ้างอิงไวยากรณ์ที่มีโครงสร้างครอบคลุมสำหรับ Modern Fortran (2008/2018) ช่วยเสริมการอ้างอิง Fortran หลักโดยมุ่งเน้นไปที่รูปแบบไวยากรณ์ที่ละเอียดถี่ถ้วน การทำงานของอาร์เรย์ โมดูล OOP และการประมวลผลประสิทธิภาพสูง
---
...
| `==``/=` | ความเท่าเทียมกัน | `a == b`| `/=`คือ "ไม่เท่ากัน" |
| `<``>``<=``>=` | การเปรียบเทียบ | `a >= b`| |
| `.and.``.or.``.not.`|`.and.`ตรรกะ | `a .and. b`| |
| `.eqv.``.neqv.` | ความเท่าเทียมกันทางตรรกะ | `a .eqv. b`| |
| `//`| การต่อสตริง | `'hello' // ' world'`| |
---
...
## Coarrays (การเขียนโปรแกรมแบบขนาน)
```fortran
...
## สรุป
ไวยากรณ์ของ Modern Fortran นั้นสะอาด มีโครงสร้าง และปรับให้เหมาะสมสำหรับการคำนวณเชิงตัวเลข การดำเนินการของอาร์เรย์จะกำจัดลูปสำหรับงานทางคณิตศาสตร์ส่วนใหญ่ โมดูลจัดให้มีการจัดการการห่อหุ้มและเนมสเปซ คุณสมบัติ OOP (ประเภทที่ได้รับ การสืบทอด ความหลากหลาย) ช่วยให้สามารถจัดระเบียบโค้ดได้ Coarrays เสนอการเขียนโปรแกรมแบบขนานดั้งเดิมโดยไม่มีไลบรารีภายนอก จุดแข็งของ Fortran — ประสิทธิภาพ การดำเนินการอาเรย์ และความแม่นยำเชิงตัวเลข — ยังคงไม่มีใครเทียบได้สำหรับการคำนวณทางวิทยาศาสตร์ สำหรับ HPC ฟิสิกส์การคำนวณ และการจำลองทางวิศวกรรม Fortran ยังคงเป็นโรงไฟฟ้าต่อไป