...
## 3. การกำหนดอาร์เรย์เทียบกับองค์ประกอบที่ชาญฉลาด
```fortran
...
## 5. ไม่ใช้ฟีเจอร์ Fortran สมัยใหม่
```fortran
...
## 6 หน่วยความจำรั่วด้วยอาร์เรย์ที่จัดสรรได้
```fortran
...
## สรุป
การมุ่งเน้นการคำนวณทางวิทยาศาสตร์ของ Fortran สร้างกับดัก: การจัดทำดัชนีแบบ 1 การพิมพ์โดยนัย (ใช้`implicit none`เสมอ) การดำเนินการกับอาร์เรย์เทียบกับลูป และข้อกำหนดเฉพาะของเจตนา Modern Fortran (2003+) มีโมดูล ประเภทที่ได้รับ และ OOP — ใช้พวกมัน วิธี Fortran คือ:`implicit none`เสมอ ระบุ`intent`สำหรับอาร์กิวเมนต์ทั้งหมด ใช้การดำเนินการอาร์เรย์ และจัดสรรคืนสิ่งที่คุณจัดสรร