...
## สรุป
ไวยากรณ์ของ Clojure มีวงเล็บเหมือนกัน ทุกรูปแบบคือรายการ ความคล้ายคลึงกันนี้ช่วยให้มาโครที่มีประสิทธิภาพสามารถแปลงโค้ดเป็นข้อมูลได้ โครงสร้างข้อมูลถาวรทำให้เกิดความไม่เปลี่ยนแปลงด้วยการแบ่งปันโครงสร้างเพื่อประสิทธิภาพ มาโครเธรดจะสร้างไปป์ไลน์ข้อมูลที่อ่านได้ Concurrency Primitives (อะตอม, อ้างอิง, เอเจนต์, แชนเนล) จัดการการเปลี่ยนแปลงสถานะได้อย่างปลอดภัย Lisp/Clojure มีอิทธิพลอย่างมากต่อการเขียนโปรแกรมสมัยใหม่ การรวบรวมขยะ, REPL, มาโคร และการเขียนโปรแกรมเชิงฟังก์ชันล้วนสืบย้อนไปถึง Lisp