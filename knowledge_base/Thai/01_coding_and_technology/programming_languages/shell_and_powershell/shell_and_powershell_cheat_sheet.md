...
## ข้อมูลพื้นฐานเกี่ยวกับ PowerShell
```powershell
# Variables
$name = "Alice"
$age = 30
...
## การจัดการข้อผิดพลาดของ PowerShell
```powershell
try {
