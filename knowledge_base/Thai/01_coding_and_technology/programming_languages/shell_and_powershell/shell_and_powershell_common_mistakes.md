...
# Shell & PowerShell — ข้อผิดพลาดทั่วไปและการต่อต้านรูปแบบ
เอกสารนี้รวบรวมข้อผิดพลาด กับดัก และรูปแบบการต่อต้านที่พบบ่อยที่สุดใน Shell/Bash และ PowerShell พร้อมการแก้ไข
---

## 1. ตัวแปรที่ไม่มีเครื่องหมายคำพูด (Bash)
```bash
...
## 8 PowerShell: วัตถุไปป์ไลน์เทียบกับสตริง
```powershell
...
## สรุป
กับดักสคริปต์เชลล์: อ้างอิงตัวแปรใน Bash เสมอ ใช้`[[ ]]`บน`[ ]`ใช้`set -euo pipefail`ตรวจสอบรหัสทางออก และทำความเข้าใจการกำหนดขอบเขตเชลล์ย่อย PowerShell traps: ใช้เครื่องหมายคำพูดคู่สำหรับการแก้ไข ใช้`-eq`ไม่ใช่`==`และจำไว้ว่าวัตถุไปป์ไลน์มีคุณสมบัติ ทั้งให้รางวัลแก่การอ้างอิงอย่างระมัดระวังและการจัดการข้อผิดพลาดที่ชัดเจน