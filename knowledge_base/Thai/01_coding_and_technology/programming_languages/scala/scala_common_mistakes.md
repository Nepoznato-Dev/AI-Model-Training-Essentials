...
# Scala - ข้อผิดพลาดทั่วไปและการต่อต้านรูปแบบ
เอกสารนี้รวบรวมข้อผิดพลาด กับดัก และรูปแบบการต่อต้านที่พบบ่อยที่สุดใน Scala พร้อมการแก้ไข
---
...
## 2. ไม่ใช้การจับคู่รูปแบบสำหรับประเภทที่ปิดผนึก
```scala
// ❌ WRONG — if/else chain
...
## 6. ไม่จัดการ`Option`อย่างถูกต้อง
```scala
...
## 7. การต่อต้านรูปแบบ: Null ใน Scala
```scala
// ❌ WRONG — using null
...
## สรุป
พลังของ Scala มาพร้อมกับความรับผิดชอบ: ชอบ`val`มากกว่า`var`ใช้การจับคู่รูปแบบสำหรับประเภทที่ปิดผนึก จัดการ`Option`อย่างถูกต้อง (อย่าเรียก`.get`) ใช้ for-comprehensions แทน Futures ที่ซ้อนกัน และหลีกเลี่ยง null Scala 3 ลดความซับซ้อนของรูปแบบเหล่านี้ด้วยการแจงนับ วิธีการขยาย และประเภทยูเนียน หลักการสำคัญ: หากคอมไพลเลอร์สามารถตรวจสอบได้ ให้คอมไพเลอร์ตรวจสอบมัน