...
# Scala - รูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุด
คู่มือนี้ครอบคลุมถึงรูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุดในการเขียนโค้ด Scala 3 ที่สะอาดและใช้งานได้จริง
---
...
## สรุป
สำนวน Scala เน้น: ความไม่เปลี่ยนรูป (`val`), การจับคู่รูปแบบ, ประเภทที่ปิดผนึก, ตัวเลือก/อย่างใดอย่างหนึ่งเพื่อความปลอดภัย, เพื่อความเข้าใจ, คอลเลกชันการทำงาน และคลาสประเภท (ให้/ใช้ใน Scala 3) ปฏิบัติตามคำแนะนำสไตล์ Scala ใช้ scalafmt สำหรับการจัดรูปแบบ และใช้ scalafix สำหรับ Linting ไวยากรณ์ที่สะอาดกว่า การแจงนับ ประเภททึบแสง และวิธีการขยายของ Scala 3 ทำให้ภาษาเข้าถึงได้ง่ายขึ้นในขณะที่ยังคงประสิทธิภาพการทำงานไว้