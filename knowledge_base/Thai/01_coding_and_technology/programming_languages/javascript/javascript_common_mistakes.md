...
-->
# JavaScript — ข้อผิดพลาดทั่วไปและการต่อต้านรูปแบบ
เอกสารนี้รวบรวมข้อผิดพลาด กับดัก และรูปแบบการต่อต้านที่พบบ่อยที่สุดใน JavaScript แต่ละรายการจะแสดงแนวทางที่ไม่ถูกต้อง อธิบายว่าทำไมจึงล้มเหลว และให้แนวทางแก้ไขที่ถูกต้อง
---

## 1.`this`ความสับสนที่ผูกพัน
```javascript
...
## 3.`var`ปัญหาเกี่ยวกับการชักรอกและขอบเขต
```javascript
...
## 5. ไม่จัดการกับการปฏิเสธตามสัญญา
```javascript
...
## 6. การแก้ไขวัตถุระหว่างการวนซ้ำ
```javascript
...
## 9. วัตถุที่คล้ายอาร์เรย์ไม่ใช่อาร์เรย์
```javascript
...
## 10. การต่อต้านรูปแบบ: การเปลี่ยนพารามิเตอร์ฟังก์ชัน
```javascript
...
## 11. ไม่เข้าใจ Event Loop และ Microtasks
```javascript
...
## 12. การต่อต้านรูปแบบ: การใช้ `eval()`
```javascript
...
## 13. ลืมทำความสะอาดผู้ฟังเหตุการณ์
```javascript
// ❌ WRONG — memory leak
class Component {
  mount() {
...
## 14. การคัดลอกแบบตื้นเทียบกับการคัดลอกแบบลึก
```javascript
...
## สรุป
ความยืดหยุ่นของ JavaScript มาพร้อมกับกับดัก: การเชื่อมโยง`this`ขึ้นอยู่กับไซต์การโทร`==`ดำเนินการบีบบังคับ สัญญาจำเป็นต้องมีการจัดการข้อผิดพลาด และการจัดลำดับลูปเหตุการณ์ (งานย่อยก่อนงานมาโคร) ไม่ชัดเจน กฎสมัยใหม่นั้นเรียบง่าย: ใช้`const`/`let`ไม่เคยใช้`var`เลือกใช้`===`มากกว่า`==`จัดการการปฏิเสธสัญญาเสมอ ใช้ฟังก์ชันลูกศรสำหรับการโทรกลับ หลีกเลี่ยงการเปลี่ยนแปลง และล้างข้อมูล Listener เหตุการณ์ การปฏิบัติตามกฎเหล่านี้จะช่วยขจัดข้อบกพร่องของ JavaScript ส่วนใหญ่