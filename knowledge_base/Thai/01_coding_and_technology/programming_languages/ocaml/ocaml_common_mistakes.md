...
-->
# OCaml — ข้อผิดพลาดทั่วไปและการต่อต้านรูปแบบ
เอกสารนี้รวบรวมข้อผิดพลาด กับดัก และรูปแบบการต่อต้านที่พบบ่อยที่สุดใน OCaml พร้อมการแก้ไข
---

## 1. การจับคู่รูปแบบโดยสังเขป
```ocaml
(* ❌ WRONG — missing cases *)
...
## 4. ไม่ได้ใช้`Option`อย่างถูกต้อง
```ocaml
...
## 5. สถานะที่ไม่แน่นอนในฟังก์ชันแบบเรียกซ้ำ
```ocaml
...
## สรุป
กับดัก OCaml: การจับคู่รูปแบบโดยสังเขป (คำเตือนคอมไพเลอร์),`=`คือความเท่าเทียมกันของโครงสร้างในขณะที่`==`เป็นแบบฟิสิคัล, ตัดทอนการหารจำนวนเต็ม ใช้`Option`แทนข้อยกเว้น และหลีกเลี่ยงสถานะที่ไม่แน่นอนโดยหันไปใช้การเรียกซ้ำและการพับส่วนท้าย คอมไพเลอร์ของ OCaml คือพันธมิตรของคุณ — โปรดใส่ใจคำเตือนของมัน