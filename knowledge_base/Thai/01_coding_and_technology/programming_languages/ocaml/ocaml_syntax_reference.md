...
# OCaml - การอ้างอิงไวยากรณ์
เอกสารนี้ให้การอ้างอิงไวยากรณ์ที่มีโครงสร้างและครอบคลุมสำหรับ OCaml (4.x/5.x) ช่วยเสริมการอ้างอิง OCaml หลักโดยมุ่งเน้นไปที่รูปแบบไวยากรณ์ที่ละเอียดถี่ถ้วน ประเภทข้อมูลพีชคณิต การจับคู่รูปแบบ โมดูล และสำนวนการเขียนโปรแกรมเชิงฟังก์ชัน
---
...
## สรุป
ไวยากรณ์ของ OCaml นั้นสะอาดตาและเป็นคณิตศาสตร์ ประเภทข้อมูลพีชคณิตและการจับคู่รูปแบบที่ละเอียดถี่ถ้วนทำให้สถานะที่เป็นไปไม่ได้ไม่สามารถเป็นตัวแทนได้ ระบบโมดูลพร้อมฟังก์ชันให้การสร้างนามธรรมที่ทรงพลังโดยไม่มีค่าใช้จ่ายรันไทม์ การอนุมานประเภทหมายถึงความปลอดภัยโดยไม่มีการใช้คำฟุ่มเฟือย อิทธิพลของ OCaml ที่มีต่อ Rust, F#, TypeScript และ Swift นั้นไม่อาจปฏิเสธได้ สำหรับการเขียนโปรแกรมระบบ คอมไพเลอร์ และการตรวจสอบอย่างเป็นทางการ OCaml ยังคงเป็นตัวเลือกอันดับต้นๆ