...
---
# Rust — รูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุด
คู่มือนี้ครอบคลุมถึงรูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุดในการเขียนโค้ด Rust ที่สะอาดและปลอดภัย
---
...
## สรุป
สำนวนสนิมเน้นที่: ความเป็นเจ้าของและการยืม`Result`/`Option`สำหรับการจัดการข้อผิดพลาด การแจงนับด้วยวิธีการ ลักษณะเฉพาะสำหรับนามธรรม การผูกมัดตัววนซ้ำ ตัวชี้อัจฉริยะสำหรับสถานะที่ใช้ร่วมกัน และนามธรรมที่ไม่มีต้นทุน ปฏิบัติตาม`rustfmt`สำหรับการจัดรูปแบบ`clippy`สำหรับ Linting และหลักเกณฑ์ Rust API ชุมชน Rust ให้ความสำคัญกับความปลอดภัย ประสิทธิภาพ และความถูกต้อง - "หากคอมไพล์ก็จะใช้งานได้" ต้องการ`&str`มากกว่า`String`ในอาร์กิวเมนต์ของฟังก์ชัน ใช้`?`สำหรับการแพร่กระจายข้อผิดพลาด และรับลักษณะทั่วไปด้วย `#[derive(Debug, Clone, ...)]`