...
คู่มือนี้ครอบคลุมถึงรูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุดในการเขียนโค้ด C# (12+) ที่ทันสมัยและสะอาดตา
---
...
## IDisposable และการจัดการทรัพยากร
```csharp
...
## สรุป
สำนวน C# สมัยใหม่เน้น: บันทึกสำหรับข้อมูล การจับคู่รูปแบบ ความปลอดภัยแบบ null (ประเภทการอ้างอิงที่เป็นโมฆะ) LINQ สำหรับคอลเลกชัน async/await ด้วย CancellationToken การพึ่งพาการฉีด ตัวสร้างหลัก นิพจน์คอลเลกชัน และการประกาศ`using`ปฏิบัติตามข้อตกลงการเข้ารหัส C# ใช้`dotnet format`สำหรับการจัดรูปแบบ และใช้ตัววิเคราะห์ Roslyn สำหรับคุณภาพของโค้ด C# สมัยใหม่ (12+) มีความกระชับและสื่ออารมณ์ — ครอบคลุมบันทึก การจับคู่รูปแบบ และตัวสร้างหลัก