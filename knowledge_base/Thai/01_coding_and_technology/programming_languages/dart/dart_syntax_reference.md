...
-->
# Dart - การอ้างอิงไวยากรณ์
เอกสารนี้ให้การอ้างอิงไวยากรณ์ที่มีโครงสร้างและครอบคลุมสำหรับ Dart (3.x) มันเสริมการอ้างอิง Dart หลักโดยมุ่งเน้นไปที่รูปแบบไวยากรณ์ที่ละเอียดถี่ถ้วน ความปลอดภัยของ null การเขียนโปรแกรมแบบอะซิงก์ และรูปแบบการออกแบบที่เน้น Flutter
---
...
|----------|-|---------|-------|
| `+``-``*``/``%``~/` | เลขคณิต | `7 ~/ 3`| `~/`เป็นการหารจำนวนเต็ม |
| `==``!=` | ความเท่าเทียมกัน | `a == b`| |
| `<``>``<=``>=` | การเปรียบเทียบ | `a >= b`| |
| `&&``\|\|``!`|`&&`ตรรกะ | `a && b`| ลัดวงจร |
| `??`| การรวมตัวกันเป็นโมฆะ | `a ?? b`| `b`ถ้า`a`เป็น null |
| `?.`| การเข้าถึงแบบ Null Aware | `a?.b`| null ถ้า`a`เป็น null |
| `!`| การยืนยันค่าว่าง | `a!`| พ่นถ้าเป็นโมฆะ |
| `..``?..` | น้ำตก | `obj..a..b`| การดำเนินการลูกโซ่บนวัตถุเดียวกัน |
| `??=`| มอบหมายแบบ Null Aware | `a ??= b`| กำหนดถ้าเป็นโมฆะ |
| `as`| พิมพ์หล่อ | `obj as String`| โยนความล้มเหลว |
| `is``is!` | พิมพ์การทดสอบ | `obj is String`| |
| `=>`| ฟังก์ชั่นลูกศร | `() => expr`| |
### สัญกรณ์น้ำตก
```dart
...
## สรุป
ไวยากรณ์ของ Dart นั้นชัดเจน สม่ำเสมอ และออกแบบมาเพื่อประสิทธิภาพการทำงาน ความปลอดภัยที่เป็นโมฆะของเสียงจะช่วยลดข้อผิดพลาดในการอ้างอิงที่เป็นโมฆะ ณ เวลารวบรวม Async/รอและสตรีมให้รูปแบบที่เป็นธรรมชาติสำหรับการเขียนโปรแกรมแบบอะซิงโครนัส คลาส มิกซ์อิน และคลาสที่ปิดผนึกช่วยให้สามารถจัดองค์ประกอบของออบเจ็กต์ได้อย่างยืดหยุ่น การจับคู่รูปแบบ บันทึก และตัวปรับแต่งคลาสของ Dart 3 ช่วยเพิ่มความหมาย แม้ว่าจุดประสงค์หลักของ Dart คือ Flutter แต่ไวยากรณ์ของมันก็เหมาะสมอย่างยิ่งสำหรับโดเมนแอปพลิเคชันใดๆ — ฝั่งเซิร์ฟเวอร์ (พร้อม Dart Frog หรือ Shelf), เครื่องมือ CLI และเว็บแอปพลิเคชัน (คอมไพล์เป็น JavaScript)