...
---
# Dart — ข้อผิดพลาดทั่วไปและการต่อต้านรูปแบบ
เอกสารนี้รวบรวมข้อผิดพลาด กับดัก และรูปแบบการต่อต้านที่พบบ่อยที่สุดใน Dart พร้อมการแก้ไข
---

## 1. การใช้ความปลอดภัยในทางที่ผิด
```dart
// ❌ WRONG — force unwrap
...
## 2. Async/Await โดยไม่มีข้อผิดพลาดในการจัดการ
```dart
...
## 3. ไม่ได้ใช้`const`Constructors
```dart
...
## 5. ไม่ใช้ Spread และ Collection-if
```dart
...
## 6. การต่อต้านรูปแบบ: StatefulWidget ขนาดใหญ่
```dart
...
## สรุป
ความปลอดภัยของ Dart นั้นทรงพลัง — อย่าเอาชนะมันด้วย`!`ใช้ตัวสร้าง`const`สำหรับอินสแตนซ์ Canonical แทนที่`hashCode`ด้วย`==`เสมอ ใช้ตัวดำเนินการ collection-if และ Spread สำหรับการสร้างรายการที่กระชับ และแยกตรรกะทางธุรกิจออกจากวิดเจ็ต Dart ให้รางวัลโค้ดที่สะอาด ปลอดภัย และถูกต้องตามข้อกำหนด