...
## มัณฑนากร (TC39 Stage 3 / TypeScript 5.0+)
```typescript
// Class decorator
...
## สรุป
ระบบประเภทของ TypeScript เป็นคุณลักษณะที่กำหนดและมีความลึกซึ้งอย่างเห็นได้ชัด ตั้งแต่คำอธิบายประกอบพื้นฐานไปจนถึงข้อมูลทั่วไป ประเภทตามเงื่อนไข ประเภทแมป ประเภทลิเทอรัลเทมเพลต และ`infer`ระบบประเภทโดยพื้นฐานแล้วคือภาษาเชิงฟังก์ชันที่ทำงานในเวลาคอมไพล์ การทำความเข้าใจการทำงานร่วมกันระหว่าง`interface`กับ`type`ประเภททั่วไปและยูทิลิตี้ และการพิมพ์แบบโครงสร้างและแบบระบุ รองรับการเขียน TypeScript ที่มีทั้งความปลอดภัยและถูกหลักสรีรศาสตร์ ภาษามีการพัฒนาอย่างต่อเนื่อง โดยแต่ละเวอร์ชันจะเพิ่มพลังการแสดงออกมากขึ้น ขณะเดียวกันก็รักษาความเข้ากันได้แบบย้อนหลังกับ JavaScript อย่างสมบูรณ์