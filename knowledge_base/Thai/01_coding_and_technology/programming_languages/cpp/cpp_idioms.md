...
-->
# C++ - รูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุด
คู่มือนี้ครอบคลุมถึงรูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุดในการเขียนโค้ด C++ (20/23) ที่ทันสมัยและสะอาดตา
---

## RAII และตัวชี้อัจฉริยะ
```cpp
...
## สรุป
สำนวน C++ สมัยใหม่เน้นที่: RAII และตัวชี้อัจฉริยะ, ความหมายการย้าย,`auto`สำหรับการลดประเภท, ช่วงและอัลกอริทึม (C++20), แนวคิดสำหรับข้อจำกัดของเทมเพลต,`std::optional`/`std::expected`สำหรับการขาดงาน/ข้อผิดพลาด, Rule of Zero และ`constexpr`สำหรับการคำนวณเวลาคอมไพล์ ปฏิบัติตาม`clang-format`สำหรับการจัดรูปแบบ,`clang-tidy`สำหรับ Linting และคอมไพล์ด้วย`-Wall -Wextra -Werror`ชุมชน C++ ให้ความสำคัญกับนามธรรมที่มีต้นทุนเป็นศูนย์ และ "ไม่ต้องจ่ายเงินสำหรับสิ่งที่คุณไม่ได้ใช้"