...
# Ruby — ข้อผิดพลาดทั่วไปและการต่อต้านรูปแบบ
เอกสารนี้รวบรวมข้อผิดพลาด กับดัก และรูปแบบการต่อต้านที่พบบ่อยที่สุดใน Ruby แต่ละรายการจะแสดงแนวทางที่ไม่ถูกต้อง อธิบายว่าทำไมจึงล้มเหลว และให้แนวทางแก้ไขที่ถูกต้อง
---

## 1. การแก้ไขคอลเลกชันระหว่างการวนซ้ำ
```ruby
...
## 3. การแก้ไขสตริงเทียบกับการต่อข้อมูล
```ruby
...
## 4. ไม่ใช้บล็อก/ตัวแจงนับตามสำนวน
```ruby
# ❌ WRONG — C-style loop
i = 0
...
## 5. การใช้ตัวแปรทั่วโลกในทางที่ผิด
```ruby
...
## 9. สัญลักษณ์และความสับสนของสตริง
```ruby
...
## สรุป
การแสดงออกของ Ruby สามารถนำไปสู่การต่อต้านรูปแบบ: การแก้ไขคอลเลกชันระหว่างการวนซ้ำ คลาสหลักของการแพตช์ลิง ตัวแปรโกลบอล และโมเดลไขมัน วิธี Ruby คือ: ใช้ตัวแจงนับ (`each`,`map`,`reject`) ชอบสัญลักษณ์และอาร์กิวเมนต์คำหลัก หยุดค่าตัวอักษรสตริง แยกอ็อบเจ็กต์บริการออกจากโมเดล และใช้การปรับแต่งแทนแพตช์ลิง Ruby ให้รางวัลแก่นักพัฒนาที่ยอมรับบล็อก การพิมพ์แบบเป็ด และหลักการที่ทำให้ประหลาดใจน้อยที่สุด