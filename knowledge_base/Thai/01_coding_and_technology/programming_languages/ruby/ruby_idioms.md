...
---
# Ruby — รูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุด
คู่มือนี้ครอบคลุมถึงรูปแบบสำนวนและแนวทางปฏิบัติที่ดีที่สุดในการเขียนโค้ด Rubyish ที่สะอาดตา
---
...
## สรุป
สำนวน Ruby เน้น: ความสุขของนักพัฒนา แบบแผนในการกำหนดค่า บล็อกและตัววนซ้ำ การพิมพ์แบบ Duck และไวยากรณ์ที่แสดงออก ปฏิบัติตาม Ruby Style Guide ใช้ RuboCop สำหรับ Linting และใช้ StandardRB สำหรับการจัดรูปแบบตามความคิดเห็น Ruby ให้ความสำคัญกับความสามารถในการอ่าน — โค้ดควรอ่านได้เหมือนภาษาอังกฤษ ต้องการวิธีการนับมากกว่าการวนซ้ำแบบแมนนวล ใช้สัญลักษณ์สำหรับตัวระบุ และยอมรับบล็อกสำหรับการวนซ้ำและการจัดการทรัพยากร