...
-->
# COBOL - การอ้างอิงไวยากรณ์
เอกสารนี้ให้การอ้างอิงไวยากรณ์ที่มีโครงสร้างและครอบคลุมสำหรับ COBOL (2014+) ช่วยเสริมการอ้างอิงภาษาโคบอลหลักโดยมุ่งเน้นไปที่รูปแบบไวยากรณ์ที่ละเอียดถี่ถ้วน คำอธิบายข้อมูล การประมวลผลไฟล์ และตรรกะทางธุรกิจ
---
...
## สรุป
ไวยากรณ์ของ COBOL นั้นละเอียดตามการออกแบบ - ทุกคำสั่งอ่านได้เหมือนภาษาอังกฤษ คำอธิบายข้อมูลที่มีส่วนคำสั่ง PIC จะกำหนดรูปแบบฟิลด์ได้อย่างแม่นยำ โครงสร้างสี่ส่วนบังคับให้มีการแยกข้อกังวล การจัดการไฟล์ถูกสร้างขึ้นในภาษา สำหรับการประมวลผลข้อมูลทางธุรกิจ เลขคณิตทศนิยมของ COBOL และ I/O เชิงบันทึกยังคงไม่มีใครเทียบได้ การทำความเข้าใจภาษาโคบอลหมายถึงการเข้าใจรากฐานของการประมวลผลระดับองค์กร