...
Copybooks เป็นกลไกของ COBOL สำหรับการใช้โค้ดซ้ำ ซึ่งคล้ายกับ`#include`ในภาษา C โดยจะถูกจัดเก็บเป็นสมาชิกแยกต่างหากและแทรกไว้ในเวลาคอมไพล์
```cobol
...
COBOL มีคำสั่ง PERFORM ให้เลือกหลายรูปแบบสำหรับการเขียนโปรแกรมแบบมีโครงสร้าง
```cobol
       PROCEDURE DIVISION.
...
## สรุป
ภาษาโคบอลเป็นมรดกตกทอดของยุคแรกๆ ของคอมพิวเตอร์ที่ไม่ยอมตาย เพราะมันไม่มีเงินพอจะทำได้ ระบบธนาคารและภาครัฐของโลกขึ้นอยู่กับโปรแกรม COBOL ที่ทำงานได้อย่างน่าเชื่อถือมานานหลายทศวรรษ แม้ว่าจะไม่มีใครเลือกภาษาโคบอลสำหรับโครงการใหม่ในปัจจุบัน แต่ภาษายังคงมีความสำคัญอย่างยิ่งสำหรับการรักษาโครงสร้างพื้นฐานที่เป็นรากฐานทางการเงินทั่วโลก การขาดแคลนนักพัฒนาภาษาโคบอลทำให้เป็นช่องทางที่ทำกำไรได้อย่างน่าประหลาดใจ