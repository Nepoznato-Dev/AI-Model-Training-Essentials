...
-->
# Lua — ข้อผิดพลาดทั่วไปและการต่อต้านรูปแบบ
เอกสารนี้รวบรวมข้อผิดพลาด กับดัก และรูปแบบการต่อต้านที่พบบ่อยที่สุดใน Lua พร้อมการแก้ไข
---

## 1. การจัดทำดัชนีแบบ 1-Based
```lua
...
## 7. ไม่ใช้ Metatables สำหรับ OOP
```lua
...
## สรุป
ความเรียบง่ายของ Lua ทำให้เกิดกับดัก: การจัดทำดัชนีแบบ 1 มีเพียง`nil`และ`false`เท่านั้นที่เป็นเท็จ ตารางเป็นการอ้างอิง (ไม่ใช่ค่า) ตัวแปรเป็นแบบโกลบอลตามค่าเริ่มต้น และ`pairs`จะไม่เรียงลำดับในขณะที่`ipairs`ถูกเรียงลำดับ วิธี Lua คือ: ใช้`local`เสมอ, ใช้`ipairs`สำหรับอาร์เรย์และ`pairs`สำหรับพจนานุกรม, ใช้`table.concat`สำหรับการสร้างสตริง และใช้ metatables สำหรับ OOP ความเรียบง่ายของ Lua คือพลัง — แต่ให้ความเคารพต่อกรณีขอบ