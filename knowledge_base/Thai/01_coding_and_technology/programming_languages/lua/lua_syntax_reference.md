...
| `//`| การแบ่งชั้น | `7 // 2`| ส่งคืน 3 (Lua 5.3+) |
| `==``~=` | ความเท่าเทียมกัน | `a == b`| `~=`คือ "ไม่เท่ากัน" |
| `<``>``<=``>=` | การเปรียบเทียบ | `a >= b`| |
| `and``or``not`| ตรรกะ | `a and b`| ส่งคืนตัวถูกดำเนินการ ไม่ใช่ booleans |
| `..`| การต่อข้อมูล | `"hello" .. " world"`| |
| `#`| ความยาว | `#t`| ความยาวของสตริงหรือตาราง |
| `&``\|``~``<<``>>`| ระดับบิต | `a & b`| Lua 5.3+ (การดำเนินการจำนวนเต็ม) |
### ตัวดำเนินการเชิงตรรกะ — การส่งคืนที่ไม่ใช่บูลีน
```lua
...
## สรุป
ไวยากรณ์ของ Lua มีเจตนาน้อยที่สุด — สามารถอธิบายภาษาทั้งหมดได้ในหน้าเดียว ตารางทำหน้าที่เป็นโครงสร้างข้อมูลสากล (อาร์เรย์ พจนานุกรม วัตถุ โมดูล) Metatables ให้ความสามารถในการขยายโดยไม่มีความซับซ้อนของภาษา Coroutines ช่วยให้สามารถทำงานร่วมกันแบบมัลติทาสก์และมีรูปแบบตัววนซ้ำที่สวยงาม พลังของภาษามาจากความสามารถในการฝังได้: Lua ได้รับการออกแบบมาให้อยู่ภายในแอปพลิเคชันโฮสต์ โดยให้ความสามารถในการเขียนสคริปต์โดยมีค่าใช้จ่ายน้อยที่สุด สำหรับการพัฒนาเกม การกำหนดค่า และระบบฝังตัว ความเรียบง่ายของ Lua คือจุดแข็งที่ยิ่งใหญ่ที่สุด — ภาษาเล็กๆ ที่ทำในสิ่งที่ต้องการอย่างแท้จริง และไม่มีอะไรเพิ่มเติม