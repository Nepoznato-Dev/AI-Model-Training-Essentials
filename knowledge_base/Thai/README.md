...
**องค์กร:** ไดเรกทอรีเฉพาะเรื่อง 10 รายการ + การอ้างอิงภาษาการเขียนโปรแกรม 34 รายการ
---
...
| [embedded_systems_and_iot.md](01_coding_and_technology/embedded_systems_and_iot.md)| ไมโครคอนโทรลเลอร์, เซ็นเซอร์, RTOS, โปรโตคอล IoT, การประมวลผลแบบ Edge |
...
|----------|------|-|----------|------|
| หลาม | `programming_languages/python/`| | จาวาสคริปต์ | `programming_languages/javascript/`|
| ซี | `programming_languages/c/`| | ซี++ | `programming_languages/cpp/`|
| ชวา | `programming_languages/java/`| | ซี# | `programming_languages/csharp/`|
| ไป | `programming_languages/go/`| | สนิม | `programming_languages/rust/`|
| ประเภทสคริปต์ | `programming_languages/typescript/`| | เอสแอลแอล | `programming_languages/sql/`|
| ทับทิม | `programming_languages/ruby/`| | PHP | `programming_languages/php/`|
| สวิฟท์ | `programming_languages/swift/`| | คอตลิน | `programming_languages/kotlin/`|
| อาร์ | `programming_languages/r/`| | วิชวลเบสิก | `programming_languages/visual_basic/`|
| โผ | `programming_languages/dart/`| | สกาล่า | `programming_languages/scala/`|
| ฮาสเคล | `programming_languages/haskell/`| | จูเลีย | `programming_languages/julia/`|
| หลัว | `programming_languages/lua/`| | เพิร์ล | `programming_languages/perl/`|
| เออร์ลัง/Elixir | `programming_languages/erlang_and_elixir/`| | โอแคมล์ | `programming_languages/ocaml/`|
| อารัมภบท | `programming_languages/prolog/`| | กระเพื่อม/Clojure | `programming_languages/lisp_and_clojure/`|
| เอด้า | `programming_languages/ada/`| | การประกอบ | `programming_languages/assembly/`|
| MATLAB | `programming_languages/matlab/`| | ฟอร์ทราน | `programming_languages/fortran/`|
| ภาษาโคบอล | `programming_languages/cobol/`| | เชลล์/พาวเวอร์เชลล์ | `programming_languages/shell_and_powershell/`|
| เดลฟี/ปาสคาล | `programming_languages/delphi_object_pascal/`| | เกา | `programming_languages/scratch/`|
...
| [data_ethics_and_privacy.md](03_data_science_and_analytics/data_ethics_and_privacy.md)| GDPR, ความยินยอมของข้อมูล, อคติของอัลกอริทึม, รูปแบบที่มืดมน, การทำให้ไม่ระบุชื่อ |
| [ensemble_methods.md](03_data_science_and_analytics/ensemble_methods.md)| การใส่ถุง การเพิ่มกำลัง การซ้อน การโหวต ฟอเรสต์แบบสุ่ม XGBoost |
| [feature_engineering.md](03_data_science_and_analytics/feature_engineering.md)| การแปลง การเข้ารหัส การเลือกคุณลักษณะ การลดขนาด |
| [geospatial_analysis.md](03_data_science_and_analytics/geospatial_analysis.md)| ระบบพิกัด, ปฏิบัติการเชิงพื้นที่, GeoPandas, การวิเคราะห์แรสเตอร์ |
### 04 — วิทยาศาสตร์ธรรมชาติ
| ไฟล์ | คำอธิบาย |
|-|-------------|
...
| ไฟล์ | คำอธิบาย |
|-|-------------|
| [business_and_economics.md](05_business_and_economics/business_and_economics.md)| โครงสร้างองค์กร การตลาด เศรษฐศาสตร์ สตาร์ทอัพ |
| [finance_and_investing.md](05_business_and_economics/finance_and_investing.md)| การเงินส่วนบุคคล การลงทุน ตลาด การเกษียณ |
| [law_and_legal_systems.md](05_business_and_economics/law_and_legal_systems.md)| ระบบกฎหมาย สัญญา การละเมิด ทรัพย์สินทางปัญญา การจ้างงาน |
| [marketing_and_digital_strategy.md](05_business_and_economics/marketing_and_digital_strategy.md)| 4Ps, ช่องทางดิจิทัล, SEO/SEM, การวิเคราะห์, กลยุทธ์แบรนด์ |
| [management_and_project_methodologies.md](05_business_and_economics/management_and_project_methodologies.md)| ความเป็นผู้นำ, Agile/Scrum/Kanban, OKRs, การบริหารความเสี่ยง |
| [behavioural_economics.md](05_business_and_economics/behavioural_economics.md)| อคติทางความรู้ความเข้าใจ ทฤษฎีแนวโน้ม การวิเคราะห์พฤติกรรม การกระตุ้น สถาปัตยกรรมทางเลือก |
| [game_theory.md](05_business_and_economics/game_theory.md)| สมดุลของแนช ภาวะที่กลืนไม่เข้าคายไม่ออกของนักโทษ การออกแบบกลไก การประมูล |
| [intellectual_property_and_innovation.md](05_business_and_economics/intellectual_property_and_innovation.md)| สิทธิบัตร ลิขสิทธิ์ เครื่องหมายการค้า ความลับทางการค้า การออกใบอนุญาตโอเพ่นซอร์ส |
| [organisational_design_and_culture.md](05_business_and_economics/organisational_design_and_culture.md)| โครงสร้างองค์กร ประเภทของวัฒนธรรม การจัดการการเปลี่ยนแปลง พลวัตของทีม |
| [supply_chain_and_operations.md](05_business_and_economics/supply_chain_and_operations.md)| การจัดการสินค้าคงคลัง, การผลิตแบบลีน, โลจิสติกส์, เอฟเฟกต์บูลแส้ |
...
| ไฟล์ | คำอธิบาย |
|-|-------------|
| [dictionary.md](07_general_reference/dictionary.md)| คำจำกัดความคำศัพท์ที่ครอบคลุม (A-Z) |
| [general_knowledge.md](07_general_reference/general_knowledge.md)| ระบบสุริยะ ร่างกายมนุษย์ ภูมิศาสตร์ พลังงาน |
| [technology_and_computing.md](07_general_reference/technology_and_computing.md)| พื้นฐานคอมพิวเตอร์ อินเทอร์เน็ต ฐานข้อมูล คลาวด์ ความปลอดภัย |
| [safe_communication.md](07_general_reference/safe_communication.md)| แนวทางการสื่อสารและแนวปฏิบัติที่ดีที่สุด |
| [learning_science_and_pedagogy.md](07_general_reference/learning_science_and_pedagogy.md)| แบบฝึกหัดการสืบค้น การทำซ้ำโดยเว้นระยะ อนุกรมวิธานของบลูม การออกแบบการเรียนรู้ |
| [research_methodology.md](07_general_reference/research_methodology.md)| วิธีการทางวิทยาศาสตร์ การสุ่มตัวอย่าง ความถูกต้อง การออกแบบการทดลอง การทบทวนโดยผู้ทรงคุณวุฒิ |
| [writing_and_communication.md](07_general_reference/writing_and_communication.md)| หลักการพีระมิด การนำเสนอ การโน้มน้าวใจ การเขียนเชิงธุรกิจ |
### 08 — อนาคตและเทรนด์
| ไฟล์ | คำอธิบาย |
|-|-------------|
...
| ไฟล์ | คำอธิบาย |
|-|-------------|
| [ai_llm_failures.md](09_lessons_from_failures/ai_llm_failures.md)| ภาพหลอน อคติ ความล้มเหลวในการจัดตำแหน่ง |
| [code_quality_issues.md](09_lessons_from_failures/code_quality_issues.md)| ข้อผิดพลาดในการเขียนโค้ดทั่วไปและรูปแบบการต่อต้าน |
| [cognitive_logical_issues.md](09_lessons_from_failures/cognitive_logical_issues.md)| ข้อผิดพลาดในการใช้เหตุผลและอคติทางปัญญา |
| [rag_vector_search.md](09_lessons_from_failures/rag_vector_search.md)| ข้อผิดพลาดในการค้นหา RAG และเวกเตอร์ |
| [security_vulnerabilities.md](09_lessons_from_failures/security_vulnerabilities.md)| ช่องโหว่ด้านความปลอดภัยทั่วไป |
| [system_reliability.md](09_lessons_from_failures/system_reliability.md)| ความล้มเหลวของระบบและรูปแบบความน่าเชื่อถือ |
| [api_design_and_integration_failures.md](09_lessons_from_failures/api_design_and_integration_failures.md)| รูปแบบการต่อต้าน API, การเปลี่ยนแปลงที่เสียหาย, ความล้มเหลวในการกำหนดเวอร์ชัน, ความล้มเหลวแบบเรียงซ้อน |
| [data_pipeline_and_etl_failures.md](09_lessons_from_failures/data_pipeline_and_etl_failures.md)| สคีมาดริฟท์, ข้อมูลที่ซ้ำกัน, ช่องว่างในการตรวจสอบ, การตรวจสอบไปป์ไลน์ |
| [ml_project_failures.md](09_lessons_from_failures/ml_project_failures.md)| ข้อมูลรั่วไหล, ความคาดหวังไม่ตรงกัน, ความล้มเหลวในการปรับใช้, การสลายตัวของโมเดล |
### 10 — การอ้างอิงด่วน
| ไฟล์ | คำอธิบาย |
|-|-------------|
...
4. เลือกภาษาใน `01_coding_and_technology/programming_languages/python/`
...
- **ข้อมูลทางการแพทย์:** เนื้อหาใน`medicine_and_healthcare.md`มีวัตถุประสงค์เพื่อการศึกษาเท่านั้น และไม่ควรแทนที่คำแนะนำทางการแพทย์จากผู้เชี่ยวชาญ
- **ข้อมูลทางกฎหมาย:** เนื้อหาใน`law_and_legal_systems.md`เป็นเพียงข้อมูลและไม่ถือเป็นคำแนะนำทางกฎหมาย
- **ข้อมูลทางการเงิน:** เนื้อหาใน`finance_and_investing.md`เป็นเนื้อหาเพื่อการศึกษา และไม่ควรถือเป็นคำแนะนำทางการเงิน
- **การคาดการณ์ในอนาคต:** เนื้อหาใน`08_future_and_trends/`มีข้อมูลการเก็งกำไรและการคาดการณ์ที่อาจมีการเปลี่ยนแปลง
---

## แนวทางการใช้งาน
### สำหรับระบบ AI
- ไฟล์ทั้งหมดใช้ส่วนหัวที่มีลำดับชั้นที่ชัดเจน (ชื่อ `#`, ส่วน `##`, ส่วนย่อย `###`)
- ตารางใช้สำหรับการเปรียบเทียบแบบมีโครงสร้างตลอด
- ตัวอย่างโค้ดรวมถึงการเน้นไวยากรณ์
- การอ้างอิงโยงใช้ลิงก์มาร์กดาวน์แบบสัมพันธ์
### สำหรับผู้อ่านที่เป็นมนุษย์
- ไฟล์เขียนด้วยบทสนทนาที่เป็นกลาง
- ใช้ตารางและการเปรียบเทียบแบบมีโครงสร้างแทนย่อหน้าหนาแน่น
- ตัวอย่างและการเปรียบเทียบในโลกแห่งความเป็นจริงช่วยให้เกิดแนวคิดที่เป็นนามธรรม
- แต่ละไฟล์มีส่วนสรุป
---

## การมีส่วนร่วมและข้อมูลเมตา
ไฟล์เนื้อหาทุกไฟล์ในฐานความรู้นี้ (ทุกอย่างยกเว้น`README.md`) จะเปิดขึ้นพร้อมกับบล็อกส่วนหน้าของ YAML เป็นไปตามรูปแบบการติดตามผู้สนับสนุนแบบเดียวกับที่ใช้โดย[skills](../../skills/skill-creator.md)ดังนั้นการประพันธ์ การแก้ไข และบทวิจารณ์จึงสามารถติดตามได้จากทั้งสองคอลเลกชัน สำหรับเวิร์กโฟลว์การสนับสนุนทั่วไป — การฟอร์กกิ้ง การแยกสาขา คำขอดึง การวางไฟล์ และหลักการตั้งชื่อ — ดูที่รูท [CONTRIBUTING.md](../../CONTRIBUTING.md)
### สคีมาของ Frontmatter
แต่ละไฟล์เริ่มต้นด้วยบล็อกนี้ (ระหว่างตัวคั่น `---`) แบ่งออกเป็นห้าส่วนที่แสดงความคิดเห็น:
```yaml
---
# Metadata
...
| สนาม | ที่มา / วัตถุประสงค์ |
|---|---|
| `title`| ดึงมาจากส่วนหัว`#`แรกของไฟล์ |
| `description`| สรุปบรรทัดเดียว ไฟล์หัวข้อนำรายการจากดัชนีของ README นี้มาใช้ซ้ำ ไฟล์ภาษาการเขียนโปรแกรมใช้คำอธิบายที่สร้างขึ้น |
| `category`/`reviewed_by`| มาจากไดเรกทอรีหลัก (`01_coding_and_technology`→ "การเข้ารหัสและเทคโนโลยี" / "ทีมฐานความรู้การเข้ารหัสและเทคโนโลยี") |
| `version`| เวอร์ชันความหมาย ชนกับการแก้ไขแต่ละครั้ง (ดูด้านล่าง) |
| `authors`/`contributors`| ผู้เขียนต้นฉบับและใครก็ตามที่ได้แก้ไขไฟล์ตั้งแต่นั้นมา |
| `changelog`| ผนวกเฉพาะรายการการเปลี่ยนแปลง โดยใหม่สุดก่อน |
| `review_date`/`next_review`| จังหวะ ~6 เดือนและ ~1 ปี สะท้อนตารางทบทวนทักษะ |
| `tags`| โทเค็นชื่อไฟล์บวกกับคีย์เวิร์ดหมวดหมู่ที่ชัดเจน (เช่น`coding-and-technology`) |
| `difficulty_level`| กำหนดตามหมวดหมู่ พร้อมการแทนที่ต่อภาษา (เช่น Haskell/Assembly →`advanced`, Scratch →`beginner`) |
| `estimated_reading_time`| คำนวณจากจำนวนบรรทัด |
### การแก้ไขไฟล์
เมื่อคุณเปลี่ยนไฟล์ฐานความรู้ ให้ซิงค์ส่วนหน้าของไฟล์ไว้:
1. **ชน`version`** กำลังติดตาม[SemVer](https://semver.org/):
   - แพทช์ (`1.0.x`): การพิมพ์ผิด การจัดรูปแบบ การแก้ไขเล็กน้อย
   - รอง (`1.x.0`): ส่วนใหม่ เนื้อหาเพิ่มเติม ตัวอย่างใหม่
   - Major (`x.0.0`): เขียนใหม่หรือปรับโครงสร้างใหม่ทั้งหมด
2. **เพิ่มรายการบันทึกการเปลี่ยนแปลง** (ใหม่ที่สุดก่อน) อธิบายสิ่งที่คุณเปลี่ยนแปลง:   ```yaml
   changelog:
     - version: "1.1.0"
       date: "2026-08-05"
       author: "Your Name"
     ...
     - version: "1.0.0"
       ...
       changes: "Added YAML frontmatter metadata for contributor tracking"
   ```
3. **อัปเดต`last_modified`** เป็นวันที่คุณเปลี่ยนแปลง
4. **เพิ่มตัวคุณเองใน`contributors`** หากเป็นการแก้ไขไฟล์ครั้งแรก:   ```yaml
   contributors:
     - name: "Your Name"
...
### รายการตรวจสอบคุณภาพ
ก่อนที่จะส่งไฟล์ฐานความรู้ใหม่หรือที่มีการแก้ไข ให้ตรวจสอบ:
- [ ] ส่วนหน้าของ YAML เสร็จสมบูรณ์และถูกต้อง (มีทั้งหมดห้าส่วนอยู่ระหว่างตัวคั่น `---`)
- [ ]`title`,`description`,`category`,`version`,`status`ถูกตั้งค่าแล้ว
- [ ] มีผู้เขียนอย่างน้อยหนึ่งรายอยู่ในรายการ`authors`
- [ ]`changelog`มีรายการบันทึกการเปลี่ยนแปลง (ล่าสุดก่อน)
- [ ]`last_modified`สะท้อนถึงวันที่ของวันนี้
- [ ]`tags`รวมคำหลักที่เกี่ยวข้อง 3-6 คำ บวกกับคำหลักหมวดหมู่ที่สะอาดตา
- [ ]`difficulty_level`ถูกตั้งค่าแล้ว (เริ่มต้น / กลาง / ขั้นสูง)
- [ ]`estimated_reading_time`มีความสมจริงสำหรับความยาวของเนื้อหา
- [ ] เนื้อหาเนื้อหาเป็นไปตาม[Usage Guidelines](#usage-guidelines)ด้านบน
- [ ] ไม่มีการอ้างอิงโยงที่เสียหาย
---

*ฐานความรู้นี้เป็นการรวบรวมเอกสารที่มีชีวิต มีการปรับปรุงและขยายอย่างต่อเนื่อง*