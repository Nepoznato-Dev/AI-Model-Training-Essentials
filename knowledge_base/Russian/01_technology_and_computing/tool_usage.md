...
4. Откройте pull request в GitHub / GitLab.
5. Внесите дополнительные коммиты по итогам code review.
...
- Используйте tab completion, чтобы быстро дописывать имена файлов и команды.
