...
### Подробное описание объединения
...
### Шаблон 2: Потоки состояний```prolog
...
|-----------|--------|-------------|
| **Хвостовая рекурсия** | Высокий | Используйте аккумуляторы для постоянного места в стеке |
| **Вырез (зеленый)** | Высокий | Устраните ненужные точки выбора |
| **Таблица оценки** | Высокий | `:- table pred/N`запоминает результаты |
| **Индексирование** | Средний | Ставьте дискриминирующий аргумент на первое место |
| **Списки различий** | Средний | Объединение списков O(1) |
