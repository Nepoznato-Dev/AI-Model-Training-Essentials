...
# PHP — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны и лучшие практики написания чистого, современного кода PHP (8.3+).
---
...
## Краткое содержание
Современные идиомы PHP подчеркивают: объявления типов, свойства только для чтения, перечисления, выражения соответствия, продвижение конструктора, нулевой оператор, именованные аргументы и волокна. Следуйте PSR-12 для стиля, PHPStan для статического анализа и Laravel Pint или PHP-CS-Fixer для форматирования. Современный PHP (8.3+) — это чистый, типобезопасный язык. Используйте новые функции и избегайте устаревших шаблонов.