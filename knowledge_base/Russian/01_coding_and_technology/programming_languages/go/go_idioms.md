...
-->
# Go — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны и лучшие практики написания чистого идиоматического кода на Go.
---
...
## Краткое содержание
Идиомы Go подчеркивают: простоту, явную обработку ошибок, небольшие интерфейсы, композицию вместо наследования, горутины с контекстом и «принимать интерфейсы, возвращать структуры». Следуйте`gofmt`для форматирования,`golangci-lint`для проверки и официального руководства по комментариям к обзору кода Go. Сообщество Go ценит читаемость, простоту и «очевидный способ сделать это». Избегайте умного кода — код Go должен быть скучным и предсказуемым.