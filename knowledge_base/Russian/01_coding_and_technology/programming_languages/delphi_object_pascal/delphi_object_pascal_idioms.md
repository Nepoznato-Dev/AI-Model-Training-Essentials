...
-->
# Delphi/Object Pascal — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны для написания чистого кода Delphi и Object Pascal.
---

## Управление ресурсами с помощью try/finally
```delphi
...
## Краткое содержание
Идиомы Delphi подчеркивают:`try/finally`для детерминированной очистки ресурсов,`Format`для построения строк, интерфейсы для слабой связи, записи для носителей данных, специальную обработку исключений и современные функции, такие как обобщенные и анонимные методы. Delphi ценит явное управление ресурсами — «создайте, используйте, наконец освободите».