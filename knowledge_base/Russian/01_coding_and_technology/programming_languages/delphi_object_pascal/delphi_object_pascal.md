...
| `{$APPTYPE GUI}`| Приложение с графическим интерфейсом (по умолчанию) |  __ЗАЩИЩЕНО_3__ |
...
В состав интегрированной среды разработки Delphi входит полнофункциональный встроенный отладчик.
...
| **Точки останова событий** | Прерывание исключений, загрузок DLL, событий потока |
