...
# Фортран — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны и лучшие практики написания чистого современного кода на Фортране (2018+).
---
...
## Краткое содержание
Современные идиомы Фортрана подчеркивают:`implicit none`, операции с массивами (избегайте циклов), массивы предполагаемой формы, производные типы с процедурами, привязанными к типу, и`intent`для всех аргументов. Следуйте fprettify для форматирования. Современный Fortran (2018+) с coarrays и DO CONCURRENT изначально поддерживает параллельные вычисления.