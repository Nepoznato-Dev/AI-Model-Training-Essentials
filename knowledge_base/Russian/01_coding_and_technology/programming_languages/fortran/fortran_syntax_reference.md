...
-->
# Фортран — Справочник по синтаксису
В этом документе представлен полный структурированный справочник по синтаксису современного Фортрана (2008/2018). Он дополняет основной справочник по Фортрану, уделяя особое внимание исчерпывающим синтаксическим шаблонам, операциям с массивами, модулям, ООП и высокопроизводительным вычислениям.
---
...
| `<``>``<=``>=` | Сравнение | `a >= b`| |
| `.and.``.or.``.not.`| Логический | `a .and. b`| |
| `.eqv.``.neqv.` | Логическая эквивалентность | `a .eqv. b`| |
...
## Coarrays (параллельное программирование)
```fortran
...
## Краткое содержание
Синтаксис современного Фортрана понятен, структурирован и оптимизирован для численных вычислений. Операции с массивами исключают циклы для большинства математических задач. Модули обеспечивают инкапсуляцию и управление пространством имен. Функции ООП (производные типы, наследование, полиморфизм) обеспечивают чистую организацию кода. Coarrays предлагает собственное параллельное программирование без внешних библиотек. Сильные стороны Фортрана — производительность, операции с массивами и числовая точность — остаются непревзойденными для научных вычислений. Fortran продолжает оставаться мощным инструментом для высокопроизводительных вычислений, вычислительной физики и инженерного моделирования.