...
- **Отказоустойчивость**: деревья супервизора автоматически перезапускают сбойные процессы. Системы корректно восстанавливаются после ошибок.
- **Распределено по замыслу**: узлы Erlang прозрачно обмениваются данными между машинами. Создан для кластеров.
...
|  __ЗАЩИЩЕНО_3__ | Скомпилировать проект |
