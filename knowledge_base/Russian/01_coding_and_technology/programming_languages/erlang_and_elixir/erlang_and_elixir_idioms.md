...
-->
# Erlang & Elixir — Идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны для Erlang и Elixir на виртуальной машине BEAM.
---
...
## Краткое содержание
Идиомы Эликсира подчеркивают: оператор канала, сопоставление с образцом,`with`для цепочки ошибок и спецификации типа `@spec`. Идиомы Эрланга подчеркивают: сопоставление с образцом, понимание списков, обратные вызовы gen_server и философию «пусть произойдет сбой». Оба ценят неизменность, передачу сообщений и отказоустойчивость.