...
# Дарт — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны и лучшие практики написания чистого идиоматического кода Dart.
---
...
## Краткое содержание
Идиомы Dart подчеркивают: нулевую безопасность, константные конструкторы, записи и сопоставление с образцом (Dart 3), async/await и методы расширения. Следуйте руководству «Эффективный Dart», используйте`dart format`для форматирования и`dart analyze`для проверки. Dart ценит безопасность и производительность — с Flutter «напишите один раз, бегите где угодно».