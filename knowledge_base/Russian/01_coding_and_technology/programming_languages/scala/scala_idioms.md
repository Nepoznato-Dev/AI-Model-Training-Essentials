...
# Scala — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны и лучшие практики написания чистого, функционального кода Scala 3.
---
...
## Краткое содержание
Идиомы Scala подчеркивают: неизменяемость (`val`), сопоставление с образцом, запечатанные типы, Option/Either для безопасности, for-comprehension, функциональные коллекции и классы типов (данные/используемые в Scala 3). Следуйте Руководству по стилю Scala, используйте scalafmt для форматирования и scalafix для проверки. Чистый синтаксис Scala 3, перечисления, непрозрачные типы и методы расширения делают язык более доступным, сохраняя при этом его функциональную мощь.