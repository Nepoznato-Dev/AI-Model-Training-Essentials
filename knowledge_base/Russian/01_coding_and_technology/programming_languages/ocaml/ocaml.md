...
Новый брат OCaml **Reason** (разработанный Facebook/Meta) и **ReScript** (ранее BuckleScript) привносит систему типов и производительность OCaml в веб-разработку, компилируя ее в JavaScript.
---
...
|  __ЗАЩИЩЕНО_3__ | Запустить тесты |
...
| **пространство-время** | Профилирование памяти (4.x) |  __ЗАЩИЩЕНО_3__ |
