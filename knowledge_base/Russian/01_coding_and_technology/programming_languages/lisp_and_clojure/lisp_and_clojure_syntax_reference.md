...
---
# Lisp и Clojure — Справочник по синтаксису
В этом документе представлен полный структурированный справочник по синтаксису Common Lisp и Clojure. Он дополняет основной справочник по Lisp/Clojure, уделяя особое внимание S-выражениям, макросам, постоянным структурам данных и шаблонам функционального программирования.
---
...
## Краткое содержание
Синтаксис Clojure заключен в круглые скобки — каждая форма представляет собой список. Эта гомоиконичность позволяет использовать мощные макросы, преобразующие код в данные. Постоянные структуры данных обеспечивают неизменность и совместное использование структур для повышения эффективности. Потоковые макросы создают читаемые конвейеры данных. Примитивы параллелизма (атомы, ссылки, агенты, каналы) безопасно обрабатывают изменения состояния. Влияние Lisp/Clojure на современное программирование огромно — сборка мусора, REPL, макросы и функциональное программирование восходят к Lisp.