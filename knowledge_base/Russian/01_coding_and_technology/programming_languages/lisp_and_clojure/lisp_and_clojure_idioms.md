...
-->
# Lisp и Clojure — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны для Lisp и Clojure.
---
...
## Краткое содержание
В идиомах Clojure особое внимание уделяется неизменяемым данным, потоковым макросам (`->`,`->>`), деструктуризации, ключевым словам как функциям и спецификациям для проверки. Общие идиомы Lisp подчеркивают:`with-open`для ресурсов, `push`/`nreverse` для построения списков и множественных значений. Оба ценят гомоиконичность и развитие, основанное на REPL.