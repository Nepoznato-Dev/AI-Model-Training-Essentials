...
-->
# Межъязыковое сравнение — ввод-вывод и файловые операции
## Консольный вывод
| Язык | Печать в стандартный вывод |
|----------|----------------|
| Питон | `print("Hello")`|
| JavaScript | `console.log("Hello")`|
| Ржавчина | `println!("Hello")`|
| Перейти | `fmt.Println("Hello")`|
| Ява | `System.out.println("Hello")`|
| С | `printf("Hello\n")`|
| С++ | `std::cout << "Hello" << std::endl`|
| С# | `Console.WriteLine("Hello")`|
| Руби | `puts "Hello"`|
| Свифт | `print("Hello")`|
| Котлин | `println("Hello")`|
| PHP | `echo "Hello\n"`|
| TypeScript | `console.log("Hello")`|
| Хаскелл | `putStrLn "Hello"`|
| Скала | `println("Hello")`|
| р | `cat("Hello\n")`|
| Юлия | `println("Hello")`|
| Перл | `say "Hello"`|
...
| МАТЛАБ | `disp('Hello')`|
| Дарт | `print('Hello')`|
| Пролог | `write('Hello'), nl.`|
| Лисп | `(format t "Hello~%")`|
| Эликсир | `IO.puts("Hello")`|
| Эрланг | `io:format("Hello~n")`|
| OCaml | `print_endline "Hello"`|
| Ада | `Put_Line("Hello")`|
| КОБОЛ | `DISPLAY 'Hello'`|
| Фортран | `print *, 'Hello'`|
| Ассамблея | `syscall`(запись в fd 1) |
| Дельфи | `WriteLn('Hello')`|
| Царапина | `say [Hello]`|
| ВБ | `Console.WriteLine("Hello")`|
| Шелл | `echo "Hello"`|
| SQL | Н/Д (возвращает наборы результатов) |
## Чтение файла
```python
# Python
