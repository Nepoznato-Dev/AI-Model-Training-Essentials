...
-->
# Ada — Идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны для написания чистого и безопасного кода Ada.
---
...
## Краткое содержание
Идиомы Ada подчеркивают: строгую типизацию, частные типы для инкапсуляции, контракты (предварительные/постусловия) и утверждения. Следуйте Руководству по стилю Ada и используйте GNATprove для формальной проверки. Ада превыше всего ценит безопасность и правильность.