...
# Джулия — Идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны и лучшие практики написания чистого идиоматического кода Julia.
---
...
## Краткое содержание
Идиомы Julia подчеркивают: стабильность типов, множественную отправку, широковещательную рассылку с помощью`.`, понимание и производительность через конкретные типы. Следуйте Руководству по стилю Julia, используйте JuliaFormatter для форматирования и JET для анализа вывода типов. Ценности Julia «по умолчанию делают его быстрым» — пишите чистый код и позволяйте JIT-компилятору оптимизировать его.