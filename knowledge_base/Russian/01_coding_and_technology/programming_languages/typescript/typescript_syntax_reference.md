...
## Декораторы (TC39 Stage 3/TypeScript 5.0+)
```typescript
// Class decorator
...
### Константные утверждения и сужение
```typescript
...
## Краткое содержание
Система типов TypeScript — его определяющая особенность, и она особенно глубока. Система типов, начиная с базовых аннотаций и заканчивая обобщениями, условными типами, отображаемыми типами, литеральными типами шаблонов и`infer`, по существу представляет собой функциональный язык, работающий во время компиляции. Понимание взаимодействия между`interface`и`type`, универсальными и служебными типами, а также структурной и номинальной типизацией помогает писать TypeScript, который является одновременно безопасным и эргономичным. Язык продолжает развиваться, с каждым выпуском добавляя все больше выразительных возможностей, сохраняя при этом полную обратную совместимость с JavaScript.