...
-->
# Сборка — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны для написания чистого, удобного в сопровождении ассемблерного кода (фокус x86/x64 с синтаксисом NASM).
---
...
## Соглашения о регистрации и пролог/эпилог
```nasm
...
## Локальные метки и организация кода
```nasm
...
## Краткое содержание
Идиомы сборки подчеркивают: именованные константы вместо магических чисел, макросы для повторяющихся шаблонов, определения структур для размещения данных, ABI-совместимый пролог/эпилог, локальные метки для удобочитаемости, защитную проверку ввода и `xor`/`lea` для эффективных операций. Сборка превыше всего ценит ясность: «если вы не можете это прочитать, вы не сможете отладить это в 3 часа ночи».