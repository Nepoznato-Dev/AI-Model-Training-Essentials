...
## Функции и соглашения о вызовах
```nasm
...
## Краткое содержание
Синтаксис языка ассемблера определяется архитектурой процессора и ассемблером (NASM, GAS, MASM). x86-64 предоставляет 16 регистров общего назначения, несколько режимов адресации и сотни инструкций, охватывающих перемещение данных, арифметику, логику, поток управления, SIMD и системные вызовы. Используемый здесь синтаксис NASM является наиболее распространенным для разработки под Linux x86-64. Освоение сборки требует понимания регистров, стека, соглашений о вызовах и того, как конструкции высокого уровня сопоставляются с машинными инструкциями.