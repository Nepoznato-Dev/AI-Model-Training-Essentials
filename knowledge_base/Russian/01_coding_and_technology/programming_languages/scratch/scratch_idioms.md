...
-->
# Scratch — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны для написания чистых, хорошо организованных проектов Scratch.
---
...
## Пользовательские блоки (Мои блоки)
```
...
## Краткое содержание
Идиомы Scratch подчеркивают: четкое наименование спрайтов, одну ответственность за каждый спрайт, широковещательные сообщения для связи, пользовательские блоки для повторного использования, клонирование для нескольких экземпляров, структурированные игровые циклы и «запуск без обновления экрана» для повышения производительности. Организация Scratch вознаграждает — «хорошо названный спрайт — это половина программы».