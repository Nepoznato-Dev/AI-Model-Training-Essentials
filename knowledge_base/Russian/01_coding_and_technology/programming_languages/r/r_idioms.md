...
-->
# R — Идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны и лучшие практики написания чистого идиоматического кода R.
---
...
## Краткое содержание
Идиомы подчеркивают: векторизацию (избегание циклов), каналы tidyverse (`|>`),`<-`для присваивания, именование Snake_case и функциональное программирование с помощью`purrr`. Следуйте руководству по стилю Tidyverse, используйте lintr для проверки и styler для форматирования. R оценивает векторизованные операции и канал для читаемых преобразований данных.