...
## Краткое содержание
Синтаксис COBOL по своей сути многословен — каждое выражение читается как по-английски. Описания данных с помощью предложений PIC точно определяют форматы полей. Структура из четырех подразделений обеспечивает разделение функций. Обработка файлов встроена в язык. Для обработки бизнес-данных десятичная арифметика COBOL и ориентированный на записи ввод-вывод остаются непревзойденными. Понимание COBOL означает понимание основ корпоративных вычислений.