...
---
# Visual Basic — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны для написания чистого кода Visual Basic (.NET).
---

## Опция Строгая и типовая безопасность
```vb
...
## Шаблоны асинхронности/ожидания
```vb
...
## Краткое содержание
Идиомы Visual Basic подчеркивают:`Option Strict On`для безопасности типов, блоки`Using`для управления ресурсами, интерполяцию строк, LINQ для коллекций,`Async/Await`повсюду, специальную обработку исключений и современные функции, такие как сопоставление с образцом и операторы с нулевыми условиями. VB ценит читабельность: «код должен читаться как хорошо организованная спецификация».