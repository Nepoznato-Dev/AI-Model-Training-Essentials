...
# C# — Идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны и лучшие практики написания чистого современного кода на C# (12+).
---

## Современный синтаксис C#
```csharp
// ✅ Records for data
...
## Краткое содержание
В современных идиомах C# особое внимание уделяется: записям для данных, сопоставлению с образцом, нулевой безопасности (ссылочные типы, допускающие значение NULL), LINQ для коллекций, async/await с CancellationToken, внедрению зависимостей, первичным конструкторам, выражениям коллекций и объявлениям `using`. Следуйте соглашениям по кодированию C#, используйте`dotnet format`для форматирования и анализаторы Roslyn для проверки качества кода. Современный C# (12+) лаконичен и выразителен — включает в себя записи, сопоставление шаблонов и первичные конструкторы.