...
---
# Java — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны и лучшие практики написания чистого, современного кода Java (17+).
---

## Современный синтаксис Java
```java
...
## Краткое содержание
Современные идиомы Java подчеркивают: записи для данных, запечатанные классы для иерархий, сопоставление с образцом, выражения переключения, текстовые блоки, потоки для обработки коллекций, необязательный для отсутствия, попытку с ресурсами для очистки, виртуальные потоки для параллелизма и внедрение зависимостей. Следуйте Руководству по стилю Google Java, используйте`javafmt`или`Spotless`для форматирования и Error Prone или Checkstyle для проверки. Современная Java (17–21+) с записями, запечатанными классами, сопоставлением с образцом и виртуальными потоками лаконична и выразительна — включает в себя новые функции.