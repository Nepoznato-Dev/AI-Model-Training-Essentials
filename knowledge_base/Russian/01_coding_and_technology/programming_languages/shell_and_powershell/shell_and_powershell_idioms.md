...
# Shell и PowerShell — идиоматические шаблоны и лучшие практики
В этом руководстве рассматриваются идиоматические шаблоны для сценариев Bash/Zsh и PowerShell.
---
...
## Краткое содержание
Идиомы оболочки подчеркивают:`set -euo pipefail`, цитирование переменных,`[[ ]]`вместо`[ ]`, расширение параметров и ловушки очистки. Идиомы PowerShell подчеркивают: CmdletBinding, конвейерную обработку, разделение и структурированную обработку ошибок. Следуйте ShellCheck для Bash и PSScriptAnalyzer для PowerShell.