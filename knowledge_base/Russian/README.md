...
**Организация:** 10 тематических каталогов + 34 справочника по языкам программирования.
---
...
| [embedded_systems_and_iot.md](01_coding_and_technology/embedded_systems_and_iot.md)| Микроконтроллеры, датчики, ОСРВ, протоколы Интернета вещей, периферийные вычисления |
...
| Язык | Путь | | Язык | Путь |
|----------|------|-|----------|------|
| Питон | `programming_languages/python/`| | JavaScript | `programming_languages/javascript/`|
| С | `programming_languages/c/`| | С++ | `programming_languages/cpp/`|
| Ява | `programming_languages/java/`| | С# | `programming_languages/csharp/`|
| Перейти | `programming_languages/go/`| | Ржавчина | `programming_languages/rust/`|
| TypeScript | `programming_languages/typescript/`| | SQL | `programming_languages/sql/`|
| Руби | `programming_languages/ruby/`| | PHP | `programming_languages/php/`|
| Свифт | `programming_languages/swift/`| | Котлин | `programming_languages/kotlin/`|
| р | `programming_languages/r/`| | Визуальный Бейсик | `programming_languages/visual_basic/`|
| Дарт | `programming_languages/dart/`| | Скала | `programming_languages/scala/`|
| Хаскелл | `programming_languages/haskell/`| | Юлия | `programming_languages/julia/`|
| Луа | `programming_languages/lua/`| | Перл | `programming_languages/perl/`|
| Эрланг/Эликсир | `programming_languages/erlang_and_elixir/`| | OCaml | `programming_languages/ocaml/`|
| Пролог | `programming_languages/prolog/`| | Лисп/Кложур | `programming_languages/lisp_and_clojure/`|
| Ада | `programming_languages/ada/`| | Ассамблея | `programming_languages/assembly/`|
| МАТЛАБ | `programming_languages/matlab/`| | Фортран | `programming_languages/fortran/`|
| КОБОЛ | `programming_languages/cobol/`| | Оболочка/PowerShell | `programming_languages/shell_and_powershell/`|
| Делфи/Паскаль | `programming_languages/delphi_object_pascal/`| | Царапина | `programming_languages/scratch/`|
...
| [data_ethics_and_privacy.md](03_data_science_and_analytics/data_ethics_and_privacy.md)| GDPR, согласие на использование данных, алгоритмическая предвзятость, темные шаблоны, анонимизация |
| [ensemble_methods.md](03_data_science_and_analytics/ensemble_methods.md)| Упаковка, буст, штабелирование, голосование, случайные леса, XGBoost |
| [feature_engineering.md](03_data_science_and_analytics/feature_engineering.md)| Преобразования, кодировки, выбор признаков, уменьшение размерности |
| [geospatial_analysis.md](03_data_science_and_analytics/geospatial_analysis.md)| Системы координат, пространственные операции, GeoPandas, растровый анализ |
### 04 — Естественные науки
| Файл | Описание |
|------|-------------|
...
| Файл | Описание |
|------|-------------|
| [business_and_economics.md](05_business_and_economics/business_and_economics.md)| Корпоративные структуры, маркетинг, экономика, стартапы |
| [finance_and_investing.md](05_business_and_economics/finance_and_investing.md)| Личные финансы, инвестирование, рынки, выход на пенсию |
| [law_and_legal_systems.md](05_business_and_economics/law_and_legal_systems.md)| Правовые системы, договоры, правонарушения, интеллектуальная собственность, трудоустройство |
| [marketing_and_digital_strategy.md](05_business_and_economics/marketing_and_digital_strategy.md)| 4P, цифровые каналы, SEO/SEM, аналитика, стратегия бренда |
| [management_and_project_methodologies.md](05_business_and_economics/management_and_project_methodologies.md)| Лидерство, Agile/Scrum/Kanban, OKR, управление рисками |
| [behavioural_economics.md](05_business_and_economics/behavioural_economics.md)| Когнитивные искажения, теория перспектив, эвристика, подталкивание, архитектура выбора |
| [game_theory.md](05_business_and_economics/game_theory.md)| Равновесие Нэша, дилемма заключенного, конструкция механизмов, аукционы |
| [intellectual_property_and_innovation.md](05_business_and_economics/intellectual_property_and_innovation.md)| Патенты, авторские права, товарные знаки, коммерческая тайна, лицензирование открытого исходного кода |
| [organisational_design_and_culture.md](05_business_and_economics/organisational_design_and_culture.md)| Организационные структуры, типы культуры, управление изменениями, динамика команды |
| [supply_chain_and_operations.md](05_business_and_economics/supply_chain_and_operations.md)| Управление запасами, бережливое производство, логистика, эффект кнута |
...
| Файл | Описание |
|------|-------------|
| [dictionary.md](07_general_reference/dictionary.md)| Подробные определения слов (A-Z) |
| [general_knowledge.md](07_general_reference/general_knowledge.md)| Солнечная система, тело человека, география, энергетика |
| [technology_and_computing.md](07_general_reference/technology_and_computing.md)| Основы вычислений, Интернет, базы данных, облака, безопасность |
| [safe_communication.md](07_general_reference/safe_communication.md)| Рекомендации и лучшие практики в области коммуникации |
| [learning_science_and_pedagogy.md](07_general_reference/learning_science_and_pedagogy.md)| Практика извлечения информации, интервальное повторение, таксономия Блума, дизайн обучения |
| [research_methodology.md](07_general_reference/research_methodology.md)| Научный метод, выборка, валидность, дизайн эксперимента, экспертная оценка |
| [writing_and_communication.md](07_general_reference/writing_and_communication.md)| Принцип пирамиды, презентации, убеждение, деловое письмо |
...
| Файл | Описание |
|------|-------------|
| [ai_llm_failures.md](09_lessons_from_failures/ai_llm_failures.md)| Галлюцинации, предвзятость, сбои в выравнивании |
| [code_quality_issues.md](09_lessons_from_failures/code_quality_issues.md)| Распространенные ошибки кодирования и антишаблоны |
| [cognitive_logical_issues.md](09_lessons_from_failures/cognitive_logical_issues.md)| Ошибки в рассуждениях и когнитивные искажения |
| [rag_vector_search.md](09_lessons_from_failures/rag_vector_search.md)| RAG и ловушки поиска векторов |
| [security_vulnerabilities.md](09_lessons_from_failures/security_vulnerabilities.md)| Распространенные уязвимости безопасности |
| [system_reliability.md](09_lessons_from_failures/system_reliability.md)| Системные сбои и закономерности надежности |
| [api_design_and_integration_failures.md](09_lessons_from_failures/api_design_and_integration_failures.md)| Антишаблоны API, критические изменения, сбои версий, каскадные сбои |
| [data_pipeline_and_etl_failures.md](09_lessons_from_failures/data_pipeline_and_etl_failures.md)| Дрейф схемы, дублирование данных, пробелы в проверке, мониторинг конвейера |
| [ml_project_failures.md](09_lessons_from_failures/ml_project_failures.md)| Утечка данных, несоответствие ожиданий, сбои при развертывании, разрушение модели |
...
4. Выберите язык в `01_coding_and_technology/programming_languages/python/`.
...
- **Медицинская информация:** Содержимое`medicine_and_healthcare.md`предназначено только для образовательных целей и не должно заменять профессиональную медицинскую консультацию.
- **Юридическая информация:** Содержимое`law_and_legal_systems.md`носит информационный характер и не представляет собой юридическую консультацию.
- **Финансовая информация.** Содержание`finance_and_investing.md`носит образовательный характер и не должно рассматриваться как финансовый совет.
- **Прогнозы на будущее:** Содержимое`08_future_and_trends/`содержит спекулятивную информацию и прогнозы, которые могут измениться.
---

## Рекомендации по использованию
### Для систем искусственного интеллекта
- Все файлы имеют четкие иерархические заголовки (заголовок `#`, разделы `##`, подразделы `###`).
- Таблицы используются для структурированных сравнений повсюду.
- Примеры кода включают подсветку синтаксиса.
- В перекрестных ссылках используются относительные ссылки уценки.
### Для читателей-людей
- Файлы написаны разговорным, нейтральным тоном.
- Вместо плотных абзацев используются таблицы и структурированные сравнения.
- Примеры и аналогии из реальной жизни помогают обосновать абстрактные концепции.
- Каждый файл включает в себя сводный раздел.
---

## Вклад и метаданные
Каждый файл содержимого в этой базе знаний (все, кроме этого `README.md`) открывается с блоком заголовка YAML. Он следует тому же шаблону отслеживания участников, что и[skills](../../skills/skill-creator.md), поэтому авторство, редактирование и обзоры можно отслеживать в обеих коллекциях. Общий рабочий процесс внесения вклада — разветвление, ветвление, запросы на включение, размещение файлов и соглашения об именах — см. в корне [CONTRIBUTING.md](../../CONTRIBUTING.md).
### Схема фронтмэттера
Каждый файл начинается с этого блока (между разделителями `---`), разделенного на пять разделов с комментариями:
```yaml
---
# Metadata
...
| Поле | Источник/Цель |
|---|---|
| `title`| Взято из первого заголовка файла`#`|
| `description`| Однострочное резюме; файлы тем повторно используют запись из индекса этого README, файлы языка программирования используют сгенерированное описание |
| `category`/`reviewed_by`| Получено из родительского каталога (`01_coding_and_technology`→ «Кодирование и технологии» / «Группа базы знаний по программированию и технологиям») |
| `version`| Семантическая версия; удар при каждом редактировании (см. ниже) |
| `authors`/`contributors`| Первоначальный автор и все, кто с тех пор редактировал файл |
| `changelog`| Список изменений, доступный только для добавления, сначала самые новые |
| `review_date`/`next_review`| Календарность ~6 месяцев и ~1 год, что соответствует графику проверки навыков |
| `tags`| Токены имени файла плюс ключевое слово чистой категории (например, `coding-and-technology`) |
| `difficulty_level`| Устанавливается по категориям с переопределениями для каждого языка (например, Haskell/Assembly → `advanced`, Scratch → `beginner`) |
| `estimated_reading_time`| Рассчитывается по количеству строк |
### Редактирование файла
При изменении файла базы знаний синхронизируйте его заголовок:
1. **Увеличьте`version`** после [SemVer](https://semver.org/):
   - Патч (`1.0.x`): опечатки, форматирование, мелкие исправления.
   - Незначительный (`1.x.0`): новые разделы, расширенный контент, новые примеры.
   - Major (`x.0.0`): полная перезапись или реструктуризация.
2. **Добавьте запись в журнале изменений** (сначала самую новую), описывающую, что вы изменили:   ```yaml
   changelog:
     - version: "1.1.0"
       date: "2026-08-05"
       author: "Your Name"
     ...
     - version: "1.0.0"
       ...
       changes: "Added YAML frontmatter metadata for contributor tracking"
   ```
3. **Обновите`last_modified`** до даты изменения.
4. **Добавьте себя в`contributors`**, если это ваше первое редактирование файла:   ```yaml
   contributors:
     - name: "Your Name"
...
Прежде чем отправлять новый или отредактированный файл базы знаний, проверьте:
- [ ] Вводная часть YAML заполнена и действительна (присутствуют все пять разделов между разделителями `---`).
- [ ] `title`, `description`, `category`, `version`,`status`установлены.
- [ ] По крайней мере один автор указан в `authors`. 
- [ ]`changelog`имеет запись, документирующую изменение (сначала самые новые)
- [ ]`last_modified`отображает сегодняшнюю дату
- [ ]`tags`включает 3–6 релевантных ключевых слов плюс ключевое слово «чистая категория».
- [ ]`difficulty_level`установлен (начинающий/средний/продвинутый)
- [ ]`estimated_reading_time`соответствует длине контента.
- [ ] Содержимое тела соответствует [Usage Guidelines](#usage-guidelines), указанному выше.
- [ ] Нет неработающих перекрестных ссылок
---

*Эта база знаний представляет собой живую коллекцию документов, постоянно улучшаемую и расширяемую.*