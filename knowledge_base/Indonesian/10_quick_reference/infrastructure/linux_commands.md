...
# Referensi Cepat Perintah Linux
Perintah penting Linux/Unix untuk navigasi dan administrasi sistem.
---
...
| `Ctrl+C`| Bunuh perintah saat ini |
| `Ctrl+Z`| Tangguhkan perintah |
| `Ctrl+D`| Keluar dari shell/EOF |
| `Ctrl+L`| Hapus layar |
| `Ctrl+A`| Pergi ke baris awal |
| `Ctrl+E`| Pergi ke akhir baris |
| `Ctrl+U`| Hapus ke baris awal |
| `Ctrl+K`| Hapus ke akhir baris |
| `Ctrl+R`| Riwayat pencarian |
| `Ctrl+W`| Hapus kata sebelum kursor |
---

## Praktik Terbaik
✅ **Lakukan:**
- Gunakan`sudo`dengan hemat dan hati-hati
- Uji perintah destruktif tanpa tanda eksekusi terlebih dahulu
- Simpan cadangan sebelum perubahan besar
- Gunakan nama file yang bermakna (tanpa spasi)
- Belajar menggunakan halaman`man`(`man command`)
❌ **Jangan:**
- Jalankan`rm -rf /`atau perintah berbahaya serupa
- Gunakan`chmod 777`pada file sensitif
- Abaikan pesan peringatan
- Edit file sistem tanpa cadangan
- Jalankan skrip yang tidak dikenal sebagai root
---

*Terakhir diperbarui: Juli 2026 | Kompatibel dengan Linux/Unix*