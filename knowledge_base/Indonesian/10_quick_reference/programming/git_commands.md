...
### Sinkronisasi dengan Utama```bash
...
### Alur Kerja Perbaikan Terbaru```bash
git checkout main
git pull
...
## Pintasan Keyboard (Git Bash)
| Pintasan | Aksi |
|----------|--------|
| `Ctrl+R`| Membalikkan riwayat pencarian |
| `Tab`| Pelengkapan otomatis |
| `Ctrl+C`| Batalkan perintah |
| `Ctrl+Z`| Tangguhkan proses |
| `fg`| Lanjutkan proses yang ditangguhkan |
---

## Praktik Terbaik
✅ **Lakukan:**
- Tulis pesan komit yang jelas dan deskriptif
- Sering melakukan dengan pengelompokan logis
- Gunakan cabang untuk fitur/perbaikan
- Tarik sebelum mulai bekerja
- Sering-seringlah meninjau `git status`
❌ **Jangan:**
- Melakukan data sensitif (kunci API, kata sandi)
- Paksa dorong ke cabang bersama
- Komit file biner besar
- Abaikan konflik penggabungan
- Bekerja langsung di main/master
---
...
*Terakhir diperbarui: Juli 2026 | Git 2.x*