...
| **Optimasi** | Menemukan solusi optimal dalam ruang pencarian yang luas | Logistik; keuangan; ilmu material |
...
|-------------------|----------|--------|--------|
| **IBM** | Superkonduktor | 1.000+ | Prosesor condor; keunggulan kuantum belum didemonstrasikan untuk masalah praktis |
