...
---
# Rekayasa Cepat
Rekayasa cepat adalah praktik merancang, menyempurnakan, dan mengoptimalkan masukan masukan untuk mendapatkan keluaran terbaik dari model bahasa. Ini adalah seni dan sains, dan merupakan antarmuka utama untuk mengendalikan perilaku LLM tanpa penyesuaian.
---
...
**Dengan konteks:**
> "Anda adalah pengembang Python senior. Tulis fungsi untuk mengurutkan daftar kamus berdasarkan kunci tertentu. Gunakan petunjuk tipe dan tangani kasus tepi. Audiensnya adalah pengembang junior."
...
Biarkan model menyisipkan penalaran dengan pemanggilan alat. Ia dapat berpikir, kemudian bertindak (misalnya mencari di web, menjalankan kode), lalu berpikir lagi berdasarkan hasilnya.
**Struktur cepat:**
