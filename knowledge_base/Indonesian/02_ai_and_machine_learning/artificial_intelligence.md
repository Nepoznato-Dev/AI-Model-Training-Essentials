...
| **Pengenalan ucapan** | Hampir seperti manusia dalam audio yang bersih | Berjuang dengan aksen yang berat, kebisingan latar belakang |
| **Penalaran** | Meningkat dengan cepat; dapat memecahkan banyak masalah logika | Gagal dalam permasalahan baru yang membutuhkan pemahaman tulus |
...
- **Generalisasikan dengan sempurna** ke domain yang sangat berbeda dari data pelatihan
...
- **Robot humanoid** (Tesla Optimus, Gambar AI) — muncul; tugas-tugas fisik untuk tujuan umum masih sangat sulit
