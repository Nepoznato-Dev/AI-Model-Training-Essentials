...
- **Precision@k**: Bagian item yang relevan di antara rekomendasi teratas.
...
- **Mitigasi:** Latih ulang secara berkala, pantau kinerja, gunakan algoritme deteksi penyimpangan.
---

## Penyetelan Hyperparameter
- **Penelusuran Grid**: Coba secara menyeluruh semua kombinasi kumpulan hyperparameter yang telah ditentukan sebelumnya. Sederhana namun mahal secara komputasi.
