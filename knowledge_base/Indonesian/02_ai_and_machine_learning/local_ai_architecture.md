...
| INT4 (4-bit) | 0,5 | ~1,9 GB | ~3,5GB | ~6,5GB | ~35 GB |
**Pedoman praktis:**
...
Memuat bobot model langsung dari disk tanpa memuatnya seluruhnya ke dalam RAM (berguna untuk model besar pada sistem dengan memori terbatas). llama.cpp menggunakan pemetaan memori secara default.
---
