...
Melatih model AI besar memang mengesankan, tetapi penerapannya secara efisien adalah tempat sebagian besar rekayasa terjadi. Model yang membutuhkan waktu 10 detik untuk merespons atau memerlukan delapan GPU A100 tidak berguna untuk sebagian besar aplikasi nyata. Pengoptimalan model adalah seni dan ilmu untuk membuat model menjadi lebih kecil, lebih cepat, dan lebih murah — tanpa terlalu mengorbankan kualitas. File ini mencakup kuantisasi, pemangkasan, distilasi, dan alat praktis untuk memasukkan model ke dalam produksi.
---
...
- **Gunakan vLLM untuk penayangan LLM.** Ini adalah opsi sumber terbuka tercepat untuk inferensi LLM throughput tinggi.
