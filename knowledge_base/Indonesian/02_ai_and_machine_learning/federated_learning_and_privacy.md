...
| Properti | Deskripsi |
|----------|-------------|
| **Data non-IID** | Setiap perangkat mempunyai sebaran data yang berbeda-beda (tidak independen dan terdistribusi secara identik) |
...
| **Hak untuk menghapus** | Must be able to remove a person's data from a trained model (machine unlearning) |
| **Hak atas penjelasan** | Models must be interpretable enough to explain individual predictions |
| **Privasi berdasarkan desain** | Privacy must be built into systems from the start |
---
