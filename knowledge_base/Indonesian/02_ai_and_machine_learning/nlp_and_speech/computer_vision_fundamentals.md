...
Gambar RGB 1920×1080 adalah tensor berbentuk`(1080, 1920, 3)`— berukuran 6,2 juta piksel, masing-masing dengan 3 nilai.
### Operasi Kunci
| Operasi | Deskripsi |
|-----------|-------------|
...
Ide sederhana ini memungkinkan jaringan dengan 152+ lapisan dilatih secara efektif, dan kini menjadi standar di hampir semua arsitektur mendalam.
---
