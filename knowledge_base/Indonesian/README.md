...
**Organisasi:** 10 direktori tematik + 34 referensi bahasa pemrograman
---
...
| [embedded_systems_and_iot.md](01_coding_and_technology/embedded_systems_and_iot.md)| Mikrokontroler, sensor, RTOS, protokol IoT, komputasi tepi |
...
|----------|------|-|----------|------|
| ular piton | `programming_languages/python/`| | JavaScript | `programming_languages/javascript/`|
| C | `programming_languages/c/`| | C++ | `programming_languages/cpp/`|
| Jawa | `programming_languages/java/`| | C#| `programming_languages/csharp/`|
| Pergi | `programming_languages/go/`| | Karat | `programming_languages/rust/`|
| Skrip Ketik | `programming_languages/typescript/`| | SQL | `programming_languages/sql/`|
| rubi | `programming_languages/ruby/`| | PHP | `programming_languages/php/`|
| Cepat | `programming_languages/swift/`| | Kotlin | `programming_languages/kotlin/`|
| R | `programming_languages/r/`| | Visual Dasar | `programming_languages/visual_basic/`|
| Anak panah | `programming_languages/dart/`| | Skala | `programming_languages/scala/`|
...
| Erlang/Ramuan | `programming_languages/erlang_and_elixir/`| | OCaml | `programming_languages/ocaml/`|
| Prolog | `programming_languages/prolog/`| | Cadel/Clojure | `programming_languages/lisp_and_clojure/`|
| Ada | `programming_languages/ada/`| | Majelis | `programming_languages/assembly/`|
| MATLAB | `programming_languages/matlab/`| | Fortran | `programming_languages/fortran/`|
| COBOL | `programming_languages/cobol/`| | Cangkang/PowerShell | `programming_languages/shell_and_powershell/`|
| Delphi/Pascal | `programming_languages/delphi_object_pascal/`| | Gores | `programming_languages/scratch/`|
...
| [data_ethics_and_privacy.md](03_data_science_and_analytics/data_ethics_and_privacy.md)| GDPR, persetujuan data, bias algoritmik, pola gelap, anonimisasi |
| [ensemble_methods.md](03_data_science_and_analytics/ensemble_methods.md)| Mengantongi, meningkatkan, menumpuk, memilih, hutan acak, XGBoost |
| [feature_engineering.md](03_data_science_and_analytics/feature_engineering.md)| Transformasi, pengkodean, pemilihan fitur, pengurangan dimensi |
| [geospatial_analysis.md](03_data_science_and_analytics/geospatial_analysis.md)| Sistem koordinat, operasi spasial, GeoPandas, analisis raster |
### 04 — Ilmu Pengetahuan Alam
| Berkas | Deskripsi |
|------|-------------|
...
| Berkas | Deskripsi |
|------|-------------|
| [business_and_economics.md](05_business_and_economics/business_and_economics.md)| Struktur perusahaan, pemasaran, ekonomi, startup |
| [finance_and_investing.md](05_business_and_economics/finance_and_investing.md)| Keuangan pribadi, investasi, pasar, pensiun |
| [law_and_legal_systems.md](05_business_and_economics/law_and_legal_systems.md)| Sistem hukum, kontrak, gugatan, IP, pekerjaan |
| [marketing_and_digital_strategy.md](05_business_and_economics/marketing_and_digital_strategy.md)| 4P, saluran digital, SEO/SEM, analitik, strategi merek |
| [management_and_project_methodologies.md](05_business_and_economics/management_and_project_methodologies.md)| Kepemimpinan, Agile/Scrum/Kanban, OKR, manajemen risiko |
| [behavioural_economics.md](05_business_and_economics/behavioural_economics.md)| Bias kognitif, teori prospek, heuristik, dorongan, arsitektur pilihan |
| [game_theory.md](05_business_and_economics/game_theory.md)| Ekuilibrium Nash, dilema tahanan, desain mekanisme, lelang |
| [intellectual_property_and_innovation.md](05_business_and_economics/intellectual_property_and_innovation.md)| Paten, hak cipta, merek dagang, rahasia dagang, lisensi sumber terbuka |
| [organisational_design_and_culture.md](05_business_and_economics/organisational_design_and_culture.md)| Struktur organisasi, tipe budaya, manajemen perubahan, dinamika tim |
| [supply_chain_and_operations.md](05_business_and_economics/supply_chain_and_operations.md)| Manajemen inventaris, lean manufacturing, logistik, bullwhip effect |
### 06 — Humaniora & Seni
| Berkas | Deskripsi |
|------|-------------|
...
| Berkas | Deskripsi |
|------|-------------|
| [dictionary.md](07_general_reference/dictionary.md)| Definisi kata komprehensif (A-Z) |
| [general_knowledge.md](07_general_reference/general_knowledge.md)| Tata surya, tubuh manusia, geografi, energi |
| [technology_and_computing.md](07_general_reference/technology_and_computing.md)| Dasar-dasar komputasi, internet, database, cloud, keamanan |
| [safe_communication.md](07_general_reference/safe_communication.md)| Pedoman komunikasi dan praktik terbaik |
| [learning_science_and_pedagogy.md](07_general_reference/learning_science_and_pedagogy.md)| Praktek pengambilan, pengulangan spasi, taksonomi Bloom, desain pembelajaran |
| [research_methodology.md](07_general_reference/research_methodology.md)| Metode ilmiah, pengambilan sampel, validitas, desain eksperimen, peer review |
| [writing_and_communication.md](07_general_reference/writing_and_communication.md)| Prinsip Piramida, Presentasi, Persuasi, Penulisan Bisnis |
### 08 — Masa Depan & Tren
| Berkas | Deskripsi |
|------|-------------|
...
| Berkas | Deskripsi |
|------|-------------|
| [ai_llm_failures.md](09_lessons_from_failures/ai_llm_failures.md)| Halusinasi, bias, kegagalan penyelarasan |
| [code_quality_issues.md](09_lessons_from_failures/code_quality_issues.md)| Kesalahan pengkodean umum dan anti-pola |
| [cognitive_logical_issues.md](09_lessons_from_failures/cognitive_logical_issues.md)| Kesalahan penalaran dan bias kognitif |
| [rag_vector_search.md](09_lessons_from_failures/rag_vector_search.md)| Jebakan pencarian RAG dan vektor |
| [security_vulnerabilities.md](09_lessons_from_failures/security_vulnerabilities.md)| Kerentanan keamanan umum |
| [system_reliability.md](09_lessons_from_failures/system_reliability.md)| Kegagalan sistem dan pola keandalan |
| [api_design_and_integration_failures.md](09_lessons_from_failures/api_design_and_integration_failures.md)| Anti-pola API, perubahan yang dapat menyebabkan gangguan, kegagalan pembuatan versi, kegagalan berjenjang |
| [data_pipeline_and_etl_failures.md](09_lessons_from_failures/data_pipeline_and_etl_failures.md)| Penyimpangan skema, duplikat data, kesenjangan validasi, pemantauan saluran pipa |
| [ml_project_failures.md](09_lessons_from_failures/ml_project_failures.md)| Kebocoran data, ketidaksesuaian ekspektasi, kegagalan penerapan, pembusukan model |
### 10 — Referensi Cepat
| Berkas | Deskripsi |
|------|-------------|
...
4. Pilih bahasa di `01_coding_and_technology/programming_languages/python/`
...
## Penafian Penting
- **Informasi Medis:** Konten dalam`medicine_and_healthcare.md`hanya untuk tujuan pendidikan dan tidak boleh menggantikan nasihat medis profesional.
- **Informasi Hukum:** Konten di`law_and_legal_systems.md`bersifat informatif dan bukan merupakan nasihat hukum.
- **Informasi Keuangan:** Konten di`finance_and_investing.md`bersifat mendidik dan tidak boleh dianggap sebagai nasihat keuangan.
- **Proyeksi Masa Depan:** Konten di`08_future_and_trends/`berisi informasi spekulatif dan proyeksi yang mungkin berubah.
---

## Pedoman Penggunaan
### Untuk Sistem AI
- Semua file menggunakan judul hierarki yang jelas (judul `#`, bagian `##`, subbagian `###`)
- Tabel digunakan untuk perbandingan terstruktur secara keseluruhan
- Contoh kode mencakup penyorotan sintaksis
- Referensi silang menggunakan tautan penurunan harga relatif
### Untuk Pembaca Manusia
- File ditulis dengan nada percakapan dan netral
- Tabel dan perbandingan terstruktur digunakan sebagai pengganti paragraf padat
- Contoh dan analogi dunia nyata membantu mendasari konsep abstrak
- Setiap file menyertakan bagian ringkasan
---

## Berkontribusi & Metadata
Setiap file konten di basis pengetahuan ini (semuanya kecuali`README.md`ini) dibuka dengan blok frontmatter YAML. Ini mengikuti pola pelacakan kontributor yang sama yang digunakan oleh[skills](../../skills/skill-creator.md), sehingga kepenulisan, pengeditan, dan ulasan tetap dapat dilacak di kedua koleksi. Untuk alur kerja kontribusi umum — forking, percabangan, permintaan tarik, penempatan file, dan konvensi penamaan — lihat root[CONTRIBUTING.md](../../CONTRIBUTING.md).
### Skema Materi Depan
Setiap file dimulai dengan blok ini (antara pembatas `---`), dibagi menjadi lima bagian yang diberi komentar:
```yaml
---
# Metadata
...
|---|---|
| `title`| Diambil dari judul`#`pertama file |
| `description`| Ringkasan satu baris; file topik menggunakan kembali entri dari indeks README ini, file bahasa pemrograman menggunakan deskripsi |
| `category`/`reviewed_by`| Berasal dari direktori induk (`01_coding_and_technology`→ "Coding dan Teknologi" / "Tim Basis Pengetahuan Coding & Teknologi") |
| `version`| Versi semantik; benjolan pada setiap pengeditan (lihat di bawah) |
| `authors`/`contributors`| Penulis asli ditambah siapa saja yang telah mengedit file |
| `changelog`| Daftar perubahan hanya dapat ditambahkan, yang terbaru terlebih dahulu |
| `review_date`/`next_review`| Irama ~6 bulan dan ~1 tahun, mencerminkan jadwal tinjauan keterampilan |
| `tags`| Token nama file ditambah kata kunci kategori bersih (mis.`coding-and-technology`) |
| `difficulty_level`| Ditetapkan berdasarkan kategori, dengan penggantian per bahasa (misalnya Haskell/Assembly →`advanced`, Scratch →`beginner`) |
| `estimated_reading_time`| Dihitung dari jumlah baris |
### Mengedit Berkas
Saat Anda mengubah file basis pengetahuan, jaga agar materi depannya tetap sinkron:
1. **Bump`version`** mengikuti[SemVer](https://semver.org/):
   - Patch (`1.0.x`): kesalahan ketik, pemformatan, koreksi kecil
   - Minor (`1.x.0`): bagian baru, konten yang diperluas, contoh baru
   - Mayor (`x.0.0`): penulisan ulang atau restrukturisasi lengkap
2. **Tambahkan entri log perubahan** (yang terbaru terlebih dahulu) yang menjelaskan apa yang Anda ubah:   ```yaml
   changelog:
     - version: "1.1.0"
       date: "2026-08-05"
       author: "Your Name"
     ...
     - version: "1.0.0"
       ...
       changes: "Added YAML frontmatter metadata for contributor tracking"
   ```
3. **Perbarui`last_modified`** ke tanggal perubahan Anda
4. **Tambahkan diri Anda ke`contributors`** jika ini adalah pengeditan pertama Anda pada file:   ```yaml
   contributors:
     - name: "Your Name"
...
Sebelum mengirimkan file basis pengetahuan baru atau yang telah diedit, verifikasi:
- [ ] Frontmatter YAML lengkap dan valid (kelima bagian ada, di antara pembatas `---`)
- [ ]`title`,`description`,`category`,`version`,`status`disetel
- [ ] Setidaknya satu penulis terdaftar di`authors`
- [ ]`changelog`memiliki entri yang mendokumentasikan perubahan (yang terbaru terlebih dahulu)
- [ ]`last_modified`mencerminkan tanggal hari ini
- [ ]`tags`sertakan 3-6 kata kunci yang relevan ditambah kata kunci kategori bersih
- [ ]`difficulty_level`disetel (pemula / menengah / lanjutan)
- [ ]`estimated_reading_time`realistis untuk panjang konten
- [ ] Isi isi mengikuti[Usage Guidelines](#usage-guidelines)di atas
- [ ] Tidak ada referensi silang yang rusak
---

*Basis pengetahuan ini adalah kumpulan dokumen hidup, yang terus ditingkatkan dan diperluas.*