...
- Gunakan `tmux` atau `screen` untuk menjaga sesi tetap hidup ketika terputus dari server jarak jauh.
- `man <command>` menampilkan halaman manual untuk perintah bawaan apa pun.
