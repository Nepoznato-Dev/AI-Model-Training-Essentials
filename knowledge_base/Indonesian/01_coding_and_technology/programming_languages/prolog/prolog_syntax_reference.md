...
# Prolog — Referensi Sintaks
Dokumen ini memberikan referensi sintaksis yang komprehensif dan terstruktur untuk Prolog. Ini melengkapi referensi Prolog utama dengan berfokus pada pola sintaksis yang lengkap, penyatuan, penelusuran mundur, DCG, dan idiom pemrograman logika.
---
...
## Ringkasan
Sintaks Prolog minimal — fakta, aturan, dan pertanyaan. Kekuatannya berasal dari penyatuan dan kemunduran, yang mengubah bahasa tersebut menjadi mesin pencari solusi logis. DCG menyediakan generasi parser yang elegan. Daftar menggunakan pencocokan pola kepala/ekor. Untuk kepuasan kendala, sistem pakar, dan komputasi simbolik, pendekatan deklaratif Prolog memecahkan masalah yang bersifat verbose dalam bahasa imperatif.