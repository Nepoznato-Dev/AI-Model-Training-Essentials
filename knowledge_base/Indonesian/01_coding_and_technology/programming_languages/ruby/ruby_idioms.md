...
---
# Ruby — Pola Idiomatik & Praktik Terbaik
Panduan ini mencakup pola idiomatik dan praktik terbaik untuk menulis kode Ruby yang bersih.
---
...
## Ringkasan
Idiom Ruby menekankan: kebahagiaan pengembang, konvensi atas konfigurasi, blok dan iterator, pengetikan bebek, dan sintaksis ekspresif. Ikuti Panduan Gaya Ruby, gunakan RuboCop untuk linting, dan StandardRB untuk pemformatan berdasarkan pendapat. Ruby menghargai keterbacaan — kode harus dibaca seperti bahasa Inggris. Lebih memilih metode Enumerable daripada loop manual, gunakan simbol untuk pengidentifikasi, dan gunakan blok untuk iterasi dan manajemen sumber daya.