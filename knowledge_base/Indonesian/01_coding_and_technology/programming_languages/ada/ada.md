...
## Mengapa Ada Penting
- **Sistem yang sangat penting bagi keselamatan **: Dirancang dari awal untuk sistem yang kegagalan bukanlah suatu pilihan.
- **Pengetikan kuat**: Sistem pengetikan yang paling ketat dibandingkan bahasa umum lainnya — menangkap kesalahan pada waktu kompilasi yang tidak dapat ditemukan dalam bahasa lain.
- **Konkurensi bawaan**: Tasking (pemrograman bersamaan) adalah bagian dari bahasa, bukan perpustakaan.
- **Verifikasi formal**: Mendukung metode formal untuk membuktikan kebenaran program.
- **Fitur keandalan**: Pengecualian bawaan, kontrak (kondisi pra/pasca), dan pemeriksaan waktu proses.
- **Ada Modern**: Ada 2012 dan Ada 2022 telah menambahkan fitur-fitur modern dengan tetap menjaga jaminan keamanan.
## Pengorbanan
| Batasan | Detail | Solusi Khas |
|-----------|---------|-------------------|
| **Komunitas khusus** | Basis pengembang kecil dibandingkan dengan C, Java, atau Python | Komunitas khusus namun berpengetahuan |
| **Sintaks verbose** | Lebih bertele-tele dari C atau Python | Terima sebagai bagian dari desain berorientasi keselamatan |
| **Ekosistem terbatas** | Lebih sedikit perpustakaan dibandingkan bahasa umum | Tulis kode khusus; gunakan perpustakaan standar yang luas |
| **Kurva pembelajaran** | Bahasa yang rumit dengan banyak fitur keselamatan | Mulailah dengan subset "SPARK" Ada untuk pekerjaan yang kritis terhadap keselamatan |
| **Ketersediaan kompiler** | Opsi kompiler lebih sedikit (GNAT adalah yang utama) | GNAT gratis dan terpelihara dengan baik |
---
...
### Jenis dan Warisan yang Ditandai (OOP)
```ada
-- Abstract base type
package Shapes is
...
### Generik (Polimorfisme Waktu Kompilasi)
```ada
...
### Objek yang Dilindungi (Data Bersama yang Aman untuk Thread)
```ada
...
## Pola Desain
### Pola 1: Pengamat dengan Objek yang Dilindungi
```ada
...
### Pola 2: Mesin Negara dengan Tipe yang Didiskriminasi
```ada
...
### Pola 3: RAII dengan Tipe Terkendali
```ada
...
## Penerapan
### SPARK untuk Sertifikasi Penting Keselamatan
```ada
...
## Kapan Menggunakan Ada
| Skenario | Mengapa Ada | Alternatif Lebih Baik |
|----------|---------|-------------------|
| Sistem yang kritis terhadap keselamatan | Dirancang untuk ini; dukungan verifikasi formal | — |
| Penerbangan / Dirgantara | Kompiler bersertifikat; Kepatuhan DO-178C | — |
| Sistem pertahanan | warisan Departemen Pertahanan; fitur keamanan | — |
| Kereta Api / Alat Kesehatan | Persyaratan integritas tinggi | — |
...
## Ringkasan
Ada adalah bahasa yang dibangun untuk kebenaran. Sistem tipenya yang ketat, konkurensi bawaan, dan dukungan verifikasi formal menjadikannya pilihan untuk sistem yang kegagalannya tidak dapat diterima. Meskipun komunitasnya kecil dibandingkan dengan bahasa umum, Ada tetap penting dalam bidang penerbangan, pertahanan, luar angkasa, dan bidang penting keselamatan lainnya. Untuk aplikasi-aplikasi ini, pendekatan ketat Ada terhadap rekayasa perangkat lunak bukanlah sebuah batasan — itulah intinya.