...
# Ada — Kesalahan Umum & Anti-Pola
Dokumen ini berisi katalog kesalahan, jebakan, dan anti-pola paling umum di Ada beserta koreksinya.
---

## 1. Tidak Menggunakan `pragma Strict`
```ada
...
## 2. Kesalahan Rentang pada Subtipe
```ada
...
## 3. Tidak Menggunakan Parameter Bernama untuk Keterbacaan
```ada
...
## Ringkasan
Pengetikan kuat Ada mencegah banyak bug tetapi membutuhkan disiplin: gunakan`pragma Strict`, tangani`Constraint_Error`untuk subtipe, gunakan asosiasi parameter bernama agar mudah dibaca, selalu tangani pengecualian, dan rancang komunikasi tugas dengan hati-hati untuk menghindari kebuntuan. Ada menghargai pemrograman yang hati-hati dan sadar akan keselamatan.