...
## Dekorator (TC39 Tahap 3 / TypeScript 5.0+)
```typescript
// Class decorator
...
## Ringkasan
Sistem tipe TypeScript adalah fitur penentunya, dan sangat mendalam. Dari anotasi dasar hingga generik, tipe kondisional, tipe yang dipetakan, tipe literal templat, dan`infer`, sistem tipe pada dasarnya adalah bahasa fungsional yang beroperasi pada waktu kompilasi. Memahami interaksi antara`interface`vs`type`, tipe generik vs utilitas, dan pengetikan struktural vs nominal mendukung penulisan TypeScript yang aman dan ergonomis. Bahasa ini terus berkembang, dengan setiap rilis menambahkan lebih banyak kekuatan ekspresif sambil mempertahankan kompatibilitas penuh dengan JavaScript.