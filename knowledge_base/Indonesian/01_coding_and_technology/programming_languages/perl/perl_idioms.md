...
-->
# Perl — Pola Idiomatik & Praktik Terbaik
Panduan ini mencakup pola idiomatik dan praktik terbaik untuk menulis kode Perl (5.38+) yang bersih dan modern.
---
...
## Ringkasan
Idiom Perl modern menekankan:`use strict; use warnings;`, tanda tangan, katakanlah, postderef, dan OOP modern (kata kunci kelas di 5.38+). Ikuti perlcritic untuk linting dan perltidy untuk pemformatan. Perl menghargai TMTOWTDI (Ada Lebih dari Satu Cara Untuk Melakukannya) — namun Perl modern menyatu pada pola yang lebih bersih dan mudah dipelihara.