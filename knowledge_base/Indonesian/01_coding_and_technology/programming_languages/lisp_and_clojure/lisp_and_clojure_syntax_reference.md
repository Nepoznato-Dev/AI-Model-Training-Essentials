...
-->
# Lisp & Clojure — Referensi Sintaks
Dokumen ini memberikan referensi sintaksis yang komprehensif dan terstruktur untuk Common Lisp dan Clojure. Ini melengkapi referensi utama Lisp/Clojure dengan berfokus pada ekspresi S, makro, struktur data persisten, dan pola pemrograman fungsional.
---

## Clojure — Sintaks Inti
```clojure
;; Literals
42              ;; integer
3.14            ;; float
...
## Ringkasan
Sintaks Clojure diberi tanda kurung secara seragam — setiap formulir adalah daftar. Homoikonisitas ini memungkinkan makro kuat yang mengubah kode menjadi data. Struktur data yang persisten memberikan kekekalan dengan pembagian struktural untuk efisiensi. Makro threading membuat alur data yang dapat dibaca. Primitif konkurensi (atom, referensi, agen, saluran) menangani perubahan status dengan aman. Pengaruh Lisp/Clojure pada pemrograman modern sangat besar — ​​pengumpulan sampah, REPL, makro, dan pemrograman fungsional semuanya berasal dari Lisp.