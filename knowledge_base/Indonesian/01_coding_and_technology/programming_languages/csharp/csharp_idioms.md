...
Panduan ini mencakup pola idiomatik dan praktik terbaik untuk menulis kode C# (12+) yang bersih dan modern.
---
...
## IDisposable & Manajemen Sumber Daya
```csharp
...
## Ringkasan
Idiom C# modern menekankan: catatan untuk data, pencocokan pola, keamanan nol (tipe referensi yang dapat dibatalkan), LINQ untuk koleksi, async/menunggu dengan CancellationToken, injeksi ketergantungan, konstruktor utama, ekspresi koleksi, dan deklarasi `using`. Ikuti Konvensi Pengkodean C#, gunakan`dotnet format`untuk pemformatan, dan penganalisis Roslyn untuk kualitas kode. C# modern (12+) ringkas dan ekspresif — mencakup rekaman, pencocokan pola, dan konstruktor utama.