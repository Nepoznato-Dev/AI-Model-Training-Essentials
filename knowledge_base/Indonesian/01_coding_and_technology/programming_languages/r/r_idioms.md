...
---
# R — Pola Idiomatik & Praktik Terbaik
Panduan ini mencakup pola idiomatik dan praktik terbaik untuk menulis kode R idiomatik yang bersih.
---
...
## Ringkasan
Idiom R menekankan: vektorisasi (hindari loop), pipa rapi (`|>`),`<-`untuk penugasan, penamaan kasus_ular, dan pemrograman fungsional dengan`purrr`. Ikuti Panduan Gaya Tidyverse, gunakan lintr untuk linting, dan styler untuk pemformatan. R menghargai operasi yang divektorkan dan pipa untuk transformasi data yang dapat dibaca.