...
# Kotlin — Pola Idiomatik & Praktik Terbaik
Panduan ini mencakup pola idiomatik dan praktik terbaik untuk menulis kode Kotlin yang bersih dan idiomatis.
---
...
## Ringkasan
Idiom Kotlin menekankan: keamanan null, kelas data, tipe tersegel, fungsi cakupan, fungsi ekstensi, coroutine, dan kode berorientasi ekspresi. Ikuti Konvensi Pengodean Kotlin, gunakan ktlint untuk pemformatan, dan deteksi untuk analisis statis. Kotlin menghargai keringkasan dan ekspresi — menulis lebih sedikit boilerplate, menggunakan perpustakaan standar, dan menggunakan`val`secara default.