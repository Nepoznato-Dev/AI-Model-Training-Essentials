...
-->
# Go — Referensi Sintaks
Dokumen ini memberikan referensi sintaksis yang komprehensif dan terstruktur untuk Go. Ini melengkapi referensi utama Go dengan berfokus pada pola sintaksis yang lengkap, tabel operator, dan mekanisme internal goroutine, saluran, dan antarmuka.
---
...
| `-`| Pengurangan | `3 - 2`| `1`| |
| `*`| Perkalian | `3 * 2`| `6`| |
| `/`| Divisi | `7 / 2`| `3`| Pembagian bilangan bulat untuk int |
| `%`| Sisa | `7 % 2`| `1`| Tanda cocok dengan dividen |
| `&`| Sedikit demi sedikit DAN | `5 & 3`| `1`| |
| `\|`| Sedikit demi sedikit ATAU | `5 \| 3`| `7`| |
| `^`| XOR sedikit demi sedikit | `5 ^ 3`| `6`| Juga pelengkap bitwise (unary) |
| `&^`| Agak jelas (DAN TIDAK) | `5 &^ 3`| `4`| Unik untuk Dikunjungi |
| `<<`| Pergeseran Kiri | `5 << 1`| `10`| |
| `>>`| Pergeseran Kanan | `5 >> 1`| `2`| |
### Operator Perbandingan
| Operator | Nama | Contoh | Catatan |
|----------|------|---------|-------|
| `==`| Sama | `x == y`| Hanya tipe yang sebanding |
| `!=`| Tidak Sama | `x != y`| |
| `<`,`>`,`<=`,`>=`| Memesan | `x >= y`| String dibandingkan secara leksikografis |
### Operator Logika
| Operator | Nama | Contoh | Catatan |
|----------|------|---------|-------|
...
## Ringkasan
Sintaks Go sengaja dibuat minimal — tidak ada pewarisan, tidak ada metode yang berlebihan, tidak ada pengecualian, tidak ada makro. Yang tersisa hanyalah serangkaian konstruksi yang bersih dan ortogonal: struct dan antarmuka untuk komposisi, goroutine dan saluran untuk konkurensi, dan penanganan kesalahan eksplisit untuk keandalan. Kekuatan bahasa tidak berasal dari sintaksis yang kompleks, melainkan dari interaksi elegan dari bahasa primitifnya yang sederhana. Generik (Go 1.18+) menambahkan fleksibilitas tipe tanpa mengorbankan kejelasan karakteristik Go.