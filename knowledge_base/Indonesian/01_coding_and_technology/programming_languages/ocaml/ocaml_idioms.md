...
-->
# OCaml — Pola Idiomatik & Praktik Terbaik
Panduan ini mencakup pola idiomatik untuk menulis kode OCaml yang bersih dan idiomatis.
---
...
## Ringkasan
Idiom OCaml menekankan: pencocokan pola menyeluruh, modul dan fungsi untuk abstraksi, Hasil/Opsi untuk keamanan, dan operator pipa pertama (`|>`). Ikuti`ocamlformat`untuk pemformatan dan`ocaml-lsp`untuk dukungan IDE. Nilai OCaml mengetikkan keamanan dan presisi matematis.