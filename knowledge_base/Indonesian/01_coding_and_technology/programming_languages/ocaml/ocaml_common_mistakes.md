...
---
# OCaml — Kesalahan Umum & Anti-Pola
Dokumen ini mengkatalogkan kesalahan, jebakan, dan anti-pola paling umum di OCaml beserta koreksinya.
---

## 1. Pencocokan Pola Tidak Lengkap
```ocaml
(* ❌ WRONG — missing cases *)
...
## 4. Tidak Menggunakan`Option`dengan Benar
```ocaml
...
## 5. Keadaan yang Dapat Diubah dalam Fungsi Rekursif
```ocaml
...
## Ringkasan
Perangkap OCaml: pencocokan pola tidak lengkap (peringatkan kompiler),`=`adalah persamaan struktural sedangkan`==`bersifat fisik, pembagian bilangan bulat terpotong, gunakan`Option`sebagai ganti pengecualian, dan hindari keadaan yang bisa berubah demi rekursi dan lipatan ekor. Kompiler OCaml adalah sekutu Anda — perhatikan peringatannya.