...
## Daftarkan Konvensi & Prolog/Epilog
```nasm
...
## Ringkasan
Idiom perakitan menekankan: konstanta bernama di atas angka ajaib, makro untuk pola berulang, definisi struktur untuk tata letak data, prolog/epilog yang sesuai dengan ABI, label lokal agar mudah dibaca, validasi masukan defensif, dan`xor`/`lea`untuk operasi yang efisien. Majelis menghargai kejelasan di atas segalanya — "jika Anda tidak dapat membacanya, Anda tidak dapat melakukan debug pada jam 3 pagi."