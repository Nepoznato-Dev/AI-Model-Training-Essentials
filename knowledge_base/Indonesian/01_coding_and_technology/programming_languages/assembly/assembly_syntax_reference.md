...
## Ringkasan
Sintaks bahasa rakitan ditentukan oleh arsitektur prosesor dan assembler (NASM, GAS, MASM). x86-64 menyediakan 16 register tujuan umum, beberapa mode pengalamatan, dan ratusan instruksi yang mencakup pergerakan data, aritmatika, logika, aliran kontrol, SIMD, dan panggilan sistem. Sintaks NASM yang digunakan di sini adalah yang paling umum untuk pengembangan Linux x86-64. Menguasai perakitan memerlukan pemahaman register, tumpukan, konvensi pemanggilan, dan bagaimana konstruksi tingkat tinggi dipetakan ke instruksi mesin.