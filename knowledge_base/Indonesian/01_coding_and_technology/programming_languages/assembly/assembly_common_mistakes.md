...
## 3. Off-by-One dalam Operasi String
```asm
...
## 5. Loop Tak Terbatas dari Kondisi Keluar yang Hilang
```asm
...
## Ringkasan
Perangkap perakitan: pertahankan register yang disimpan di callee, pertahankan penyelarasan tumpukan 16-byte, sertakan terminator nol dalam string, jelaskan secara eksplisit tentang ukuran operan, dan selalu sediakan kondisi keluar loop. Pemrograman perakitan memerlukan pemahaman perangkat keras pada tingkat terendah — setiap instruksi memiliki konsekuensi terhadap register, memori, dan flag.