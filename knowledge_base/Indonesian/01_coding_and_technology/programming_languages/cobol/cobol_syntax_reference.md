...
## Ringkasan
Sintaks COBOL dirancang secara verbose — setiap pernyataan dibaca seperti bahasa Inggris. Deskripsi data dengan klausa PIC secara tepat menentukan format lapangan. Struktur empat divisi menerapkan pemisahan kepentingan. Penanganan file sudah ada di dalam bahasa tersebut. Untuk pemrosesan data bisnis, aritmatika desimal COBOL dan I/O berorientasi rekaman tetap tak tertandingi. Memahami COBOL berarti memahami dasar komputasi perusahaan.