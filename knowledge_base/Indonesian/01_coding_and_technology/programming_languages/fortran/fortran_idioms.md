...
---
# Fortran — Pola Idiomatik & Praktik Terbaik
Panduan ini mencakup pola idiomatik dan praktik terbaik untuk menulis kode Fortran (2018+) yang bersih dan modern.
---
...
## Ringkasan
Idiom Fortran modern menekankan:`implicit none`, operasi array (hindari loop), array berbentuk asumsi, tipe turunan dengan prosedur terikat tipe, dan`intent`untuk semua argumen. Ikuti fprettify untuk memformat. Fortran modern (2018+) dengan coarrays dan DO CONCURRENT mendukung komputasi paralel secara asli.