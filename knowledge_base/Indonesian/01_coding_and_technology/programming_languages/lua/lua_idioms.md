...
-->
# Lua — Pola Idiomatik & Praktik Terbaik
Panduan ini mencakup pola idiomatik dan praktik terbaik untuk menulis kode Lua yang bersih dan idiomatik.
---
...
## Ringkasan
Idiom Lua menekankan: tabel sebagai struktur data universal, variabel lokal, penutupan untuk negara, metatabel untuk OOP, dan pengindeksan berbasis 1. Ikuti luacheck untuk linting dan stylua untuk memformat. Lua menghargai kesederhanaan dan minimalis — bahasanya sengaja dibuat kecil, sehingga pola muncul dari komposisi.