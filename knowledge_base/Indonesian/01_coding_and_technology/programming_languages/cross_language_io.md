...
# Perbandingan Lintas Bahasa — Operasi I/O & File
## Keluaran Konsol
| Bahasa | Cetak ke stdout |
|----------|----------------|
| ular piton | `print("Hello")`|
| JavaScript | `console.log("Hello")`|
| Karat | `println!("Hello")`|
| Pergi | `fmt.Println("Hello")`|
| Jawa | `System.out.println("Hello")`|
| C | `printf("Hello\n")`|
...
| Lua | `print("Hello")`|
| MATLAB | `disp('Hello')`|
| Anak panah | `print('Hello')`|
| Prolog | `write('Hello'), nl.`|
| Cadel | `(format t "Hello~%")`|
| Ramuan | `IO.puts("Hello")`|
| Erlang | `io:format("Hello~n")`|
| OCaml | `print_endline "Hello"`|
| Ada | `Put_Line("Hello")`|
| COBOL | `DISPLAY 'Hello'`|
| Fortran | `print *, 'Hello'`|
| Majelis | `syscall`(tulis ke fd 1) |
| Delfi | `WriteLn('Hello')`|
| Gores | `say [Hello]`|
| VB | `Console.WriteLine("Hello")`|
| cangkang | `echo "Hello"`|
| SQL | T/A (mengembalikan kumpulan hasil) |
## Membaca File
```python
# Python
