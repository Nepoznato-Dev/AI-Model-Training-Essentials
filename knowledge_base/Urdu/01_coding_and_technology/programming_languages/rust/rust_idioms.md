...
## خلاصہ
زنگ کے محاوروں پر زور دیا گیا ہے: ملکیت اور قرض لینا، غلطی سے نمٹنے کے لیے`Result`/ `Option`، طریقوں کے ساتھ enums، تجرید کے لیے خصائل، تکرار کرنے والا سلسلہ، مشترکہ حالت کے لیے سمارٹ پوائنٹرز، اور صفر لاگت تجرید۔ فارمیٹنگ کے لیے `rustfmt`، linting کے لیے `clippy`، اور Rust API کے رہنما خطوط پر عمل کریں۔ رسٹ کمیونٹی حفاظت، کارکردگی اور درستگی کی قدر کرتی ہے - "اگر یہ مرتب کرتی ہے تو یہ کام کرتی ہے۔" فنکشن آرگیومینٹس میں`String`پر`&str`کو ترجیح دیں، خرابی پھیلانے کے لیے`?`استعمال کریں، اور`#[derive(Debug, Clone, ...)]`کے ساتھ عام خصلتیں اخذ کریں۔