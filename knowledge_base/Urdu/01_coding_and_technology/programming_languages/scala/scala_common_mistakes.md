...
-->
# اسکیلا - عام غلطیاں اور اینٹی پیٹرن
یہ دستاویز Scala میں سب سے عام غلطیوں، ٹریپس، اور اینٹی پیٹرن کو تصحیح کے ساتھ کیٹلاگ کرتا ہے۔
---

## 1.`val`کی بجائے`var`استعمال کرنا
```scala
...
## 2. مہربند اقسام کے لیے پیٹرن میچنگ کا استعمال نہیں کرنا
```scala
// ❌ WRONG — if/else chain
...
## 6.`Option`کو مناسب طریقے سے ہینڈل نہیں کرنا
```scala
...
## 7. اینٹی پیٹرن: اسکالا میں کالعدم
```scala
// ❌ WRONG — using null
...
## 8. Generics کے ساتھ Erasure ٹائپ کریں۔
```scala
...
## خلاصہ
Scala کی طاقت ذمہ داری کے ساتھ آتی ہے:`var`پر`val`کو ترجیح دیں، سیل شدہ اقسام کے لیے پیٹرن میچنگ کا استعمال کریں،`Option`کو صحیح طریقے سے ہینڈل کریں (کبھی بھی`.get`کو کال نہ کریں)، نیسٹڈ فیوچرز کے بجائے فہم کے لیے استعمال کریں، اور null سے بچیں۔ Scala 3 ان میں سے بہت سے نمونوں کو enums، توسیع کے طریقوں، اور یونین کی اقسام کے ساتھ آسان بناتا ہے۔ کلیدی اصول: اگر مرتب کرنے والا اسے چیک کرسکتا ہے، تو مرتب کرنے والے کو اسے چیک کرنے دیں۔