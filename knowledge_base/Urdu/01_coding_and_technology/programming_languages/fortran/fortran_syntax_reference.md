...
| `.eqv.``.neqv.` | منطقی مساوات | `a .eqv. b`| |
| `//`| سٹرنگ کنکٹنیشن | `'hello' // ' world'`| |
---
...
## خلاصہ
جدید فورٹران کا نحو صاف، منظم اور عددی حساب کے لیے موزوں ہے۔ ارے آپریشنز زیادہ تر ریاضیاتی کاموں کے لیے لوپس کو ختم کر دیتے ہیں۔ ماڈیول انکیپسولیشن اور نام کی جگہ کا انتظام فراہم کرتے ہیں۔ OOP خصوصیات (ماخوذ اقسام، وراثت، پولیمورفزم) کلین کوڈ تنظیم کو فعال کرتی ہیں۔ Coarrays بیرونی لائبریریوں کے بغیر مقامی متوازی پروگرامنگ پیش کرتے ہیں۔ فورٹران کی طاقتیں - کارکردگی، صف کے آپریشنز، اور عددی درستگی - سائنسی کمپیوٹنگ کے لیے بے مثال ہیں۔ HPC، کمپیوٹیشنل فزکس، اور انجینئرنگ سمولیشن کے لیے، فورٹران ایک پاور ہاؤس بنا ہوا ہے۔