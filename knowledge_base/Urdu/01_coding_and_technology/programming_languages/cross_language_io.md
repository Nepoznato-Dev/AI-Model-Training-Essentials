...
-->
# کراس لینگویج کا موازنہ — I/O اور فائل آپریشنز
## کنسول آؤٹ پٹ
| زبان | stdout پر پرنٹ کریں |
|------------|----------------|
| ازگر | `print("Hello")`|
| جاوا اسکرپٹ | `console.log("Hello")`|
| مورچا | `println!("Hello")`|
| جاؤ | `fmt.Println("Hello")`|
...
| سوئفٹ | `print("Hello")`|
| کوٹلن | `println("Hello")`|
| پی ایچ پی | `echo "Hello\n"`|
| TypeScript | `console.log("Hello")`|
| ہاسکل | `putStrLn "Hello"`|
| سکالا | `println("Hello")`|
| آر | `cat("Hello\n")`|
| جولیا | `println("Hello")`|
| پرل | `say "Hello"`|
...
| لِسپ | `(format t "Hello~%")`|
| ایلکسیر | `IO.puts("Hello")`|
| ایرلنگ | `io:format("Hello~n")`|
| OCaml | `print_endline "Hello"`|
| اڈا | `Put_Line("Hello")`|
| کوبول | `DISPLAY 'Hello'`|
| فورٹران | `print *, 'Hello'`|
| اسمبلی | `syscall`(fd 1 پر لکھیں) |
| ڈیلفی | `WriteLn('Hello')`|
| سکریچ | `say [Hello]`|
| VB | `Console.WriteLine("Hello")`|
| شیل | `echo "Hello"`|
| ایس کیو ایل | N/A (نتیجے کے سیٹ واپس کرتا ہے) |
## فائل پڑھنا
```python
# Python
