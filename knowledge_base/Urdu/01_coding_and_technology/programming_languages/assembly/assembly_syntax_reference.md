...
## خلاصہ
اسمبلی لینگویج نحو کی تعریف پروسیسر آرکیٹیکچر اور اسمبلر (NASM, GAS, MASM) سے ہوتی ہے۔ x86-64 16 عام مقصد کے رجسٹر، ایک سے زیادہ ایڈریسنگ موڈز، اور ڈیٹا کی نقل و حرکت، ریاضی، منطق، کنٹرول فلو، SIMD، اور سسٹم کالز پر محیط سیکڑوں ہدایات فراہم کرتا ہے۔ لینکس x86-64 کی ترقی کے لیے یہاں استعمال ہونے والا NASM نحو سب سے عام ہے۔ اسمبلی میں مہارت حاصل کرنے کے لیے رجسٹر، اسٹیک، کالنگ کنونشنز، اور مشین کی ہدایات کے مطابق اعلیٰ سطح کی تعمیرات کو سمجھنے کی ضرورت ہوتی ہے۔