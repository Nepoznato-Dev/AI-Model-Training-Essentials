...
# سوئفٹ — محاوراتی نمونے اور بہترین طرز عمل
یہ گائیڈ صاف، سوئفٹ کوڈ لکھنے کے لیے محاوراتی نمونوں اور بہترین طریقوں کا احاطہ کرتا ہے۔
---
...
## خلاصہ
تیز محاوروں پر زور دیا جاتا ہے: حفاظت (اختیاری، محافظ)، قدر کی اقسام (اسٹرکٹس)، پروٹوکول پر مبنی ڈیزائن، پیٹرن کی مماثلت، async/await، اور immutability (`let` بذریعہ ڈیفالٹ)۔ Swift API ڈیزائن کے رہنما خطوط پر عمل کریں، کوڈ کے معیار کے لیے SwiftLint اور فارمیٹنگ کے لیے SwiftFormat استعمال کریں۔ سوئفٹ حفاظت اور اظہار کی قدر کرتا ہے - "اگر یہ مرتب کرتا ہے، تو یہ شاید درست ہے۔"