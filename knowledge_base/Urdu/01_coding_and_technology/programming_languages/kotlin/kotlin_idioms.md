...
-->
# کوٹلن — محاوراتی نمونے اور بہترین طرز عمل
یہ گائیڈ محاوراتی نمونوں اور صاف ستھرے، محاوراتی کوٹلن کوڈ لکھنے کے بہترین طریقوں کا احاطہ کرتا ہے۔
---
...
## خلاصہ
کوٹلن کے محاوروں پر زور دیا جاتا ہے: کالعدم حفاظت، ڈیٹا کی کلاسیں، مہربند اقسام، دائرہ کار کے افعال، توسیعی افعال، کوروٹینز، اور اظہار پر مبنی کوڈ۔ کوٹلن کوڈنگ کنونشنز پر عمل کریں، فارمیٹنگ کے لیے ktlint استعمال کریں، اور جامد تجزیہ کے لیے ڈیٹیکٹ۔ کوٹلن جامعیت اور اظہار خیال کی قدر کرتا ہے — کم بوائلر پلیٹ لکھیں، معیاری لائبریری کو اپنائیں، اور`val`کو بطور ڈیفالٹ استعمال کریں۔