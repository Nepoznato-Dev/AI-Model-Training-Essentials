...
یہ گائیڈ صاف، جدید C++ (20/23) کوڈ لکھنے کے لیے محاوراتی نمونوں اور بہترین طریقوں کا احاطہ کرتا ہے۔
---

## RAII اور اسمارٹ پوائنٹرز
```cpp
...
## خلاصہ
جدید C++ محاورات اس بات پر زور دیتے ہیں: RAII اور سمارٹ پوائنٹرز، موو سیمینٹکس، قسم کی کٹوتی کے لیے `auto`، رینجز اور الگورتھم (C++20)، ٹیمپلیٹ کی رکاوٹوں کے لیے تصورات،`std::optional`/ `std::expected`، غیر حاضری کے لیے، اور بے ضابطگیوں کے لیے کمپائل ٹائم کمپیوٹیشن کے لیے `constexpr`۔ فارمیٹنگ کے لیے `clang-format`، linting کے لیے `clang-tidy`، اور`-Wall -Wextra -Werror`کے ساتھ کمپائل کریں۔ C++ کمیونٹی صفر لاگت کے تجریدوں کی قدر کرتی ہے اور "جو آپ استعمال نہیں کرتے اس کی ادائیگی نہ کریں۔"