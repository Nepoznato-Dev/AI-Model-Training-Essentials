...
## خلاصہ
Erlang اور Elixir BEAM VM کی سپر پاورز کا اشتراک کرتے ہیں: ہلکے وزن کے عمل، پیغام کی منتقلی، اور غلطی کو برداشت کرنے والے نگرانی کے درخت۔ ایرلنگ کا نحو کم سے کم اور فعال ہے۔ ایلیکسیر پائپس، میکروز اور پروٹوکول کے ساتھ جدید نحو کا اضافہ کرتا ہے۔ OTP رویے (GenServer، سپروائزر، ایپلی کیشن) قابل اعتماد نظاموں کی تعمیر کے لیے جنگ کے آزمائشی نمونے فراہم کرتے ہیں۔ ریئل ٹائم، تقسیم شدہ، غلطی برداشت کرنے والی ایپلی کیشنز کے لیے، ایرلنگ/ایلیکسیر بے مثال ہے۔