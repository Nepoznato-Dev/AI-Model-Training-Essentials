...
---
# Erlang & Elixir — عام غلطیاں اور اینٹی پیٹرن
یہ دستاویز ایرلنگ اور ایلیکسیر میں سب سے عام غلطیوں، ٹریپس، اور اینٹی پیٹرن کو تصحیح کے ساتھ کیٹلاگ کرتا ہے۔
---

## 1. سنگل اسائنمنٹ (Erlang)
```erlang
...
## 2. لنکنگ/مانیٹرنگ کے عمل نہیں (Erlang)
```erlang
...
## 3. جنسرور کال بغیر ٹائم آؤٹ (Elixir)
```elixir
...
## 4. بغیر ٹائم آؤٹ کے`receive`میں پیٹرن میچ (Erlang)
```erlang
...
## 5. نیسٹڈ پیٹرن میچنگ کے لیے`with`استعمال نہیں کرنا (Elixir)
```elixir
...
## 6. اینٹی پیٹرن: طویل عرصے سے چلنے والی GenServer کال بیکس
```elixir
...
## خلاصہ
Erlang/Elixir ٹریپس: متغیرات واحد اسائنمنٹ ہیں، پروسیسز کو لنکس/مانیٹر کی ضرورت ہوتی ہے، GenServer کالز کو واضح ٹائم آؤٹ کی ضرورت ہوتی ہے،`receive`بغیر ٹائم آؤٹ کے ہمیشہ کے لیے بلاک ہوتے ہیں، اور GenServer کال بیکس کو بلاک نہیں ہونا چاہیے۔ BEAM کا طریقہ یہ ہے: اسے کریش ہونے دیں (نگرانی کے ساتھ)، صاف پیٹرن کی مماثلت کے لیے`with`استعمال کریں، GenServer کال بیکس کو تیز رکھیں، اور ہمیشہ عمل کی ناکامیوں کو ہینڈل کریں۔