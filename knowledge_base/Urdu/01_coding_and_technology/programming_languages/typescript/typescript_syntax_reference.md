...
---
# TypeScript - نحوی حوالہ
یہ دستاویز TypeScript کے لیے ایک جامع، ساختی نحوی حوالہ فراہم کرتی ہے۔ یہ ٹائپ سسٹم، جنرکس، یوٹیلیٹی ٹائپس، اور ایڈوانسڈ ٹائپ لیول پروگرامنگ پر فوکس کر کے TypeScript کے اہم حوالہ کو مکمل کرتا ہے۔
---

## ٹائپ سسٹم کے بنیادی اصول
### پرائمیٹو اور بلٹ ان اقسام
```typescript
// Primitives
...
## ڈیکوریٹرز (TC39 اسٹیج 3 / TypeScript 5.0+)
```typescript
// Class decorator
...
## خلاصہ
TypeScript کا ٹائپ سسٹم اس کی وضاحتی خصوصیت ہے، اور یہ خاص طور پر گہرا ہے۔ بنیادی تشریحات سے لے کر جنرکس، مشروط قسمیں، نقشہ بندی کی اقسام، تمثیل لغوی اقسام، اور `infer`، ٹائپ سسٹم بنیادی طور پر ایک فعال زبان ہے جو مرتب وقت پر کام کرتی ہے۔`interface`بمقابلہ `type`، جنرکس بمقابلہ یوٹیلیٹی اقسام، اور ساختی بمقابلہ برائے نام ٹائپنگ کے درمیان انٹرپلے کو سمجھنا ٹائپ اسکرپٹ کو لکھنے کی حمایت کرتا ہے جو محفوظ اور ایرگونومک دونوں طرح سے ہے۔ زبان کا ارتقاء جاری ہے، ہر ریلیز کے ساتھ جاوا اسکرپٹ کے ساتھ مکمل پسماندہ مطابقت کو برقرار رکھتے ہوئے مزید اظہار کی طاقت شامل ہوتی ہے۔