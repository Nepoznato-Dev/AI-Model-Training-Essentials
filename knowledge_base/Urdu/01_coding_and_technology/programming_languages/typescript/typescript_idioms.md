...
# TypeScript — محاوراتی نمونے اور بہترین طرز عمل
یہ گائیڈ صاف، محفوظ ٹائپ اسکرپٹ کوڈ لکھنے کے لیے محاوراتی نمونوں اور بہترین طریقوں کا احاطہ کرتا ہے۔
---
...
## خلاصہ
TypeScript محاورات اس بات پر زور دیتے ہیں: سخت قسم کی جانچ، آبجیکٹ کی شکلوں کے لیے انٹرفیس، ریاست کے لیے امتیازی یونینز، تنگ کرنے کے لیے ٹائپ گارڈز، رکاوٹوں کے ساتھ جنرک، غیر متغیر ہونے کے لیے `readonly`، اور لغوی اقسام کے لیے `as const`۔`typescript-eslint`کے ساتھ ESLint کی پیروی کریں، فارمیٹنگ کے لیے زیادہ خوبصورت، اور ہمیشہ`strict: true`کو فعال کریں۔ TypeScript کمیونٹی قسم کی حفاظت کی قدر کرتی ہے - اگر یہ مرتب کرتی ہے، تو یہ شاید کام کرتی ہے۔ اشیاء کی شکلوں کے لیے `interface`، یونینوں اور یوٹیلیٹیز کے لیے`type`کو ترجیح دیں، اور ہر قیمت پر`any`سے بچیں۔