...
## خلاصہ
بصری بنیادی محاورات اس بات پر زور دیتے ہیں: قسم کی حفاظت کے لیے `Option Strict On`، وسائل کے انتظام کے لیے`Using`بلاکس، سٹرنگ انٹرپولیشن، مجموعوں کے لیے LINQ،`Async/Await`بھر میں، مخصوص استثنا ہینڈلنگ، اور جدید خصوصیات جیسے پیٹرن میچنگ اور نال کنڈیشنل آپریٹرز۔ VB پڑھنے کی اہلیت کی قدر کرتا ہے - "کوڈ کو اچھی طرح سے منظم تفصیلات کی طرح پڑھنا چاہئے۔"