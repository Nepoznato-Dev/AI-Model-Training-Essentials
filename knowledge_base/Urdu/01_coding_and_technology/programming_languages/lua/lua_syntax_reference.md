...
|------------|------|---------|---------|
| `+``-``*``/``%``^` | ریاضی | `2 ^ 10`| `^`کفایت ہے |
| `//`| فلور ڈویژن | `7 // 2`| واپسی 3 (Lua 5.3+) |
| `==``~=` | مساوات | `a == b`| `~=`"برابر نہیں ہے" |
| `<``>``<=``>=` | موازنہ | `a >= b`| |
| `and``or``not`| منطقی | `a and b`| آپرینڈز واپس کرتا ہے، بولین نہیں |
| `..`| کنٹینیشن | `"hello" .. " world"`| |
| `#`| لمبائی | `#t`| سٹرنگ یا ٹیبل کی لمبائی |
| `&``\|``~``<<``>>`| Bitwise | `a & b`| Lua 5.3+ (انٹیجر اوپس) |
### منطقی آپریٹرز — نان بولین ریٹرن
```lua
...
## خلاصہ
Lua کی ترکیب جان بوجھ کر کم سے کم ہے — پوری زبان کو ایک صفحے میں بیان کیا جا سکتا ہے۔ جدولیں یونیورسل ڈیٹا سٹرکچر کے طور پر کام کرتی ہیں (ارے، لغات، اشیاء، ماڈیولز)۔ میٹی ٹیبلز زبان کی پیچیدگی کے بغیر توسیع پذیری فراہم کرتے ہیں۔ Coroutines کوآپریٹو ملٹی ٹاسکنگ اور خوبصورت تکرار کرنے والے پیٹرن کو فعال کرتے ہیں۔ زبان کی طاقت اس کے سرایت پذیری سے حاصل ہوتی ہے: Lua کو میزبان ایپلی کیشنز کے اندر رہنے کے لیے ڈیزائن کیا گیا ہے، جو کم سے کم اوور ہیڈ کے ساتھ اسکرپٹنگ کی صلاحیتیں فراہم کرتا ہے۔ گیم ڈویلپمنٹ، کنفیگریشن، اور ایمبیڈڈ سسٹمز کے لیے، Lua کی سادگی اس کی سب سے بڑی طاقت ہے — ایک چھوٹی سی زبان جو بالکل وہی کرتی ہے جس کی اسے ضرورت ہے، اور اس سے زیادہ کچھ نہیں۔