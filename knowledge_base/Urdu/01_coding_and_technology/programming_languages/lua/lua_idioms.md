...
# Lua — محاوراتی نمونے اور بہترین طرز عمل
یہ گائیڈ صاف، محاوراتی Lua کوڈ لکھنے کے لیے محاوراتی نمونوں اور بہترین طریقوں کا احاطہ کرتا ہے۔
---
...
## خلاصہ
Lua محاورے اس بات پر زور دیتے ہیں: جدولیں بطور یونیورسل ڈیٹا ڈھانچہ، مقامی متغیرات، ریاست کے لیے بندش، OOP کے لیے میٹیٹیبلز، اور 1 پر مبنی اشاریہ سازی۔ linting کے لیے luacheck اور فارمیٹنگ کے لیے stylua پر عمل کریں۔ Lua سادگی اور minimalism کی قدر کرتا ہے - زبان جان بوجھ کر چھوٹی ہے، لہذا نمونے ساخت سے ابھرتے ہیں۔