...
-->
# Java — محاوراتی نمونے اور بہترین طرز عمل
یہ گائیڈ صاف، جدید جاوا (17+) کوڈ لکھنے کے لیے محاوراتی نمونوں اور بہترین طریقوں کا احاطہ کرتا ہے۔
---
...
## خلاصہ
جدید جاوا محاورے اس بات پر زور دیتے ہیں: ڈیٹا کے ریکارڈز، درجہ بندی کے لیے سیل بند کلاسز، پیٹرن کی مماثلت، سوئچ ایکسپریشنز، ٹیکسٹ بلاکس، کلیکشن پروسیسنگ کے لیے اسٹریمز، غیر موجودگی کے لیے اختیاری، صفائی کے لیے وسائل کے ساتھ کوشش، ہم آہنگی کے لیے ورچوئل تھریڈز، اور انحصاری انجیکشن۔ گوگل جاوا اسٹائل گائیڈ پر عمل کریں، فارمیٹنگ کے لیے`javafmt`یا `Spotless`، اور لنٹنگ کے لیے Error Prone یا Checkstyle استعمال کریں۔ جدید جاوا (17-21+) ریکارڈز، سیل شدہ کلاسز، پیٹرن میچنگ، اور ورچوئل تھریڈز کے ساتھ جامع اور اظہار خیال ہے — نئی خصوصیات کو قبول کریں۔