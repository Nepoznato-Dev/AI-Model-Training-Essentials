...
یہ گائیڈ صاف، محفوظ سی کوڈ لکھنے کے لیے محاوراتی نمونوں اور بہترین طریقوں کا احاطہ کرتا ہے۔
---

## ہیڈر گارڈز اور شامل ہیں۔
```c
...
## خلاصہ
C محاورے اس بات پر زور دیتے ہیں: محتاط میموری مینجمنٹ، دفاعی پروگرامنگ، انکیپسولیشن کے لیے مبہم ڈھانچے، ڈو-وائل کے ساتھ میکرو، گوٹو کلین اپ کے ساتھ سنگل ایگزٹ پوائنٹس، اور جدید C11/C23 خصوصیات۔ فارمیٹنگ کے لیے `clang-format`، linting کے لیے `clang-tidy`، اور ہمیشہ`-Wall -Wextra -Werror`کے ساتھ کمپائل کریں۔ ٹیسٹنگ کے دوران سینیٹائزر (ASan، UBSan) استعمال کریں۔ سی کمیونٹی سادگی، کارکردگی، اور واضح کنٹرول کی قدر کرتی ہے - "پروگرامر پر بھروسہ کریں۔"