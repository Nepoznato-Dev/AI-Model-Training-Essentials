...
## قابل شناخت اور وسائل کا انتظام
```csharp
...
## خلاصہ
جدید C# محاورے اس بات پر زور دیتے ہیں: ڈیٹا کے ریکارڈز، پیٹرن کی مماثلت، null سیفٹی (نطلاح حوالہ کی قسمیں)، مجموعوں کے لیے LINQ، منسوخی ٹوکن کے ساتھ async/انتظار، انحصار انجیکشن، بنیادی تعمیر کنندگان، مجموعہ اظہار، اور`using`اعلانات۔ C# کوڈنگ کنونشنز پر عمل کریں، فارمیٹنگ کے لیے`dotnet format`اور کوڈ کے معیار کے لیے Roslyn تجزیہ کار استعمال کریں۔ جدید C# (12+) جامع اور اظہار خیال ہے - ریکارڈز، پیٹرن میچنگ، اور بنیادی تعمیر کنندگان کو گلے لگانا۔