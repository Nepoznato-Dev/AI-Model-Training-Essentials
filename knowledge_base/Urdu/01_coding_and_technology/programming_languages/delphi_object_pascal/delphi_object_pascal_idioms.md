...
## وسائل کا انتظام کوشش کے ساتھ/آخر میں
```delphi
...
## خلاصہ
ڈیلفی محاورے اس بات پر زور دیتے ہیں: ڈیٹرمنسٹک ریسورس کلین اپ کے لیے `try/finally`، سٹرنگ بلڈنگ کے لیے `Format`، ڈھیلے کپلنگ کے لیے انٹرفیس، ڈیٹا کیریئرز کے لیے ریکارڈ، مخصوص استثنیٰ ہینڈلنگ، اور جدید خصوصیات جیسے جنرک اور گمنام طریقے۔ ڈیلفی وسائل کے واضح انتظام کی قدر کرتا ہے - "اسے بنائیں، استعمال کریں، آخر کار اسے آزاد کریں۔"