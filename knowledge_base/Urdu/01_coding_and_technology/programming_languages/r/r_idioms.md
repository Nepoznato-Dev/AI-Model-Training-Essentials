...
## خلاصہ
R محاورے زور دیتے ہیں: ویکٹرائزیشن (لوپس سے بچیں)، صاف ستھرا پائپ (`|>`)،`<-`تفویض کے لیے، snake_case کا نام، اور`purrr`کے ساتھ فنکشنل پروگرامنگ۔ Tidyverse Style گائیڈ پر عمل کریں، linting کے لیے lintr اور فارمیٹنگ کے لیے styler کا استعمال کریں۔ پڑھنے کے قابل ڈیٹا کی تبدیلیوں کے لیے R ویکٹرائزڈ آپریشنز اور پائپ کی قدر کرتا ہے۔