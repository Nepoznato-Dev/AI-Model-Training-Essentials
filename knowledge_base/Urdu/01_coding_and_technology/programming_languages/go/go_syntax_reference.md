...
| `-`| گھٹاؤ | `3 - 2`| `1`| |
| `*`| ضرب | `3 * 2`| `6`| |
| `/`| ڈویژن | `7 / 2`| `3`| ints کے لیے عددی تقسیم |
| `%`| باقی | `7 % 2`| `1`| مماثل منافع پر دستخط کریں |
| `&`| بٹ وائز اور | `5 & 3`| `1`| |
| `\|`| Bitwise OR | `5 \| 3`| `7`| |
| `^`| Bitwise XOR | `5 ^ 3`| `6`| اس کے علاوہ bitwise complement (unary) |
| `&^`| تھوڑا سا واضح (اور نہیں) | `5 &^ 3`| `4`| جانے کے لیے منفرد |
| `<<`| بائیں شفٹ | `5 << 1`| `10`| |
| `>>`| دائیں شفٹ | `5 >> 1`| `2`| |
### موازنہ آپریٹرز
| آپریٹر | نام | مثال | نوٹس |
|------------|------|---------|---------|
| `==`| برابر | `x == y`| صرف موازنہ کی اقسام |
| `!=`| برابر نہیں | `x != y`| |
| `<`,`>`,`<=`,`>=`| آرڈرنگ | `x >= y`| سٹرنگز کا موازنہ لغت کے لحاظ سے |
### منطقی آپریٹرز
| آپریٹر | نام | مثال | نوٹس |
|------------|------|---------|---------|
...
### پرائمیٹوز کو مطابقت پذیر بنائیں
```go
// Mutex
var mu sync.Mutex
mu.Lock()
...
## خلاصہ
گو کا نحو جان بوجھ کر کم سے کم ہے — کوئی وراثت نہیں، کوئی طریقہ اوورلوڈنگ نہیں، کوئی استثنا نہیں، کوئی میکرو نہیں۔ جو باقی رہ گیا ہے وہ تعمیرات کا ایک صاف، آرتھوگونل سیٹ ہے: ساخت کے لیے سٹرکٹس اور انٹرفیس، ہم آہنگی کے لیے گوروٹینز اور چینلز، اور قابل اعتمادی کے لیے واضح غلطی سے نمٹنے۔ زبان کی طاقت پیچیدہ نحو سے نہیں بلکہ اس کے سادہ پریمیٹیو کے خوبصورت تعامل سے آتی ہے۔ Generics (Go 1.18+) Go کی خصوصیت کی وضاحت کو قربان کیے بغیر قسم کی لچک کا اضافہ کرتا ہے۔