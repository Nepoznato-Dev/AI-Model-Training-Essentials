...
## خلاصہ
شیل محاورے اس بات پر زور دیتے ہیں: `set -euo pipefail`، متغیرات کا حوالہ دیتے ہوئے،`[[ ]]`پر `[ ]`، پیرامیٹر کی توسیع، اور صفائی کے جال۔ PowerShell محاورے اس بات پر زور دیتے ہیں: CmdletBinding، پائپ لائن پروسیسنگ، splatting، اور سٹرکچرڈ ایرر ہینڈلنگ۔ باش کے لیے ShellCheck اور PowerShell کے لیے PSScriptAnalyzer کو فالو کریں۔