...
# ازگر - محاوراتی نمونے اور بہترین طرز عمل
یہ گائیڈ صاف، پائتھونک کوڈ لکھنے کے لیے محاوراتی نمونوں اور بہترین طریقوں کا احاطہ کرتا ہے۔
---
...
## خلاصہ
Pythonic کوڈ Python کے Zen کی پیروی کرتا ہے: پڑھنے کے قابل، واضح، سادہ اور فلیٹ۔ کلیدی محاورات میں شامل ہیں: فہرست/ڈیکٹ/سیٹ فہم، سیاق و سباق کے منتظمین (`with` )، EAFP ایرر ہینڈلنگ،`enumerate`/`zip`تکرار کے لیے،`dataclass`ڈیٹا کنٹینرز کے لیے، اشارے ٹائپ کریں، پیک کھولنا، اور سچائی چیک کریں۔ Python کمیونٹی پڑھنے کی اہلیت کو اہمیت دیتی ہے اور "اسے کرنے کا ایک واضح طریقہ ہونا چاہیے۔" سٹائل کے لیے PEP 8 کی پیروی کریں، linting کے لیے`ruff`استعمال کریں، اور جب ممکن ہو تیسرے فریق کے حل پر معیاری لائبریری کو ترجیح دیں۔