...
---
# ازگر نحو کی دھوکہ دہی کی شیٹ
Python 3.x نحو اور عام نمونوں کے لیے فوری حوالہ۔
---

## بنیادی نحو
### متغیرات اور ڈیٹا کی اقسام```python
...
## فوری ٹپس
- سنگل لائن تبصروں کے لیے`#`استعمال کریں۔
- docstrings اور ملٹی لائن سٹرنگز کے لیے`"""triple quotes"""`استعمال کریں۔
- انڈینٹیشن کے معاملات (عام طور پر 4 جگہیں)
- نام دینے کے کنونشن: متغیرات/فنکشنز کے لیے `snake_case`، کلاسز کے لیے `PascalCase`
-`__name__ == "__main__"`چیک کرنے کے لیے کہ آیا اسکرپٹ براہ راست چل رہا ہے۔
- پروجیکٹ آئسولیشن کے لیے`virtualenv`یا`venv`استعمال کریں
-`pip install package_name`کے ساتھ پیکجز انسٹال کریں۔
---

*آخری بار اپ ڈیٹ کیا گیا: جولائی 2026 | Python 3.x*