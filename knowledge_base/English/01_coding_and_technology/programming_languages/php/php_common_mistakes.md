...
-->
# PHP — Common Mistakes & Anti-Patterns

This document catalogs the most common mistakes, traps, and anti-patterns in PHP with corrections.

---

## 1. Loose Comparison (`==`) Pitfalls
...
## 4. Variable Variables and Dynamic Access
...
## 6. Global State and Superglobals
...
## 8. Not Using Composer Autoloading
...
## 10. Anti-Pattern: Business Logic in Views
...
PHP's flexibility is both its strength and weakness. The cardinal rules: always use strict comparison (`===`), use prepared statements for SQL, enable `declare(strict_types=1)`, use Composer for autoloading, regenerate session IDs after authentication, and keep business logic out of views. Modern PHP (8.x) with strict types, union types, match expressions, and named arguments is a far cry from PHP 5 — embrace the modern features.
