...
Modern Java idioms emphasize: records for data, sealed classes for hierarchies, pattern matching, switch expressions, text blocks, streams for collection processing, Optional for absence, try-with-resources for cleanup, virtual threads for concurrency, and dependency injection. Follow the Google Java Style Guide, use `javafmt` or `Spotless` for formatting, and Error Prone or Checkstyle for linting. Modern Java (17-21+) with records, sealed classes, pattern matching, and virtual threads is concise and expressive — embrace the new features.
