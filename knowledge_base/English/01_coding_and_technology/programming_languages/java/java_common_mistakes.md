...
-->
# Java — Common Mistakes & Anti-Patterns

This document catalogs the most common mistakes, traps, and anti-patterns in Java. Each entry shows the incorrect approach, explains why it fails, and provides the correct solution.

---

## 1. `equals()` vs `==` for Objects
...
## 3. Not Closing Resources (Try-with-Resources)
...
## 7. Not Handling InterruptedException
...
## 9. Mutable Objects as HashMap Keys
...
## 10. Anti-Pattern: Catching `Exception` or `Throwable`
...
## 11. Not Overriding `hashCode` When Overriding `equals`
...
## 12. Race Conditions with Double-Checked Locking
...
Java's verbosity can hide subtle bugs: `==` vs `equals()`, concurrent modification, resource leaks, autoboxing performance traps, and the equals/hashCode contract. The modern Java approach is: use `Objects.equals()` for null-safe comparison, always use try-with-resources, return empty collections instead of null, catch specific exceptions, and follow the single responsibility principle. Java 8+ features (streams, Optional, method references) reduce boilerplate while making code safer and more expressive.
