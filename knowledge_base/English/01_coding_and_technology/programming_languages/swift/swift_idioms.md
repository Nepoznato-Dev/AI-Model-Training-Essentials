...
-->
# Swift — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns and best practices for writing clean, Swift code.
...
Swift idioms emphasize: safety (optionals, guard), value types (structs), protocol-oriented design, pattern matching, async/await, and immutability (`let` by default). Follow the Swift API Design Guidelines, use SwiftLint for code quality, and SwiftFormat for formatting. Swift values safety and expressiveness — "if it compiles, it's probably correct."
