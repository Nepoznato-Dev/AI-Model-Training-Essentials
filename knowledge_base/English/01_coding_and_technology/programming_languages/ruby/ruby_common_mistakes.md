...
---
# Ruby — Common Mistakes & Anti-Patterns

This document catalogs the most common mistakes, traps, and anti-patterns in Ruby. Each entry shows the incorrect approach, explains why it fails, and provides the correct solution.
...
## 4. Not Using Blocks/Enumerators Idiomatically
...
## 6. Monkey Patching Core Classes
...
## 7. Not Understanding `return` in Blocks
...
## 10. Not Freezing String Literals
...
Ruby's expressiveness can lead to anti-patterns: modifying collections during iteration, monkey patching core classes, global variables, and fat models. The Ruby way is: use enumerators (`each`, `map`, `reject`), prefer symbols and keyword arguments, freeze string literals, extract service objects from models, and use refinements instead of monkey patches. Ruby rewards developers who embrace blocks, duck typing, and the principle of least surprise.
