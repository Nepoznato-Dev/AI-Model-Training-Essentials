...
# Go — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns and best practices for writing clean, idiomatic Go code.
...
Go idioms emphasize: simplicity, explicit error handling, small interfaces, composition over inheritance, goroutines with context, and "accept interfaces, return structs." Follow `gofmt` for formatting, `golangci-lint` for linting, and the official Go Code Review Comments guide. The Go community values readability, simplicity, and "the obvious way to do it." Avoid clever code — Go code should be boring and predictable.
