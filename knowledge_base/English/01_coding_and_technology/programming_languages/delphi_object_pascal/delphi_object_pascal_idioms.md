...
---
# Delphi / Object Pascal — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns for writing clean Delphi and Object Pascal code.
...
Delphi idioms emphasize: `try/finally` for deterministic resource cleanup, `Format` for string building, interfaces for loose coupling, records for data carriers, specific exception handling, and modern features like generics and anonymous methods. Delphi values explicit resource management — "create it, use it, free it in finally."
