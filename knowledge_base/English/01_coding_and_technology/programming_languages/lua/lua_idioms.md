...
# Lua — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns and best practices for writing clean, idiomatic Lua code.
...
Lua idioms emphasize: tables as the universal data structure, local variables, closures for state, metatables for OOP, and 1-based indexing. Follow luacheck for linting and stylua for formatting. Lua values simplicity and minimalism — the language is intentionally small, so patterns emerge from composition.
