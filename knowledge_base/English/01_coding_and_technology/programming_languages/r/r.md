...
R excels at data manipulation, statistical modelling, visualisation, and reporting. Its package ecosystem (CRAN) has over 20,000 packages covering virtually every statistical method ever devised.

---

## Why R Matters

- **Statistical computing**: The most comprehensive collection of statistical methods in any language.
- **Data visualisation**: ggplot2 produces publication-quality graphics. The grammar of graphics paradigm is unmatched.
- **Reproducible research**: R Markdown / Quarto let you combine code, results, and narrative in a single document.
- **Academic standard**: Used in statistics, bioinformatics, epidemiology, ecology, economics, and social sciences.
- **Tidyverse**: A cohesive set of packages (dplyr, ggplot2, tidyr, readr) that make data analysis elegant and consistent.
- **Free and open source**: No licensing costs; actively maintained by a global community.

## The Trade-offs

| Limitation | Details | Typical Workaround |
|-----------|---------|-------------------|
| **Performance** | Single-threaded by default; slow for large datasets | Use `data.table`, parallel packages, or Rcpp for C++ integration |
| **Memory usage** | Loads entire datasets into RAM | Use `data.table::fread`, arrow package for out-of-core processing |
| **Not a general-purpose language** | Awkward for web development, systems programming, or apps | Use Python, Go, or JavaScript for non-statistical tasks |
| **Inconsistent syntax** | Base R has quirks; different packages use different conventions | Use tidyverse for consistency |
| **Job market** | Mostly academic/research roles | Data science roles increasingly prefer Python |
...
### Non-Standard Evaluation and Metaprogramming
...
### Pattern 1: Tidy Evaluation for Flexible Functions
...
### Pattern 2: Functional Programming with purrr
...
| Scenario | Why R | Better Alternative |
|----------|-------|-------------------|
| Statistical analysis | Most comprehensive statistical methods | Python (statsmodels, scipy) |
| Data visualisation | ggplot2 is unmatched for publication quality | Python (matplotlib, seaborn) for interactive |
| Academic research | Standard in many fields | — |
| Bioinformatics | Bioconductor has 2,000+ specialised packages | Python for production pipelines |
| Reporting (R Markdown/Quarto) | Integrated analysis + narrative | Jupyter (Python) |
| Production ML systems | Not designed for deployment | Python, Java |
| Web development | Not suited | JavaScript, Python |
| Large-scale data processing | Memory-bound | Python (PySpark), SQL |
...
## Statistical Modelling Deep Dive
