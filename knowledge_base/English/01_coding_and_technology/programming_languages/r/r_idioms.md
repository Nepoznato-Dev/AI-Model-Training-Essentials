...
# R — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns and best practices for writing clean, idiomatic R code.
...
R idioms emphasize: vectorization (avoid loops), tidyverse pipes (`|>`), `<-` for assignment, snake_case naming, and functional programming with `purrr`. Follow the Tidyverse Style Guide, use lintr for linting, and styler for formatting. R values vectorized operations and the pipe for readable data transformations.
