...
---
# Scratch — Common Mistakes & Anti-Patterns

This document catalogs the most common mistakes and traps in Scratch with corrections.

---

## 1. Not Using "Stop" to End Scripts
...
## 5. Infinite Loops Without Yield
...
Scratch traps: always use "stop" to end games, separate clone logic from original sprite logic, use "broadcast and wait" for synchronous communication, use sprite-specific variables when needed, and add waits in forever loops to prevent freezing. Scratch teaches fundamental concepts — respect the event-driven model.
