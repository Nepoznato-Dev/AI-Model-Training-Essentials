...
---
# Scratch — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns for writing clean, well-organized Scratch projects.
...
Scratch idioms emphasize: clear sprite naming, one responsibility per sprite, broadcast messages for communication, custom blocks for reuse, cloning for multiple instances, structured game loops, and "run without screen refresh" for performance. Scratch rewards organization — "a well-named sprite is half the program."
