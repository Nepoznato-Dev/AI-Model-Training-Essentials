...
---
# Shell & PowerShell — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns for Bash/Zsh and PowerShell scripting.
...
Shell idioms emphasize: `set -euo pipefail`, quoting variables, `[[ ]]` over `[ ]`, parameter expansion, and cleanup traps. PowerShell idioms emphasize: CmdletBinding, pipeline processing, splatting, and structured error handling. Follow ShellCheck for Bash and PSScriptAnalyzer for PowerShell.
