...
---
# Perl — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns and best practices for writing clean, modern Perl (5.38+) code.
...
Modern Perl idioms emphasize: `use strict; use warnings;`, signatures, say, postderef, and modern OOP (class keyword in 5.38+). Follow perlcritic for linting and perltidy for formatting. Perl values TMTOWTDI (There's More Than One Way To Do It) — but modern Perl converges on cleaner, more maintainable patterns.
