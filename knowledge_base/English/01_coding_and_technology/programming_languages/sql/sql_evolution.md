...
---
# SQL — Version History & Evolution

## Timeline

| Version | Year | Key Theme |
|---------|------|-----------|
| SEQUEL  | 1974 | Original IBM research language (Chamberlin & Boyce) |
| SQL-86  | 1986 | **First ANSI standard** (SQL-86) |
| SQL-89  | 1989 | Minor revision (integrity constraints) |
| SQL-92  | 1992 | **Major**: `JOIN`, subqueries, `CASE`, `COALESCE` |
| SQL:1999 | 1999 | **Regular expressions**, recursive queries, triggers, BLOBs |
| SQL:2003 | 2003 | **Window functions**, XML, `GENERATED` columns |
| SQL:2006 | 2006 | XML support, `MERGE` |
| SQL:2008 | 2008 | `INSTEAD OF` triggers, `TRUNCATE`, `ORDER BY` in views |
| SQL:2011 | 2011 | **Temporal data** (`AS OF`, `FOR SYSTEM_TIME`), `FETCH FIRST` |
| SQL:2016 | 2016 | **JSON support**, row pattern recognition |
| SQL:2019 | 2019 | **Polymorphic table functions**, `LISTAGG` |
| SQL:2023 | 2023 | **`JSON_TABLE`**, `SET` operations, array enhancements |

## Major Milestones

### SEQUEL and Early SQL (1974–1986)
- **1974**: Donald Chamberlin & Raymond Boyce create SEQUEL at IBM Research
- **Goal**: Query manipulation for System R (relational database)
- Renamed to SQL (Structured Query Language) due to trademark conflict
- **1986**: First ANSI standard (SQL-86)
- **1987**: ISO adopts SQL-87

### SQL-92 — The Foundation (1992)
- **The most important standard** — all modern SQL descends from this
...
### SQL:1999 — Modern SQL Begins (1999)
- Regular expressions (`LIKE`, `SIMILAR TO`)
...
### SQL:2011 — Temporal Data (2011)
- **Temporal tables**: `FOR SYSTEM_TIME AS OF`, `VERSIONING`
- `FETCH FIRST n ROWS ONLY` (standard `LIMIT`)
- `OFFSET`/`FETCH` pagination

### SQL:2016–2023 — JSON & Beyond (2016–present)
- **2016**: JSON data type, `JSON_VALUE`, `JSON_QUERY`, `JSON_EXISTS`
- **2019**: Polymorphic table functions, `LISTAGG`
- **2023**: `JSON_TABLE` (relational view of JSON), `SET` operations, array enhancements
