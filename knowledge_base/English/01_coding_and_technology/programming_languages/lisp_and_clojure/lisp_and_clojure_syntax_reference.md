...
-->
# Lisp & Clojure — Syntax Reference

This document provides a comprehensive, structured syntax reference for Common Lisp and Clojure. It complements the main Lisp/Clojure reference by focusing on S-expressions, macros, persistent data structures, and functional programming patterns.
...
Clojure's syntax is uniformly parenthesized — every form is a list. This homoiconicity enables powerful macros that transform code as data. Persistent data structures provide immutability with structural sharing for efficiency. Threading macros create readable data pipelines. Concurrency primitives (atoms, refs, agents, channels) handle state changes safely. Lisp/Clojure's influence on modern programming is enormous — garbage collection, REPLs, macros, and functional programming all trace back to Lisp.
