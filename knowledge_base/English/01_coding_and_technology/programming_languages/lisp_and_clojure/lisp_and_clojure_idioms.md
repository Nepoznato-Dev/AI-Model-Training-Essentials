...
-->
# Lisp & Clojure — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns for Lisp and Clojure.
...
Clojure idioms emphasize: immutable data, threading macros (`->`, `->>`), destructuring, keywords as functions, and spec for validation. Common Lisp idioms emphasize: `with-open` for resources, `push`/`nreverse` for list building, and multiple values. Both value homoiconicity and REPL-driven development.
