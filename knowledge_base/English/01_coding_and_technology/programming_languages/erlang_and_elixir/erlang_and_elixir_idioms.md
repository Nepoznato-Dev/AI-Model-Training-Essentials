...
# Erlang & Elixir — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns for Erlang and Elixir on the BEAM VM.
...
Elixir idioms emphasize: pipe operator, pattern matching, `with` for error chaining, and `@spec` type specs. Erlang idioms emphasize: pattern matching, list comprehensions, gen_server callbacks, and "let it crash" philosophy. Both value immutability, message passing, and fault tolerance.
