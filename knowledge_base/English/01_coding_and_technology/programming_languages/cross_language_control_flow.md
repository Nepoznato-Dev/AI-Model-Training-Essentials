...
-->
# Cross-Language Comparison — Control Flow
...
| C# | `x switch { 1 => ..., _ => ... }` (C# 8+) |
| TypeScript | No native pattern matching (use if/else) |
| Python | `match x: case 1: ... case _: ...` (Python 3.10+) |
| Prolog | Built into clause matching |
| Go | `switch x { case 1: ... default: ... }` |
