...
## Register Conventions & Prologue/Epilogue
...
## Local Labels & Code Organization
...
Assembly idioms emphasize: named constants over magic numbers, macros for repeated patterns, struct definitions for data layout, ABI-compliant prologue/epilogue, local labels for readability, defensive input validation, and `xor`/`lea` for efficient operations. Assembly rewards clarity above all — "if you can't read it, you can't debug it at 3 AM."
