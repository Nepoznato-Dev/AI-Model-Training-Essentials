...
-->
# Fortran — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns and best practices for writing clean, modern Fortran (2018+) code.
...
Modern Fortran idioms emphasize: `implicit none`, array operations (avoid loops), assumed-shape arrays, derived types with type-bound procedures, and `intent` for all arguments. Follow fprettify for formatting. Modern Fortran (2018+) with coarrays and DO CONCURRENT supports parallel computing natively.
