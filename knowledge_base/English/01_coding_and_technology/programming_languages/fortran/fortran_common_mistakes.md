...
# Fortran — Common Mistakes & Anti-Patterns

This document catalogs the most common mistakes, traps, and anti-patterns in Fortran with corrections.
...
## 5. Not Using Modern Fortran Features
...
## 6. Memory Leaks with Allocatable Arrays
...
Fortran's scientific computing focus creates traps: 1-based indexing, implicit typing (always use `implicit none`), array operations vs loops, and intent specifications. Modern Fortran (2003+) has modules, derived types, and OOP — use them. The Fortran way is: `implicit none` always, specify `intent` for all arguments, use array operations, and deallocate what you allocate.
