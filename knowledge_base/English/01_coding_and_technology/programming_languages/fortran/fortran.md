...
Fortran (Formula Translation) is the oldest high-level programming language still in widespread use, first developed by IBM in 1957 for scientific and engineering computation. Despite its age, modern Fortran (Fortran 2008/2018/2023) is a capable, high-performance language used extensively in numerical weather prediction, computational fluid dynamics, physics simulations, financial modelling, and high-performance computing (HPC). Many of the world's fastest supercomputers run Fortran code.

The language has evolved significantly from its early days. Modern Fortran has modules, derived types, generic procedures, coarrays (parallel programming), and interoperability with C. It remains the language of choice for many scientific computing applications where performance is paramount.

---

## Why Fortran Matters

- **HPC performance**: Fortran compilers produce some of the fastest numerical code available — often matching or exceeding C/C++ for array operations.
- **Legacy codebases**: Decades of scientific code (climate models, physics simulations) are written in Fortran.
- **Array operations**: Native multi-dimensional array support with syntax designed for mathematical computation.
- **Numerical stability**: The language and compilers are optimised for floating-point computation.
- **Coarrays**: Built-in parallel programming support (Fortran 2008+).
- **Still evolving**: Fortran 2023 adds modern features while maintaining backwards compatibility.

## The Trade-offs

| Limitation | Details | Typical Workaround |
|-----------|---------|-------------------|
| **Niche community** | Small and specialised — mostly scientific/HPC | Active community in computational science |
| **Limited ecosystem** | Fewer libraries than Python, Java, or C++ | Use BLAS/LAPACK for numerical work; C interoperability for other needs |
| **Not general-purpose** | Poor for web, mobile, GUI, or systems programming | Use Fortran for computation; wrap in Python/C for applications |
| **Perception** | Often seen as "obsolete" despite modern capabilities | Focus on its strengths: numerical and HPC |
| **Hiring** | Few Fortran developers entering the market | Existing experts in academia and national labs |
...
### Test Framework (fortran-test or pFUnit)
...
### Python Integration (via f2py or shared library)
...
### Pattern 1: Array Programming (Avoid Loops)
...
### Pattern 2: Parameterised Derived Types
...
### Pattern 3: Callback Pattern with Procedure Pointers
...
| Scenario | Why Fortran | Better Alternative |
|----------|-----------|-------------------|
| HPC / supercomputing | Optimised for numerical performance | C++ (with care), Julia |
| Scientific simulations | Decades of validated code | Python (for prototyping), C++ |
| Climate/weather models | Legacy codebases; performance | — |
| Computational physics | Native array operations | Python (NumPy), Julia |
| Financial modelling (HPC) | Performance for large-scale computation | C++, Python |
| General application development | Not suited | Python, Java, Go |
| Web development | Not suited | JavaScript, Python |
| Data science (interactive) | Not the workflow | Python, R |
