...
---
# Dart — Idiomatic Patterns & Best Practices

This guide covers idiomatic patterns and best practices for writing clean, idiomatic Dart code.
...
Dart idioms emphasize: null safety, const constructors, records and pattern matching (Dart 3), async/await, and extension methods. Follow the Effective Dart guide, use `dart format` for formatting, and `dart analyze` for linting. Dart values safety and productivity — "write once, run anywhere" with Flutter.
