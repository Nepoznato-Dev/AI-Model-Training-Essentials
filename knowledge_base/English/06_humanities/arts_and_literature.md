...
### Fiction Genres
- **Literary Fiction**: Character-driven narratives focusing on themes, style, and psychological depth (e.g., "To Kill a Mockingbird" by Harper Lee)
- **Science Fiction**: Speculative fiction exploring futuristic technology, space exploration, time travel, parallel universes (e.g., "Dune" by Frank Herbert, "1984" by George Orwell)
- **Fantasy**: Magical worlds, mythical creatures, supernatural elements (e.g., "The Lord of the Rings" by J.R.R. Tolkien, "Harry Potter" by J.K. Rowling)
- **Mystery/Detective**: Crime-solving narratives with puzzles and investigations (e.g., Agatha Christie's Hercule Poirot series, Arthur Conan Doyle's Sherlock Holmes)
- **Horror**: Intended to frighten, unsettle, or create suspense (e.g., "The Shining" by Stephen King, "Dracula" by Bram Stoker)
- **Romance**: Focus on romantic relationships and emotional journeys (e.g., Jane Austen's "Pride and Prejudice", Nicholas Sparks novels)
- **Historical Fiction**: Set in specific historical periods with accurate details (e.g., "The Book Thief" by Markus Zusak, "Wolf Hall" by Hilary Mantel)
- **Magical Realism**: Realistic settings with magical elements treated as ordinary (e.g., "One Hundred Years of Solitude" by Gabriel García Márquez)

### Non-Fiction Genres
- **Biography/Autobiography**: Life stories of real people (e.g., "The Diary of a Young Girl" by Anne Frank, "Becoming" by Michelle Obama)
...
### Poetry Forms
- **Sonnet**: 14-line poem with specific rhyme scheme (Shakespearean: ABAB CDCD EFEF GG; Petrarchan: ABBAABBA CDECDE)
- **Haiku**: Japanese form with 5-7-5 syllable pattern
- **Limerick**: Five-line humorous poem with AABBA rhyme scheme
- **Free Verse**: No regular meter or rhyme pattern
- **Villanelle**: 19 lines with specific repetition pattern (e.g., "Do Not Go Gentle into That Good Night" by Dylan Thomas)
...
### Historical Periods
- **Classical Literature** (8th century BCE - 5th century CE): Greek and Roman works emphasizing reason, order, and humanism
- **Medieval Literature** (5th - 15th century): Religious themes, chivalric romances, allegories (e.g., "The Divine Comedy" by Dante)
- **Renaissance** (14th - 17th century): Humanism, revival of classical learning (e.g., Shakespeare, Cervantes)
- **Enlightenment** (17th - 18th century): Reason, science, individual rights (e.g., Voltaire, Jonathan Swift)
- **Romanticism** (late 18th - mid-19th century): Emotion, nature, individualism (e.g., Wordsworth, Goethe, Mary Shelley)
- **Realism** (mid-19th century): Accurate depiction of everyday life (e.g., Tolstoy, George Eliot, Mark Twain)
- **Modernism** (late 19th - mid-20th century): Experimental forms, stream of consciousness (e.g., James Joyce, Virginia Woolf, T.S. Eliot)
...
- **Pop Art** (1950s - 1960s): Popular culture imagery (e.g., Warhol, Lichtenstein)
...
- **Performance Art**: Live actions, body art, happenings
...
- **Classical Crossover**: Fusion of classical and popular styles

### Music Theory Fundamentals
- **Notes and Scales**: Major, minor, chromatic, pentatonic, modes
- **Chords and Harmony**: Triads, seventh chords, chord progressions
- **Rhythm and Meter**: Time signatures, tempo, syncopation
- **Melody and Counterpoint**: Thematic development, voice leading
- **Form and Structure**: Sonata form, symphony movements, verse-chorus structure
...
- **Musical Theater**: Songs, dance, dialogue integrated (e.g., "Hamilton", "Les Misérables", "The Phantom of the Opera")
...
- **Science Fiction**: Futuristic technology, space, time travel

### Film Movements
- **German Expressionism** (1920s): Distorted visuals, psychological themes ("The Cabinet of Dr. Caligari")
...
- **Cinematographer/Director of Photography**: Camera work, lighting, visual style
...
- **Point of View**: First person, second person, third person (limited, omniscient)
...
- **Flashback**: Scenes from earlier in the story

### Structural Elements
- **Plot**: Exposition, rising action, climax, falling action, resolution
- **Character Development**: Protagonist, antagonist, dynamic/static characters
...
- Metropolitan Museum of Art (New York): Comprehensive collections
- British Museum (London): Human history and culture
- Vatican Museums (Vatican City): Renaissance art, Sistine Chapel
- Uffizi Gallery (Florence): Italian Renaissance masterpieces
- Hermitage Museum (St. Petersburg): One of oldest and largest museums
- Museum of Modern Art - MoMA (New York): Modern and contemporary art

### Literary Awards
- Nobel Prize in Literature: International recognition
...
- National Book Award (USA): American literature
...
- **Iconography**: Symbolic meanings and cultural references
