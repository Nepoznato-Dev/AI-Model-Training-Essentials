...
- **Europe**: Western peninsula of Eurasia, diverse cultures, European Union political bloc
...
- **Alps**: Europe, central European range, major tourism and skiing destination
...
- **Mississippi-Missouri**: North America, major drainage system of United States
...
- **Arabian Desert**: Middle East, covers most of Arabian Peninsula
...
- **Highland**: Varies with elevation, cooler at altitude
...
### Languages
- **Most Spoken** (native + second language): English (~1.5B), Mandarin Chinese (~1.1B), Hindi (~600M), Spanish (~550M), French (~300M), Arabic (~275M)
- **Language Families**: Indo-European, Sino-Tibetan, Afro-Asiatic, Austronesian, Niger-Congo
...
- **Totalitarian**: Complete state control over public and private life
- **Federal**: Power divided between national and regional governments
- **Unitary**: Centralized government, regional authorities subordinate

### International Organizations
- **United Nations (UN)**: 193 member states, peacekeeping, humanitarian aid, international law
- **NATO**: North Atlantic Treaty Organization, military alliance (32 members as of 2024)
- **European Union (EU)**: 27 member states, economic and political union, euro currency (20 members)
...
- **World Bank**: Development financing, poverty reduction
...
- **Exclave**: Part of country separated from main territory (e.g., Kaliningrad, Alaska)
- **Buffer State**: Country between rival powers (historical: Afghanistan, Mongolia)
- **Heartland Theory**: Control of Eastern Europe controls Heartland, controls World Island (Eurasia-Africa)
...
- **Resources**: ~48% of world's proven oil reserves, natural gas

### Asia-Pacific
- **East Asia**: China (rising superpower), Japan (economic powerhouse), South Korea (technology leader), North Korea (nuclear tensions)
...
### Africa
- **Colonial Legacy**: Artificial borders, ethnic divisions, language policies
- **Development Challenges**: Poverty, infrastructure, governance, debt
- **Rising Powers**: Nigeria (largest economy), South Africa (industrialized), Ethiopia (fast-growing)
- **Regional Issues**: Sahel instability, Horn of Africa conflicts, Great Lakes region
...
- **Food Security**: Agricultural land, water access, supply chains
- **Rare Earth Elements**: China controls ~80% of processing, essential for electronics and green tech
- **Semiconductor Supply Chains**: Taiwan produces ~60% of world's chips, geopolitical flashpoint
...
- **Naval Power**: Control of sea lanes, chokepoints (Strait of Hormuz, Malacca, Suez, Panama)
...
- **Chinese Belt and Road**: Infrastructure investments creating economic influence
...
- **Spatial Analysis**: Pattern recognition, proximity analysis, network analysis
- **Cartography**: Map-making, projections, scale, symbology

### Applications
- **Urban Planning**: Land use, transportation, zoning
- **Environmental Monitoring**: Deforestation, pollution, climate change
...
- **Saul Bernard Cohen** (1921-2022): Geopolitical systems analysis

## Important Geographic Terms

- **Chokepoint**: Narrow passage critical for trade/military movement
- **Hinterland**: Area serving a port or city economically
- **Irredentism**: Claiming territory based on historical/ethnic ties
- **Nation-State**: Political unit where nation and state boundaries align
- **Realpolitik**: Politics based on practical objectives rather than ideals
- **Self-Determination**: Right of peoples to choose their sovereignty
