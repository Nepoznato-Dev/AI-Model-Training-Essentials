---
# Metadatos
título: "Phi-3-mini y el panorama del modelo de IA local"
descripción: "Ejecutando modelos localmente"
...
# Clasificación
Etiquetas: [phi3, local, modelos, inteligencia artificial y aprendizaje automático]
...
Phi-3-mini es un modelo de lenguaje pequeño (SLM) desarrollado por Microsoft Research, lanzado en abril de 2026. Sus características definitorias son:
...
- **Implementación móvil**: Microsoft demostró Phi-3-mini ejecutándose en un iPhone 14
...
*Fuente: Informe técnico de Microsoft Phi-3 (abril de 2026)*
---
...
## Otros modelos locales notables (2026)
### Llama 3 (Meta, 2026)
...
## El mercado local de modelos de IA en 2026-2025
La brecha entre los modelos locales y en la nube se redujo drásticamente en 2026:
