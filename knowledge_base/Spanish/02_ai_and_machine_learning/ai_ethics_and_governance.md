---
# Metadatos
título: "Ética y gobernanza de la IA"
descripción: "Sesgo de IA, equidad, rendición de cuentas, regulación, marcos de gobernanza"
...
# Clasificación
Etiquetas: [ai, ética, gobernanza, IA y aprendizaje automático]
...
|-----------|--------------|-----------|
| **Equidad** | La IA no debería discriminar a los grupos protegidos | Definir matemáticamente la justicia es sorprendentemente difícil; diferentes definiciones de equidad conflicto |
