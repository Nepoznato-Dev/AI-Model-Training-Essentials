---
# Metadatos
título: "Sistemas de recomendación"
descripción: "Filtrado colaborativo, basado en contenido, híbrido, factorización matricial"
...
# Clasificación
Etiquetas: [recomendación, sistemas, inteligencia artificial y aprendizaje automático]
...
|----------|-----------|-----------|
| **Nuevo usuario** | Sin historial de interacciones | Utilice datos demográficos; mostrar artículos populares; utilizar señales contextuales (ubicación, dispositivo, hora) |
