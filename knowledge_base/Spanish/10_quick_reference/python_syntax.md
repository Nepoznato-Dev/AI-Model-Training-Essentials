---
# Metadatos
título: "Hoja de referencia de sintaxis de Python"
descripción: "Hoja de referencia de sintaxis de Python"
...
# Clasificación
Etiquetas: [python, sintaxis, referencia rápida]
nivel_dificultad: "principiante"
requisitos previos: []
estimado_reading_time: "14 minutos"
...
## Sintaxis básica
### Variables y tipos de datos```python
...
### Operaciones de diccionario```python
# Merge dictionaries
{**d1, **d2}
d1 | d2                     # Python 3.9+
...
## Consejos rápidos
- Utilice`#`para comentarios de una sola línea
- Utilice`"""triple quotes"""`para cadenas de documentos y cadenas de varias líneas
- La sangría importa (normalmente 4 espacios)
- Convenciones de nomenclatura:`snake_case`para variables/funciones,`PascalCase`para clases
-`__name__ == "__main__"`para comprobar si el script se ejecuta directamente
- Utilice`virtualenv`o`venv`para aislar el proyecto
- Instalar paquetes con `pip install package_name`
---

*Última actualización: julio de 2026 | Pitón 3.x*