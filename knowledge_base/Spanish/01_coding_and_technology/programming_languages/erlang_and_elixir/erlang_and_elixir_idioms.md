...
-->
# Erlang & Elixir: patrones idiomáticos y mejores prácticas
Esta guía cubre patrones idiomáticos para Erlang y Elixir en BEAM VM.
---
...
## Resumen
Los modismos de Elixir enfatizan: operador de tubería, coincidencia de patrones,`with`para encadenamiento de errores y especificaciones de tipo `@spec`. Los modismos de Erlang enfatizan: coincidencia de patrones, comprensión de listas, devoluciones de llamadas gen_server y filosofía de "dejar que falle". Ambos valoran la inmutabilidad, el paso de mensajes y la tolerancia a fallos.