...
# COBOL — Referencia de sintaxis
Este documento proporciona una referencia de sintaxis completa y estructurada para COBOL (2014+). Complementa la referencia principal de COBOL al centrarse en patrones de sintaxis exhaustivos, descripciones de datos, procesamiento de archivos y lógica empresarial.
---
...
## Resumen
La sintaxis de COBOL es detallada por diseño: cada declaración se lee como en inglés. Las descripciones de datos con cláusulas PIC definen con precisión los formatos de campo. La estructura de cuatro divisiones impone la separación de preocupaciones. El manejo de archivos está integrado en el idioma. Para el procesamiento de datos empresariales, la aritmética decimal de COBOL y la E/S orientada a registros siguen siendo incomparables. Comprender COBOL significa comprender los fundamentos de la informática empresarial.