...
---
# Lisp & Clojure: referencia de sintaxis
Este documento proporciona una referencia de sintaxis completa y estructurada para Common Lisp y Clojure. Complementa la referencia principal de Lisp/Clojure centrándose en expresiones S, macros, estructuras de datos persistentes y patrones de programación funcional.
---

## Clojure: sintaxis principal
```clojure
;; Literals
42              ;; integer
3.14            ;; float
...
## Resumen
La sintaxis de Clojure está uniformemente entre paréntesis: cada forma es una lista. Esta homoiconicidad permite macros potentes que transforman el código en datos. Las estructuras de datos persistentes proporcionan inmutabilidad con intercambio estructural para mayor eficiencia. Las macros de subprocesamiento crean canales de datos legibles. Las primitivas de concurrencia (átomos, referencias, agentes, canales) manejan los cambios de estado de forma segura. La influencia de Lisp/Clojure en la programación moderna es enorme: la recolección de basura, los REPL, las macros y la programación funcional se remontan a Lisp.