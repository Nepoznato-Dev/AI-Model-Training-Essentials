...
## Resumen
Los modismos de Shell enfatizan: `set -euo pipefail`, citar variables,`[[ ]]`sobre `[ ]`, expansión de parámetros y trampas de limpieza. Los modismos de PowerShell enfatizan: CmdletBinding, procesamiento de canalizaciones, salpicaduras y manejo estructurado de errores. Siga ShellCheck para Bash y PSScriptAnalyzer para PowerShell.