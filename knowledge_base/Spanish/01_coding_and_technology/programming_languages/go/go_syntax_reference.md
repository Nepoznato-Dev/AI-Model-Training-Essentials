...
| `/`| División | `7 / 2`| `3`| División de enteros para enteros |
| `%`| Resto | `7 % 2`| `1`| Signo coincide con dividendo |
| `&`| Bit a bit Y | `5 & 3`| `1`| |
| `\|`| Bit a bit O | `5 \| 3`| `7`| |
| `^`| XOR bit a bit | `5 ^ 3`| `6`| También complemento bit a bit (unario) |
| `&^`| Un poco claro (Y NO) | `5 &^ 3`| `4`| Único para llevar |
| `<<`| Desplazamiento a la izquierda | `5 << 1`| `10`| |
| `>>`| Desplazamiento a la derecha | `5 >> 1`| `2`| |
### Operadores de comparación
| Operador | Nombre | Ejemplo | Notas |
|----------|------|---------|-------|
| `==`| Igual | `x == y`| Sólo tipos comparables |
| `!=`| No iguales | `x != y`| |
|  `<`, `>`, `<=`,`>=`| Realizar pedidos | `x >= y`| Cadenas comparadas lexicográficamente |
### Operadores lógicos
| Operador | Nombre | Ejemplo | Notas |
|----------|------|---------|-------|
...
## Resumen
La sintaxis de Go es intencionalmente mínima: sin herencia, sin sobrecarga de métodos, sin excepciones, sin macros. Lo que queda es un conjunto limpio y ortogonal de construcciones: estructuras e interfaces para la composición, rutinas y canales para la concurrencia y manejo explícito de errores para la confiabilidad. El poder del lenguaje no proviene de una sintaxis compleja sino de la interacción elegante de sus primitivos simples. Los genéricos (Go 1.18+) agregan flexibilidad de tipos sin sacrificar la claridad característica de Go.