...
# Scratch: patrones idiomáticos y mejores prácticas
Esta guía cubre patrones idiomáticos para escribir proyectos Scratch limpios y bien organizados.
---
...
## Resumen
Los modismos de Scratch enfatizan: nombres de sprites claros, una responsabilidad por sprite, mensajes de transmisión para comunicación, bloques personalizados para reutilización, clonación para múltiples instancias, bucles de juego estructurados y "ejecutar sin actualizar la pantalla" para mejorar el rendimiento. Organización de recompensas de Scratch: "un objeto con buen nombre es la mitad del programa".