...
# Scratch: errores comunes y antipatrones
Este documento cataloga los errores y trampas más comunes en Scratch con correcciones.
---

## 1. No utilizar "Detener" para finalizar scripts
```
...
## 5. Bucles infinitos sin rendimiento
```
...
## Resumen
Trampas de scratch: use siempre "detener" para finalizar los juegos, separe la lógica de clonación de la lógica de sprites original, use "transmitir y esperar" para la comunicación sincrónica, use variables específicas de sprites cuando sea necesario y agregue esperas en bucles eternos para evitar la congelación. Scratch enseña conceptos fundamentales: respete el modelo basado en eventos.