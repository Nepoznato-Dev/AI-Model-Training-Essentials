...
-->
# Perl: patrones idiomáticos y mejores prácticas
Esta guía cubre patrones idiomáticos y mejores prácticas para escribir código Perl (5.38+) limpio y moderno.
---
...
## Resumen
Los modismos modernos de Perl enfatizan: `use strict; use warnings;`, firmas, por ejemplo, postderef y programación orientada a objetos moderna (palabra clave de clase en 5.38+). Siga perlcritic para linting y perltidy para formatear. Perl valora TMTOWTDI (Hay más de una manera de hacerlo), pero el Perl moderno converge en patrones más limpios y fáciles de mantener.