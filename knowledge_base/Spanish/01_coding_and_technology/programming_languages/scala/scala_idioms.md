...
# Scala: patrones idiomáticos y mejores prácticas
Esta guía cubre patrones idiomáticos y mejores prácticas para escribir código Scala 3 limpio y funcional.
---
...
## Resumen
Los modismos de Scala enfatizan: inmutabilidad (`val`), coincidencia de patrones, tipos sellados, Opción/Cualquiera por seguridad, para comprensión, colecciones funcionales y clases de tipos (dadas/usadas en Scala 3). Siga la Guía de estilo de Scala, use scalafmt para formatear y scalafix para linting. La sintaxis más limpia, las enumeraciones, los tipos opacos y los métodos de extensión de Scala 3 hacen que el lenguaje sea más accesible y al mismo tiempo conserva su poder funcional.