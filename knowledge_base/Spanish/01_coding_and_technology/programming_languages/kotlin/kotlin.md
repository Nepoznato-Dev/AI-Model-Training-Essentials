...
- **Estándar de Android**: idioma preferido de Google para Android. La mayoría del código nuevo de Android es Kotlin.
- **100% compatible con Java**: utilice todas las bibliotecas, marcos y herramientas de Java. Migrar gradualmente.
- **Seguridad nula**: el sistema de tipos evita excepciones de puntero nulo en el momento de la compilación.
- **Conciso**: significativamente menos repetitivo que Java: clases de datos, funciones de extensión, conversiones inteligentes.
- **Corrutinas**: subprocesos ligeros para programación asíncrona: más sencillo que CompletableFuture o las devoluciones de llamada de Java.
- **Multiplataforma**: Kotlin Multiplatform te permite compartir código entre Android, iOS, web y backend.
- **Lado del servidor**: Ktor, Spring Boot (soporte completo de Kotlin) y Exposed hacen que Kotlin sea viable para backends.
## Las compensaciones
| Limitación | Detalles | Solución típica |
|-----------|-----------------|-------------------|
| **Dependencia de JVM** | Requiere JVM (o Kotlin/Native para objetivos que no son JVM) | Utilice la imagen nativa de GraalVM para implementaciones pequeñas |
| **Velocidad de compilación** | Más lento que Java para proyectos grandes | Utilice compilación incremental; Kotlin 2.0 mejora esto |
| **Curva de aprendizaje para desarrolladores de Java** | Funciones de extensión, corrutinas y DSL son conceptos nuevos | Adopción gradual; la mayoría de los patrones de Java todavía funcionan |
| **Comunidad más pequeña que Java** | Menos recursos y bibliotecas específicos de Kotlin | Aproveche el enorme ecosistema de Java |
| **Madurez multiplataforma de Kotlin** | Sigue evolucionando para compartir iOS en producción | Úselo para lógica empresarial compartida; mantener la interfaz de usuario nativa |
---
...
### Clases selladas y coincidencia de patrones
```kotlin
...
### Desestructuración avanzada y coincidencia de patrones
```kotlin
...
### Distribuidores de rutinas y contextos
```kotlin
import kotlinx.coroutines.*
...
### Canales: comunicación entre corrutinas
```kotlin
...
### Simultaneidad estructurada y manejo de errores
```kotlin
...
### Configuración de compilación (build.gradle.kts)
```kotlin
plugins {
...
### Kotlin/Nativo y C Interoperabilidad
```kotlin
...
## Patrones de diseño
### Singleton (seguro para subprocesos de forma predeterminada)
```kotlin
...
### Patrón de construcción (Kotlin idiomático)
```kotlin
...
### Patrón de estrategia con Lambdas
```kotlin
...
## Implementación
### Fat JAR con complemento Shadow
```kotlin
// build.gradle.kts
plugins {
...
### Implementación multiplataforma de Kotlin
```kotlin
...
| Marco | Dominio |
|-----------|----------------|
| **Composición Jetpack** | Kit de herramientas de interfaz de usuario de Android moderno |
| **Ktor** | Marco web ligero del lado del servidor |
| **Bota de primavera** | Soporte completo de Kotlin para backends empresariales |
| **Kotlin multiplataforma** | Comparta código entre Android, iOS, web y escritorio |
| **Expuesto** | Biblioteca Kotlin SQL (consultas de tipo seguro) |
| **Moneda** | Marco de inyección de dependencia |
### Herramientas de construcción
| Herramienta | Propósito |
|------|---------|
| **Gradle (Kotlin DSL)** | Sistema de compilación: Kotlin es el lenguaje de script de compilación preferido |
| **IDEA IntelliJ** | IDE de JetBrains: el mejor soporte para Kotlin |
---

## Cuándo usar Kotlin
| Escenario | ¿Por qué Kotlin? Mejor alternativa |
|----------|-----------|-------------------|
| Desarrollo de Android | Idioma preferido de Google | Java (para bases de código heredadas) |
| Servidores JVM | Alternativa moderna de Java | Java, Ir |
| Multiplataforma (lógica compartida) | Kotlin multiplataforma | Flutter (para compartir UI) |
| Aplicaciones de escritorio | Posible con Compose Multiplataforma | C#, Swift para nativos |
| Aplicaciones JVM generales | Menos detallado que Java | Java para equipos más grandes |
| Programación de sistemas que no son JVM | No es el objetivo principal | Óxido, vamos, C |
| Interfaz web | Kotlin/JS existe pero es limitado | Mecanografiado, JavaScript |
