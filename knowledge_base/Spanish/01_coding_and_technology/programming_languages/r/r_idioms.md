...
---
# R — Patrones idiomáticos y mejores prácticas
Esta guía cubre patrones idiomáticos y mejores prácticas para escribir código R limpio e idiomático.
---
...
## Resumen
Los modismos de R enfatizan: vectorización (evitar bucles), canalizaciones tidyverse (`|>`),`<-`para asignación, denominación de casos de serpiente y programación funcional con`purrr`. Siga la Guía de estilo de Tidyverse, use lintr para aplicar linting y styler para formatear. R valora las operaciones vectorizadas y la tubería para transformaciones de datos legibles.