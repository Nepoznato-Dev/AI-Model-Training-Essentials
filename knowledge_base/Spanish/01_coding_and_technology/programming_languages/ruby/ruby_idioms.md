...
---
# Ruby: patrones idiomáticos y mejores prácticas
Esta guía cubre patrones idiomáticos y mejores prácticas para escribir código Rubyish limpio.
---
...
## Coincidencia de patrones (Ruby 3+)
```ruby
# ✅ Pattern matching
case user
in { name:, role: "admin" }
...
## Protocolos y escritura de patos
```ruby
...
## Resumen
Los modismos de Ruby enfatizan: felicidad del desarrollador, convención sobre la configuración, bloques e iteradores, tipeo pato y sintaxis expresiva. Siga la Guía de estilo Ruby, use RuboCop para linting y StandardRB para formato obstinado. Ruby valora la legibilidad: el código debe leerse como en inglés. Prefiera los métodos enumerables a los bucles manuales, utilice símbolos para identificadores y adopte bloques para la iteración y la gestión de recursos.