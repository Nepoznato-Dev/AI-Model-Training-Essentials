...
-->
# Comparación entre idiomas: E/S y operaciones de archivos
## Salida de consola
| Idioma | Imprimir en salida estándar |
|----------|----------------|
| Pitón | `print("Hello")`|
| JavaScript | `console.log("Hello")`|
| Óxido | `println!("Hello")`|
| Ir | `fmt.Println("Hello")`|
...
| PHP | `echo "Hello\n"`|
| Mecanografiado | `console.log("Hello")`|
| Haskel | `putStrLn "Hello"`|
| Escala | `println("Hello")`|
| R | `cat("Hello\n")`|
| Julia | `println("Hello")`|
| Perla | `say "Hello"`|
| Lúa | `print("Hello")`|
| MATLAB | `disp('Hello')`|
| Dardo | `print('Hello')`|
| Prólogo | `write('Hello'), nl.`|
| Ceceo | `(format t "Hello~%")`|
...
| COBOL | `DISPLAY 'Hello'`|
| Fortrán | `print *, 'Hello'`|
| Asamblea | `syscall`(escribir en fd 1) |
| Delfos | `WriteLn('Hello')`|
| Rascar | `say [Hello]`|
| V.B. | `Console.WriteLine("Hello")`|
| Concha | `echo "Hello"`|
| SQL | N/A (devuelve conjuntos de resultados) |
## Leyendo un archivo
```python
# Python
