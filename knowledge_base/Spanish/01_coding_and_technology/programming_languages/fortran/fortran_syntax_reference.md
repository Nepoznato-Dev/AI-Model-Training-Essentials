...
# Fortran - Referencia de sintaxis
Este documento proporciona una referencia de sintaxis completa y estructurada para Modern Fortran (2008/2018). Complementa la referencia principal de Fortran al centrarse en patrones de sintaxis exhaustivos, operaciones de matriz, módulos, programación orientada a objetos e informática de alto rendimiento.
---
...
| `.eqv.``.neqv.` | Equivalencia lógica | `a .eqv. b`| |
...
## Módulos y programación orientada a objetos
```fortran
...
## Coarrays (programación paralela)
```fortran
...
## Resumen
La sintaxis de Fortran moderno es limpia, estructurada y optimizada para el cálculo numérico. Las operaciones de matriz eliminan los bucles en la mayoría de las tareas matemáticas. Los módulos proporcionan encapsulación y gestión de espacios de nombres. Las características de programación orientada a objetos (tipos derivados, herencia, polimorfismo) permiten una organización limpia del código. Coarrays ofrece programación paralela nativa sin bibliotecas externas. Los puntos fuertes de Fortran (rendimiento, operaciones de matriz y precisión numérica) siguen siendo incomparables para la informática científica. Para HPC, física computacional y simulación de ingeniería, Fortran sigue siendo una potencia.