...
---
# Fortran: patrones idiomáticos y mejores prácticas
Esta guía cubre patrones idiomáticos y mejores prácticas para escribir código Fortran (2018+) limpio y moderno.
---
...
## Resumen
Los modismos modernos de Fortran enfatizan: `implicit none`, operaciones con matrices (evitar bucles), matrices con forma asumida, tipos derivados con procedimientos vinculados a tipos y`intent`para todos los argumentos. Siga fprettify para formatear. Modern Fortran (2018+) con coarrays y DO CONCURRENT admite computación paralela de forma nativa.