...
## Programación orientada a objetos con metatablas
```lua
...
## Resumen
Los modismos de Lua enfatizan: tablas como estructura de datos universal, variables locales, cierres para estado, metatablas para programación orientada a objetos e indexación basada en 1. Siga luacheck para ver pelusas y stylua para formatear. Lua valora la simplicidad y el minimalismo: el lenguaje es intencionalmente pequeño, por lo que los patrones surgen de la composición.