...
-->
# Haskell: patrones idiomáticos y mejores prácticas
Esta guía cubre patrones idiomáticos y mejores prácticas para escribir código Haskell limpio e idiomático.
---
...
## Resumen
Los modismos de Haskell enfatizan: tipos fuertes, coincidencia de patrones, mónadas para efectos, funciones puras y evaluación perezosa (con rigor cuando sea necesario). Siga la Guía de estilo de Haskell, use`hlint`para sugerencias y`fourmolu`para formatear. Haskell valora la corrección y la composición: "hacer que los estados ilegales sean irrepresentables".