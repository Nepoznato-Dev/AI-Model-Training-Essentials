...
---
# Lenguaje ensamblador: referencia de sintaxis
Este documento proporciona una referencia de sintaxis completa y estructurada para el ensamblado x86-64 (sintaxis NASM). Complementa la referencia principal de Ensamblaje centrándose en categorías de instrucción exhaustivas, modos de direccionamiento, convenciones de marco de pila y patrones de programación de sistemas.
---

## Registros y tamaños de datos
```nasm
...
## Resumen
La sintaxis del lenguaje ensamblador está definida por la arquitectura del procesador y el ensamblador (NASM, GAS, MASM). x86-64 proporciona 16 registros de uso general, múltiples modos de direccionamiento y cientos de instrucciones que abarcan movimiento de datos, aritmética, lógica, flujo de control, SIMD y llamadas al sistema. La sintaxis NASM utilizada aquí es la más común para el desarrollo de Linux x86-64. Dominar el ensamblaje requiere comprender los registros, la pila, las convenciones de llamada y cómo las construcciones de alto nivel se asignan a las instrucciones de la máquina.