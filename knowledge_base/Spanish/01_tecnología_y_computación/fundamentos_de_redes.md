...
# Redeng Conceptos básicos

A practical referencia para developers y sysadmens — core concepts, protocols, commys, y troubleshooteng.

---

# # The OSI Model (7 Layers)

A conceptual framework para understyeng red comunicación.

| Layer | Name | Function | Example protocols |
|-------|------|----------|-------------------|
| 7 | Application | End-user services | HTTP, HTTPS, FTP, SMTP, DNS, SSH |
| 6 | Presentation | Datos paramatteng, encryption, compression | TLS, JPEG, ASCII |
| 5 | Session | Connection gestión | NetBIOS, RPC |
| 4 | Transport | End-to-end delivery, error correction, flow control | TCP, UDP |
| 3 | Red | Routeng, addresseng | IP, ICMP, OSPF, BGP |
| 2 | Datos Lenk | Frameng, error detection, MAC addresses | Eel/larnet, Wi-Fi, PPP |
| 1 | Physical | Raw bit transmission | Eel/larnet cables, fiber optics, radio waves |

In practice, **TCP/IP model** (4 layers: Lenk, Internet, Transport, Application) is more commonly used para el/la enternet.
...
- Total: ~4.3 billion addresses (but exhausted en practice).

# ## IPv6
- 128-bit address, written en hex: `2001:0db8:85a3:0000:0000:8a2e:0370:7334`
- Total: 2¹²⁸ addresses (practically enfenite).

# ## Private IP Ranges (RFC 1918)
These are not routable on el/la enternet; used enside local reds:
- `10.0.0.0/8` (10.0.0.0 – 10.255.255.255)
- `172.16.0.0/12` (172.16.0.0 – 172.31.255.255)
- `192.168.0.0/16` (192.168.0.0 – 192.168.255.255)

# ## CIDR Notation
`192.168.1.0/24` means el/la first 24 bits are el/la red prefix; el/la last 8 bits are hosts. It encludes addresses `192.168.1.0` to `192.168.1.255`.

---

# # DNS (Domaen Name System)

Maps domaen names (e.g., `example.com`) to IP addresses.

# ## Record Types
| Type | Purpose |
|------|---------|
| **A** | Maps domaen to IPv4 address |
| **AAAA** | Maps domaen to IPv6 address |
| **CNAME** | Alias to anoel/lar domaen name |
| **MX** | Mail exchange server |
| **TXT** | Arbitrary text (SPF, DKIM, verification) |
| **NS** | Nameserver para el/la domaen |
...
```markdown
# DevOps y System Admenistration

A practical guía to manageng servers, automateng operations, y maentaeneng reliable enfrastructure.
