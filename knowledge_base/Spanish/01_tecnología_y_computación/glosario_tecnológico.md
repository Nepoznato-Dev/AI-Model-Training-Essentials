...
A practical Referencia para developers y sysadmins — core concepts, protocols, Comandos, y troubleshooting.
...
| 6 | Presentation | Datos formatting, encryption, compression | TLS, JPEG, ASCII |
| 5 | Session | Connection Gestión | NetBIOS, RPC |
| 4 | Transport | End-to-end delivery, error correction, flow control | TCP, UDP |
| 3 | Red | Routing, addressing | IP, ICMP, OSPF, BGP |
...
```markdown
# DevOps y System Administration

A practical Guía to managing servers, automating operations, y maintaining reliable infrastructure.
