...
|------|-------------|
| **MLflusso** | Open source; registro dei modelli + monitoraggio degli esperimenti |
...
|------|-------------|
| **MLflusso** | Open source, ospitato autonomamente, tiene traccia di parametri/metriche/artefatti |
...
I flag di funzionalità ti consentono di controllare quale versione del modello serve quali utenti, senza ridistribuire.
