...
|-----------|--------------|-----------|
| **Equità** | L’intelligenza artificiale non dovrebbe discriminare i gruppi protetti | Definire matematicamente l’equità è sorprendentemente difficile; diverse definizioni di equità sono in conflitto |
