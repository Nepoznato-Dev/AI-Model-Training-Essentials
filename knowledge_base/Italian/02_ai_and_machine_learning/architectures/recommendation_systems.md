...
|-----------|-------------|--------|
| **Pregiudizio di popolarità** | Gli articoli popolari vengono consigliati di più, diventando più popolari | Gli articoli a coda lunga sono sottoserviti |
...
| **Diverse raccomandazioni** | Ottimizza esplicitamente per la diversità insieme alla pertinenza |
