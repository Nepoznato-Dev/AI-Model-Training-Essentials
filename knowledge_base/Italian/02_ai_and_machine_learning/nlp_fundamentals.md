...
|------|-------------|---------|
| **Tokenizzazione** | Dividere il testo in token (parole, sottoparole o caratteri) | "Adoro la PNL" →`["I", "love", "NLP"]`|
...
| **Riconoscimento dell'entità denominata (NER)** | Identificare persone, organizzazioni, luoghi nel testo | BERT + strato CRF |
