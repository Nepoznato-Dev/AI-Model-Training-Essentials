...
L’addestramento di un modello di intelligenza artificiale di grandi dimensioni è impressionante, ma la sua implementazione efficiente è il luogo in cui avviene la maggior parte dell’ingegneria. Un modello che impiega 10 secondi per rispondere o richiede otto GPU A100 è inutile per la maggior parte delle applicazioni reali. L'ottimizzazione dei modelli è l'arte e la scienza di realizzare modelli più piccoli, più veloci e più economici, senza sacrificare troppo la qualità. Questo file copre la quantizzazione, la potatura, la distillazione e gli strumenti pratici per mettere in produzione i modelli.
---
...
| **Costo** | L'inferenza della GPU è costosa; un modello da 70 miliardi costa circa $ 0,05-0,15 per 1 milione di token su hardware cloud |
...
| 5. Ripeti | Ripetere la potatura e la messa a punto per una maggiore compressione |
---

## Distillazione della conoscenza
Addestrare un piccolo modello di "studente" a imitare un grande modello di "insegnante".
| Componente | Ruolo |
|-----------|------|
...
|------|-------------|---------|
| **Basato su Logit** | Lo studente corrisponde alle probabilità di output dell'insegnante | Distillazione originale di Hinton |
...
## Consigli pratici
- **Inizia con la quantizzazione.** La quantizzazione INT4 (AWQ o GPTQ) offre il miglior compromesso qualità-dimensione. La maggior parte dei modelli 7B funziona comodamente su una singola GPU consumer a INT4.
