...
| **Conforme** | Convoluzione + autoattenzione | Vari | Combina le funzionalità locali (conv) e globali (attenzione) |
...
| **2010-2017** | Parametrico statistico (HMM, neurale precoce) | Meglio ma comunque riconoscibile come sintetico |
