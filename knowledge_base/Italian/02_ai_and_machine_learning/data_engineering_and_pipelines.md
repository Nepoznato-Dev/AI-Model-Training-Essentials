...
Il passaggio da ETL a ELT è stato guidato da data warehouse sul cloud (BigQuery, Snowflake, Redshift) in grado di scalare l'elaborazione indipendentemente dallo storage. Non è più necessario preelaborare tutto prima del caricamento.
---
