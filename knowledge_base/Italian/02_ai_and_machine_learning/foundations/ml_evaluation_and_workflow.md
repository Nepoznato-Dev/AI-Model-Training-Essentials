...
- **Ricerca a griglia**: prova in modo esaustivo tutte le combinazioni di un insieme predefinito di iperparametri. Semplice ma computazionalmente costoso.
...
- **Ottimizzazione bayesiana**: costruisce un modello probabilistico della funzione obiettivo e seleziona gli iperparametri in modo intelligente. Librerie: Optuna, Hyperopt, scikit-optimize.
...
6. **Analisi degli errori**: guarda gli esempi in cui il modello sbaglia. Identificare modelli (ad esempio classi rare, input ambigui) e fornire informazioni dettagliate sulla preparazione dei dati o sulla progettazione delle funzionalità.
---
...
- **Deriva della previsione**: monitora la distribuzione dei risultati previsti.
