...
# Erlang & Elixir — Riepilogo
## Nozioni di base sull'elisir
```elixir
# Variables (immutable)
name = "Alice"
age = 30
...
## Flusso di controllo dell'elisir
```elixir
# if/else
if condition do
  "yes"
