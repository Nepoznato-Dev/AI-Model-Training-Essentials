...
## Opzione rigorosa e sicurezza del tipo
```vb
...
## Riepilogo
Gli idiomi di Visual Basic enfatizzano:`Option Strict On`per l'indipendenza dal tipo, blocchi`Using`per la gestione delle risorse, interpolazione di stringhe, LINQ per raccolte,`Async/Await`in tutto, gestione specifica delle eccezioni e funzionalità moderne come la corrispondenza dei modelli e gli operatori condizionali null. Leggibilità dei valori VB: "il codice dovrebbe essere letto come una specifica ben organizzata".