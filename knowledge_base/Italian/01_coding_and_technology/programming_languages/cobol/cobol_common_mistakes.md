...
-->
# COBOL: errori comuni e anti-modelli
Questo documento cataloga gli errori, le trappole e gli anti-pattern più comuni in COBOL con le relative correzioni.
---

## 1. Non utilizzare nomi di condizioni a 88 livelli
```cobol
* ❌ WRONG — magic numbers
...
## 3. Non inizializzare le variabili
```cobol
...
## 4. ESEGUIRE senza limiti espliciti
```cobol
...
## 5. Non utilizzare le moderne funzionalità COBOL
```cobol
...
## Riepilogo
La sintassi dettagliata di COBOL nasconde trappole: numeri magici senza nomi di condizioni a 88 livelli, overflow numerico da clausole PIC sottodimensionate, variabili non inizializzate e loop PERFORM illimitati. Il moderno COBOL (2002+) aggiunge FUNCTION TRIM, PERFORM in linea e altri miglioramenti. Il modo COBOL è: utilizzare nomi di condizioni a 88 livelli, controllare ON DIMENSIONE ERRORE, inizializzare con VALUE e collegare tutti i cicli.