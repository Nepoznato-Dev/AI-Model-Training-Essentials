...
---
# COBOL — Riferimento alla sintassi
Questo documento fornisce un riferimento sintattico completo e strutturato per COBOL (2014+). Completa il riferimento COBOL principale concentrandosi su modelli di sintassi esaustivi, descrizioni di dati, elaborazione di file e logica di business.
---
...
## Riepilogo
La sintassi di COBOL è prolissa per natura: ogni istruzione si legge come l'inglese. Le descrizioni dei dati con clausole PIC definiscono con precisione i formati dei campi. La struttura a quattro divisioni impone la separazione delle preoccupazioni. La gestione dei file è integrata nel linguaggio. Per l'elaborazione dei dati aziendali, l'aritmetica decimale e l'I/O orientato ai record di COBOL rimangono impareggiabili. Comprendere COBOL significa comprendere le basi dell'informatica aziendale.