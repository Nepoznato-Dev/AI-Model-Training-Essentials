...
## 1. Non utilizzare "Stop" per terminare gli script
```
...
## Riepilogo
Trappole antigraffio: usa sempre "stop" per terminare i giochi, separa la logica del clone dalla logica dello sprite originale, usa "trasmetti e attendi" per la comunicazione sincrona, usa variabili specifiche dello sprite quando necessario e aggiungi attese in cicli perenni per evitare il congelamento. Scratch insegna concetti fondamentali: rispetta il modello basato sugli eventi.