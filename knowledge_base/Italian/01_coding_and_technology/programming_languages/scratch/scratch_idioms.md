...
-->
# Scratch: modelli idiomatici e migliori pratiche
Questa guida copre i modelli idiomatici per scrivere progetti Scratch puliti e ben organizzati.
---
...
## Riepilogo
Gli idiomi di Scratch enfatizzano: chiara denominazione degli sprite, una responsabilità per sprite, messaggi trasmessi per la comunicazione, blocchi personalizzati per il riutilizzo, clonazione per più istanze, cicli di gioco strutturati e "esecuzione senza aggiornamento dello schermo" per le prestazioni. Organizzazione di premi Scratch: "uno sprite con un bel nome è metà del programma".