...
## Registra convenzioni e prologo/epilogo
```nasm
...
## Etichette locali e organizzazione del codice
```nasm
...
## Riepilogo
Gli idiomi di assembly enfatizzano: costanti con nome su numeri magici, macro per modelli ripetuti, definizioni di strutture per il layout dei dati, prologo/epilogo conforme a ABI, etichette locali per la leggibilità, convalida difensiva dell'input e`xor`/`lea`per operazioni efficienti. L'assemblaggio premia soprattutto la chiarezza: "se non puoi leggerlo, non puoi eseguirne il debug alle 3 del mattino".