...
---
# JavaScript: cronologia ed evoluzione delle versioni
## Cronologia
| Versione | Anno | Tema chiave |
|---------|------|-----------|
| ES1 | 1997 | Prima edizione (Netscape) |
| ES2 | 1998 | Piccole modifiche editoriali |
| ES3 | 1999 | Regex,`try/catch`,`switch`|
| ES4 | — | Abbandonato (troppo ambizioso) |
| ES5 | 2009| Modalità rigorosa, JSON,`map/filter/reduce`|
| ES5.1 | 2011 | Correzioni editoriali |
| ES6/2015 | 2015| **Maggiore**:`let/const`, frecce, classi, promesse, moduli |
| ES7/2016 | 2016| `**`,`Array.includes`|
| ES8/2017 | 2017 | `async/await`,`Object.entries`, memoria condivisa |
| ES9/2018 | 2018 | Riposo/allargamento,`for-await-of`,`Promise.finally`|
| ES10/2019 | 2019 | `Array.flat`,`Object.fromEntries`,`BigInt`|
| ES11/2020 | 2020 | `??`,`?.`,`Promise.allSettled`, dinamico`import()`|
| ES12/2021 | 2021 | `String.replaceAll`,`Promise.any`, assegnazione logica |
| ES13/2022 | 2022 |`await`di livello superiore, campi classe, `Array.at()`,`#private`|
| ES14/2023 | 2023 | `Array.findLast`, hashbang, simboli come chiavi WeakMap |
| ES15/2024 | 2024 | `Promise.withResolvers`,`Object.groupBy`,`Atomics.waitAsync`|
| ES16/2025 | 2025 | Helper iteratori, metodi `Set`,`import attributes`|
## Traguardi importanti
### L'era dei browser (1995–2009)
- **1995**: Brendan Eich crea JavaScript in 10 giorni presso Netscape
- **1997**: ECMA-262 standardizza il linguaggio
- **1999**: ES3: la versione che ha dominato per un decennio
- **2005**: rivoluzione AJAX (Google Maps, Gmail) — JS diventa una cosa seria
- **2006**: jQuery semplifica lo sviluppo cross-browser
- **2008**: motore V8 (cromato): inizia la rivoluzione delle prestazioni JS
- **2009**: Node.js: JavaScript sfugge al browser
### L'era moderna (2015-oggi)
- **2015**: ES6: il più grande aggiornamento di sempre; `let/const`, funzioni freccia, classi, Promesse, valori letterali modello, destrutturazione, moduli,`Symbol`,`Map/Set`, generatori,`for...of`
- **2017**: `async/await`: la programmazione asincrona diventa leggibile
- **2020**: concatenamento opzionale`?.`e coalescenza nulla`??`
- **2022**:`await`di livello superiore, campi di classe privata
- **2024**:`Promise.withResolvers`, `Object.groupBy`
## ES6 (2015) – Il Big Bang
```javascript
// Before ES6
var name = "Alice";
