...
# Vai: modelli idiomatici e migliori pratiche
Questa guida illustra i modelli idiomatici e le migliori pratiche per scrivere codice Go pulito e idiomatico.
---
...
## Riepilogo
Gli idiomi Go enfatizzano: semplicità, gestione esplicita degli errori, piccole interfacce, composizione sull'ereditarietà, goroutine con contesto e "accetta interfacce, restituisce strutture". Segui`gofmt`per la formattazione,`golangci-lint`per i lanugine e la guida ufficiale ai commenti sulla revisione del codice Go. La community di Go valorizza la leggibilità, la semplicità e "il modo più ovvio per farlo". Evita il codice intelligente: il codice Go dovrebbe essere noioso e prevedibile.