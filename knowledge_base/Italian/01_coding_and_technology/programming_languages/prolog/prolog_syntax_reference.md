...
## Riepilogo
La sintassi di Prolog è minima: fatti, regole e domande. Il potere deriva dall’unificazione e dal backtracking, che trasformano il linguaggio in un motore di ricerca per soluzioni logiche. I DCG forniscono un'elegante generazione di parser. Gli elenchi utilizzano la corrispondenza del modello testa/coda. Per la soddisfazione dei vincoli, i sistemi esperti e il calcolo simbolico, l'approccio dichiarativo di Prolog risolve problemi che sono dettagliati nei linguaggi imperativi.