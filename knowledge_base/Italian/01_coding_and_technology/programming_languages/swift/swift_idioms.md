...
-->
# Swift: modelli idiomatici e migliori pratiche
Questa guida illustra i modelli idiomatici e le migliori pratiche per scrivere codice Swift pulito.
---
...
## Riepilogo
Gli idiomi Swift enfatizzano: sicurezza (opzionali, guardia), tipi di valore (strutture), progettazione orientata al protocollo, corrispondenza di modelli, async/await e immutabilità (`let`per impostazione predefinita). Segui le linee guida per la progettazione dell'API Swift, utilizza SwiftLint per la qualità del codice e SwiftFormat per la formattazione. Swift apprezza la sicurezza e l'espressività: "se viene compilato, probabilmente è corretto".