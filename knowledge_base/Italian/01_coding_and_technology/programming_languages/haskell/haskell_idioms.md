...
## Riepilogo
Gli idiomi Haskell enfatizzano: tipi forti, corrispondenza di modelli, monadi per effetti, funzioni pure e valutazione pigra (con rigore quando necessario). Segui la Guida allo stile Haskell, utilizza`hlint`per suggerimenti e`fourmolu`per la formattazione. Haskell valorizza la correttezza e la composizione: "rendere irrappresentabili gli stati illegali".