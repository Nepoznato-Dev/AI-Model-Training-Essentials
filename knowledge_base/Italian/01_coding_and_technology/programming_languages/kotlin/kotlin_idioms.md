...
# Kotlin: modelli idiomatici e migliori pratiche
Questa guida copre i modelli idiomatici e le migliori pratiche per scrivere codice Kotlin pulito e idiomatico.
---
...
## Riepilogo
Gli idiomi Kotlin enfatizzano: sicurezza nulla, classi di dati, tipi sigillati, funzioni di ambito, funzioni di estensione, coroutine e codice orientato alle espressioni. Segui le convenzioni di codifica Kotlin, usa ktlint per la formattazione e detekt per l'analisi statica. Kotlin valorizza la concisione e l'espressività: scrivi meno standard, abbraccia la libreria standard e usa`val`per impostazione predefinita.