...
-->
# Lisp & Clojure — Riferimento alla sintassi
Questo documento fornisce un riferimento sintattico completo e strutturato per Common Lisp e Clojure. Completa il riferimento principale Lisp/Clojure concentrandosi su espressioni S, macro, strutture dati persistenti e modelli di programmazione funzionale.
---

## Clojure — Sintassi fondamentale
```clojure
;; Literals
42              ;; integer
3.14            ;; float
...
## Riepilogo
La sintassi di Clojure è uniformemente racchiusa tra parentesi: ogni forma è una lista. Questa omoiconicità consente macro potenti che trasformano il codice in dati. Le strutture dati persistenti forniscono immutabilità con condivisione strutturale per l'efficienza. Le macro di threading creano pipeline di dati leggibili. Le primitive di concorrenza (atomi, riferimenti, agenti, canali) gestiscono i cambiamenti di stato in modo sicuro. L'influenza di Lisp/Clojure sulla programmazione moderna è enorme: garbage collection, REPL, macro e programmazione funzionale risalgono tutti a Lisp.