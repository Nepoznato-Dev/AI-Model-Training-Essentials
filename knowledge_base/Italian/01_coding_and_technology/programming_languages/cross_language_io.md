...
# Confronto tra lingue: operazioni di I/O e file
## Uscita console
| Lingua | Stampa su stdout |
|----------|----------------|
| Pitone | `print("Hello")`|
| JavaScript | `console.log("Hello")`|
| Ruggine | `println!("Hello")`|
| Vai | `fmt.Println("Hello")`|
| Giava | `System.out.println("Hello")`|
| C| `printf("Hello\n")`|
...
| PHP | `echo "Hello\n"`|
| Dattiloscritto | `console.log("Hello")`|
| Haskell | `putStrLn "Hello"`|
| Scala | `println("Hello")`|
| R | `cat("Hello\n")`|
| Giulia | `println("Hello")`|
| Perl | `say "Hello"`|
| Lua | `print("Hello")`|
| MATLAB | `disp('Hello')`|
| Dardo | `print('Hello')`|
| Prologo | `write('Hello'), nl.`|
| Lisp | `(format t "Hello~%")`|
| Elisir | `IO.puts("Hello")`|
| Erlang | `io:format("Hello~n")`|
| OCaml | `print_endline "Hello"`|
| Ada | `Put_Line("Hello")`|
| COBOL | `DISPLAY 'Hello'`|
| Fortran | `print *, 'Hello'`|
| Assemblea | `syscall`(scrivi su fd 1) |
| Delfi | `WriteLn('Hello')`|
| Gratta | `say [Hello]`|
| V.B. | `Console.WriteLine("Hello")`|
| Conchiglia | `echo "Hello"`|
| SQL | N/D (restituisce set di risultati) |
## Lettura di un file
```python
# Python
