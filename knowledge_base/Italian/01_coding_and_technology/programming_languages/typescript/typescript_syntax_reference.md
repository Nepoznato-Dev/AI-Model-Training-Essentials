...
# TypeScript: riferimento alla sintassi
Questo documento fornisce un riferimento completo e strutturato alla sintassi per TypeScript. Completa il riferimento TypeScript principale concentrandosi sul sistema di tipi, sui generici, sui tipi di utilità e sulla programmazione avanzata a livello di tipo.
---

## Digitare Fondamenti di sistema
### Tipi primitivi e incorporati
```typescript
// Primitives
...
### Tipi di utilità personalizzate
```typescript
...
## Decoratori (TC39 Stage 3 / TypeScript 5.0+)
```typescript
// Class decorator
...
### Affermazioni e restringimenti costanti
```typescript
...
## Riepilogo
Il sistema di tipi di TypeScript è la sua caratteristica distintiva ed è particolarmente profondo. Dalle annotazioni di base ai generici, ai tipi condizionali, ai tipi mappati, ai tipi letterali modello e`infer`, il sistema di tipi è essenzialmente un linguaggio funzionale che opera in fase di compilazione. Comprendere l'interazione tra`interface`e `type`, tipi generici e di utilità e tipizzazione strutturale e nominale supporta la scrittura di TypeScript sicura ed ergonomica. Il linguaggio continua ad evolversi, con ogni versione che aggiunge più potenza espressiva pur mantenendo la piena compatibilità con le versioni precedenti di JavaScript.