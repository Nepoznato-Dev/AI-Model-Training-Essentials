...
utilizzato tramite API), GPT-3.5 (la spina dorsale del ChatGPT originale) e GPT-4
...
(Claude 1, 2, 3 Haiku / Sonetto / Opus) sono noti per finestre di contesto lunghe (su
...
modelli in quantizzazione a 4 bit; una GPU da 24 GB può gestire modelli da 70 B a 4 bit.
...
Le GPU supportano XeSS (super-sampling di Intel) e hanno un supporto limitato ma in crescita
...
visitando quel database per ottenere informazioni hardware autorevoli.
---
...
pass@k — la probabilità che almeno una delle k soluzioni generate superi tutto
prove. GPT-4 ottiene un punteggio di ~87% (pass@1); un modello 7B ben calibrato può raggiungere circa il 50–60%.
### Hella Swag
...
richiede ~4 GB. La quantizzazione in genere provoca una precisione piccola ma accettabile
