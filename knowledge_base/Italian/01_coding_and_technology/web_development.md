...
- **Preprocessori**: Sass, Less (variabili, mixin, annidamento)
#### JavaScript
...
- **Versionamento**: percorso URL, intestazioni, parametri di query
...
- **Manifesto app Web**: installa prompt, icone, colori del tema
