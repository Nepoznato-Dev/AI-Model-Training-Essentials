...
**Organizzazione:** 10 directory tematiche + 34 riferimenti a linguaggi di programmazione
---
...
| [embedded_systems_and_iot.md](01_coding_and_technology/embedded_systems_and_iot.md)| Microcontrollori, sensori, RTOS, protocolli IoT, edge computing |
...
|----------|------|-|----------|------|
| Pitone | `programming_languages/python/`| | JavaScript | `programming_languages/javascript/`|
| C| `programming_languages/c/`| | C++ | `programming_languages/cpp/`|
| Giava | `programming_languages/java/`| | C# | `programming_languages/csharp/`|
| Vai | `programming_languages/go/`| | Ruggine | `programming_languages/rust/`|
| Dattiloscritto | `programming_languages/typescript/`| | SQL | `programming_languages/sql/`|
| Rubino | `programming_languages/ruby/`| | PHP | `programming_languages/php/`|
| Veloce | `programming_languages/swift/`| | Kotlin | `programming_languages/kotlin/`|
| R | `programming_languages/r/`| | VisualBasic | `programming_languages/visual_basic/`|
| Dardo | `programming_languages/dart/`| | Scala | `programming_languages/scala/`|
| Haskell | `programming_languages/haskell/`| | Giulia | `programming_languages/julia/`|
| Lua | `programming_languages/lua/`| | Perl | `programming_languages/perl/`|
| Erlang/Elisir | `programming_languages/erlang_and_elixir/`| | OCaml | `programming_languages/ocaml/`|
| Prologo | `programming_languages/prolog/`| | Lisp/Clojure | `programming_languages/lisp_and_clojure/`|
| Ada | `programming_languages/ada/`| | Assemblea | `programming_languages/assembly/`|
...
| Delfi/Pascal | `programming_languages/delphi_object_pascal/`| | Gratta | `programming_languages/scratch/`|
...
| [data_ethics_and_privacy.md](03_data_science_and_analytics/data_ethics_and_privacy.md)| GDPR, consenso sui dati, bias algoritmico, dark pattern, anonimizzazione |
| [ensemble_methods.md](03_data_science_and_analytics/ensemble_methods.md)| Bagging, boosting, stacking, votazione, foreste casuali, XGBoost |
| [feature_engineering.md](03_data_science_and_analytics/feature_engineering.md)| Trasformazioni, codifiche, selezione di feature, riduzione della dimensionalità |
| [geospatial_analysis.md](03_data_science_and_analytics/geospatial_analysis.md)| Sistemi di coordinate, operazioni spaziali, GeoPanda, analisi raster |
### 04 — Scienze naturali
| File | Descrizione |
|------|-------------|
...
| File | Descrizione |
|------|-------------|
| [business_and_economics.md](05_business_and_economics/business_and_economics.md)| Strutture aziendali, marketing, economia, startup |
| [finance_and_investing.md](05_business_and_economics/finance_and_investing.md)| Finanza personale, investimenti, mercati, pensione |
| [law_and_legal_systems.md](05_business_and_economics/law_and_legal_systems.md)| Ordinamenti giuridici, contratti, illeciti, proprietà intellettuale, lavoro |
| [marketing_and_digital_strategy.md](05_business_and_economics/marketing_and_digital_strategy.md)| 4P, canali digitali, SEO/SEM, analisi, strategia di marca |
| [management_and_project_methodologies.md](05_business_and_economics/management_and_project_methodologies.md)| Leadership, Agile/Scrum/Kanban, OKR, gestione del rischio |
| [behavioural_economics.md](05_business_and_economics/behavioural_economics.md)| Bias cognitivi, teoria del prospetto, euristiche, nudges, architettura delle scelte |
| [game_theory.md](05_business_and_economics/game_theory.md)| Equilibrio di Nash, dilemma del prigioniero, progettazione dei meccanismi, aste |
| [intellectual_property_and_innovation.md](05_business_and_economics/intellectual_property_and_innovation.md)| Brevetti, copyright, marchi, segreti commerciali, licenze open source |
| [organisational_design_and_culture.md](05_business_and_economics/organisational_design_and_culture.md)| Strutture organizzative, tipi di cultura, gestione del cambiamento, dinamiche di gruppo |
| [supply_chain_and_operations.md](05_business_and_economics/supply_chain_and_operations.md)| Gestione delle scorte, produzione snella, logistica, effetto frusta |
...
| File | Descrizione |
|------|-------------|
| [dictionary.md](07_general_reference/dictionary.md)| Definizioni complete delle parole (A-Z) |
| [general_knowledge.md](07_general_reference/general_knowledge.md)| Sistema solare, corpo umano, geografia, energia |
| [technology_and_computing.md](07_general_reference/technology_and_computing.md)| Nozioni di base di informatica, Internet, database, cloud, sicurezza |
| [safe_communication.md](07_general_reference/safe_communication.md)| Linee guida e buone pratiche di comunicazione |
| [learning_science_and_pedagogy.md](07_general_reference/learning_science_and_pedagogy.md)| Pratica di recupero, ripetizione distanziata, tassonomia di Bloom, progettazione dell'apprendimento |
| [research_methodology.md](07_general_reference/research_methodology.md)| Metodo scientifico, campionamento, validità, disegno sperimentale, peer review |
| [writing_and_communication.md](07_general_reference/writing_and_communication.md)| Principio della piramide, presentazioni, persuasione, scrittura aziendale |
...
| File | Descrizione |
|------|-------------|
| [ai_llm_failures.md](09_lessons_from_failures/ai_llm_failures.md)| Allucinazioni, pregiudizi, fallimenti di allineamento |
| [code_quality_issues.md](09_lessons_from_failures/code_quality_issues.md)| Errori comuni di codifica e anti-pattern |
| [cognitive_logical_issues.md](09_lessons_from_failures/cognitive_logical_issues.md)| Errori di ragionamento e bias cognitivi |
| [rag_vector_search.md](09_lessons_from_failures/rag_vector_search.md)| Insidie ​​​​della ricerca RAG e vettoriale |
| [security_vulnerabilities.md](09_lessons_from_failures/security_vulnerabilities.md)| Vulnerabilità comuni della sicurezza |
| [system_reliability.md](09_lessons_from_failures/system_reliability.md)| Guasti del sistema e modelli di affidabilità |
| [api_design_and_integration_failures.md](09_lessons_from_failures/api_design_and_integration_failures.md)| Anti-pattern API, modifiche di rilievo, errori di controllo delle versioni, errori a cascata |
| [data_pipeline_and_etl_failures.md](09_lessons_from_failures/data_pipeline_and_etl_failures.md)| Deriva dello schema, dati duplicati, lacune di validazione, monitoraggio della pipeline |
| [ml_project_failures.md](09_lessons_from_failures/ml_project_failures.md)| Perdita di dati, mancata corrispondenza delle aspettative, errori di distribuzione, decadimento del modello |
...
4. Scegli una lingua in `01_coding_and_technology/programming_languages/python/`
...
- **Informazioni mediche:** Il contenuto di`medicine_and_healthcare.md`è solo a scopo didattico e non deve sostituire la consulenza medica professionale.
- **Informazioni legali:** Il contenuto di`law_and_legal_systems.md`è informativo e non costituisce una consulenza legale.
- **Informazioni finanziarie:** I contenuti di`finance_and_investing.md`sono didattici e non devono essere considerati consigli finanziari.
- **Proiezioni future:** Il contenuto di`08_future_and_trends/`contiene informazioni speculative e proiezioni che potrebbero cambiare.
---

## Linee guida per l'uso
### Per sistemi di intelligenza artificiale
- Tutti i file utilizzano intestazioni gerarchiche chiare (titolo `#`, sezioni `##`, sottosezioni `###`)
- Le tabelle vengono utilizzate per confronti strutturati in tutto
- Gli esempi di codice includono l'evidenziazione della sintassi
- I riferimenti incrociati utilizzano collegamenti di riduzione relativi
### Per lettori umani
- I file sono scritti in un tono colloquiale e neutro
- Vengono utilizzate tabelle e confronti strutturati al posto di paragrafi densi
- Esempi e analogie del mondo reale aiutano a radicare concetti astratti
- Ogni file include una sezione di riepilogo
---

## Contributi e metadati
Ogni file di contenuto in questa knowledge base (tutto tranne questo`README.md`) si apre con un blocco frontmatter YAML. Segue lo stesso modello di tracciamento dei contributori utilizzato da [skills](../../skills/skill-creator.md), quindi la paternità, le modifiche e le recensioni rimangono tracciabili in entrambe le raccolte. Per il flusso di lavoro generale del contributo: biforcazione, ramificazione, richieste pull, posizionamento dei file e convenzioni di denominazione, vedere la radice[CONTRIBUTING.md](../../CONTRIBUTING.md).
### Schema di Frontmatter
Ogni file inizia con questo blocco (tra i delimitatori `---`), suddiviso in cinque sezioni commentate:
```yaml
---
# Metadata
...
| Campo | Fonte/Scopo |
|---|---|
| `title`| Estratto dalla prima intestazione`#`del file |
| `description`| Riepilogo di una riga; i file di argomento riutilizzano la voce dall'indice di questo README, i file del linguaggio di programmazione utilizzano una descrizione generata |
| `category`/`reviewed_by`| Derivato dalla directory principale (`01_coding_and_technology`→ "Coding and Technology" / "Coding & Technology Knowledge Base Team") |
| `version`| Versione semantica; bump su ogni modifica (vedi sotto) |
| `authors`/`contributors`| Autore originale più chiunque abbia da allora modificato il file |
| `changelog`| Elenco delle modifiche di sola aggiunta, prima la più recente |
| `review_date`/`next_review`| Cadenza di ~6 mesi e ~1 anno, che rispecchia il programma di revisione delle competenze |
| `tags`| Token del nome file più una parola chiave di categoria pulita (ad esempio`coding-and-technology`) |
| `difficulty_level`| Impostato per categoria, con sostituzioni per lingua (ad esempio Haskell/Assembly → `advanced`, Scratch → `beginner`) |
| `estimated_reading_time`| Calcolato dal conteggio delle righe |
### Modificare un file
Quando modifichi un file della knowledge base, mantieni sincronizzato il suo frontmatter:
1. **Bump`version`** seguendo[SemVer](https://semver.org/):
   - Patch (`1.0.x`): errori di battitura, formattazione, correzioni minori
   - Minore (`1.x.0`): nuove sezioni, contenuti ampliati, nuovi esempi
   - Maggiore (`x.0.0`): riscrittura o ristrutturazione completa
2. **Aggiungi una voce al registro delle modifiche** (prima la più recente) che descriva cosa hai modificato:   ```yaml
   changelog:
     - version: "1.1.0"
       date: "2026-08-05"
       author: "Your Name"
     ...
     - version: "1.0.0"
       ...
       changes: "Added YAML frontmatter metadata for contributor tracking"
   ```
3. **Aggiorna`last_modified`** alla data della modifica
4. **Aggiungiti a`contributors`** se è la prima modifica al file:   ```yaml
   contributors:
     - name: "Your Name"
...
Prima di inviare un file della knowledge base nuovo o modificato, verificare:
- [] Il frontmatter YAML è completo e valido (tutte e cinque le sezioni presenti, tra i delimitatori `---`)
- [ ]`title`,`description`,`category`,`version`,`status`sono impostati
- [ ] Almeno un autore è elencato in`authors`
- [ ]`changelog`ha una voce che documenta la modifica (prima la più recente)
- [ ]`last_modified`riflette la data odierna
- [ ]`tags`include 3-6 parole chiave pertinenti più la parola chiave della categoria pulita
- [ ]`difficulty_level`è impostato (principiante / intermedio / avanzato)
- [ ]`estimated_reading_time`è realistico per la lunghezza del contenuto
- [ ] Il contenuto del corpo segue[Usage Guidelines](#usage-guidelines)sopra
- [ ] Nessun riferimento incrociato interrotto
---

*Questa base di conoscenza è una raccolta di documenti vivente, continuamente migliorata e ampliata.*