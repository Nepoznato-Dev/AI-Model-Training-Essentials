...
| `RUN`| Esegue un comando durante la compilazione | `RUN pip install -r requirements.txt`|
...
| Servizio non raggiungibile | `kubectl get endpoints <service>`→ sono stati selezionati i pod? |
