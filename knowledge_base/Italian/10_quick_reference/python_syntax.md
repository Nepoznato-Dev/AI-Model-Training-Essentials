...
# Foglio informativo sulla sintassi Python
Riferimento rapido per la sintassi Python 3.x e i modelli comuni.
---

## Sintassi di base
### Variabili e tipi di dati```python
...
### Operazioni sul dizionario```python
# Merge dictionaries
{**d1, **d2}
d1 | d2                     # Python 3.9+
...
## Suggerimenti rapidi
- Utilizzare`#`per commenti a riga singola
- Utilizzare`"""triple quotes"""`per docstring e stringhe multilinea
- Il rientro è importante (tipicamente 4 spazi)
- Convenzioni di denominazione:`snake_case`per variabili/funzioni,`PascalCase`per classi
-`__name__ == "__main__"`per verificare se lo script viene eseguito direttamente
- Utilizzare`virtualenv`o`venv`per l'isolamento del progetto
- Installa i pacchetti con `pip install package_name`
---

*Ultimo aggiornamento: luglio 2026 | Python 3.x*