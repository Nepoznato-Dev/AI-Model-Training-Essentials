...
Comandi Linux/Unix essenziali per la navigazione e l'amministrazione del sistema.
---
...
| `Ctrl+C`| Uccidi il comando corrente |
| `Ctrl+Z`| Sospendere il comando |
| `Ctrl+D`| Esci dalla shell/EOF |
...
| `Ctrl+R`| Cronologia delle ricerche |
| `Ctrl+W`| Elimina la parola prima del cursore |
---

## Migliori pratiche
✅ **Fai:**
- Utilizzare`sudo`con parsimonia e attenzione
- Testare prima i comandi distruttivi senza flag di esecuzione
- Conserva i backup prima di modifiche importanti
- Utilizza nomi di file significativi (senza spazi)
- Impara a utilizzare le pagine`man`(`man command`)
❌ **Non farlo:**
- Esegui`rm -rf /`o comandi pericolosi simili
- Utilizza`chmod 777`su file sensibili
- Ignorare i messaggi di avviso
- Modifica i file di sistema senza backup
- Esegui script sconosciuti come root
---

*Ultimo aggiornamento: luglio 2026 | Compatibile con Linux/Unix*