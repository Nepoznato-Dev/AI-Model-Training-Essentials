...
Comandi Git essenziali per il controllo della versione.
---
...
### Avvia una nuova funzionalità```bash
git checkout main
git pull
...
### Sincronizza con Principale```bash
...
### Flusso di lavoro dell'aggiornamento rapido```bash
git checkout main
git pull
...
## Scorciatoie da tastiera (Git Bash)
| Scorciatoia | Azione |
|----------|--------|
| `Ctrl+R`| Cronologia ricerche invertite |
| `Tab`| Completamento automatico |
| `Ctrl+C`| Annulla comando |
| `Ctrl+Z`| Sospendi processo |
| `fg`| Riprendere il processo sospeso |
---

## Migliori pratiche
✅ **Fai:**
- Scrivi messaggi di commit chiari e descrittivi
- Impegnarsi frequentemente con raggruppamenti logici
- Utilizzare i rami per funzionalità/correzioni
- Tirare prima di iniziare il lavoro
- Controlla spesso `git status`
❌ **Non farlo:**
- Commit dati sensibili (chiavi API, password)
- Forza il push sui rami condivisi
- Effettua il commit di file binari di grandi dimensioni
- Ignora i conflitti di unione
- Lavora direttamente su main/master
---
...
*Ultimo aggiornamento: luglio 2026 | Git 2.x*