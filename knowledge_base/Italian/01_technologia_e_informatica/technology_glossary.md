...
### Phi-3-mini
Phi-3-mini è uno Small Language Model (SLM) sviluppato da Microsoft con 3,8 miliardi di parametri. È stato rilasciato nell’aprile 2024. Invece di puntare solo alla quantità di dati, è stato addestrato su un dataset accuratamente curato, spesso descritto come di qualità "textbook". Nonostante le dimensioni contenute, ottiene risultati competitivi su benchmark di ragionamento e può essere eseguito anche su hardware consumer o dispositivi mobili sufficientemente potenti.
