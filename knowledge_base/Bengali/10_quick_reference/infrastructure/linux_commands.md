...
### অনুমতি নম্বর
-`7`= rwx (পড়ুন + লিখুন + কার্যকর করুন)
-`6`= rw- (পড় + লিখুন)
-`5`= r-x (পড়ুন + কার্যকর করুন)
-`4`= r-- (শুধু পঠনযোগ্য)
---

## টেক্সট প্রসেসিং
### অনুসন্ধান করুন এবং প্রতিস্থাপন করুন```bash
...
|------------|---------|
| `Tab`| স্বয়ংসম্পূর্ণ |
| `Ctrl+C`| বর্তমান কমান্ড হত্যা |
| `Ctrl+Z`| সাসপেন্ড কমান্ড |
| `Ctrl+D`| প্রস্থান শেল/ইওএফ |
| `Ctrl+L`| পরিষ্কার পর্দা |
| `Ctrl+A`| লাইন শুরুতে যান |
| `Ctrl+E`| লাইনের শেষে যান |
| `Ctrl+U`| লাইন শুরু থেকে মুছুন |
| `Ctrl+K`| লাইনের শেষে মুছুন |
| `Ctrl+R`| অনুসন্ধান ইতিহাস |
| `Ctrl+W`| কার্সারের আগে শব্দ মুছুন |
---

## সর্বোত্তম অভ্যাস
✅ **করুন:**
-`sudo`অল্প এবং সাবধানে ব্যবহার করুন
- প্রথমে এক্সিকিউশন ফ্ল্যাগ ছাড়া ধ্বংসাত্মক কমান্ড পরীক্ষা করুন
- বড় পরিবর্তনের আগে ব্যাকআপ রাখুন
- অর্থপূর্ণ ফাইলের নাম ব্যবহার করুন (স্পেস নেই)
-`man`পৃষ্ঠাগুলি ব্যবহার করতে শিখুন (`man command`)
❌ **করবেন না:**
-`rm -rf /`বা অনুরূপ বিপজ্জনক কমান্ড চালান
- সংবেদনশীল ফাইলগুলিতে`chmod 777`ব্যবহার করুন৷
- সতর্কতা বার্তা উপেক্ষা করুন
- ব্যাকআপ ছাড়া সিস্টেম ফাইল সম্পাদনা করুন
- রুট হিসাবে অজানা স্ক্রিপ্ট চালান
---

*শেষ আপডেট: জুলাই 2026 | লিনাক্স/ইউনিক্স সামঞ্জস্যপূর্ণ*