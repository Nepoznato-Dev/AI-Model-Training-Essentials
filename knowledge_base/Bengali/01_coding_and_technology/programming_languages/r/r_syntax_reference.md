...
|----------|------|---------|-------|
| `+``-``*``/``^`| পাটিগণিত | `2^10`| |
| `%%`| মডুলাস | `7 %% 3`| রিটার্ন 1 |
| `%/%`| পূর্ণসংখ্যা বিভাজন | `7 %/% 3`| রিটার্নস 2 |
| `==``!=` | সমতা | `x == y`| ভেক্টরাইজড |
| `<``>``<=``>=` | তুলনা | `x >= y`| ভেক্টরাইজড |
| `&``\|``!`| যৌক্তিক (ভেক্টরাইজড) | `x & y`| উপাদান-ভিত্তিক |
| `&&``\|\|` | যৌক্তিক (স্কেলার) | `x && y`| শুধুমাত্র প্রথম উপাদান |
| `%in%`| সদস্যপদ | `x %in% y`| |
| `<-``=` | অ্যাসাইনমেন্ট | `x <- 10`| `<-`হল ইডিওম্যাটিক |
| `->`| রাইট অ্যাসাইন | `10 -> x`| কদাচিৎ ব্যবহৃত |
| `<<-`| গ্লোবাল অ্যাসাইন | `x <<- 10`| অভিভাবক env এ বরাদ্দ করুন |
| `$`| নির্যাস উপাদান | `df$column`| |
| `[``[[` | ইনডেক্সিং | `x[1]`/`x[[1]]`| `[`একই ধরনের প্রদান করে; `[[`নির্যাস |
| `%>%`| পাইপ (magrittr) | `x %>% f()`| |
| `\|>`| পাইপ (বেস R 4.1+) | `x \|> f()`| দেশীয় পাইপ |
### ভেক্টরাইজড অপারেশন
```r
...
## সারাংশ
R এর সিনট্যাক্স পরিসংখ্যানগত কম্পিউটিং এবং ডেটা বিশ্লেষণের জন্য ডিজাইন করা হয়েছে। অপারেশনের ভেক্টরাইজড প্রকৃতি বেশিরভাগ কাজের জন্য লুপগুলিকে সরিয়ে দেয়। পরিপাটি ইকোসিস্টেম (dplyr, ggplot2, tidyr) ডেটা ম্যানিপুলেশন এবং ভিজ্যুয়ালাইজেশনের জন্য একটি সামঞ্জস্যপূর্ণ, পাঠযোগ্য ব্যাকরণ প্রদান করে। R-এর পরিসংখ্যানগত মডেলিং ক্ষমতা - মৌলিক টি-পরীক্ষা থেকে মিশ্র-প্রভাব মডেল পর্যন্ত - গভীরতার সাথে তুলনাহীন। তথ্য বিজ্ঞান, পরিসংখ্যান, এবং পুনরুত্পাদনযোগ্য গবেষণার জন্য, R একটি অপরিহার্য হাতিয়ার রয়ে গেছে।