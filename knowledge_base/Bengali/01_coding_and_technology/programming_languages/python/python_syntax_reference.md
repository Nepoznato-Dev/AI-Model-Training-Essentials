...
-->
# পাইথন - সিনট্যাক্স রেফারেন্স
এই নথিটি পাইথনের জন্য একটি ব্যাপক, কাঠামোগত সিনট্যাক্স রেফারেন্স প্রদান করে। এটি সম্পূর্ণ সিনট্যাক্স প্যাটার্ন, অপারেটর টেবিল এবং অভ্যন্তরীণ মেকানিক্সের উপর ফোকাস করে মূল পাইথন রেফারেন্সের পরিপূরক।
---
...
|----------|------|---------|---------|-------|
| `+`| সংযোজন | `3 + 2`| `5`| এছাড়াও স্ট্রিং/তালিকা সংযুক্তি |
| `-`| বিয়োগ | `3 - 2`| `1`| এছাড়াও unary negation |
| `*`| গুণ | `3 * 2`| `6`| এছাড়াও স্ট্রিং/তালিকা পুনরাবৃত্তি |
| `/`| সত্য বিভাগ | `7 / 2`| `3.5`| সর্বদা ভাসা ফেরে |
| `//`| মেঝে বিভাগ | `7 // 2`| `3`| ঋণাত্মক অসীমের দিকে বৃত্তাকার |
| `%`| মডুলাস | `7 % 2`| `1`| সাইন মেলে ডিভাজর |
| `**`| ব্যাখ্যা | `2 ** 10`| `1024`| ডান-সহযোগী |
### তুলনা এবং বুলিয়ান অপারেটর
| অপারেটর | নাম | উদাহরণ | নোট |
|----------|------|---------|-------|
| `==`| সমান | `x == y`| মূল্য তুলনা (পরিচয় নয়) |
| `!=`| সমান নয় | `x != y`| |
| `<`,`>`,`<=`,`>=`| অর্ডারিং | `x >= y`| চেইনযোগ্য:`a < b < c`|
| `is`| পরিচয় | `x is y`| স্মৃতিতে একই বস্তু |
| `is not`| পরিচয় নয় | `x is not None`|`!= None`এর চেয়ে পছন্দের |
| `in`| সদস্যপদ | `x in collection`| সেট/ডিক্টের জন্য O(1), তালিকার জন্য O(n) |
| `and`| যৌক্তিক এবং | `a and b`| শর্ট সার্কিট; শেষ সত্য/মিথ্যা মান ফেরত |
| `or`| যৌক্তিক বা | `a or b`| শর্ট সার্কিট; প্রথম সত্য/মিথ্যা মান প্রদান করে |
| `not`| যৌক্তিক নয় | `not x`| |
### বিটওয়াইজ অপারেটর
| অপারেটর | নাম | উদাহরণ | নোট |
|----------|------|---------|-------|
| `&`| এবং | `5 & 3`| `1`|
...
| 8 | `^`| বাম |
| 9 | `\|`| বাম |
| 10 | `==`,`!=`,`<`,`>`,`<=`,`>=`,`is`,`is`, XQZMARKER2 | চেইনেবল |
| 11 | `not`| ঠিক |
| 12 | `and`| বাম |
| 13 (সর্বনিম্ন) | `or`| বাম |
### অ্যাসাইনমেন্ট এবং অগমেন্টেড অ্যাসাইনমেন্ট
```python
...
| সংগ্রহ | আদেশ করা | পরিবর্তনযোগ্য | সদৃশ | সিনট্যাক্স | দেখুন |
|------------|---------|---------|------------|---------|---------|
| `list`| হ্যাঁ | হ্যাঁ | হ্যাঁ | `[1, 2, 3]`| O(n) |
| `tuple`| হ্যাঁ | না | হ্যাঁ | `(1, 2, 3)`| O(n) |
| `dict`| হ্যাঁ (3.7+) | হ্যাঁ | কী: না | `{"k": "v"}`| O(1) গড় |
| `set`| না | হ্যাঁ | না | `{1, 2, 3}`| O(1) গড় |
| `frozenset`| না | না | না | `frozenset({1,2})`| O(1) গড় |
### তালিকা
```python
# Creation
nums = [1, 2, 3, 4, 5]
...
### ব্যতিক্রম হ্যান্ডলিং প্যাটার্ন
```python
...
## সারাংশ
এই সিনট্যাক্স রেফারেন্সটি পাইথনের সম্পূর্ণ বৈশিষ্ট্য সেট কভার করে — বেসিক অপারেটর থেকে এবং উন্নত মেটাপ্রোগ্রামিং, বর্ণনাকারী এবং টাইপ সিস্টেমের মাধ্যমে নিয়ন্ত্রণ প্রবাহ। পাইথনের সিনট্যাক্স ইচ্ছাকৃতভাবে ন্যূনতম এবং পাঠযোগ্য, তবে এর গভীরতা যথেষ্ট: প্যাটার্ন ম্যাচিং, অ্যাসিঙ্ক জেনারেটর, প্রোটোকল এবং মেটাক্লাসগুলি জটিল অ্যাপ্লিকেশনগুলির জন্য শক্তিশালী সরঞ্জাম সরবরাহ করে। ভাষাটি ক্রমাগত বিকশিত হতে থাকে, প্রতিটি রিলিজ বৈশিষ্ট্য যুক্ত করে যা পশ্চাদগামী সামঞ্জস্য বজায় রেখে অভিব্যক্তি উন্নত করে।