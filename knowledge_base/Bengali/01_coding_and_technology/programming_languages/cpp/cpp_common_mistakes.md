...
এই নথিটি C++-এ সবচেয়ে সাধারণ ভুল, ফাঁদ এবং অ্যান্টি-প্যাটার্নের ক্যাটালগ করে। প্রতিটি এন্ট্রি ভুল পদ্ধতি দেখায়, ব্যাখ্যা করে কেন এটি ব্যর্থ হয় এবং সঠিক সমাধান প্রদান করে। আধুনিক C++ (C++ 11/14/17/20) বেশিরভাগ ক্লাসিক সমস্যা এড়াতে সরঞ্জাম সরবরাহ করে।
---

## 1. তিন/পাঁচটি লঙ্ঘনের নিয়ম
```cpp
...
## 2. স্মার্ট পয়েন্টারের পরিবর্তে কাঁচা`new`/ `delete`
```cpp
...
## 6.`std::move`সঠিকভাবে ব্যবহার করছেন না
```cpp
...
## 7. অ্যান্টি-প্যাটার্ন: হেডারে`using namespace std;`ব্যবহার করা
```cpp
...
## 8. স্বাক্ষরিত ওভারফ্লো থেকে অনির্ধারিত আচরণ
```cpp
...
## 10. অ্যান্টি-প্যাটার্ন: ম্যানুয়াল রিসোর্স ম্যানেজমেন্ট (প্রি-RAII)
```cpp
...
## 11. টেমপ্লেট ব্লোট এবং লং কম্পাইল টাইমস
```cpp
...
## 12.`[[nodiscard]]`এবং`[[maybe_unused]]`ব্যবহার করছেন না
```cpp
...
## সারাংশ
C++ এর জটিলতা ভুলের জন্য অনেক সুযোগ তৈরি করে: পাঁচের নিয়ম, অবজেক্ট স্লাইসিং, ইটারেটর অকার্যকরকরণ, ঝুলন্ত রেফারেন্স, এবং স্বাক্ষরিত ওভারফ্লো থেকে অনির্ধারিত আচরণ। আধুনিক C++ হল প্রতিষেধক: কাঁচা`new`/`delete`, RAII এর পরিবর্তে সমস্ত সংস্থান,`std::vector`এবং`std::string`কাঁচা অ্যারের পরিবর্তে স্মার্ট পয়েন্টার ব্যবহার করুন, দক্ষতার জন্য শব্দার্থবিদ্যা সরান, এবং XQQZMARKER4 মানকে ক্যাট সাইন-এ ফেরত দিন। C++ মূল নির্দেশিকাগুলি একটি কারণে বিদ্যমান — সেগুলি অনুসরণ করুন এবং আপনি যা মিস করেন তা ধরতে ক্ল্যাং-টাইডি এবং স্যানিটাইজারগুলির মতো সরঞ্জামগুলি ব্যবহার করুন৷