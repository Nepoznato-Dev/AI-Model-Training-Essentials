...
-->
# OCaml — সিনট্যাক্স রেফারেন্স
এই নথিটি OCaml (4.x/5.x) এর জন্য একটি ব্যাপক, কাঠামোগত সিনট্যাক্স রেফারেন্স প্রদান করে। এটি সম্পূর্ণ সিনট্যাক্স প্যাটার্ন, বীজগাণিতিক ডেটা টাইপ, প্যাটার্ন ম্যাচিং, মডিউল এবং কার্যকরী প্রোগ্রামিং ইডিয়মগুলিতে ফোকাস করে মূল OCaml রেফারেন্সের পরিপূরক।
---
...
## সারাংশ
OCaml এর সিনট্যাক্স পরিষ্কার এবং গাণিতিক। বীজগাণিতিক তথ্য প্রকার এবং সম্পূর্ণ প্যাটার্নের মিল অসম্ভব অবস্থাকে অপ্রতিরোধ্য করে তোলে। ফাংশন সহ মডিউল সিস্টেম রানটাইম খরচ ছাড়াই শক্তিশালী বিমূর্ততা প্রদান করে। প্রকার অনুমান মানে শব্দহীনতা ছাড়া নিরাপত্তা। মরিচা, এফ#, টাইপস্ক্রিপ্ট এবং সুইফটের উপর OCaml এর প্রভাব অনস্বীকার্য। সিস্টেম প্রোগ্রামিং, কম্পাইলার এবং আনুষ্ঠানিক যাচাইকরণের জন্য, OCaml একটি শীর্ষ পছন্দ।