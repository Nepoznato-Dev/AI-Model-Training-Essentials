...
| `-`| বিয়োগ | `3 - 2`| `1`| |
| `*`| গুণ | `3 * 2`| `6`| |
| `/`| বিভাগ | `7 / 2`| `3`| ints এর জন্য পূর্ণসংখ্যা বিভাজন |
| `%`| অবশিষ্ট | `7 % 2`| `1`| সাইন মেলে লভ্যাংশ |
| `&`| বিটওয়াইজ এবং | `5 & 3`| `1`| |
| `\|`| বিটওয়াইজ বা | `5 \| 3`| `7`| |
| `^`| বিটওয়াইজ XOR | `5 ^ 3`| `6`| এছাড়াও bitwise পরিপূরক (unary) |
| `&^`| বিট পরিষ্কার (এবং নয়) | `5 &^ 3`| `4`| যেতে অনন্য |
| `<<`| বাম শিফট | `5 << 1`| `10`| |
| `>>`| ডান স্থানান্তর | `5 >> 1`| `2`| |
### তুলনা অপারেটর
| অপারেটর | নাম | উদাহরণ | নোট |
|----------|------|---------|-------|
| `==`| সমান | `x == y`| তুলনীয় প্রকার শুধুমাত্র |
| `!=`| সমান নয় | `x != y`| |
| `<`,`>`,`<=`,`>=`| অর্ডারিং | `x >= y`| স্ট্রিংগুলি অভিধানিকভাবে তুলনা করে |
### লজিক্যাল অপারেটর
| অপারেটর | নাম | উদাহরণ | নোট |
|----------|------|---------|-------|
...
## সারাংশ
গো-এর সিনট্যাক্স ইচ্ছাকৃতভাবে ন্যূনতম — কোনও উত্তরাধিকার নেই, কোনও পদ্ধতি ওভারলোডিং নেই, কোনও ব্যতিক্রম নেই, কোনও ম্যাক্রো নেই৷ যা অবশিষ্ট থাকে তা হল একটি পরিষ্কার, অর্থোগোনাল গঠনের সেট: কম্পোজিশনের জন্য স্ট্রাকস এবং ইন্টারফেস, একযোগে গরউটিন এবং চ্যানেল এবং নির্ভরযোগ্যতার জন্য স্পষ্ট ত্রুটি পরিচালনা। ভাষার শক্তি জটিল সিনট্যাক্স থেকে নয় বরং এর সাধারণ আদিমতার মার্জিত মিথস্ক্রিয়া থেকে আসে। জেনেরিক্স (Go 1.18+) Go-এর বৈশিষ্ট্যগত স্বচ্ছতাকে ত্যাগ না করেই টাইপ নমনীয়তা যোগ করে।