...
-->
# যান — সাধারণ ভুল এবং অ্যান্টি-প্যাটার্ন
এই নথিটি গো-তে সবচেয়ে সাধারণ ভুল, ফাঁদ এবং অ্যান্টি-প্যাটার্নগুলির ক্যাটালগ করে৷ প্রতিটি এন্ট্রি ভুল পদ্ধতি দেখায়, ব্যাখ্যা করে কেন এটি ব্যর্থ হয় এবং সঠিক সমাধান প্রদান করে।
---

## 1. Goroutines মধ্যে লুপ পরিবর্তনশীল ক্যাপচার
```go
...
## 5. স্ট্রাকট পদ্ধতিতে Nil পয়েন্টার ডিরেফারেন্স
```go
...
## 7. অ্যান্টি-প্যাটার্ন: সময়ের আগে নামযুক্ত ভেরিয়েবল ফিরিয়ে দেওয়া
```go
...
## 8. মানচিত্রের পুনরাবৃত্তি ক্রম এলোমেলো
```go
...
## 10. অ্যান্টি-প্যাটার্ন: ইন্টারফেস দূষণ
```go
...
## 11. শুরু করার জন্য`sync.Once`ব্যবহার করা হচ্ছে না
```go
...
## 12.`sync`প্রকারগুলি অনুলিপি করা হচ্ছে
```go
...
## সারাংশ
গো-এর সরলতা হল এর শক্তি, কিন্তু এতে সূক্ষ্ম ফাঁদ রয়েছে: আনবাফার করা চ্যানেলগুলি থেকে গোরুটিন ফাঁস, স্লাইস অ্যাপেন্ড সিমেন্টিকস যা মূল পরিবর্তন করে না, লুপগুলিতে জমা হওয়া বিলম্বিত কল এবং ইচ্ছাকৃতভাবে এলোমেলো করা ম্যাপ পুনরাবৃত্তি। গো প্রবাদগুলি পথ নির্দেশ করে: প্রতিটি ত্রুটি পরিচালনা করুন, ইন্টারফেসগুলি গ্রহণ করুন তবে স্ট্রাকটগুলি ফিরিয়ে দিন, মিউটেক্স প্রকারের জন্য পয়েন্টার রিসিভারগুলি ব্যবহার করুন এবং ম্যানুয়াল গোরুটিন পরিচালনার চেয়ে কনকারেন্সি প্রাইমিটিভ (`sync.Once` ,`errgroup`, প্রসঙ্গ বাতিল) পছন্দ করুন৷ প্রথমে সহজ কোড লিখুন — চতুরতার উপরে স্বচ্ছতার পুরস্কার পান।