...
-->
# Cross-Language Comparison — I/O এবং ফাইল অপারেশন
## কনসোল আউটপুট
| ভাষা | stdout এ প্রিন্ট করুন |
|------------|----------------|
| পাইথন | `print("Hello")`|
| জাভাস্ক্রিপ্ট | `console.log("Hello")`|
| মরিচা | `println!("Hello")`|
| যান | `fmt.Println("Hello")`|
| জাভা | `System.out.println("Hello")`|
| গ | `printf("Hello\n")`|
| সি++ | `std::cout << "Hello" << std::endl`|
| C# | `Console.WriteLine("Hello")`|
| রুবি | `puts "Hello"`|
| সুইফট | `print("Hello")`|
| কোটলিন | `println("Hello")`|
| পিএইচপি | `echo "Hello\n"`|
| টাইপস্ক্রিপ্ট | `console.log("Hello")`|
| হাসকেল | `putStrLn "Hello"`|
| স্কালা | `println("Hello")`|
| আর | `cat("Hello\n")`|
| জুলিয়া | `println("Hello")`|
| পার্ল | `say "Hello"`|
| লুয়া | `print("Hello")`|
| ম্যাটল্যাব | `disp('Hello')`|
| ডার্ট | `print('Hello')`|
| প্রোলগ | `write('Hello'), nl.`|
| লিস্প | `(format t "Hello~%")`|
| এলিক্সির | `IO.puts("Hello")`|
| এরলাং | `io:format("Hello~n")`|
| OCaml | `print_endline "Hello"`|
| আদা | `Put_Line("Hello")`|
| COBOL | `DISPLAY 'Hello'`|
| ফোর্টরান | `print *, 'Hello'`|
| সমাবেশ | `syscall`(fd 1 এ লিখুন) |
| ডেলফি | `WriteLn('Hello')`|
| আঁচড় | `say [Hello]`|
| ভিবি | `Console.WriteLine("Hello")`|
| শেল | `echo "Hello"`|
| এসকিউএল | N/A (ফলাফল সেট ফেরত দেয়) |
## একটি ফাইল পড়া
```python
# Python
