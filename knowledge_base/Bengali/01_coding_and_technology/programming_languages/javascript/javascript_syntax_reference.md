...
-->
# জাভাস্ক্রিপ্ট — সিনট্যাক্স রেফারেন্স
এই নথিটি জাভাস্ক্রিপ্টের জন্য একটি ব্যাপক, কাঠামোগত সিনট্যাক্স রেফারেন্স প্রদান করে। এটি সম্পূর্ণ সিনট্যাক্স প্যাটার্ন, অপারেটর টেবিল এবং অভ্যন্তরীণ মেকানিক্সের উপর ফোকাস করে প্রধান জাভাস্ক্রিপ্ট রেফারেন্সের পরিপূরক।
---
...
| `/`| বিভাগ | `7 / 2`| `3.5`| |
| `%`| অবশিষ্ট | `7 % 2`| `1`| |
| `**`| ব্যাখ্যা | `2 ** 10`| `1024`| ES2016 |
| `++`| বৃদ্ধি | `x++`/`++x`| | পোস্ট- এবং প্রি-ইনক্রিমেন্ট |
| `--`| হ্রাস | `x--`/`--x`| | পোস্ট- এবং প্রি-ডিক্রিমেন্ট |
| `+x`,`-x`| ইউনারি | `+"42"`→`42`| সংখ্যায় জবরদস্তি টাইপ করুন |
### তুলনা ও সমতা
| অপারেটর | নাম | উদাহরণ | নোট |
|----------|------|---------|-------|
| `===`| কঠোর সমতা | `1 === 1`| কোন প্রকার জবরদস্তি নয় - সর্বদা এটি পছন্দ করুন |
| `!==`| কঠোর অসমতা | `1 !== "1"`| `true`— বিভিন্ন প্রকার |
| `==`| বিমূর্ত সমতা | `1 == "1"`| টাইপ জবরদস্তি — এড়িয়ে চলুন |
| `!=`| বিমূর্ত অসমতা | `1 != "1"`| `false`— এড়িয়ে চলুন |
| `<`,`>`,`<=`,`>=`| সম্পর্কীয় | `"b" > "a"`| স্ট্রিং এর জন্য লেক্সিকোগ্রাফিক |
### যৌক্তিক এবং বাতিল অপারেটর
| অপারেটর | নাম | উদাহরণ | নোট |
|----------|------|---------|-------|
| `&&`| যৌক্তিক এবং | `a && b`| প্রথম মিথ্যা বা শেষ মান ফেরত দেয় |
| `\|\|`| যৌক্তিক বা | `a \|\| b`| প্রথম সত্য বা শেষ মান প্রদান করে |
| `!`| যৌক্তিক নয় | `!true`| `false`|
| `??`| শূন্য কোলেসিং | `a ?? b`|`a`শুধুমাত্র`null`/`undefined`হলেই`b`ফেরত দেয় |
| `?.`| ঐচ্ছিক চেইনিং | `obj?.prop?.method()`|`undefined`থেকে শর্ট-সার্কিট |
### বিটওয়াইজ অপারেটর
| অপারেটর | নাম | উদাহরণ | নোট |
|----------|------|---------|-------|
| `&`| এবং | `5 & 3`| `1`|
...
### অ্যাসাইনমেন্ট ও ডিস্ট্রাকচারিং
```javascript
// Basic assignment
let x = 10;
...
|------------|------------|---------------|
| 1 (সর্বোচ্চ) | `()``[]``.``?.` | বাম |
| 2 | `new`(আর্গ ছাড়া) | ঠিক |
| 3 | `++``--` (পোস্টফিক্স) | N/A |
| 4 | `!``~``+x``-x``typeof``void``delete``++` `--`prefix) | ঠিক |
| 5 | `**`| ঠিক |
| 6 | `*``/``%`| বাম |
| 7 | `+``-` | বাম |
| 8 | `<<``>>``>>>`| বাম |
...
## ডেটা স্ট্রাকচার
### অন্তর্নির্মিত সংগ্রহ ওভারভিউ
| সংগ্রহ | আদেশ করা | পরিবর্তনযোগ্য | সদৃশ | কী প্রকার | দেখুন |
|------------|---------|---------|------------|----------|---------|
| `Array`| হ্যাঁ | হ্যাঁ | হ্যাঁ | সূচক (সংখ্যা) | O(n) |
| `Object`| হ্যাঁ (সন্নিবেশ) | হ্যাঁ | কী: না | স্ট্রিং/সিম্বল | O(1) গড় |
| `Map`| হ্যাঁ (সন্নিবেশ) | হ্যাঁ | কী: না | যেকোন | O(1) গড় |
| `Set`| হ্যাঁ (প্রবেশ) | হ্যাঁ | না | — | O(1) গড় |
| `WeakMap`| না | হ্যাঁ | কী: না | অবজেক্ট শুধুমাত্র | O(1) গড় |
| `WeakSet`| না | হ্যাঁ | না | অবজেক্ট শুধুমাত্র | O(1) গড় |
### অ্যারে
```javascript
// Creation
...
### দুর্বল রেফ এবং চূড়ান্তকরণ রেজিস্ট্রি
```javascript
...
## সারাংশ
জাভাস্ক্রিপ্টের সিনট্যাক্স পৃষ্ঠে প্রতারণামূলকভাবে সহজ কিন্তু উল্লেখযোগ্য গভীরতা রয়েছে। ভাষাটি একটি সাধারণ স্ক্রিপ্টিং টুল থেকে ক্লাস, মডিউল, জেনারেটর, প্রক্সি এবং একটি পরিশীলিত অ্যাসিঙ্ক মডেল সহ একটি মাল্টি-প্যারাডাইম ভাষায় বিকশিত হয়েছে। অপারেটরের অগ্রাধিকার বোঝা, ইভেন্ট লুপ, প্রোটোটাইপ চেইন এবং`this`বাইন্ডিংয়ের সূক্ষ্মতা দক্ষ বিকাশকারীদের বিশেষজ্ঞদের থেকে আলাদা করে। আধুনিক জাভাস্ক্রিপ্ট (ES2020+) সাথে ঐচ্ছিক চেইনিং, নালিশ কোলেসিং, `Promise.allSettled`, এবং শীর্ষ-স্তরের অপেক্ষা অনগ্রসর সামঞ্জস্য বজায় রেখে বয়লারপ্লেট কমাতে থাকে।