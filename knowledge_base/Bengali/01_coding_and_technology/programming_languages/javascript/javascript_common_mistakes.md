...
---
# জাভাস্ক্রিপ্ট — সাধারণ ভুল এবং অ্যান্টি-প্যাটার্ন
এই নথিটি জাভাস্ক্রিপ্টের সবচেয়ে সাধারণ ভুল, ফাঁদ এবং অ্যান্টি-প্যাটার্নগুলি ক্যাটালগ করে। প্রতিটি এন্ট্রি ভুল পদ্ধতি দেখায়, ব্যাখ্যা করে কেন এটি ব্যর্থ হয় এবং সঠিক সমাধান প্রদান করে।
---

## 1.`this`বাঁধাই বিভ্রান্তি
```javascript
...
## 3.`var`উত্তোলন এবং সুযোগ সংক্রান্ত সমস্যা
```javascript
...
## 5. প্রতিশ্রুতি প্রত্যাখ্যানগুলি পরিচালনা না করা
```javascript
...
## 6. পুনরাবৃত্তির সময় বস্তু পরিবর্তন করা
```javascript
...
## 7. অ্যান্টি-প্যাটার্ন: কলব্যাক হেল
```javascript
...
## 9. অ্যারের মতো অবজেক্টগুলি অ্যারে নয়
```javascript
...
## 10. অ্যান্টি-প্যাটার্ন: মিউটেটিং ফাংশন প্যারামিটার
```javascript
...
## 11. ইভেন্ট লুপ এবং মাইক্রোটাস্ক না বোঝা
```javascript
...
## 12. অ্যান্টি-প্যাটার্ন:`eval()`ব্যবহার করা
```javascript
...
## 13. ইভেন্ট শ্রোতাদের পরিষ্কার করতে ভুলে যাওয়া
```javascript
// ❌ WRONG — memory leak
class Component {
  mount() {
...
## সারাংশ
জাভাস্ক্রিপ্টের নমনীয়তা ফাঁদের সাথে আসে:`this`বাইন্ডিং কল সাইটের উপর নির্ভর করে,`==`জবরদস্তি করে, প্রতিশ্রুতিতে ত্রুটি পরিচালনার প্রয়োজন হয় এবং ইভেন্ট লুপ অর্ডারিং (ম্যাক্রোটাস্কের আগে মাইক্রোটাস্ক) অ-স্পষ্ট। আধুনিক নিয়মগুলি সহজ:`const`/`let`কখনও`var`ব্যবহার করবেন না,`==`এর চেয়ে`===`পছন্দ করবেন না, সর্বদা প্রতিশ্রুতি প্রত্যাখ্যানগুলি পরিচালনা করুন, কলব্যাকের জন্য তীর ফাংশন ব্যবহার করুন, মিউটেশন এড়ান এবং ইভেন্ট শ্রোতাদের পরিষ্কার করুন৷ এই নিয়মগুলি অনুসরণ করলে জাভাস্ক্রিপ্টের বেশিরভাগ বাগ দূর হয়।