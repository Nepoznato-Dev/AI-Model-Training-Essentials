...
| মডেল | ভাষা | মেকানিজম |
|---------|------------|------------|
| **ব্যতিক্রম (চেষ্টা/ধরা)** | Java, C++, C#, Python, Ruby, PHP, JavaScript, TypeScript, Kotlin, Swift, Dart, Scala, VB, Delphi | `try { } catch (e) { }`|
| **ফলাফল/বিকল্প প্রকার** | মরিচা, হাসকেল, OCaml, Scala (এছাড়াও) | `Result<T, E>`,`Maybe a`|
| **একাধিক রিটার্ন মান** | যাও, লুয়া | `value, err := f()`|
| **ত্রুটি কোড** | C, Fortran | ত্রুটি কোড ফেরত দিন, ম্যানুয়ালি চেক করুন |
| **প্যাটার্ন মিলে যাওয়া ত্রুটি** | এলিক্সির, এরলাং | `{:ok, value}`/`{:error, reason}`|
| **শর্তগুলি (পুনরায় চালু করা যায়)** | কমন লিস্প | `restart-case`,`handler-bind`|
| **কোন ত্রুটি হ্যান্ডলিং** | স্ক্র্যাচ, SQL (বেসিক) | N/A |
| **চুক্তি** | অ্যাডা, আইফেল | `Pre`,`Post`শর্তাবলী |
## ব্যতিক্রম-ভিত্তিক ত্রুটি হ্যান্ডলিং
```python
# Python
try:
    result = 10 / 0
...
## সারাংশ: দৃষ্টান্ত পরিচালনার ত্রুটি
| দৃষ্টান্ত | দৃষ্টিভঙ্গি | পেশাদার | কনস |
|----------|----------|------|------|
| **ব্যতিক্রম** | নিক্ষেপ/ধরা | পরিষ্কার সুখী পথ, স্ট্যাক ট্রেস | ভুলে যাওয়া যায়, নিয়ন্ত্রণ প্রবাহের অপব্যবহার |
| **ফলাফলের ধরন** | রিটার্ন`Ok`/`Err`| স্পষ্ট, ত্রুটি উপেক্ষা করতে পারবেন না | ভার্বোস,`?`অপারেটর প্রয়োজন |
| **ত্রুটি কোড** | int স্থিতি ফেরত | সহজ, সি-সামঞ্জস্যপূর্ণ | উপেক্ষা করা সহজ, কোন প্রসঙ্গ নেই |
| **একাধিক রিটার্ন** | `value, err := f()`| স্পষ্ট, বাজে |`err`চেক করতে ভুলবেন না
| **প্যাটার্ন ম্যাচিং** | `{:ok, v}`/`{:error, r}`| সম্পূর্ণ, কার্যকরী |`with`ছাড়া ভার্বোস |
| **শর্ত** | রিস্টার্টযোগ্য হ্যান্ডলার | সবচেয়ে শক্তিশালী, পুনরুদ্ধারযোগ্য | জটিল, খুব কমই বোঝা যায় |