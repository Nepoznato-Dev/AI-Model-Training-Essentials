...
## 1. ধার পরীক্ষকের সাথে লড়াই করা — অপ্রয়োজনীয় ক্লোনিং
```rust
...
## 3. উৎপাদনে`unwrap()`এর সাথে ফলাফল উপেক্ষা করা
```rust
...
## 5. অ্যান্টি-প্যাটার্ন: সর্বত্র`Rc`/`RefCell`ব্যবহার করা
```rust
...
## 6. মুভ শব্দার্থবিদ্যা বোঝা যাচ্ছে না
```rust
...
## 7. অ্যান্টি-প্যাটার্ন: অতিরিক্ত`to_string()`/ `to_owned()`
```rust
...
## 9. ইটারেটর ইনভালিডেশন — অপ্রয়োজনীয়ভাবে সংগ্রহ করা
```rust
...
## 10. অ্যান্টি-প্যাটার্ন: পদ্ধতি ছাড়া এনাম
```rust
...
## 11. সাধারণ বৈশিষ্ট্যের জন্য`#[derive]`ব্যবহার করা হচ্ছে না
```rust
...
## 12. ডকুমেন্টেশন ছাড়াই অনিরাপদ কোড
```rust
...
## সারাংশ
মরিচা এর কম্পাইলার কঠোর কিন্তু ন্যায্য - বেশিরভাগ ত্রুটি আপনাকে মেমরি নিরাপত্তা সম্পর্কে কিছু শেখায়। সবচেয়ে বড় ভুলগুলি কম্পাইলার ত্রুটি নয় বরং অ্যান্টি-প্যাটার্নস: ধার পরীক্ষককে খুশি করার জন্য অপ্রয়োজনীয় ক্লোনিং, উৎপাদনে`unwrap()`ব্যবহার করা, মালিকানা চেষ্টা করার আগে `Rc<RefCell<T>>`-এ পৌঁছানো এবং রেফারেন্স যথেষ্ট হলে স্ট্রিংগুলি বরাদ্দ করা৷ রাস্টেসিয়ান মানসিকতা হল: কম্পাইলার আপনাকে শূন্য-খরচ বিমূর্ততার দিকে গাইড করতে দিন। প্রয়োজনে শুধুমাত্র ক্লোন করুন,`?`দিয়ে ত্রুটিগুলি প্রচার করুন,`String`এর চেয়ে`&str`পছন্দ করুন এবং প্রতিটি`unsafe`ব্লককে নথিভুক্ত করুন৷