...
# মরিচা — ইডিওম্যাটিক প্যাটার্ন এবং সর্বোত্তম অভ্যাস
এই গাইডটি পরিষ্কার, নিরাপদ মরিচা কোড লেখার জন্য বাহাদুরি প্যাটার্ন এবং সর্বোত্তম অনুশীলনগুলি কভার করে।
---
...
## সারাংশ
মরিচা বাগধারা জোর দেয়: মালিকানা এবং ধার, ত্রুটি পরিচালনার জন্য`Result`/ `Option`, পদ্ধতি সহ enums, বিমূর্ততার জন্য বৈশিষ্ট্য, পুনরাবৃত্তিকারী চেইনিং, শেয়ার করা অবস্থার জন্য স্মার্ট পয়েন্টার এবং শূন্য-খরচ বিমূর্তকরণ। ফরম্যাটিং এর জন্য `rustfmt`, লিন্টিং এর জন্য`clippy`এবং রাস্ট API নির্দেশিকা অনুসরণ করুন৷ মরিচা সম্প্রদায় নিরাপত্তা, কর্মক্ষমতা এবং সঠিকতাকে মূল্য দেয় - "যদি এটি সংকলন করে তবে এটি কাজ করে।" ফাংশন আর্গুমেন্টে`String`এর চেয়ে`&str`পছন্দ করুন, ত্রুটি প্রচারের জন্য`?`ব্যবহার করুন এবং`#[derive(Debug, Clone, ...)]`দিয়ে সাধারণ বৈশিষ্ট্যগুলি বের করুন।