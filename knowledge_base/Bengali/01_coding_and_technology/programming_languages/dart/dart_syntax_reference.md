...
|----------|------|---------|-------|
| `+``-``*``/``%``~/` | পাটিগণিত | `7 ~/ 3`| `~/`হল পূর্ণসংখ্যা বিভাগ |
| `==``!=` | সমতা | `a == b`| |
| `<``>``<=``>=` | তুলনা | `a >= b`| |
| `&&``\|\|``!`| যৌক্তিক | `a && b`| শর্ট সার্কিট |
| `??`| নাল কোলেসিং | `a ?? b`| `b`যদি`a`শূন্য হয় |
| `?.`| শূন্য-সচেতন অ্যাক্সেস | `a?.b`|`a`শূন্য হলে null |
| `!`| শূন্য দাবী | `a!`| ছুড়ে দেয় যদি শূন্য |
| `..``?..` | ক্যাসকেড | `obj..a..b`| একই বস্তুর উপর চেইন অপারেশন |
| `??=`| শূন্য-সচেতন বরাদ্দ | `a ??= b`| শূন্য থাকলে বরাদ্দ করুন |
| `as`| টাইপ কাস্ট | `obj as String`| ব্যর্থতার উপর নিক্ষেপ |
| `is``is!` | টাইপ টেস্ট | `obj is String`| |
| `=>`| তীর ফাংশন | `() => expr`| |
### ক্যাসকেড স্বরলিপি
```dart
...
## এক্সটেনশন পদ্ধতি এবং প্যাটার্ন
```dart
// Extension methods
...
## সারাংশ
ডার্টের সিনট্যাক্স পরিষ্কার, সামঞ্জস্যপূর্ণ এবং উত্পাদনশীলতার জন্য ডিজাইন করা হয়েছে। সাউন্ড নাল সেফটি কম্পাইলের সময় নাল রেফারেন্স ত্রুটি দূর করে। অ্যাসিঙ্ক/অপেক্ষা এবং স্ট্রিমগুলি অ্যাসিঙ্ক্রোনাস প্রোগ্রামিংয়ের জন্য প্রাকৃতিক নিদর্শন সরবরাহ করে। ক্লাস, মিক্সিন এবং সিল করা ক্লাসগুলি নমনীয় বস্তুর রচনাকে সক্ষম করে। Dart 3 এর প্যাটার্ন ম্যাচিং, রেকর্ড এবং ক্লাস মডিফায়ারগুলি অভিব্যক্তি যোগ করে। যদিও ডার্টের প্রাথমিক উদ্দেশ্য হল ফ্লটার, এর সিনট্যাক্স যেকোনো অ্যাপ্লিকেশন ডোমেনের জন্য উপযুক্ত - সার্ভার-সাইড (ডার্ট ফ্রগ বা শেল্ফ সহ), CLI টুলস এবং ওয়েব অ্যাপ্লিকেশন (জাভাস্ক্রিপ্টে সংকলিত)।