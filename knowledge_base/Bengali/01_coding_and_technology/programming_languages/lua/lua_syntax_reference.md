...
| `//`| মেঝে বিভাগ | `7 // 2`| রিটার্ন 3 (Lua 5.3+) |
| `==``~=` | সমতা | `a == b`| `~=`হল "সমান নয়" |
| `<``>``<=``>=` | তুলনা | `a >= b`| |
| `and``or``not`| যৌক্তিক | `a and b`| অপারেন্ড ফেরত দেয়, বুলিয়ান নয় |
| `..`| সংযুক্তি | `"hello" .. " world"`| |
| `#`| দৈর্ঘ্য | `#t`| স্ট্রিং বা টেবিলের দৈর্ঘ্য |
| `&``\|``~``<<``>>`| বিটওয়াইজ | `a & b`| Lua 5.3+ (পূর্ণসংখ্যা অপস) |
### লজিক্যাল অপারেটর — নন-বুলিয়ান রিটার্ন
```lua
...
### অগ্রাধিকার (সর্বোচ্চ থেকে সর্বনিম্ন)
| অগ্রাধিকার | অপারেটর |
|------------|------------|
| 1 (সর্বোচ্চ) | `^`|
| 2 | `not``#``-`(ইউনারি) |
...
## সারণী — সর্বজনীন ডেটা স্ট্রাকচার
```lua
...
## সারাংশ
লুয়ার সিনট্যাক্স ইচ্ছাকৃতভাবে ন্যূনতম — সমগ্র ভাষা একটি একক পৃষ্ঠায় বর্ণনা করা যেতে পারে। টেবিল সার্বজনীন ডেটা কাঠামো (অ্যারে, অভিধান, বস্তু, মডিউল) হিসাবে কাজ করে। মেটাটেবল ভাষা জটিলতা ছাড়াই এক্সটেনসিবিলিটি প্রদান করে। Coroutines সমবায় মাল্টিটাস্কিং এবং মার্জিত পুনরাবৃত্তি প্যাটার্ন সক্ষম করে। ভাষার শক্তি তার এম্বেডযোগ্যতা থেকে আসে: লুয়া হোস্ট অ্যাপ্লিকেশনের ভিতরে থাকার জন্য ডিজাইন করা হয়েছে, ন্যূনতম ওভারহেড সহ স্ক্রিপ্টিং ক্ষমতা প্রদান করে। গেম ডেভেলপমেন্ট, কনফিগারেশন, এবং এমবেডেড সিস্টেমের জন্য, লুয়ার সরলতা হল এর সবচেয়ে বড় শক্তি — একটি ছোট ভাষা যা ঠিক যা করতে হবে তা করে এবং এর বেশি কিছু নয়।