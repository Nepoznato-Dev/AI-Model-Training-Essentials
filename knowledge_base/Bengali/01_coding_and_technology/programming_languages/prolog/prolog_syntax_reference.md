...
---
# প্রোলগ — সিনট্যাক্স রেফারেন্স
এই নথিটি প্রোলগের জন্য একটি ব্যাপক, কাঠামোগত সিনট্যাক্স রেফারেন্স প্রদান করে। এটি সম্পূর্ণ সিনট্যাক্স প্যাটার্ন, ইউনিফিকেশন, ব্যাকট্র্যাকিং, ডিসিজি এবং লজিক প্রোগ্রামিং ইডিয়মগুলিতে ফোকাস করে প্রধান প্রোলগ রেফারেন্সের পরিপূরক।
---
...
## সারাংশ
Prolog এর সিনট্যাক্স ন্যূনতম — তথ্য, নিয়ম এবং প্রশ্ন। শক্তি একীকরণ এবং ব্যাকট্র্যাকিং থেকে আসে, যা লজিক্যাল সমাধানের জন্য ভাষাটিকে একটি সার্চ ইঞ্জিনে পরিণত করে। DCGs মার্জিত পার্সার প্রজন্ম প্রদান. তালিকায় মাথা/টেইল প্যাটার্ন ম্যাচিং ব্যবহার করা হয়। সীমাবদ্ধতা সন্তুষ্টি, বিশেষজ্ঞ সিস্টেম এবং প্রতীকী গণনার জন্য, Prolog-এর ঘোষণামূলক পদ্ধতি এমন সমস্যাগুলি সমাধান করে যা অত্যাবশ্যক ভাষাগুলিতে ভার্বস।