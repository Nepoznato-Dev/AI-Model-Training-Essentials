...
## ম্যাক্রো এবং শর্তসাপেক্ষ সমাবেশ
```nasm
; === NASM Macros ===
...
## সারাংশ
সমাবেশ ভাষা সিনট্যাক্স প্রসেসর আর্কিটেকচার এবং অ্যাসেম্বলার (NASM, GAS, MASM) দ্বারা সংজ্ঞায়িত করা হয়। x86-64 16টি সাধারণ-উদ্দেশ্য রেজিস্টার, একাধিক অ্যাড্রেসিং মোড, এবং ডেটা চলাচল, গাণিতিক, যুক্তি, নিয়ন্ত্রণ প্রবাহ, SIMD এবং সিস্টেম কলগুলি বিস্তৃত শত শত নির্দেশ প্রদান করে। এখানে ব্যবহৃত NASM সিনট্যাক্স লিনাক্স x86-64 বিকাশের জন্য সবচেয়ে সাধারণ। মাষ্টারিং অ্যাসেম্বলির জন্য রেজিস্টার, স্ট্যাক, কলিং কনভেনশন এবং মেশিনের নির্দেশাবলীতে কীভাবে উচ্চ-স্তরের মানচিত্র তৈরি করে তা বোঝার প্রয়োজন।