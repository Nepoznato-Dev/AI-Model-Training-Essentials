---
# البيانات الوصفية
العنوان: "الثغرات الأمنية"
الوصف: "الثغرات الأمنية الشائعة"
...
# التصنيف
العلامات: [الأمان، نقاط الضعف، الدروس المستفادة من الفشل]
مستوى الصعوبة: "متقدم"
المتطلبات الأساسية: []
...
2. **التحقق من صحة الإدخال**: رفض المدخلات الضارة أو تطهيرها
3. **سياسة أمان المحتوى**: استخدم رؤوس CSP لتقييد مصادر البرامج النصية
4. ** ملفات تعريف الارتباط الخاصة بـ HTTP فقط **: تمنع وصول JavaScript إلى ملفات تعريف الارتباط الخاصة بالجلسة
...
## موضوعات ذات صلة
- **حالات فشل الذكاء الاصطناعي/LLM**: راجع`ai_llm_failures.md`للاطلاع على المعلومات الفورية ومشكلات الأمان الخاصة بالذكاء الاصطناعي
...
**السبب الجذري:**
- تم اختراق بيانات اعتماد بائع الطرف الثالث
...
**Lesson:** Segment networks; monitor third-party access; الرد على التنبيهات.
