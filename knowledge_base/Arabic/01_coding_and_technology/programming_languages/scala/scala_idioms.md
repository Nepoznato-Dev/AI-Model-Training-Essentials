...
# سكالا – الأنماط الاصطلاحية وأفضل الممارسات
يغطي هذا الدليل الأنماط الاصطلاحية وأفضل الممارسات لكتابة كود Scala 3 النظيف والوظيفي.
---
...
## ملخص
تؤكد مصطلحات Scala على: الثبات (`val`)، ومطابقة الأنماط، والأنواع المختومة، والخيار/إما للسلامة، والفهم، والمجموعات الوظيفية، وفئات الكتابة (المقدمة/الاستخدام في Scala 3). اتبع دليل نمط Scala، واستخدم scalafmt للتنسيق، وscalafix للفحص. إن بناء الجملة الأنظف والتعدادات والأنواع غير الشفافة وطرق الامتداد في Scala 3 تجعل اللغة أكثر سهولة مع الاحتفاظ بقوتها الوظيفية.