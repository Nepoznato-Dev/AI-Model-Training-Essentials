...
## ملخص
تؤكد مصطلحات Shell على: `set -euo pipefail`، والاقتباس من المتغيرات، و`[[ ]]` عبر `[ ]`، وتوسيع المعلمة، ومصائد التنظيف. تؤكد مصطلحات PowerShell على: CmdletBinding، ومعالجة خطوط الأنابيب، والرش، ومعالجة الأخطاء المنظمة. اتبع ShellCheck لـ Bash وPSScriptAnalyzer لـ PowerShell.