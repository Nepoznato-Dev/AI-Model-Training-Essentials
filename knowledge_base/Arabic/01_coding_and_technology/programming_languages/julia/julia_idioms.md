...
## ملخص
تؤكد مصطلحات جوليا على: ثبات النوع، والإرسال المتعدد، والبث باستخدام `.`، والفهم، والأداء من خلال الأنواع الملموسة. اتبع دليل Julia Style Guide، واستخدم JuliaFormatter للتنسيق، وJET لتحليل استنتاج النوع. تقدر جوليا "اجعلها سريعة بشكل افتراضي" - اكتب تعليمات برمجية نظيفة واترك مترجم JIT يقوم بالتحسين.