...
-->
# OCaml — الأخطاء الشائعة والأنماط المضادة
يقوم هذا المستند بفهرسة الأخطاء والفخاخ والأنماط المضادة الأكثر شيوعًا في OCaml مع التصحيحات.
---

## 1. مطابقة الأنماط غير الشاملة
```ocaml
(* ❌ WRONG — missing cases *)
...
## 4. عدم استخدام`Option`بشكل صحيح
```ocaml
...
## 5. الحالة المتغيرة في الدوال العودية
```ocaml
...
## ملخص
مصائد OCaml: مطابقة الأنماط غير الشاملة (يحذر المترجم)،`=`هي المساواة الهيكلية بينما`==`مادية، ويتم اقتطاع تقسيم الأعداد الصحيحة، واستخدام`Option`بدلاً من الاستثناءات، وتجنب الحالة القابلة للتغيير لصالح عودية الذيل والطيات. مترجم OCaml هو حليفك – انتبه لتحذيراته.