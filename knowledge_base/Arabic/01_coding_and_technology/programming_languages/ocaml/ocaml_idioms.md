...
-->
# OCaml — الأنماط الاصطلاحية وأفضل الممارسات
يغطي هذا الدليل الأنماط الاصطلاحية لكتابة تعليمات برمجية OCaml نظيفة واصطلاحية.
---
...
## ملخص
تؤكد مصطلحات OCaml على: مطابقة الأنماط الشاملة، والوحدات والوظائف للتجريد، والنتيجة/الخيار للسلامة، ومشغل الأنبوب الأول (`|>`). اتبع`ocamlformat`للتنسيق و`ocaml-lsp` لدعم IDE. قيم OCaml سلامة النوع والدقة الرياضية.