...
# البيانات الوصفية
العنوان: "البرولوج"
الوصف: "مرجع شامل للغة برمجة Prolog يغطي النظرة العامة والمقايضات وأساسيات بناء الجملة والنظام البيئي ومتى يتم استخدامها."
...
# التصنيف
العلامات: [البروغ، لغة البرمجة، بناء الجملة، النظام البيئي، الترميز والتكنولوجيا]
مستوى الصعوبة: "متقدم"
المتطلبات الأساسية: []
وقت_القراءة المقدر: "25 دقيقة"
# دليل المساهمة
المساهمة:
  الترخيص: "MIT"
...
| التوحيد الخاطئ | المتغيرات مرتبطة بشكل غير صحيح | استخدم __محمي_1__ للاختبار؛ تحقق من وظيفة العامل |
| مشكلة الأداء | تنفيذ بطيء | إضافة تخفيضات. استخدم __محمي_2__ ؛ تحقق من نقاط الاختيار |
---
...
| ** مدير الحزم ** |  __محمي_0__ | لا شيء | نبم |
