...
### الواجهات والأسماء المستعارة للأنواع
```typescript
...
## أنواع المرافق
### أنواع الأدوات المساعدة المضمنة
```typescript
interface User {
  id: string;
  name: string;
...
## أدوات الديكور (TC39 المرحلة 3 / TypeScript 5.0+)
```typescript
// Class decorator
...
## ملخص
نظام الكتابة الخاص بـ TypeScript هو السمة المميزة له، وهو عميق بشكل ملحوظ. بدءًا من التعليقات التوضيحية الأساسية وحتى الأنواع العامة والأنواع الشرطية والأنواع المعينة والأنواع الحرفية للقالب و`infer`، يعد نظام الكتابة في الأساس لغة وظيفية تعمل في وقت الترجمة. إن فهم التفاعل بين`interface`و`type`، والأدوية العامة مقابل أنواع الأدوات المساعدة، والكتابة الهيكلية مقابل الكتابة الاسمية يدعم كتابة TypeScript الآمنة والمريحة. تستمر اللغة في التطور، حيث يضيف كل إصدار المزيد من القوة التعبيرية مع الحفاظ على التوافق الكامل مع الإصدارات السابقة مع JavaScript.