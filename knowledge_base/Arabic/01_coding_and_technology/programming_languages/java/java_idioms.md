...
## ملخص
تؤكد مصطلحات Java الحديثة على: سجلات البيانات، والفئات المختومة للتسلسلات الهرمية، ومطابقة الأنماط، وتعبيرات التبديل، وكتل النص، وتدفقات معالجة المجموعة، واختياري للغياب، وتجربة الموارد للتنظيف، والخيوط الافتراضية للتزامن، وحقن التبعية. اتبع دليل Google Java Style Guide، واستخدم`javafmt`أو`Spotless`للتنسيق، وError Prone أو Checkstyle لإجراء الفحص. Java الحديثة (17-21+) مع السجلات والفئات المختومة ومطابقة الأنماط والخيوط الافتراضية موجزة ومعبرة - تتضمن الميزات الجديدة.