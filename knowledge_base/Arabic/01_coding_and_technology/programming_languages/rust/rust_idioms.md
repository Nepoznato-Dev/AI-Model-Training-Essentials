...
## ملخص
تؤكد التعابير الصدئة على: الملكية والاقتراض، و`Result` /`Option`لمعالجة الأخطاء، والتعدادات مع الأساليب، وسمات التجريد، وتسلسل التكرار، والمؤشرات الذكية للحالة المشتركة، والتجريدات ذات التكلفة الصفرية. اتبع`rustfmt`للتنسيق، و`clippy` للفحص، وإرشادات Rust API. يقدر مجتمع Rust السلامة والأداء والصحة - "إذا تم تجميعه، فإنه يعمل". قم بتفضيل`&str`على`String`في وسيطات الوظائف، واستخدم`?`لنشر الأخطاء، واشتق السمات المشتركة باستخدام`#[derive(Debug, Clone, ...)]`.