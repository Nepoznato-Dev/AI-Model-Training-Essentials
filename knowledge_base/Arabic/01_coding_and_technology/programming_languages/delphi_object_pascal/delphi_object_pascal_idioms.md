...
# دلفي / كائن باسكال - الأنماط الاصطلاحية وأفضل الممارسات
يغطي هذا الدليل الأنماط الاصطلاحية لكتابة كود دلفي وObject Pascal النظيف.
---

## إدارة الموارد باستخدام المحاولة/الأخيرة
```delphi
...
## ملخص
تؤكد مصطلحات دلفي على:`try/finally`لتنظيف الموارد الحتمية، و`Format` لبناء السلسلة، والواجهات للاقتران غير المحكم، وسجلات حاملات البيانات، ومعالجة الاستثناءات المحددة، والميزات الحديثة مثل الأدوية العامة والأساليب المجهولة. تقدر دلفي إدارة الموارد بشكل صريح - "قم بإنشائها، واستخدامها، وتحريرها أخيرًا."