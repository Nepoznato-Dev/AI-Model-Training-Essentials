...
# المقارنة بين اللغات — عمليات الإدخال/الإخراج والملفات
## إخراج وحدة التحكم
| اللغة | طباعة إلى stdout |
|----------|----------------|
| بايثون | `print("Hello")`|
| جافا سكريبت | `console.log("Hello")`|
| الصدأ | `println!("Hello")`|
| اذهب | `fmt.Println("Hello")`|
| جافا | `System.out.println("Hello")`|
| ج | `printf("Hello\n")`|
| سي++ | `std::cout << "Hello" << std::endl`|
| ج # | `Console.WriteLine("Hello")`|
| روبي | `puts "Hello"`|
| سويفت | `print("Hello")`|
| كوتلين | `println("Hello")`|
| PHP | `echo "Hello\n"`|
| تايب سكريبت | `console.log("Hello")`|
| هاسكل | `putStrLn "Hello"`|
| سكالا | `println("Hello")`|
| ص | `cat("Hello\n")`|
| جوليا | `println("Hello")`|
| بيرل | `say "Hello"`|
...
| ماتلاب | `disp('Hello')`|
| دارت | `print('Hello')`|
| برولوج | `write('Hello'), nl.`|
| اللثغة | `(format t "Hello~%")`|
| الإكسير | `IO.puts("Hello")`|
| إرلانج | `io:format("Hello~n")`|
| أوكامل | `print_endline "Hello"`|
| ادا | `Put_Line("Hello")`|
| كوبول | `DISPLAY 'Hello'`|
| فورتران | `print *, 'Hello'`|
| الجمعية | `syscall`(اكتب إلى fd 1) |
| دلفي | `WriteLn('Hello')`|
| سكراتش | `say [Hello]`|
| VB | `Console.WriteLine("Hello")`|
| شل | `echo "Hello"`|
| SQL | N/A (إرجاع مجموعات النتائج) |
## قراءة ملف
```python
# Python
