...
# Erlang & Elixir — الأنماط الاصطلاحية وأفضل الممارسات
يغطي هذا الدليل الأنماط الاصطلاحية لـ Erlang وElixir على BEAM VM.
---
...
## ملخص
تؤكد مصطلحات Elixir على: مشغل الأنابيب، ومطابقة الأنماط، و`with` لتسلسل الأخطاء، ومواصفات نوع `@spec`. تؤكد مصطلحات Erlang على: مطابقة الأنماط، وفهم القائمة، واستدعاءات gen_server، وفلسفة "دعها تتعطل". كلاهما يقدر الثبات، وتمرير الرسائل، والتسامح مع الخطأ.