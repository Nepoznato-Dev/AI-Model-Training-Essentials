...
# البيانات الوصفية
العنوان: "C#"
description: "مرجع شامل للغة البرمجة C# يغطي النظرة العامة والمقايضات وأساسيات بناء الجملة والنظام البيئي ومتى يتم استخدامها."
...
# التصنيف
العلامات: [csharp، لغة البرمجة، بناء الجملة، النظام البيئي، الترميز والتكنولوجيا]
مستوى الصعوبة: "متوسط"
المتطلبات الأساسية: []
...
- **LINQ**: يتيح لك الاستعلام المدمج باللغة أن تكتب استعلامات تشبه SQL مباشرة في C# مقابل أي مصدر بيانات.
##المقايضات
...
|---------|------|-------------|
| ج#7 | 2017 | مطابقة الأنماط، الصفوف، متغيرات `out`، الوظائف المحلية |
| ج#8 | 2019 | أنواع المراجع الخالية، وتعبيرات `switch`، والتدفقات غير المتزامنة |
| ج#9 | 2020 | **السجلات**، بيانات المستوى الأعلى، __محمي_2__ خصائص |
| ج#10 | 2021 | بنيات التسجيل،`using`العامة، ومساحات الأسماء ذات نطاق الملف |
| ج#11 | 2022 | حرفية السلسلة الأولية، أنماط القائمة،`required`الأعضاء، الرياضيات العامة |
| ج#12 | 2023 | المنشئون الأساسيون، تعبيرات المجموعة، المصفوفات المضمنة |
| ج#13 | 2024 |  __محمي_5__ مجموعات، أنواع أقفال جديدة، امتدادات من الدرجة الأولى |
---
...
| سطح المكتب عبر الأنظمة الأساسية | أفالونيا أو ماوي | الإلكترون (على شبكة الإنترنت) |
...
## ملخص
C# هي لغة مصقولة وحديثة ذات أغراض عامة مع أدوات ممتازة ونظام بيئي قوي. إنه يتفوق في تطوير المؤسسات، وتطوير الألعاب (Unity)، والتطبيقات عبر الأنظمة الأساسية. لقد تطورت اللغة بسرعة - أصبحت لغة C# الحديثة موجزة ومعبرة وآمنة للكتابة. على الرغم من أنها لا تتمتع بحجم النظام البيئي الذي تتمتع به Java أو Python، إلا أن جودة .NET واتساقها يجعلان لغة C# لغة منتجة وممتعة لمجموعة واسعة من التطبيقات.