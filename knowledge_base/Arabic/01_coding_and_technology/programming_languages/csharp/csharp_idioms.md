...
يغطي هذا الدليل الأنماط الاصطلاحية وأفضل الممارسات لكتابة كود C# (12+) النظيف والحديث.
---
...
## ملخص
تؤكد مصطلحات C# الحديثة على: سجلات البيانات، ومطابقة الأنماط، والسلامة الخالية (أنواع مرجعية لاغية)، وLINQ للمجموعات، والمزامنة/الانتظار باستخدام CancellationToken، وحقن التبعية، والمنشئات الأساسية، وتعبيرات المجموعة، وإعلانات `using`. اتبع اتفاقيات البرمجة C#، واستخدم`dotnet format`للتنسيق، ومحللات Roslyn لجودة التعليمات البرمجية. تتميز لغة C# الحديثة (12+) بأنها موجزة ومعبرة، وتتضمن السجلات ومطابقة الأنماط والمنشئات الأساسية.