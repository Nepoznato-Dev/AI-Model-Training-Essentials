...
# فورتران - مرجع بناء الجملة
توفر هذه الوثيقة مرجعًا شاملاً ومنظمًا لصيغة Modern Fortran (2008/2018). وهو يكمل مرجع Fortran الرئيسي من خلال التركيز على أنماط بناء الجملة الشاملة، وعمليات المصفوفة، والوحدات النمطية، وOOP، والحوسبة عالية الأداء.
---
...
|----------|------|--------|-------|
| `+``-``*``/``**`| حسابية | `2**10`| `**`هو الأس |
| `==``/=` | المساواة | `a == b`| `/=`"غير متساوٍ" |
| `<``>``<=``>=` | مقارنة | `a >= b`| |
| `.and.``.or.``.not.`| منطقي | `a .and. b`| |
| `.eqv.``.neqv.` | التكافؤ المنطقي | `a .eqv. b`| |
| `//`| تسلسل السلسلة | `'hello' // ' world'`| |
---
...
## ملخص
إن بناء جملة Fortran الحديث نظيف ومنظم ومُحسّن للحسابات الرقمية. تقوم عمليات المصفوفة بإزالة الحلقات لمعظم المهام الرياضية. توفر الوحدات التغليف وإدارة مساحة الاسم. تتيح ميزات OOP (الأنواع المشتقة، والوراثة، وتعدد الأشكال) تنظيمًا نظيفًا للتعليمات البرمجية. تقدم Coarrays برمجة متوازية أصلية بدون مكتبات خارجية. تظل نقاط قوة Fortran - الأداء، وعمليات المصفوفة، والدقة الرقمية - لا مثيل لها في الحوسبة العلمية. بالنسبة للحوسبة عالية الأداء، والفيزياء الحاسوبية، والمحاكاة الهندسية، لا تزال فورتران تمثل مركزًا قويًا.