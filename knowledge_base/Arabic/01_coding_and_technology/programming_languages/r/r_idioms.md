...
# R — الأنماط الاصطلاحية وأفضل الممارسات
يغطي هذا الدليل الأنماط الاصطلاحية وأفضل الممارسات لكتابة كود R الاصطلاحي النظيف.
---
...
## ملخص
تؤكد مصطلحات R على: التوجيه (تجنب الحلقات)، والأنابيب المرتبة (`|>`)، و`<-` للتخصيص، وتسمية حالة الأفعى، والبرمجة الوظيفية باستخدام `purrr`. اتبع دليل نمط Tidyverse، واستخدم lintr للفحص، والمصمم للتنسيق. قيم R للعمليات الموجهة والأنابيب لتحويلات البيانات القابلة للقراءة.