...
# اذهب - مرجع بناء الجملة
توفر هذه الوثيقة مرجعًا شاملاً ومنظمًا لصيغة Go. إنه يكمل مرجع Go الرئيسي من خلال التركيز على أنماط بناء الجملة الشاملة، وجداول المشغلين، والآليات الداخلية لـ goroutines، والقنوات، والواجهات.
---
...
| `-`| الطرح | `3 - 2`| `1`| |
| `*`| الضرب | `3 * 2`| `6`| |
| `/`| شعبة | `7 / 2`| `3`| قسمة عدد صحيح لـ ints |
| `%`| الباقي | `7 % 2`| `1`| التوقيع يطابق الأرباح |
| `&`| Bitwise و | `5 & 3`| `1`| |
| `\|`| Bitwise أو | `5 \| 3`| `7`| |
| `^`| XOR بالبت | `5 ^ 3`| `6`| أيضًا مكمل للبت (أحادي) |
| `&^`| واضح بعض الشيء (وليس) | `5 &^ 3`| `4`| فريدة من نوعها للذهاب |
| `<<`| التحول الأيسر | `5 << 1`| `10`| |
| `>>`| التحول الأيمن | `5 >> 1`| `2`| |
### عوامل المقارنة
| المشغل | الاسم | مثال | ملاحظات |
|----------|------|--------|-------|
| `==`| متساوي | `x == y`| الأنواع المماثلة فقط |
| `!=`| غير متساويين | `x != y`| |
| `<`,`>`,`<=`,`>=`| الطلب | `x >= y`| مقارنة السلاسل المعجمية |
### العوامل المنطقية
| المشغل | الاسم | مثال | ملاحظات |
|----------|------|--------|-------|
...
## ملخص
بناء جملة Go بسيط عمدًا - لا يوجد وراثة، ولا يوجد تحميل زائد للطرق، ولا استثناءات، ولا وحدات ماكرو. ما تبقى هو مجموعة نظيفة ومتعامدة من البنيات: بنيات وواجهات للتكوين، وgoroutines وقنوات للتزامن، ومعالجة الأخطاء الصريحة من أجل الموثوقية. إن قوة اللغة لا تأتي من بناء الجملة المعقد، بل من التفاعل الأنيق بين بداياتها البسيطة. تضيف الأدوية العامة (Go 1.18+) مرونة في الكتابة دون التضحية بالوضوح المميز لـ Go.