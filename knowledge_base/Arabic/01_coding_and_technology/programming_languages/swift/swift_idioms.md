...
# سويفت — الأنماط الاصطلاحية وأفضل الممارسات
يغطي هذا الدليل الأنماط الاصطلاحية وأفضل الممارسات لكتابة كود Swift نظيف.
---
...
## ملخص
تؤكد التعابير السريعة على: الأمان (الاختيارات، الحماية)، أنواع القيم (البنيات)، التصميم الموجه للبروتوكول، مطابقة الأنماط، عدم التزامن/الانتظار، والثبات (`let` افتراضيًا). اتبع إرشادات تصميم Swift API، واستخدم SwiftLint لجودة التعليمات البرمجية، وSwiftFormat للتنسيق. يقدر Swift السلامة والتعبير - "إذا تم تجميعه، فمن المحتمل أن يكون صحيحًا."