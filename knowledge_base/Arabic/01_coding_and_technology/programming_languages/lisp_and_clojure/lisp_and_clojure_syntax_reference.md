...
## ملخص
يتم وضع قوسين بشكل موحد في بناء جملة Clojure - كل نموذج عبارة عن قائمة. تعمل هذه التماثلية على تمكين وحدات الماكرو القوية التي تحول التعليمات البرمجية إلى بيانات. توفر هياكل البيانات المستمرة الثبات مع المشاركة الهيكلية لتحقيق الكفاءة. تعمل وحدات الماكرو الترابطية على إنشاء خطوط أنابيب بيانات قابلة للقراءة. تتعامل العناصر الأولية المتزامنة (الذرات والمراجع والوكلاء والقنوات) مع تغييرات الحالة بأمان. إن تأثير Lisp/Clojure على البرمجة الحديثة هائل، فجمع البيانات المهملة، وREPLs، ووحدات الماكرو، والبرمجة الوظيفية كلها تعود إلى Lisp.