...
## ملخص
تؤكد المصطلحات Clojure على: البيانات غير القابلة للتغيير، ووحدات الماكرو الترابطية (`->`، `->>`)، والتدمير، والكلمات الرئيسية كوظائف، والمواصفات للتحقق من الصحة. تؤكد مصطلحات Lisp الشائعة على:`with-open`للموارد، و`push` /`nreverse`لبناء القائمة، والقيم المتعددة. كلاهما يقدران التماثلية والتنمية التي تعتمد على REPL.