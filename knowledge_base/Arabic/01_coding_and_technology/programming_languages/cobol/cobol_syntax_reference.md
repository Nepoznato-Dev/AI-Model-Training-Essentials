...
---
# كوبول - مرجع بناء الجملة
توفر هذه الوثيقة مرجعًا شاملاً ومنظمًا لصيغة COBOL (2014+). وهو يكمل مرجع COBOL الرئيسي من خلال التركيز على أنماط بناء الجملة الشاملة وأوصاف البيانات ومعالجة الملفات ومنطق الأعمال.
---
...
## ملخص
بناء جملة COBOL مطول حسب التصميم - كل عبارة تُقرأ مثل اللغة الإنجليزية. تحدد أوصاف البيانات مع عبارات PIC تنسيقات الحقول بدقة. يفرض الهيكل المكون من أربعة أقسام الفصل بين الاهتمامات. معالجة الملفات مدمجة في اللغة. بالنسبة لمعالجة بيانات الأعمال، يظل الحساب العشري والإدخال/الإخراج الموجه نحو السجلات في COBOL لا مثيل لهما. إن فهم لغة COBOL يعني فهم أساس حوسبة المؤسسات.