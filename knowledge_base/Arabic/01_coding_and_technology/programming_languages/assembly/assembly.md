...
# البيانات الوصفية
العنوان: لغة التجميع
الوصف: "مرجع شامل للغة برمجة التجميع يغطي النظرة العامة والمقايضات وأساسيات بناء الجملة والنظام البيئي ومتى يتم استخدامها."
...
# التصنيف
العلامات: [التجميع، لغة البرمجة، بناء الجملة، النظام البيئي، الترميز والتكنولوجيا]
مستوى الصعوبة: "متقدم"
المتطلبات الأساسية: []
...
---
#لغة التجميع
لغة التجميع هي أدنى لغة برمجة يمكن قراءتها بواسطة الإنسان. فهو يوفر تمثيلاً مباشرًا لتعليمات كود جهاز الكمبيوتر باستخدام رموز ذاكري (مثل `MOV`، `ADD`،`JMP`) بدلاً من الثنائي الخام. كل لغة تجميع خاصة ببنية معالج معينة (x86، ARM، MIPS، RISC-V) - لن يتم تشغيل التعليمات البرمجية المكتوبة لبنية واحدة على بنية أخرى.
...
|------|--------------|-------------|
| **فوري** |  __محمي_0__ | المعامل هو قيمة ثابتة |
| **التسجيل** |  __محمي_1__ | المعامل موجود في السجل |
| **مباشر** |  __محمي_2__ | المعامل موجود على عنوان ذاكرة ثابت |
| **التسجيل غير المباشر** |  __محمي_3__ | المعامل موجود على العنوان الموجود في السجل |
| **القاعدة + الإزاحة** |  __محمي_4__ | العنوان = التسجيل + الإزاحة الثابتة |
| **مؤشر مُقاس** |  __محمي_5__ | العنوان = الأساس + (الفهرس × المقياس) |
| ** كامل SIB ** |  __محمي_6__ | القاعدة + (المؤشر × المقياس) + الإزاحة |
```nasm
...
| **الأمن** | تطوير برامج الاستغلال، تحليل البرمجيات الخبيثة، الهندسة العكسية | الطريقة الوحيدة للتفاعل مع الثنائيات المترجمة |
