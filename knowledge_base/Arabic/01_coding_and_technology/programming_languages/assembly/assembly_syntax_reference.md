...
## ملخص
يتم تعريف بناء جملة لغة التجميع من خلال بنية المعالج والمجمع (NASM، GAS، MASM). يوفر x86-64 16 سجلًا للأغراض العامة، وأنماط معالجة متعددة، ومئات من التعليمات التي تغطي حركة البيانات، والحساب، والمنطق، وتدفق التحكم، وSIMD، ومكالمات النظام. يعد بناء جملة NASM المستخدم هنا هو الأكثر شيوعًا لتطوير Linux x86-64. يتطلب إتقان التجميع فهم السجلات والمكدس واصطلاحات الاتصال وكيفية ربط البنيات عالية المستوى بتعليمات الجهاز.