...
# التجميع - الأنماط الاصطلاحية وأفضل الممارسات
يغطي هذا الدليل الأنماط الاصطلاحية لكتابة كود التجميع النظيف والقابل للصيانة (تركيز x86/x64 مع بناء جملة NASM).
---

## الثوابت ووحدات الماكرو المسماة
```nasm
...
## تسجيل الاتفاقيات والمقدمة/الخاتمة
```nasm
...
## تنظيم العلامات والأكواد المحلية
```nasm
...
## ملخص
تؤكد مصطلحات التجميع على: الثوابت المسماة فوق الأرقام السحرية، ووحدات الماكرو للأنماط المتكررة، وتعريفات البنية لتخطيط البيانات، والمقدمة/الخاتمة المتوافقة مع ABI، والتسميات المحلية لسهولة القراءة، والتحقق من صحة الإدخال الدفاعي، و`xor` /`lea`للعمليات الفعالة. التجميع يكافئ الوضوح قبل كل شيء - "إذا لم تتمكن من قراءته، فلن تتمكن من تصحيحه في الساعة 3 صباحًا."