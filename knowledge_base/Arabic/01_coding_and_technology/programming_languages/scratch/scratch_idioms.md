...
## ملخص
تؤكد مصطلحات Scratch على: تسمية واضحة للكائنات، ومسؤولية واحدة لكل كائن، ورسائل البث للاتصال، والكتل المخصصة لإعادة الاستخدام، والاستنساخ لمثيلات متعددة، وحلقات اللعبة المنظمة، و"التشغيل بدون تحديث الشاشة" للأداء. منظمة مكافآت سكراتش - "الكائن ذو الاسم الجيد هو نصف البرنامج."