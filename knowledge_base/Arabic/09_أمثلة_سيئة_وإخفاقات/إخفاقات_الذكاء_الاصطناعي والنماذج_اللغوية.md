...
2. **التسلسل الهرمي للتعليمات**: تجعل تجاوز تعليمات النظام أكثر صعوبة
...
- **التحيزات المعرفية**: راجع `cognitive_logic_issues.md` للتعرف على المغالطات والتحيزات المنطقية في استدلال الذكاء الاصطناعي
