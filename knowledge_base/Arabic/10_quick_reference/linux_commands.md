---
# البيانات الوصفية
العنوان: "مرجع سريع لأوامر Linux"
الوصف: "مرجع سطر أوامر Linux"
الفئة: "مرجع سريع"
الإصدار: "1.0.0"
الحالة: "نشط"
#مساهمة
...
# التصنيف
العلامات: [لينكس، أوامر، مرجع سريع]
مستوى الصعوبة: "مبتدئ"
المتطلبات الأساسية: []
...
| الاختصار | العمل |
|----------|--------|
|  __محمي_0__ | الإكمال التلقائي |
|  __محمي_1__ | قتل الأمر الحالي |
|  __محمي_2__ | تعليق الأمر |
|  __محمي_3__ | الخروج من الصدفة/EOF |
|  __محمي_4__ | شاشة واضحة |
|  __محمي_5__ | انتقل إلى سطر البداية |
|  __محمي_6__ | انتقل إلى نهاية السطر |
|  __محمي_7__ | حذف إلى بداية السطر |
|  __محمي_8__ | حذف إلى نهاية السطر |
|  __محمي_9__ | تاريخ البحث |
|  __محمي_10__ | حذف الكلمة قبل المؤشر |
---

## أفضل الممارسات
✅ **افعل:**
- استخدم`sudo`باعتدال وبعناية
- اختبار الأوامر التدميرية بدون علامات التنفيذ أولاً
- احتفظ بالنسخ الاحتياطية قبل التغييرات الرئيسية
- استخدم أسماء ملفات ذات معنى (بدون مسافات)
- تعلم كيفية استخدام`man`صفحة (`man command`)
❌ **لا تفعل:**
- قم بتشغيل`rm -rf /`أو أوامر خطيرة مماثلة
- استخدم`chmod 777`على الملفات الحساسة
- تجاهل رسائل التحذير
- تحرير ملفات النظام بدون نسخ احتياطية
- تشغيل البرامج النصية غير المعروفة كجذر
---

*آخر تحديث: يوليو 2026 | متوافق مع Linux/Unix*