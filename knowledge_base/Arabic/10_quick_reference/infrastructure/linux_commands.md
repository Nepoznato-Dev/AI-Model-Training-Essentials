...
| `Ctrl+C`| قتل الأمر الحالي |
| `Ctrl+Z`| تعليق الأمر |
| `Ctrl+D`| الخروج من الصدفة/EOF |
| `Ctrl+L`| شاشة واضحة |
| `Ctrl+A`| انتقل إلى سطر البداية |
| `Ctrl+E`| انتقل إلى نهاية السطر |
| `Ctrl+U`| حذف إلى بداية السطر |
| `Ctrl+K`| حذف إلى نهاية السطر |
| `Ctrl+R`| تاريخ البحث |
...
- تعلم كيفية استخدام صفحات`man`(`man command`)
❌ **لا تفعل:**
