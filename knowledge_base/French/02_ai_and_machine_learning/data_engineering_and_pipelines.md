---
# Métadonnées
titre : "Ingénierie des données et pipelines"
description : "ETL/ELT, lacs de données, orchestration, Kafka, magasins de fonctionnalités"
...
#Classement
tags : [données, ingénierie, pipelines, IA et apprentissage automatique]
...
## Qualité des données
La qualité des données est le tueur silencieux des projets ML. Les déchets entrent, les déchets sortent.
