...
Phi-3-mini est un petit modèle de langage (SLM) développé par Microsoft Research, publié en avril 2024. Ses caractéristiques déterminantes sont :
...
- **Déploiement mobile** — Microsoft a présenté le Phi-3-mini fonctionnant sur un iPhone 14 Pro
...
*Source : rapport technique Microsoft Phi-3 (avril 2024)*
---
...
## Autres modèles locaux notables (2024)
### Lama 3 (Méta, 2024)
...
## Le marché local des modèles d’IA en 2024
L’écart entre les modèles locaux et cloud s’est considérablement réduit en 2024 :
