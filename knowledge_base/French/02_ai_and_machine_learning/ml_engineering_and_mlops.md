---
# Métadonnées
titre : "ML Engineering et MLOps"
description : « Service de modèles, registres, stratégies de déploiement, surveillance des dérives »
...
#Classement
tags : [ml, ingénierie, mlops, ai-and-machine-learning]
...
| **Niveau 2 — Automatisation** | Reconversion automatisée, CI/CD pour modèles, tests automatisés |
