---
# Métadonnées
titre : "Architecture d'IA locale"
description : « Architectures de déploiement d'IA locales »
...
#Classement
tags : [local, IA, architecture, IA et apprentissage automatique]
...
Réutilisez les caches KV dans des invites similaires pour éviter de recalculer la phase de pré-remplissage. Certains frameworks prennent en charge cela (par exemple, vLLM, llama.cpp avec`--prompt-cache`).
...
Envoyez ensuite les demandes à`http://localhost:11434/api/generate`.
