---
# Métadonnées
titre : "Réseaux de neurones graphiques"
description : "GCN, GAT, transmission de messages, graphiques de connaissances, tâches graphiques"
...
#Classement
tags : [graphique, neuronal, réseaux, IA et apprentissage automatique]
...
| Problème | Descriptif | Solutions |
|---------|-------------|--------------|
| **Sur-écrasement** | Les informations provenant de nœuds distants sont compressées en vecteurs de taille fixe | Utilisez des transformateurs graphiques ; mutualisation hiérarchique |
