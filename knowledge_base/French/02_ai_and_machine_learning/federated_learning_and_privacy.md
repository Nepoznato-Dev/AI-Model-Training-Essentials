---
# Métadonnées
titre : « Apprentissage fédéré et confidentialité »
description : "Formation décentralisée, confidentialité différentielle, agrégation sécurisée"
...
#Classement
tags : [fédéré, apprentissage, confidentialité, IA et apprentissage automatique]
...
| **Formation cryptée** | Se former sur des données chiffrées (encore majoritairement théoriques pour le deep learning) |
...
| **Confidentialité dès la conception** | La confidentialité doit être intégrée aux systèmes dès le départ |
---
