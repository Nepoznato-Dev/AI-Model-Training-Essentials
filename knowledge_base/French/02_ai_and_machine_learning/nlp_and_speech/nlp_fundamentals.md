...
Ces modèles traitent le texte de gauche à droite, ce qui signifie qu'ils sont lents à s'entraîner (impossibles de parallélisme) et qu'ils ont du mal avec des dépendances à longue portée.
---
...
| **RoBERTa** | NSP supprimé ; entraînés plus longtemps avec plus de données |
