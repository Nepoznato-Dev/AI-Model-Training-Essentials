---
# Métadonnées
titre : "Modèles d'architecture logicielle"
description : "Monolithe, microservices, piloté par événements, DDD, mise en cache, SOLID"
...
#Classement
balises : [logiciel, architecture, modèles, codage et technologie]
