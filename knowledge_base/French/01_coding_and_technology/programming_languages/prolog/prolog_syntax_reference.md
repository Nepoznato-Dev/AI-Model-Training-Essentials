...
## Résumé
La syntaxe de Prolog est minimale : faits, règles et requêtes. Le pouvoir vient de l’unification et du retour en arrière, qui transforment le langage en un moteur de recherche de solutions logiques. Les DCG fournissent une génération d’analyseurs élégante. Les listes utilisent la correspondance de motifs tête/queue. Pour la satisfaction des contraintes, les systèmes experts et le calcul symbolique, l'approche déclarative de Prolog résout les problèmes verbeux dans les langages impératifs.