...
-->
# Haskell — Modèles idiomatiques et meilleures pratiques
Ce guide couvre les modèles idiomatiques et les meilleures pratiques pour écrire du code Haskell propre et idiomatique.
---
...
## Résumé
Les idiomes Haskell mettent l'accent sur : les types forts, la correspondance de modèles, les monades pour les effets, les fonctions pures et l'évaluation paresseuse (avec rigueur si nécessaire). Suivez le guide de style Haskell, utilisez`hlint`pour les suggestions et`fourmolu`pour le formatage. Haskell valorise l'exactitude et la composition - "rendre les États illégaux irreprésentables".