...
## Modèles de variables et de listes
```
...
## Résumé
Les idiomes Scratch mettent l'accent sur : une dénomination claire des sprites, une responsabilité par sprite, des messages diffusés pour la communication, des blocs personnalisés pour la réutilisation, le clonage pour plusieurs instances, des boucles de jeu structurées et "l'exécution sans rafraîchissement de l'écran" pour les performances. Organisation de récompenses Scratch : "un sprite bien nommé représente la moitié du programme."