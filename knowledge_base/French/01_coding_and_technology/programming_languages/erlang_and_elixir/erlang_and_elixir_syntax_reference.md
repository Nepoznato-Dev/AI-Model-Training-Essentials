...
-->
# Erlang & Elixir — Référence de syntaxe
Ce document fournit une référence de syntaxe complète et structurée pour Erlang et Elixir. Il complète la référence principale en se concentrant sur la correspondance de modèles, la gestion des processus, les comportements OTP et les modèles de système tolérants aux pannes.
---
...
## Processus et transmission de messages
```erlang
...
## Résumé
Erlang et Elixir partagent les super pouvoirs de BEAM VM : processus légers, transmission de messages et arborescences de supervision tolérantes aux pannes. La syntaxe d'Erlang est minimale et fonctionnelle. Elixir ajoute une syntaxe moderne avec des canaux, des macros et des protocoles. Les comportements OTP (GenServer, Supervisor, Application) fournissent des modèles éprouvés pour créer des systèmes fiables. Pour les applications en temps réel, distribuées et tolérantes aux pannes, Erlang/Elixir reste inégalé.