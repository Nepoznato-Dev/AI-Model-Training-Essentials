...
# Kotlin — Modèles idiomatiques et meilleures pratiques
Ce guide couvre les modèles idiomatiques et les meilleures pratiques pour écrire du code Kotlin propre et idiomatique.
---
...
## Classes de données et scellées
```kotlin
...
## Résumé
Les idiomes Kotlin mettent l'accent sur : la sécurité nulle, les classes de données, les types scellés, les fonctions de portée, les fonctions d'extension, les coroutines et le code orienté expression. Suivez les conventions de codage Kotlin, utilisez ktlint pour le formatage et detekt pour l'analyse statique. Kotlin valorise la concision et l'expressivité : écrivez moins de passe-partout, adoptez la bibliothèque standard et utilisez`val`par défaut.