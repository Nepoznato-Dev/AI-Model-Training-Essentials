...
# Delphi / Object Pascal — Modèles idiomatiques et meilleures pratiques
Ce guide couvre les modèles idiomatiques pour écrire du code Delphi et Object Pascal propre.
---

## Gestion des ressources avec try/finally
```delphi
...
## Conception et interfaces de classe
```delphi
...
## Résumé
Les idiomes Delphi mettent l'accent sur :`try/finally`pour le nettoyage déterministe des ressources,`Format`pour la création de chaînes, les interfaces pour le couplage lâche, les enregistrements pour les supports de données, la gestion des exceptions spécifiques et les fonctionnalités modernes telles que les génériques et les méthodes anonymes. Delphi valorise la gestion explicite des ressources : "créez-la, utilisez-la, puis libérez-la enfin".