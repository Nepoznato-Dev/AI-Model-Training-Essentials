...
---
# COBOL — Référence de syntaxe
Ce document fournit une référence de syntaxe complète et structurée pour COBOL (2014+). Il complète la référence principale COBOL en se concentrant sur les modèles de syntaxe exhaustifs, les descriptions de données, le traitement des fichiers et la logique métier.
---
...
## Résumé
La syntaxe de COBOL est verbeuse de par sa conception : chaque instruction se lit comme l'anglais. Les descriptions de données avec les clauses PIC définissent précisément les formats de champ. La structure en quatre divisions impose la séparation des préoccupations. La gestion des fichiers est intégrée au langage. Pour le traitement des données commerciales, l'arithmétique décimale et les E/S orientées enregistrement de COBOL restent inégalées. Comprendre COBOL signifie comprendre les fondements de l’informatique d’entreprise.