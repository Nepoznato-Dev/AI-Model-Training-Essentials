...
-->
# Swift — Modèles idiomatiques et meilleures pratiques
Ce guide couvre les modèles idiomatiques et les meilleures pratiques pour écrire du code Swift propre.
---
...
## Résumé
Les idiomes Swift mettent l'accent sur : la sécurité (options, garde), les types de valeur (structs), la conception orientée protocole, la correspondance de modèles, l'async/wait et l'immuabilité (`let`par défaut). Suivez les directives de conception de l'API Swift, utilisez SwiftLint pour la qualité du code et SwiftFormat pour le formatage. Swift valorise la sécurité et l'expressivité : "s'il compile, c'est probablement correct".