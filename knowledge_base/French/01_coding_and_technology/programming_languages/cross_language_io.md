...
-->
# Comparaison multilingue — Opérations d'E/S et de fichiers
## Sortie de la console
| Langue | Imprimer sur la sortie standard |
|--------------|----------------|
| Python | `print("Hello")`|
| JavaScript | `console.log("Hello")`|
| Rouille | `println!("Hello")`|
| Aller | `fmt.Println("Hello")`|
...
| PHP | `echo "Hello\n"`|
| Tapuscrit | `console.log("Hello")`|
| Haskell | `putStrLn "Hello"`|
| Échelle | `println("Hello")`|
| R | `cat("Hello\n")`|
| Julie | `println("Hello")`|
| Perl | `say "Hello"`|
| Lua | `print("Hello")`|
| MATLAB | `disp('Hello')`|
| Fléchette | `print('Hello')`|
| Prologue | `write('Hello'), nl.`|
| Lisp | `(format t "Hello~%")`|
| Élixir | `IO.puts("Hello")`|
| Erlang | `io:format("Hello~n")`|
| OCaml | `print_endline "Hello"`|
| Ada | `Put_Line("Hello")`|
| COBOL | `DISPLAY 'Hello'`|
| Fortran | `print *, 'Hello'`|
| Assemblée | `syscall`(écrire dans fd 1) |
| Delphes | `WriteLn('Hello')`|
| Gratter | `say [Hello]`|
| VB | `Console.WriteLine("Hello")`|
| Coquille | `echo "Hello"`|
| SQL | N/A (renvoie les jeux de résultats) |
## Lire un fichier
```python
# Python
