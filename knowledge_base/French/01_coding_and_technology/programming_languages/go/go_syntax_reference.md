...
| `/`| Division | `7 / 2`| `3`| Division entière pour les entiers |
| `%`| Reste | `7 % 2`| `1`| Le signe correspond au dividende |
| `&`| ET au niveau du bit | `5 & 3`| `1`| |
| `\|`| OU au niveau du bit | `5 \| 3`| `7`| |
| `^`| XOR au niveau du bit | `5 ^ 3`| `6`| Également complément au niveau du bit (unaire) |
| `&^`| Bit clair (ET PAS) | `5 &^ 3`| `4`| Unique à emporter |
| `<<`| Maj gauche | `5 << 1`| `10`| |
| `>>`| Maj droite | `5 >> 1`| `2`| |
### Opérateurs de comparaison
| Opérateur | Nom | Exemple | Remarques |
|--------------|------|---------|-------|
| `==`| Égalité | `x == y`| Types comparables uniquement |
| `!=`| Pas égal | `x != y`| |
| `<`,`>`,`<=`,`>=`| Commande | `x >= y`| Chaînes comparées lexicographiquement |
### Opérateurs logiques
| Opérateur | Nom | Exemple | Remarques |
|--------------|------|---------|-------|
...
## Résumé
La syntaxe de Go est intentionnellement minimale : pas d'héritage, pas de surcharge de méthode, pas d'exceptions, pas de macros. Ce qui reste est un ensemble de constructions propres et orthogonales : des structures et des interfaces pour la composition, des goroutines et des canaux pour la concurrence, et une gestion explicite des erreurs pour la fiabilité. La puissance du langage ne vient pas d’une syntaxe complexe mais de l’interaction élégante de ses primitives simples. Les génériques (Go 1.18+) ajoutent de la flexibilité au type sans sacrifier la clarté caractéristique de Go.