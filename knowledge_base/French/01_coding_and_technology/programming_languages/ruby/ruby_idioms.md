...
# Ruby — Modèles idiomatiques et meilleures pratiques
Ce guide couvre les modèles idiomatiques et les meilleures pratiques pour écrire du code Ruby propre.
---
...
## Correspondance de motifs (Ruby 3+)
```ruby
# ✅ Pattern matching
case user
in { name:, role: "admin" }
...
## Typage et protocoles de canard
```ruby
...
## Résumé
Les idiomes Ruby mettent l'accent sur : le bonheur des développeurs, les conventions sur la configuration, les blocs et les itérateurs, le typage canard et la syntaxe expressive. Suivez le Ruby Style Guide, utilisez RuboCop pour le peluchage et StandardRB pour un formatage avisé. Ruby valorise la lisibilité – le code doit se lire comme l’anglais. Préférez les méthodes Enumerable aux boucles manuelles, utilisez des symboles pour les identifiants et adoptez des blocs pour l'itération et la gestion des ressources.