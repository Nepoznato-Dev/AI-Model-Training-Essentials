...
---
# Visual Basic — Modèles idiomatiques et meilleures pratiques
Ce guide couvre les modèles idiomatiques pour écrire du code Visual Basic (.NET) propre.
---

## Option Sécurité stricte et de type
```vb
...
## Résumé
Les idiomes Visual Basic mettent l'accent sur :`Option Strict On`pour la sécurité des types, les blocs`Using`pour la gestion des ressources, l'interpolation de chaînes, LINQ pour les collections,`Async/Await`partout, la gestion des exceptions spécifiques et des fonctionnalités modernes telles que la correspondance de modèles et les opérateurs conditionnels nuls. Lisibilité des valeurs VB — "le code doit se lire comme une spécification bien organisée."