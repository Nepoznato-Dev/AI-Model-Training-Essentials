...
---
# Fortran — Modèles idiomatiques et meilleures pratiques
Ce guide couvre les modèles idiomatiques et les meilleures pratiques pour écrire du code Fortran (2018+) propre et moderne.
---
...
## Résumé
Les idiomes Fortran modernes mettent l'accent sur :`implicit none`, les opérations sur les tableaux (éviter les boucles), les tableaux de forme supposée, les types dérivés avec des procédures liées au type et`intent`pour tous les arguments. Suivez fprettify pour le formatage. Modern Fortran (2018+) avec coarrays et DO CONCURRENT prend en charge le calcul parallèle de manière native.