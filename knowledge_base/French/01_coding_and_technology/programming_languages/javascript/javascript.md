...
# Métadonnées
titre : "JavaScript"
description : "Référence complète sur le langage de programmation JavaScript couvrant la présentation, les compromis, les principes fondamentaux de la syntaxe, l'écosystème et quand l'utiliser."
...
#Classement
balises : [javascript, langage de programmation, syntaxe, écosystème, codage et technologie]
...
| **Sémantique originale** | `==`vs`===`,`this`liaison, levage, type coercition | Apprenez les bizarreries; utilisez ESLint ; préférez`const`/`let`plutôt que`var`|
