---
# Métadonnées
titre : "Échecs des projets d'apprentissage automatique"
description : "Fuite de données, non-concordance des attentes, échecs de déploiement, dégradation du modèle"
...
#Classement
tags : [ml, projet, échecs, leçons des échecs]
