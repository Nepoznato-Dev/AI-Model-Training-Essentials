---
# Métadonnées
titre : « Prométhée et Grafana »
description : "PromQL, exportateurs, tableaux de bord, alertes, pile de surveillance"
...
#Classement
balises : [prométhée, grafana, référence rapide]
...
|------|-------------|--------------|
| **Compteur** | Valeur croissante de façon monotone (ne monte que) | Nombre de demandes ; erreurs ; tâches accomplies |
