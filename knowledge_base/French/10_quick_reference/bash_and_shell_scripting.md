---
# Métadonnées
title : « Aide-mémoire pour les scripts Bash et Shell »
description: "Scripts Bash, traitement de texte, one-liners utiles"
...
#Classement
balises : [bash, shell, script, référence rapide]
...
## Résumé
Les scripts Bash sont un multiplicateur de force pour quiconque travaille avec des ordinateurs. Vous n'avez pas besoin de mémoriser chaque drapeau : vous devez savoir ce qui est possible et où le rechercher. Commencez par les bases : variables, conditions, boucles, tuyaux. Ajoutez ensuite des outils de traitement de texte (grep, sed, awk) selon vos besoins. Et utilisez toujours`set -euo pipefail`– à l’avenir, vous en serez reconnaissant.