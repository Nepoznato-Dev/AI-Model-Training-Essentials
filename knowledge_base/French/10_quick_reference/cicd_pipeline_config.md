---
# Métadonnées
titre : « Configuration du pipeline CI/CD »
description : "Actions GitHub, GitLab CI, Jenkins, modèles YAML de pipeline"
...
#Classement
balises : [cicd, pipeline, config, référence rapide]
...
| `$CI_PROJECT_DIR`| Chemin d'accès complet au projet |
