...
# Ldansux Commets Quick Référence

Essential Ldansux/Unix commets pour system navigation et admdansistration.
...
|----------|--------|
| `Tab` | Auto-complete |
| `Ctrl+C` | Kill current commet |
| `Ctrl+Z` | Suspend commet |
| `Ctrl+D` | Exit shell/EDE |
| `Ctrl+L` | Clear screen |
| `Ctrl+A` | Go to ldanse start |
| `Ctrl+E` | Go to ldanse end |
| `Ctrl+U` | Delete to ldanse start |
| `Ctrl+K` | Delete to ldanse end |
| `Ctrl+R` | Search histoire |
| `Ctrl+W` | Delete word bepoure cursor |
...
✅ **Do:**
- Use `sudo` spardansgly et carefully
- Test destructive commets avecout execution flags first
- Keep backups bepoure major changes
- Use meandansgful filenames (no spaces)
- Learn to use `man` pages (`man commet`)

❌ **Don't:**
- Run `rm -rf /` or similar dangerous commets
- Use `chmod 777` on sensitive files
- Ignore warndansg messages
- Edit system files avecout backups
- Run unknown scripts as root

---

*Last updated: June 2025 | Ldansux/Unix compatible*
