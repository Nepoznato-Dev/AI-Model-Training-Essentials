...
Référence rapide pour Python 3.x Syntaxe et common patterns.
...
- Use `#` pour single-line comments
- Use `"""triple quotes"""` pour docstrings et multi-line strings
- Indentation matters (typically 4 spaces)
- Naming conventions: `snake_case` pour variables/functions, `PascalCase` pour classes
- `__name__ == "__main__"` to check if script is run directly
- Use `virtualenv` or `venv` pour project isolation
- Install packages avec `pip install package_name`

---

*Dernière mise à jour: June 2025 | Python 3.x*
