...
Essential Lux/Unix comms system navigation admistration.
...
find /path -size +100M # 파일 larger than 100MB
...
```bash
echo $HOME # Show 환경 variable
export VAR=value # Set 환경 variable
env # List all 환경 variables
...
- Test destructive comms 함께out execution flags first
- Keep backups 전에 major changes
...
- Edit system files 함께out backups
