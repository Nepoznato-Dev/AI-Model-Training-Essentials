...
# SQL — 관용적 패턴 및 모범 사례
이 가이드에서는 깔끔하고 효율적인 SQL 작성을 위한 관용적 패턴과 모범 사례를 다룹니다.
---
...
## 요약
SQL 관용어는 명시적인 열 이름, 일관된 형식, 가독성을 위한 CTE, 분석을 위한 창 기능, 성능을 위한 SARGable 쿼리, 튜닝을 위한 `EXPLAIN ANALYZE`를 강조합니다. SQLFluff를 따라 형식을 지정하고 항상 매개변수화된 쿼리를 사용하여 SQL 주입을 방지하세요.