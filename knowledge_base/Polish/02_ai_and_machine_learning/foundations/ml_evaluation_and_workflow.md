...
## Dzielenie danych
### Pociąg/Weryfikacja/Podział testu
...
- FN = wynik fałszywie ujemny (błąd typu II)
### Metryki regresji
...
- **Precyzja@k**: Część odpowiednich pozycji wśród rekomendacji z najwyższej półki.
...
### Niedopasowanie
Model słabo radzi sobie zarówno w szkoleniu, jak i walidacji.
...
- **Łagodzenie:** Okresowo przekwalifikuj się, monitoruj wydajność, używaj algorytmów wykrywania dryfu.
---

## Strojenie hiperparametrów
- **Wyszukiwanie siatki**: Wyczerpujące wypróbowanie wszystkich kombinacji predefiniowanego zestawu hiperparametrów. Proste, ale kosztowne obliczeniowo.
...
- **Wnioskowanie online**: prognozy w czasie rzeczywistym za pośrednictwem interfejsu API (np. punktacja kredytowa, wykrywanie oszustw).
