...
- Bardzo szybki, szczególnie na procesorze.
...
### Transformatory z przytulającą twarzą + bitsandbytes
...
Model lokalny obsługuje typowe zapytania; w przypadku złożonych pytań powrót do modelu chmury. Daje to to, co najlepsze z obu światów — szybkość/prywatność w większości przypadków i możliwości w przypadkach brzegowych.
### Wnioskowanie rozproszone (wiele procesorów graficznych)
