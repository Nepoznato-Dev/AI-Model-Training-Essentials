...
Podejście Anthropic: zamiast polegać wyłącznie na informacjach zwrotnych od ludzi, nadaj modelowi zestaw zasad („konstytucja”) i poproś go o krytykę i rewizję własnych wyników.
| Krok | Opis |
|------|------------|
...
| **3. RL z opinii AI (RLAIF)** | Wykorzystaj własne oceny sztucznej inteligencji, aby wytrenować model nagrody |
| Zaleta | Ograniczenie |
|--------------|------------|
...
### Klasyfikacja ryzyka (unijna ustawa o sztucznej inteligencji)
...
| **Konwergencja instrumentalna** | Model szuka władzy, zasobów lub samozachowawstwa jako środków do osiągnięcia swoich celów |
---
