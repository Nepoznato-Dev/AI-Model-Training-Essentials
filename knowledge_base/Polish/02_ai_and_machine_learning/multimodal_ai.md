...
| **Transfer międzymodalny** | Wiedza z jednej modalności pomaga w innej | Zrozumienie obrazu poprawia generowanie tekstu i odwrotnie
---
...
| **4. Generuj** | Model językowy tworzy tekst uwarunkowany zarówno obrazem, jak i tekstem wejściowym |
...
| **Tekst → Dźwięk** | Znajdź dźwięki pasujące do opisu | Projekt dźwiękowy: „kroki na żwirze” |
| **Obraz → Obraz** | Znajdź wizualnie podobne obrazy | Wyszukiwanie produktów według obrazu |
### CLIP do pobierania międzymodalnego
Wspólna przestrzeń osadzania CLIP umożliwia bezproblemowe pobieranie międzymodalne:
| Krok | Opis |
|------|------------|
...
| 4 | Zwróć obrazy o największym podobieństwie |
...
| **Uczenie się kontrastowe** | Naucz się dopasowywać powiązane pary według różnych modalności (w stylu CLIP) | Budowanie wspólnych reprezentacji |
