...
|--------------|------------|
| **Sieć przekazująca** | Wymaga danych wejściowych o stałym rozmiarze; wykresy różnią się rozmiarem i strukturą |
...
| Strategia | Opis |
|--------------|------------|
| **Próbkowanie węzłów** | Próbka podzbioru węzłów i ich otoczenia typu K-hop |
