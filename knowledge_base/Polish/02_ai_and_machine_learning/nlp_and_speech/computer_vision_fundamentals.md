...
| Transformatory wizyjne (ViT) | Traktuj obraz jako sekwencję łatek; Enkoder transformatorowy |
...
3. **Zablokuj wczesne warstwy** (przechwytują ogólne cechy, takie jak krawędzie).
