...
| **SAC** (krytyk-aktor miękki) | Maksymalizuj nagrodę, utrzymując eksplorację (regularyzacja entropii) |
...
| **2. Szkolenie w zakresie modelu nagrody** | Ludzie porównują pary wyników modelu; wytrenuj model przewidywania ludzkich preferencji | Model nagrody oceniający jakość wydruku |
