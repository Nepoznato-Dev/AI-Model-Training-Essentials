...
Głównym założeniem serii Phi jest to, że **jakość danych jest ważniejsza niż ilość danych**. Tradycyjne szkolenie LLM wykorzystuje tekst zeskanowany z Internetu — setki miliardów tokenów o różnorodnej, hałaśliwej treści.
...
Phi-3-mini wykorzystuje do szkolenia około 3,3 biliona tokenów — dużo jak na absolutne standardy, ale znacznie mniej niż 15 tokenów używanych w Llama 3. Kluczowym wyróżnikiem jest potok filtrowania i sprawdzania, który wybiera wyłącznie treści wysokiej jakości.
...
Dzięki temu podstawowy predykator następnego tokenu staje się pomocnym asystentem wykonującym instrukcje.
...
Doświadczenie Phi ilustruje kilka ważnych lekcji:### 1. Dystrybucja danych szkoleniowych ma największe znaczenie
