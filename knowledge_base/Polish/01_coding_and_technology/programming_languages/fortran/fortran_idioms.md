...
# Fortran — wzorce idiomatyczne i najlepsze praktyki
W tym przewodniku opisano idiomatyczne wzorce i najlepsze praktyki dotyczące pisania czystego, nowoczesnego kodu w języku Fortran (2018+).
---
...
## Streszczenie
Współczesne idiomy języka Fortran kładą nacisk na:`implicit none`, operacje na tablicach (unikaj pętli), tablice o założonym kształcie, typy pochodne z procedurami związanymi z typami oraz`intent`dla wszystkich argumentów. Aby sformatować, wykonaj polecenie fprettify. Nowoczesny Fortran (2018+) z współrzędnymi i DO CONCURRENT natywnie obsługuje obliczenia równoległe.