...
## Procesy i przekazywanie wiadomości
```erlang
...
## Streszczenie
Erlang i Elixir dzielą supermoce BEAM VM: lekkie procesy, przekazywanie komunikatów i drzewa nadzoru odporne na błędy. Składnia Erlanga jest minimalna i funkcjonalna. Elixir dodaje nowoczesną składnię z potokami, makrami i protokołami. Zachowania OTP (GenServer, Supervisor, Application) zapewniają sprawdzone w boju wzorce budowania niezawodnych systemów. W przypadku rozproszonych i odpornych na awarie aplikacji czasu rzeczywistego Erlang/Elixir pozostaje niezrównany.