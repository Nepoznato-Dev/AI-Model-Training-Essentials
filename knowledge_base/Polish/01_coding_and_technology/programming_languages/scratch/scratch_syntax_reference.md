...
## Przegląd kategorii bloków
| Kategoria | Kolor | Typy bloków | Cel |
|---------|--------|-------------|---------|
| **Ruch** | Niebieski | Stos | Przesuń duszki, zmień pozycję, kierunek |
| **Wygląda** | Fioletowy | Stos | Zmień wygląd, powiedz/pomyśl, pokaż/ukryj |
| **Dźwięk** | Różowy | Stos | Odtwarzaj dźwięki, zmieniaj głośność/wysokość |
| **Wydarzenia** | Żółty | Kapelusz | Uruchamianie skryptów, nadawanie/odbieranie wiadomości |
| **Kontrola** | Złoto | Stos | Pętle, warunki, czekaj, stop |
| **Wyczuwanie** | Jasnoniebieski | Reporter | Wykryj kolizje, dane wejściowe, licznik czasu, odpowiedzi |
| **Operatorzy** | Zielony | Reporter | Matematyka, tekst, porównanie, logika |
| **Zmienne** | Pomarańczowy | Stos/Reporter | Przechowuj dane, operacje na listach |
| **Moje bloki** | Ciemnoczerwony | Stos | Niestandardowe definicje bloków (funkcje) |
---
...
## Streszczenie
Oparta na blokach składnia Scratcha eliminuje błędy w pisaniu i sprawia, że ​​koncepcje programistyczne stają się namacalne. Każdy skrypt zaczyna się od bloku kapelusza (zdarzenia), następnie układa bloki poleceń (ruch, wygląd, dźwięk, sterowanie, wykrywanie, operatory, zmienne) i wykorzystuje bloki reportera (okrągłe/owalne kształty) jako wartości. Bloki niestandardowe umożliwiają programowanie modułowe. Klony zapewniają zachowanie obiektowe. Zawiera listę kolekcji sklepu. Przedłużka do pióra umożliwia kreatywne rysowanie. Młodym uczniom Scratch zapewnia pełne wprowadzenie do logiki programowania, projektowania sterowanego zdarzeniami i kreatywnej ekspresji poprzez kod.