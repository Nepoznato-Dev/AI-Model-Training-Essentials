...
---
# Scala — wzorce idiomatyczne i najlepsze praktyki
W tym przewodniku opisano idiomatyczne wzorce i najlepsze praktyki dotyczące pisania czystego, funkcjonalnego kodu Scala 3.
---
...
## Streszczenie
Idiomy Scala kładą nacisk na: niezmienność (`val`), dopasowywanie wzorców, typy zapieczętowane, Option/Either ze względów bezpieczeństwa, for-zrozumienia, kolekcje funkcjonalne i klasy typów (podane/używane w Scali 3). Postępuj zgodnie z Przewodnikiem po stylu Scala, użyj scalafmt do formatowania i scalafix do lintingu. Czystsza składnia, wyliczenia, nieprzezroczyste typy i metody rozszerzeń Scali 3 sprawiają, że język jest bardziej przystępny, zachowując jednocześnie jego moc funkcjonalną.