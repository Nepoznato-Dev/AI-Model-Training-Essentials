...
## Opcja ścisła i bezpieczeństwo typu
```vb
...
## Wzorce asynchroniczne/oczekiwania
```vb
...
## Streszczenie
Idiomy Visual Basic kładą nacisk na:`Option Strict On`dla bezpieczeństwa typów, bloki`Using`do zarządzania zasobami, interpolację ciągów, LINQ dla kolekcji,`Async/Await`w całym tekście, specyficzną obsługę wyjątków i nowoczesne funkcje, takie jak dopasowywanie wzorców i operatory warunkowe o wartości null. VB ceni czytelność — „kod powinien brzmieć jak dobrze zorganizowana specyfikacja”.