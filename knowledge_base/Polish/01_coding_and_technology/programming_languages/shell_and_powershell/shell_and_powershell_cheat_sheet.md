...
## Przepływ kontroli programu PowerShell
```powershell
# If
if ($age -ge 18) {
    "adult"
...
## Obsługa błędów programu PowerShell
```powershell
try {
