...
## Streszczenie
Składnia Prologa jest minimalna — fakty, reguły i zapytania. Siła tkwi w unifikacji i cofaniu się, które zamieniają język w wyszukiwarkę logicznych rozwiązań. DCG zapewniają eleganckie generowanie parsera. Listy wykorzystują dopasowywanie wzorców głowy/ogona. W przypadku spełniania ograniczeń, systemów ekspertowych i obliczeń symbolicznych deklaratywne podejście Prologa rozwiązuje problemy, które są szczegółowe w językach imperatywnych.