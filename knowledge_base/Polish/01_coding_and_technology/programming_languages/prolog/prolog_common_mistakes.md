...
-->
# Prolog — częste błędy i anty-wzorce
Dokument ten kataloguje najczęstsze błędy, pułapki i anty-wzorce w Prologu wraz z poprawkami.
---
...
## 5. Operacje na listach bez akumulatorów
```prolog
...
## Streszczenie
Paradygmat programowania logicznego Prologa tworzy unikalne pułapki: mylące`=`(ujednolicenie),`==`(równość) i`is`(arytmetyka); nieprawidłowe umiejscowienie cięcia; nieskończona rekurencja bez śledzenia odwiedzin; i następuje sprawdzenie. Sposób Prologu polega na: dogłębnym zrozumieniu unifikacji, używaniu cięcia oszczędnie i poprawnie, używaniu akumulatorów do wydajnego budowania list i zawsze rozważaj zakończenie.