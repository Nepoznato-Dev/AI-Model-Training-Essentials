...
---
# Prolog — Historia wersji i ewolucja
## Oś czasu
| Wersja | Rok | Kluczowy motyw |
|--------|------|-----------|
| Przed Prologiem | 1965–70 | Systemy Q Colmerauera, przetwarzanie języka naturalnego |
| Prolog I | 1972 | **Pierwszy Prolog** (Alain Colmerauer, Marsylia) |
| 10 grudnia | 1977 | Prolog Davida Warrena w Edynburgu (wydajny kompilator) |
| Prolog ISO | 1995 | **Pierwsza norma ISO** (ISO/IEC 13211-1) |
| SWI-Prolog | 1987 | Jan Wielemaker — najpopularniejszy Prolog open source |
| Prolog GNU | 1999 | Daniel Diaz — natywna kompilacja |
| ISO 2. | 2012 | Sprostowanie 2 (poprawki błędów, wyjaśnienia) |
| SWI 8.x | 2018 | Składanie, racjonalne, lepsza wydajność |
| SWI 9.x | 2023 | **Tabling** (domyślnie), ulepszone moduły, system paczek |
| Wróżka | 2018 | Nowoczesny Prolog w Rust — zgodny z ISO |
| Trealla | 2022 | Szybki Prolog w C — nowoczesna implementacja |
## Główne kamienie milowe
### Narodziny Prologu (1972)
- **1972**: Alain Colmerauer tworzy Prolog na Uniwersytecie w Marsylii
- **Nazwa**: „PROgrammation en LOGique” (programowanie w logice)
- **Cel**: Przetwarzanie języka naturalnego — analizowanie zdań francuskich
- Na podstawie klauzul Horna i uchwały (Robinson, 1965)
- Pierwsze wdrożenie: ujednolicenie + backtracking
### Prolog w Edynburgu (1977)
- **1977**: David Warren tworzy Prolog DEC-10 w Edynburgu
- Wydajny kompilator — Prolog staje się praktyczny
- Edynburg Prolog staje się implementacją referencyjną
- Wpływy: klauzule Horna, przeszukiwanie w głąb, operator cięcia
### Normalizacja ISO (1995)
- **1995**: Pierwsza norma ISO (ISO/IEC 13211-1)
- Definiuje: składnię, wbudowane predykaty, arytmetykę, I/O
- Zapewnia przenośność pomiędzy wdrożeniami
### Współczesny prolog (2000–obecnie)
- **SWI-Prolog**: Najczęściej używane — tabelowanie, moduły, wielowątkowość, sieć (Pengines)
- **GNU Prolog**: Kompilacja natywna — szybkie pliki wykonywalne
- **Scryer Prolog**: Nowoczesny, oparty na rdzy, zgodny z ISO
- **Trealla Prolog**: Szybki, lekki, oparty na C
## Ewolucja składni
```prolog
