...
## Streszczenie
Składnia języka COBOL jest z założenia gadatliwa — każdą instrukcję czyta się jak po angielsku. Opisy danych z klauzulami PIC precyzyjnie definiują formaty pól. Czterodziałowa struktura wymusza rozdzielenie obaw. Obsługa plików jest wbudowana w język. W przypadku przetwarzania danych biznesowych arytmetyka dziesiętna języka COBOL i operacje we/wy zorientowane na rekordy pozostają niezrównane. Zrozumienie języka COBOL oznacza zrozumienie podstaw przetwarzania danych w przedsiębiorstwie.