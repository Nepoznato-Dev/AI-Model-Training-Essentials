...
-->
# Go — wzorce idiomatyczne i najlepsze praktyki
W tym przewodniku opisano idiomatyczne wzorce i najlepsze praktyki dotyczące pisania czystego, idiomatycznego kodu Go.
---
...
## Streszczenie
Idiomy Go kładą nacisk na: prostotę, wyraźną obsługę błędów, małe interfejsy, kompozycję zamiast dziedziczenia, goroutines z kontekstem i „akceptuj interfejsy, zwracaj struktury”. Postępuj zgodnie z`gofmt`do formatowania,`golangci-lint`do lintingu i oficjalny przewodnik po komentarzach Go Code Review. Społeczność Go ceni czytelność, prostotę i „oczywisty sposób, aby to zrobić”. Unikaj sprytnego kodu — kod Go powinien być nudny i przewidywalny.