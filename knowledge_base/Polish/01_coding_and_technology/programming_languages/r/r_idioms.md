...
-->
# R — Wzorce idiomatyczne i najlepsze praktyki
W tym przewodniku omówiono idiomatyczne wzorce i najlepsze praktyki dotyczące pisania czystego, idiomatycznego kodu R.
---
...
## Streszczenie
Idiomy R kładą nacisk na: wektoryzację (unikaj pętli), potoki tidyverse (`|>`),`<-`do przypisywania, nazewnictwo węży i ​​programowanie funkcjonalne za pomocą`purrr`. Postępuj zgodnie z Przewodnikiem po stylach Tidyverse, użyj lintr do lintingu i stylera do formatowania. R ceni operacje wektoryzowane i potok dla czytelnych transformacji danych.