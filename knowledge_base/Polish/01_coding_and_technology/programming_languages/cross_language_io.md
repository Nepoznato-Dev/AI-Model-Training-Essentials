...
---
# Porównanie międzyjęzykowe — operacje we/wy i pliki
## Dane wyjściowe konsoli
| Język | Wydrukuj na standardowe wyjście |
|-------------|----------------|
| Pythona | `print("Hello")`|
| JavaScript | `console.log("Hello")`|
| Rdza | `println!("Hello")`|
| Idź | `fmt.Println("Hello")`|
...
| Lisp | `(format t "Hello~%")`|
| Eliksir | `IO.puts("Hello")`|
| Erlang | `io:format("Hello~n")`|
| OCaml | `print_endline "Hello"`|
| Ada | `Put_Line("Hello")`|
| COBOL | `DISPLAY 'Hello'`|
| Fortran | `print *, 'Hello'`|
| Montaż | `syscall`(zapisz do fd 1) |
| Delfy | `WriteLn('Hello')`|
| Zadrapanie | `say [Hello]`|
| VB | `Console.WriteLine("Hello")`|
| Powłoka | `echo "Hello"`|
| SQL | N/A (zwraca zestawy wyników) |
## Czytanie pliku
```python
# Python
