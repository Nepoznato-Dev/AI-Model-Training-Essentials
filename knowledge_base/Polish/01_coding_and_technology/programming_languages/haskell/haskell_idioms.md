...
## Streszczenie
Idiomy Haskella kładą nacisk na: silne typy, dopasowywanie wzorców, monady efektów, czyste funkcje i leniwą ocenę (w razie potrzeby ze ścisłością). Postępuj zgodnie z Przewodnikiem po stylu Haskell, użyj`hlint`w przypadku sugestii i`fourmolu`do formatowania. Haskell ceni poprawność i skład – „uczyń nielegalne państwa niereprezentowalnymi”.