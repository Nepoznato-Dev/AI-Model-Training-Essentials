...
-->
# OCaml — wzorce idiomatyczne i najlepsze praktyki
W tym przewodniku opisano idiomatyczne wzorce pisania czystego, idiomatycznego kodu OCaml.
---
...
## Streszczenie
Idiomy OCaml kładą nacisk na: wyczerpujące dopasowywanie wzorców, moduły i funktory do abstrakcji, wynik/opcję dla bezpieczeństwa oraz operator pierwszego potoku (`|>`). Postępuj zgodnie z`ocamlformat`dla formatowania i`ocaml-lsp`dla obsługi IDE. Wartości OCaml zapewniają bezpieczeństwo i matematyczną precyzję.