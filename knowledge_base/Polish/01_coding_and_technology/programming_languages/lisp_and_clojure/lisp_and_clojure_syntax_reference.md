...
## Streszczenie
Składnia Clojure jest jednakowo ujęta w nawiasy — każdy formularz jest listą. Ta homoikoniczność umożliwia potężne makra, które przekształcają kod jako dane. Trwałe struktury danych zapewniają niezmienność i udostępnianie strukturalne w celu zwiększenia wydajności. Makra wątkowe tworzą czytelne potoki danych. Elementy podstawowe współbieżności (atomy, referencje, agenci, kanały) bezpiecznie obsługują zmiany stanu. Wpływ Lisp/Clojure na współczesne programowanie jest ogromny — usuwanie elementów bezużytecznych, REPL, makra i programowanie funkcjonalne wywodzą się z Lispa.