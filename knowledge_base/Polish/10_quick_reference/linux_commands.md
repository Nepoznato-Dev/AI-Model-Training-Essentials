...
# Krótki przegląd poleceń systemu Linux
Niezbędne polecenia systemu Linux/Unix do nawigacji i administrowania systemem.
---
...
| Skrót | Akcja |
|---------|--------|
| `Tab`| Automatyczne uzupełnianie |
| `Ctrl+C`| Zabij bieżące polecenie |
| `Ctrl+Z`| Zawieszenie polecenia |
| `Ctrl+D`| Wyjdź z powłoki/EOF |
...
| `Ctrl+R`| Historia wyszukiwania |
| `Ctrl+W`| Usuń słowo przed kursorem |
---

## Najlepsze praktyki
✅ **Zrób:**
- Używaj`sudo`oszczędnie i ostrożnie
- Najpierw testuj destrukcyjne polecenia bez flag wykonania
- Przechowuj kopie zapasowe przed poważnymi zmianami
- Używaj znaczących nazw plików (bez spacji)
- Naucz się korzystać ze stron`man`(`man command`)
❌ **Nie rób:**
- Uruchom`rm -rf /`lub podobne niebezpieczne polecenia
- Użyj`chmod 777`na wrażliwych plikach
- Ignoruj komunikaty ostrzegawcze
- Edytuj pliki systemowe bez tworzenia kopii zapasowych
- Uruchom nieznane skrypty jako root
---

*Ostatnia aktualizacja: lipiec 2026 r. | Kompatybilny z Linuxem/Unixem*