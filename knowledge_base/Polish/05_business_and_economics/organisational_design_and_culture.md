...
### Wspólne struktury
| Struktura | Opis | Mocne strony | Słabe strony |
|----------|-------------|----------|------------|
| **Funkcjonalne** | Pogrupowane według specjalizacji (inżynieria, marketing, sprzedaż) | Głęboka wiedza specjalistyczna; efektywność; jasne ścieżki kariery | Silosy; powolna koordynacja międzyfunkcyjna |
...
|--------|----------------------|--------------------------------|
| **Warstwy zarządzania** | Wiele | Niewiele |
| **Nadzór** | Zamknąć; praktyczne | Delegowany; ręce wolne |
| **Najlepsze dla** | Złożone zadania; niedoświadczone zespoły | Rutynowe zadania; doświadczone, autonomiczne zespoły |
| **Ryzyko** | Mikrozarządzanie; powolne decyzje | Brak wsparcia; luki koordynacyjne |
### Centralizacja kontra decentralizacja
| Wymiar | Scentralizowany | Zdecentralizowany |
|----------|-----------|--------------|
| **Podejmowanie decyzji** | Z góry na dół | Zepchnięty na brzeg |
| **Prędkość** | Powolny (wąskie gardło na górze) | Szybko (decyzje podejmowane lokalnie) |
| **Spójność** | Wysoki | Zmienna |
| **Innowacja** | Ograniczone przez przepustowość góry | Wyłania się z wielu źródeł |
| **Najlepsze dla** | Kryzys; wczesny etap; branże wymagające dużej zgodności | Praca oparta na wiedzy; szybko zmieniające się rynki; skalowanie |
---

## Zasady projektowania
### Kluczowe decyzje w projektowaniu organizacyjnym
| Decyzja | Pytanie | Opcje |
|---------|----------|--------|
| **Departmentalizacja** | Jak grupujemy ludzi? | Według funkcji; produkt; klient; geografia; proces |
| **Sieć dowodzenia** | Kto komu raportuje? | Jasna hierarchia; matryca; sieć |
| **Prawo decyzyjne** | Kto o czym decyduje? | Scentralizowany; zdecentralizowany; macierz RACI |
| **Mechanizmy koordynacji** | Jak zespoły współpracują ze sobą? | Role łącznikowe; zespoły interdyscyplinarne; integratorzy; wspólne cele |
| **Standardyzacja** | Ile kosztuje standardowy vs lokalny? | Procesy; wyjścia; umiejętności; normy |
### Model gwiazdy Galbraitha
| Element | Opis |
|--------|------------|
| **Strategia** | Kierunek; cele; przewaga konkurencyjna; powód istnienia organizacji |
| **Struktura** | Zgłaszanie relacji; hierarchia; grupowanie jednostek |
| **Procesy** | Przepływ informacji; podejmowanie decyzji; planowanie; budżetowanie |
| **Nagrody** | Zachęty; pomiar wydajności; zgodność ze strategią |
| **Ludzie** | Wynajmowanie; rozwój; kultura; możliwości człowieka |
Kluczowy spostrzeżenie: strategia napędza strukturę. Wszystkie pozostałe elementy muszą się zgadzać. Zmiana struktury bez zmiany procesów, nagród i rozwoju ludzi zakończy się niepowodzeniem.
---

## Kultura organizacyjna
### Czym właściwie jest kultura
| Warstwa | Opis | Widoczność |
|-------|------------|---------------|
...
| **Szacunek dla hierarchii** | Czy młodsi ludzie mogą kwestionować pomysły starszych ludzi? |
---

## Zarządzanie zmianami
### Dlaczego inicjatywy zmiany kończą się niepowodzeniem
| Powód | Opis |
|------------|------------|
| **Bez pilności** | Ludzie nie widzą, dlaczego zmiany są konieczne |
| **Brak koalicji** | Nie ma potężnej grupy napędzającej zmiany |
| **Brak wizji** | Niejasne, jak wygląda przyszły stan |
| **Słaba komunikacja** | Ludzie nie rozumieją zmiany i swojej w niej roli |
| **Żadnych szybkich zwycięstw** | Brak widocznych postępów w budowaniu dynamiki |
| **Przedwczesne świętowanie** | Ogłoszenie zwycięstwa zanim zmiany zostaną osadzone |
| **Opór kulturowy** | Zmień konflikty z głęboko zakorzenionymi założeniami |
| **Brak wzmocnienia** | Nagradzane są stare zachowania; nowe zachowania nieutrwalone |
### Model 8 kroków Kottera
| Krok | Akcja |
|------|------------|
| **1. Utwórz pilność** | Pomóż ludziom dostrzec zagrożenie wynikające z braku zmian |
| **2. Zbuduj koalicję przewodnią** | Zbierz grupę o wystarczającej mocy i wiarygodności |
| **3. Stwórz strategiczną wizję** | Stwórz jasny obraz przyszłości |
| **4. Zaciągnij armię ochotniczą** | Uzyskaj wpisowe od masy krytycznej |
| **5. Włącz akcję** | Usuń bariery; wzmacniać ludzi |
| **6. Generuj krótkoterminowe zwycięstwa** | Twórz widoczne sukcesy |
| **7. Utrzymuj przyspieszenie** | Naciskaj dalej; nie ogłaszaj zwycięstwa za wcześnie |
| **8. Zmiana Instytutu** | Zakotwicz nowe zachowania w kulturze |
---
...
| **Kapitał** | Stronniczość bliskości: upewnij się, że pracownicy zdalni mają równą widoczność i równe możliwości |
| **Współpraca** | Wyczyść własność; zdefiniowane interfejsy; regularne synchronizacje |
| **Dobre samopoczucie** | Szanuj granice; prawo do odłączenia; unikaj przeciążenia spotkaniami |
---
