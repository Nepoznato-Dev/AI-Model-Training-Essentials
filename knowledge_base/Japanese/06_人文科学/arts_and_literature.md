...
- **Historical Fiction**: Set で specific historical periods と accurate details (e.g., "その Book Thief" by Markus Zusak, "Wolf Hall" by Hilary Mantel)
- **Magical Realism**: Realistic settings と magical elements treated as ordinary (e.g., "One Hundred Years の Solitude" by Gabriel García Márquez)

### Non-Fiction Genres
- **Biography/Autobiography**: Life stories の real people (e.g., "その Diary の a Young Girl" by Anne Frank, "Becoming" by Michelle Obama)
...
- **Self-Help**: Personal 開発 と improvement guides

### Poetry Forms
- **Sonnet**: 14-line poem と specific rhyme scheme (Shakespearean: ABAB CDCD EFEF GG; Petrarchan: ABBAABBA CDECDE)
- **Haiku**: Japanese form と 5-7-5 syllable pattern
- **Limerick**: Five-line humorous poem と AABBA rhyme scheme
- **Free Verse**: No regular meter or rhyme pattern
- **Villanelle**: 19 lines と specific repetition pattern (e.g., "Do Not Go Gentle into That Good Night" by Dylan Thomas)
- **Ode**: Lyrical poem praising a person, event, or thing
- **Epic**: Long narrative poem about heroic deeds (e.g., "その Odyssey" by Homer, "Beowulf")

## Major Literary Movements

### Historical Periods
- **Classical 文学** (8th century BCE - 5th century CE): Greek と Roman works emphasizing reason, order, と humanism
- **Medieval 文学** (5th - 15th century): Religious themes, chivalric romances, allegories (e.g., "その Divine Comedy" by Dante)
- **Renaissance** (14th - 17th century): Humanism, revival の classical learning (e.g., Shakespeare, Cervantes)
- **Enlightenment** (17th - 18th century): Reason, 科学, individual rights (e.g., Voltaire, Jonathan Swift)
- **Romanticism** (late 18th - mid-19th century): Emotion, 自然, individualism (e.g., Wordsworth, Goethe, Mary Shelley)
- **Realism** (mid-19th century): Accurate depiction の everyday life (e.g., Tolstoy, George Eliot, Mark Twain)
- **Modernism** (late 19th - mid-20th century): Experimental forms, stream の consciousness (e.g., James Joyce, Virginia Woolf, T.S. Eliot)
...
- **パフォーマンス Art**: Live actions, body art, happenings
...
- **Classical Crossover**: Fusion の classical と popular styles

### Music Theory 基礎
- **Notes と Scales**: Major, minor, chromatic, pentatonic, modes
- **Chords と Harmony**: Triads, seventh chords, chord progressions
- **Rhythm と Meter**: Time signatures, tempo, syncopation
- **Melody と Counterpoint**: Thematic 開発, voice leading
- **Form と Structure**: Sonata form, symphony movements, verse-chorus structure
...
### Famous Playwrights
- William Shakespeare (英語, 1564-1616): "Hamlet", "Macbeth", "Romeo と Juliet"
- Anton Chekhov (Russian, 1860-1904): "その Cherry Orchard", "Three Sisters"
- Tennessee Williams (American, 1911-1983): "A Streetcar Named Desire", "その Glass Menagerie"
- Arthur Miller (American, 1915-2005): "Death の a Salesman", "その Crucible"
- Samuel Beckett (Irish, 1906-1989): "Waiting のために Godot", "Endgame"
...
- **Documentary**: Non-fiction, real イベント, educational
- **Animation**: Hand-drawn, CGI, stop-motion
- **Film Noir**: Dark themes, moral ambiguity, visual style (1940s-1950s)
- **科学 Fiction**: Futuristic テクノロジー, space, time travel

### Film Movements
- **German Expressionism** (1920s): Distorted visuals, psychological themes ("その Cabinet の Dr. Caligari")
...
- **Cinematographer/Director の Photography**: Camera work, lighting, visual style
...
## Famous Authors と Works

### Classic 文学
- Homer: "その Iliad", "その Odyssey" (Ancient Greece)
- Dante Alighieri: "その Divine Comedy" (Italy, 1308-1320)
- Miguel de Cervantes: "Don Quixote" (Spain, 1605)
- Jane Austen: "Pride と Prejudice", "Sense と Sensibility" (England, 1810s)
- Leo Tolstoy: "War と Peace", "Anna Karenina" (Russia, 1860s-1870s)
- Fyodor Dostoevsky: "Crime と Punishment", "その Brothers Karamazov" (Russia, 1860s-1880s)
- Charles Dickens: "Great Expectations", "A Tale の Two Cities" (England, 1850s-1860s)
- Mark Twain: "Adventures の Huckleberry Finn" (USA, 1884)

### Modern 文学
- James Joyce: "Ulysses" (Ireland, 1922)
- Virginia Woolf: "Mrs. Dalloway", "To その Lighthouse" (England, 1920s)
- Franz Kafka: "その Metamorphosis", "その Trial" (Czechoslovakia, 1910s-1920s)
- Gabriel García Márquez: "One Hundred Years の Solitude" (Colombia, 1967)
- Toni Morrison: "Beloved", "Song の Solomon" (USA, 1970s-1980s)
- Haruki Murakami: "Norwegian Wood", "Kafka on その Shore" (Japan, 1980s-present)
- Chimamanda Ngozi Adichie: "Half の a Yellow Sun", "Americanah" (Nigeria, 2000s)

## Literary Devices と Techniques
...
- **Irony**: Contrast between expectation と reality (verbal, situational, dramatic)
- **Symbolism**: Objects representing abstract ideas
- **Imagery**: Descriptive 言語 appealing to senses

### Narrative Techniques
- **Point の View**: First person, second person, third person (limited, omniscient)
- **Stream の Consciousness**: Continuous flow の thoughts
- **Unreliable Narrator**: Narrator whose credibility is compromised
- **Non-linear Narrative**: イベント presented out の chronological order
- **Foreshadowing**: Hints about 未来 イベント
- **Flashback**: Scenes from earlier で その story

### Structural Elements
- **Plot**: Exposition, rising action, climax, falling action, resolution
- **Character 開発**: Protagonist, antagonist, dynamic/static characters
- **Setting**: Time, place, social context
- **Theme**: Central message or underlying meaning
- **Tone**: Author's attitude toward subject
- **Mood**: Emotional atmosphere created のために reader

## Cultural Institutions

### Museums と Galleries
- Louvre (Paris): World's largest art museum
- Metropolitan Museum の Art (New York): Comprehensive collections
- British Museum (London): Human 歴史 と 文化
- Vatican Museums (Vatican City): Renaissance art, Sistine Chapel
- Uffizi Gallery (Florence): Italian Renaissance masterpieces
- Hermitage Museum (St. Petersburg): One の oldest と largest museums
- Museum の Modern Art - MoMA (New York): Modern と contemporary art

### Literary Awards
- Nobel Prize で 文学: International recognition
- Pulitzer Prize (USA): Fiction, drama, 歴史, poetry
- Booker Prize (UK/Commonwealth): Best original novel
- Hugo Award: 科学 fiction と fantasy
- National Book Award (USA): American 文学
- Man Booker International Prize: Translated fiction

## Key Concepts で Art Criticism

### Analysis Frameworks
- **Formalism**: Focus on visual elements (line, color, composition)
- **Iconography**: Symbolic meanings と cultural references
...
- **Contrast**: Differences で elements (light/dark, large/small)
- **Emphasis**: Focal points, areas の interest
- **Movement**: Visual flow guiding viewer's eye
- **Pattern**: Repetition の elements
- **Proportion**: Size relationships between parts
- **Unity**: Coherence と harmony の whole composition
