...
＃＃ まとめ
最新の Perl のイディオムは、`use strict; use warnings;`、シグネチャ、たとえば、postderef、および最新の OOP (5.38 以降の class キーワード) を強調しています。リンティングについては perlcritic 、フォーマットについては perltidy に従ってください。 Perl は TMTOWTDI (There's More Than One Way To Do It) を重視していますが、最新の Perl はよりクリーンで保守しやすいパターンに収束しています。