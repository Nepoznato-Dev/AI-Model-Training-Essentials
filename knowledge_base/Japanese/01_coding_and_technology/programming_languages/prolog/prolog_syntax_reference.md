...
＃＃ まとめ
Prolog の構文は、ファクト、ルール、クエリという最小限のものです。その力は、言語を論理的な解決策のための検索エンジンに変える統合とバックトラッキングから生まれます。 DCG はエレガントなパーサー生成を提供します。リストでは、先頭/末尾のパターン マッチングが使用されます。制約充足、エキスパート システム、記号計算については、Prolog の宣言的アプローチにより、命令型言語では冗長になる問題が解決されます。