...
**構成:** 10 のテーマ別ディレクトリ + 34 のプログラミング言語リファレンス
---
...
| [embedded_systems_and_iot.md](01_coding_and_technology/embedded_systems_and_iot.md)|マイクロコントローラー、センサー、RTOS、IoT プロトコル、エッジ コンピューティング |
...
|言語 |パス | |言語 |パス |
|----------|------|-|----------|------|
|パイソン | `programming_languages/python/`| | JavaScript | `programming_languages/javascript/`|
| C | `programming_languages/c/`| | C++ | `programming_languages/cpp/`|
|ジャワ | `programming_languages/java/`| | C# | `programming_languages/csharp/`|
|行く | `programming_languages/go/`| |さび | `programming_languages/rust/`|
|タイプスクリプト | `programming_languages/typescript/`| | SQL | `programming_languages/sql/`|
|ルビー | `programming_languages/ruby/`| | PHP | `programming_languages/php/`|
|スイフト | `programming_languages/swift/`| |コトリン | `programming_languages/kotlin/`|
| R | `programming_languages/r/`| |ビジュアルベーシック | `programming_languages/visual_basic/`|
|ダーツ | `programming_languages/dart/`| |スカラ座 | `programming_languages/scala/`|
|ハスケル | `programming_languages/haskell/`| |ジュリア | `programming_languages/julia/`|
|ルア | `programming_languages/lua/`| |パール | `programming_languages/perl/`|
| Erlang/エリクサー | `programming_languages/erlang_and_elixir/`| | OCaml | `programming_languages/ocaml/`|
|プロローグ | `programming_languages/prolog/`| | Lisp/Clojure | `programming_languages/lisp_and_clojure/`|
|エイダ | `programming_languages/ada/`| |組み立て | `programming_languages/assembly/`|
| MATLAB | `programming_languages/matlab/`| |フォートラン | `programming_languages/fortran/`|
|コボル |  XQZマーカー30XQZ | |シェル/パワーシェル | `programming_languages/shell_and_powershell/`|
|デルフィ/パスカル | `programming_languages/delphi_object_pascal/`| |スクラッチ | `programming_languages/scratch/`|
### 02 — AI と機械学習
|ファイル |説明 |
|------|---------------|
...
| [data_ethics_and_privacy.md](03_data_science_and_analytics/data_ethics_and_privacy.md)| GDPR、データ同意、アルゴリズムバイアス、ダークパターン、匿名化 |
| [ensemble_methods.md](03_data_science_and_analytics/ensemble_methods.md)|バギング、ブースティング、スタッキング、投票、ランダム フォレスト、XGBoost |
| [feature_engineering.md](03_data_science_and_analytics/feature_engineering.md)|変換、エンコーディング、特徴選択、次元削減 |
| [geospatial_analysis.md](03_data_science_and_analytics/geospatial_analysis.md)|座標系、空間操作、GeoPandas、ラスター解析 |
### 04 — 自然科学
|ファイル |説明 |
|------|---------------|
...
|ファイル |説明 |
|------|---------------|
| [business_and_economics.md](05_business_and_economics/business_and_economics.md)|企業構造、マーケティング、経済、スタートアップ |
| [finance_and_investing.md](05_business_and_economics/finance_and_investing.md)|個人金融、投資、市場、退職 |
| [law_and_legal_systems.md](05_business_and_economics/law_and_legal_systems.md)|法制度、契約、不法行為、知的財産、雇用 |
| [marketing_and_digital_strategy.md](05_business_and_economics/marketing_and_digital_strategy.md)| 4P、デジタルチャネル、SEO/SEM、アナリティクス、ブランド戦略 |
| [management_and_project_methodologies.md](05_business_and_economics/management_and_project_methodologies.md)|リーダーシップ、アジャイル/スクラム/カンバン、OKR、リスク管理 |
| [behavioural_economics.md](05_business_and_economics/behavioural_economics.md)|認知バイアス、プロスペクト理論、ヒューリスティック、ナッジ、選択アーキテクチャ |
| [game_theory.md](05_business_and_economics/game_theory.md)|ナッシュ均衡、囚人のジレンマ、機構設計、オークション |
| [intellectual_property_and_innovation.md](05_business_and_economics/intellectual_property_and_innovation.md)|特許、著作権、商標、企業秘密、オープンソース ライセンス |
| [organisational_design_and_culture.md](05_business_and_economics/organisational_design_and_culture.md)|組織構造、文化タイプ、変更管理、チームダイナミクス |
| [supply_chain_and_operations.md](05_business_and_economics/supply_chain_and_operations.md)|在庫管理、無駄のない製造、物流、鞭効果 |
### 06 — 人文科学と芸術
|ファイル |説明 |
|------|---------------|
...
|ファイル |説明 |
|------|---------------|
| [dictionary.md](07_general_reference/dictionary.md)|包括的な単語の定義 (A ～ Z) |
| [general_knowledge.md](07_general_reference/general_knowledge.md)|太陽系、人体、地理、エネルギー |
| [technology_and_computing.md](07_general_reference/technology_and_computing.md)|コンピューティングの基礎、インターネット、データベース、クラウド、セキュリティ |
| [safe_communication.md](07_general_reference/safe_communication.md)|コミュニケーションのガイドラインとベストプラクティス |
| [learning_science_and_pedagogy.md](07_general_reference/learning_science_and_pedagogy.md)|検索の練習、間隔をあけた繰り返し、ブルームの分類法、学習デザイン |
| [research_methodology.md](07_general_reference/research_methodology.md)|科学的方法、サンプリング、妥当性、実験計画、ピアレビュー |
| [writing_and_communication.md](07_general_reference/writing_and_communication.md)|ピラミッド原則、プレゼンテーション、説得、ビジネスライティング |
### 08 — 将来とトレンド
|ファイル |説明 |
|------|---------------|
...
|ファイル |説明 |
|------|---------------|
| [ai_llm_failures.md](09_lessons_from_failures/ai_llm_failures.md)|幻覚、偏見、調整の失敗 |
| [code_quality_issues.md](09_lessons_from_failures/code_quality_issues.md)|よくあるコーディングの間違いとアンチパターン |
| [cognitive_logical_issues.md](09_lessons_from_failures/cognitive_logical_issues.md)|推論の誤りと認知バイアス |
| [rag_vector_search.md](09_lessons_from_failures/rag_vector_search.md)| RAG とベクター検索の落とし穴 |
| [security_vulnerabilities.md](09_lessons_from_failures/security_vulnerabilities.md)|一般的なセキュリティ脆弱性 |
| [system_reliability.md](09_lessons_from_failures/system_reliability.md)|システム障害と信頼性のパターン |
| [api_design_and_integration_failures.md](09_lessons_from_failures/api_design_and_integration_failures.md)| API アンチパターン、重大な変更、バージョン管理の失敗、カスケード失敗 |
| [data_pipeline_and_etl_failures.md](09_lessons_from_failures/data_pipeline_and_etl_failures.md)|スキーマ ドリフト、重複データ、検証ギャップ、パイプライン監視 |
| [ml_project_failures.md](09_lessons_from_failures/ml_project_failures.md)|データ漏洩、期待値の不一致、展開の失敗、モデルの崩壊 |
### 10 — クイックリファレンス
|ファイル |説明 |
|------|---------------|
...
2.XQZマーカー1XQZ 
3.XQZマーカー2XQZ 
4.`01_coding_and_technology/programming_languages/python/`で言語を選択します
### ソフトウェア開発者向け
1.`01_coding_and_technology/programming_languages/python/`(または選択した言語)
2.XQZマーカー1XQZ 
3.XQZマーカー2XQZ 
4.XQZマーカー3XQZ 
5.XQZマーカー4XQZ 
...
## 重要な免責事項
- **医療情報:**`medicine_and_healthcare.md`のコンテンツは教育目的のみであり、専門的な医学的アドバイスに代わるものではありません。
- **法的情報:**`law_and_legal_systems.md`の内容は情報提供であり、法的アドバイスを構成するものではありません。
- **財務情報:**`finance_and_investing.md`のコンテンツは教育的なものであり、財務上のアドバイスとみなされるべきではありません。
- **将来の予測:**`08_future_and_trends/`のコンテンツには、変更される可能性のある推測情報と予測が含まれています。
---

## 使用ガイドライン
### AI システム向け
- すべてのファイルは明確な階層見出しを使用します (`#` タイトル、`##` セクション、`###` サブセクション)
- 表は全体を通して構造化された比較に使用されます
- コード例には構文の強調表示が含まれています
- 相互参照では相対マークダウン リンクを使用します
### 人間の読者向け
- ファイルは会話のような中立的な口調で書かれています
- 密な段落の代わりに表と構造化された比較が使用されます
- 現実世界の例とアナロジーは、抽象的な概念を定着させるのに役立ちます
- 各ファイルには概要セクションが含まれています
---

## 貢献とメタデータ
このナレッジ ベース内のすべてのコンテンツ ファイル (この`README.md`を除くすべて) は、YAML フロントマター ブロックで開きます。[skills](../../skills/skill-creator.md)で使用されているものと同じ投稿者追跡パターンに従っているため、両方のコレクションにわたって著者、編集、レビューを追跡できる状態が維持されます。一般的なコントリビューション ワークフロー (フォーク、分岐、プル リクエスト、ファイルの配置、命名規則) については、ルート[CONTRIBUTING.md](../../CONTRIBUTING.md)を参照してください。
### フロントマター スキーマ
各ファイルはこのブロック (`---` 区切り記号の間) で始まり、5 つのコメント付きセクションに分割されます。
```yaml
---
# Metadata
...
|フィールド |出典/目的 |
|---|---|
| `title`|ファイルの最初の`#`見出しから取得 |
| `description`|一行の要約。トピック ファイルはこの README のインデックスのエントリを再利用し、プログラミング言語ファイルは生成された説明を使用します。
| `category`/`reviewed_by`|親ディレクトリから派生 (`01_coding_and_technology` → "コーディングとテクノロジ" / "コーディングとテクノロジ ナレッジ ベース チーム") |
| `version`|セマンティックバージョン。各編集でバンプします (以下を参照) |
| `authors`/`contributors`|元の作成者とそれ以降にファイルを編集した人 |
| `changelog`|追加専用の変更リスト (最新のものから順) |
| `review_date`/`next_review`|スキル レビュー スケジュールを反映した、約 6 か月と約 1 年のペース |
| `tags`|ファイル名トークンとクリーン カテゴリ キーワード (例:`coding-and-technology`) |
| `difficulty_level`|カテゴリごとに設定し、言語ごとにオーバーライドします (例: Haskell/Assembly →`advanced`、Scratch →`beginner`)。
| `estimated_reading_time`|行数から計算 |
### ファイルの編集
ナレッジ ベース ファイルを変更するときは、そのフロントマターの同期を維持します。
1. **[SemVer](https://semver.org/)に続いて`version`** をバンプします:
   - パッチ (`1.0.x`): タイプミス、書式設定、軽微な修正
   - マイナー (`1.x.0`): 新しいセクション、拡張されたコンテンツ、新しい例
   - メジャー (`x.0.0`): 完全な書き換えまたは再構築
2. 変更内容を説明する **変更ログ エントリを追加** (新しいものから順):   ```yaml
   changelog:
     - version: "1.1.0"
       date: "2026-08-05"
       author: "Your Name"
     ...
     - version: "1.0.0"
       ...
       changes: "Added YAML frontmatter metadata for contributor tracking"
   ```
3. **`last_modified` **を変更の日付に更新します
4. ファイルを初めて編集する場合は、**自分自身を`contributors`** に追加します。   ```yaml
   contributors:
     - name: "Your Name"
...
### 品質チェックリスト
新しいナレッジ ベース ファイルまたは編集したナレッジ ベース ファイルを送信する前に、次のことを確認してください。
- [ ] YAML フロントマターは完全で有効です (`---` 区切り文字の間に、5 つのセクションがすべて存在します)
- [ ]`title`、`description`、`category`、`version`、`status`が設定されています
- [ ] 少なくとも 1 人の著者が`authors`にリストされています 
- [ ]`changelog`には、変更を文書化するエントリがあります (新しい順)
- [ ]`last_modified`は今日の日付を反映します
- [ ]`tags`には、3 ～ 6 個の関連キーワードとクリーン カテゴリ キーワードが含まれます
- [ ] `difficulty_level`が設定されています(初級/中級/上級)
- [ ]`estimated_reading_time`はコンテンツの長さとしては現実的です
- [ ] 本文の内容は上記の[Usage Guidelines](#usage-guidelines)に続きます
- [ ] 壊れた相互参照はありません
---

*このナレッジ ベースは、継続的に改善および拡張されている生きたドキュメントのコレクションです。*