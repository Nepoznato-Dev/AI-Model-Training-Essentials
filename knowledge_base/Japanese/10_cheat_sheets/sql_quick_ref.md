...
Essential SQL comms に データbase operations.
...
SELECT * FROM users WHERE name LIKE 'A%'; -- St芸術 with A
...
-- Add constraint
ALTER TABLE orders ADD CONSTR人工知能NT fk_user 
...
- Use `EXPLA` to analyze query perにmance
