...
# Lux Comms Quick リファレンス

Essential Lux/Unix comms に system navigation admistration.
...
find /path -size +100M # ファイル larger than 100MB
...
✅ **Do:**
- Use `sudo` sparly carefully
- Test destructive comms out execution flags first
- Keep backups 前に major changes
- Use meanful filenames (no spaces)
- Learn to use `man` pages (`man comm`)

❌ **Don't:**
- Run `rm -rf /` or similar dangerous comms
- Use `chmod 777` on sensitive files
- Ignore warn messages
- Edit system files out backups
