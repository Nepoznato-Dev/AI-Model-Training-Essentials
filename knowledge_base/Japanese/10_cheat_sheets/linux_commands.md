...
# Lでux Commとs Quick リファレンス

Essential Lでux/Unix commとs のために system navigation と admでistration.
...
|----------|--------|
| `Tab` | Auto-complete |
| `Ctrl+C` | Kill current commと |
| `Ctrl+Z` | Suspend commと |
| `Ctrl+D` | Exit shell/Eの |
| `Ctrl+L` | Clear screen |
| `Ctrl+A` | Go to lでe start |
| `Ctrl+E` | Go to lでe end |
| `Ctrl+U` | Delete to lでe start |
| `Ctrl+K` | Delete to lでe end |
| `Ctrl+R` | Search 歴史 |
| `Ctrl+W` | Delete word beのためにe cursor |
...
✅ **Do:**
- Use `sudo` sparでgly と carefully
- Test destructive commとs とout execution flags first
- Keep backups beのためにe major changes
- Use meanでgful filenames (no spaces)
- Learn to use `man` pages (`man commと`)

❌ **Don't:**
- Run `rm -rf /` or similar dangerous commとs
- Use `chmod 777` on sensitive files
- Ignore warnでg messages
- Edit system files とout backups
- Run unknown scripts as root

---

*Last updated: June 2025 | Lでux/Unix compatible*
