...
# Git コマンドのクイック リファレンス
バージョン管理に必須の Git コマンド。
---
...
## ベストプラクティス
✅ **実行してください:**
- 明確で説明的なコミット メッセージを作成する
- 論理グループを使用して頻繁にコミットする
- 機能/修正にはブランチを使用します
- 作業を始める前に引っ張ってください
-`git status`を頻繁にレビューします
❌ **してはいけないこと:**
- 機密データ (API キー、パスワード) をコミットする
- 共有ブランチへの強制プッシュ
- 大きなバイナリ ファイルをコミットする
- マージ競合を無視する
- メイン/マスター上で直接作業
