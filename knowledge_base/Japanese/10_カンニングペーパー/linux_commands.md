...
# Linux コマンド クイックリファレンス

Essential Linux/Unix コマンド のために system navigation と administration.
...
✅ **Do:**
- Use `sudo` sparingly と carefully
- Test destructive コマンド without execution flags first
- Keep backups before major changes
- Use meaningful filenames (no spaces)
- Learn to use `man` pages (`man command`)

❌ **Don't:**
- Run `rm -rf /` or similar dangerous コマンド
