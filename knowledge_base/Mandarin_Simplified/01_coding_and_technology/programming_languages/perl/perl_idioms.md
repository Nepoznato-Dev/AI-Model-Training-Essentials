...
# Perl — 惯用模式和最佳实践
本指南涵盖了编写干净、现代 Perl (5.38+) 代码的惯用模式和最佳实践。
---
...
＃＃ 概括
现代 Perl 习语强调：`use strict; use warnings;`、签名、postderef 和现代 OOP（5.38+ 中的 class 关键字）。按照 perlcritic 进行 linting，按照 perltidy 进行格式化。 Perl 重视 TMTOWTDI（有不止一种方法可以做到这一点）——但现代 Perl 集中于更干净、更可维护的模式。