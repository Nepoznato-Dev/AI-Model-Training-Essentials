...
-->
# PHP — 惯用模式和最佳实践
本指南涵盖了编写干净、现代的 PHP (8.3+) 代码的惯用模式和最佳实践。
---
...
＃＃ 概括
现代 PHP 习惯用法强调：类型声明、只读属性、枚举、匹配表达式、构造函数提升、空安全运算符、命名参数和纤程。样式遵循 PSR-12，静态分析遵循 PHPStan，格式化遵循 Laravel Pint 或 PHP-CS-Fixer。现代 PHP (8.3+) 是一种干净、类型安全的语言 — 拥抱新功能并避免遗留模式。