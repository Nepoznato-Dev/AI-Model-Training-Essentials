...
---
# Delphi / Object Pascal — 惯用模式和最佳实践
本指南涵盖了编写干净的 Delphi 和 Object Pascal 代码的惯用模式。
---

## 使用 try/finally 进行资源管理
```delphi
...
＃＃ 概括
Delphi 习语强调：`try/finally` 用于确定性资源清理、`Format` 用于字符串构建、松散耦合接口、数据载体记录、特定异常处理以及泛型和匿名方法等现代功能。 Delphi 重视显式资源管理——“创建它、使用它、最后释放它”。