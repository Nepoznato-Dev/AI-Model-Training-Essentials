...
---
# Delphi / Object Pascal — 语法参考
本文档为 Delphi/Object Pascal 提供了全面的、结构化的语法参考。它通过关注详尽的语法模式、OOP 功能、泛型、记录和语言习语来补充主要的 Delphi 参考资料。
---
...
＃＃ 概括
Delphi/Object Pascal 将简洁、可读的语法与强大的 OOP 功能相结合。类、接口、泛型和记录为应用程序开发提供了完整的工具包。该语言的显式开始/结束块、类型变量和不区分大小写的标识符使其易于使用。 VCL/FMX 框架通过可视化组件库扩展了语言，以实现快速应用程序开发。对于企业 Windows 应用程序和数据库前端，Delphi 仍然是一个高效的选择。