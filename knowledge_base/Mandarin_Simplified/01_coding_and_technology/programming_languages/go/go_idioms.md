...
---
# Go — 惯用模式和最佳实践
本指南涵盖了编写干净、惯用的 Go 代码的惯用模式和最佳实践。
---
...
＃＃ 概括
Go 惯用语强调：简单性、显式错误处理、小接口、继承之上的组合、具有上下文的 goroutine 以及“接受接口，返回结构”。按照`gofmt`进行格式化，按照`golangci-lint`进行 linting，以及官方的 Go 代码审查注释指南。 Go 社区重视可读性、简单性和“显而易见的方法”。避免聪明的代码——Go 代码应该是无聊且可预测的。