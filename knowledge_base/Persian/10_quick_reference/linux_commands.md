---
# فراداده
عنوان: "مرجع سریع دستورات لینوکس"
توضیحات: "مرجع خط فرمان لینوکس"
دسته بندی: "مرجع سریع"
نسخه: "1.0.0"
وضعیت: "فعال"
# مشارکت
...
# طبقه بندی
برچسب‌ها: [لینوکس، دستورات، مرجع سریع]
سطح سختی: "مبتدی"
پیش نیاز: []
...
---
# مرجع سریع دستورات لینوکس
دستورات ضروری لینوکس/یونیکس برای ناوبری و مدیریت سیستم.
---
...
|----------|--------|
| `Tab`| تکمیل خودکار |
|  __محافظت شده_1__ | کشتن دستور فعلی |
| `Ctrl+Z`| دستور تعلیق |
|  __محافظت شده_3__ | خروجی پوسته/EOF |
| `Ctrl+L`| پاک کردن صفحه نمایش |
| `Ctrl+A`| رفتن به شروع خط |
|  __محافظت شده_6__ | رفتن به انتهای خط |
| `Ctrl+U`| حذف به شروع خط |
| `Ctrl+K`| حذف تا انتهای خط |
|  __محافظت شده_9__ | تاریخچه جستجو |
| `Ctrl+W`| حذف کلمه قبل از مکان نما |
---

## بهترین شیوه ها
✅ ** انجام:**
- از`sudo`کم و با احتیاط استفاده کنید
- ابتدا دستورات مخرب را بدون پرچم های اجرایی آزمایش کنید
- قبل از تغییرات عمده، نسخه پشتیبان تهیه کنید
- استفاده از نام فایل های معنی دار (بدون فاصله)
- آموزش استفاده از صفحات`man`(`man command`)
❌ **نکن:**
-`rm -rf /`یا دستورات خطرناک مشابه را اجرا کنید
- از`chmod 777`در فایل های حساس استفاده کنید
- پیام های هشدار را نادیده بگیرید
- ویرایش فایل های سیستم بدون پشتیبان
- اسکریپت های ناشناخته را به عنوان روت اجرا کنید
---

*آخرین به روز رسانی: جولای 2026 | سازگار با لینوکس/یونیکس*