---
# فراداده
عنوان: "بهترین شیوه های امنیتی"
توضیحات: "OWASP Top 10، اعتبار سنجی ورودی، احراز هویت، مدیریت اسرار"
...
# طبقه بندی
برچسب ها: [امنیت، بهترین، شیوه ها، کدگذاری و فناوری]
سطح سختی: "متوسط"
پیش نیاز: []
...
- فقط مبداهای خاص را مجاز کنید (هرگز`*`در تولید نشود).
...
| **SOPS** | اسرار موجود در فایل ها را رمزگذاری کنید و آنها را متعهد کنید (با KMS یا GPG) |
