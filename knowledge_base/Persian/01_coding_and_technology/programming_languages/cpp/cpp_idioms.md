...
---
# C++ - الگوهای اصطلاحی و بهترین شیوه ها
این راهنما الگوهای اصطلاحی و بهترین شیوه ها برای نوشتن کدهای C++ (20/23) تمیز و مدرن را پوشش می دهد.
---

## RAII و اشاره گرهای هوشمند
```cpp
...
## خلاصه
اصطلاحات مدرن C++ تاکید دارند: RAII و اشاره گرهای هوشمند، معناشناسی حرکت،`auto`برای کسر نوع، محدوده ها و الگوریتم ها (C++20)، مفاهیم برای محدودیت های قالب،`std::optional`/`std::expected`برای عدم وجود/خطا، قانون XXQZMARKER، محاسبه زمان صفر، XXQZMARKER.`clang-format`را برای قالب‌بندی،`clang-tidy`را برای لینتینگ دنبال کنید و با`-Wall -Wextra -Werror`کامپایل کنید. جامعه C++ برای انتزاعات با هزینه صفر ارزش قائل است و «برای چیزی که استفاده نمی‌کنید پولی پرداخت نکنید».