...
## خلاصه
اصطلاحات Prolog تاکید دارند: تطبیق الگو در سرها، بازگشت دم با انباشته‌کننده‌ها، برش‌های سبز برای کارایی، و سبک اظهاری. از قراردادهای سبک Prolog پیروی کنید. Prolog برای خلوص منطقی ارزش قائل است - "رابطه برنامه است."