...
| `-`| تفریق | `3 - 2`| `1`| |
| `*`| ضرب | `3 * 2`| `6`| |
| `/`| بخش | `7 / 2`| `3`| تقسیم عدد صحیح برای ints |
| `%`| باقی مانده | `7 % 2`| `1`| منطبق بر سود سهام |
| `&`| بیتی و | `5 & 3`| `1`| |
| `\|`| بیتی OR | `5 \| 3`| `7`| |
| `^`| بیتی XOR | `5 ^ 3`| `6`| همچنین مکمل بیتی (یونری) |
| `&^`| کمی واضح (و نه) | `5 &^ 3`| `4`| منحصر به فرد برای رفتن |
| `<<`| Shift چپ | `5 << 1`| `10`| |
| `>>`| شیفت راست | `5 >> 1`| `2`| |
### مقایسه اپراتورها
| اپراتور | نام | مثال | یادداشت ها |
|----------|------|---------|-------|
| `==`| برابر | `x == y`| فقط انواع قابل مقایسه |
| `!=`| برابر نیست | `x != y`| |
| `<`,`>`,`<=`,`>=`| سفارش | `x >= y`| مقایسه رشته ها از نظر لغوی |
### عملگرهای منطقی
| اپراتور | نام | مثال | یادداشت ها |
|----------|------|---------|-------|
...
## خلاصه
نحو Go عمداً حداقل است - بدون ارث، بدون بارگذاری بیش از حد روش، بدون استثنا، بدون ماکرو. آنچه باقی می ماند مجموعه ای تمیز و متعامد از ساختارها است: ساختارها و رابط ها برای ترکیب، گوروتین ها و کانال ها برای همزمانی، و مدیریت خطاهای صریح برای قابلیت اطمینان. قدرت این زبان نه از نحو پیچیده، بلکه از تعامل ظریف ابتدایی های ساده آن ناشی می شود. Generics (Go 1.18+) انعطاف‌پذیری نوع را بدون به خطر انداختن وضوح مشخصه Go اضافه می‌کند.