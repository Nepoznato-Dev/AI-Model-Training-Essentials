...
# برو - الگوهای اصطلاحی و بهترین شیوه ها
این راهنما الگوهای اصطلاحی و بهترین شیوه ها برای نوشتن کد Go تمیز و اصطلاحی را پوشش می دهد.
---
...
## خلاصه
اصطلاحات Go تاکید دارند: سادگی، مدیریت خطای صریح، رابط‌های کوچک، ترکیب‌بندی بیش از وراثت، گوروتین‌ها با زمینه، و «پذیرش رابط‌ها، ساختارهای بازگشت».`gofmt`را برای قالب‌بندی،`golangci-lint`را برای پرده‌بندی، و راهنمای رسمی نظرات مرور کد Go را دنبال کنید. جامعه Go برای خوانایی، سادگی و «روش واضح برای انجام آن» ارزش قائل است. از کد هوشمندانه اجتناب کنید - کد Go باید خسته کننده و قابل پیش بینی باشد.