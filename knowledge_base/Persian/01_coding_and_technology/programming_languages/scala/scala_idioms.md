...
---
# Scala - الگوهای اصطلاحی و بهترین شیوه ها
این راهنما الگوهای اصطلاحی و بهترین شیوه ها برای نوشتن کدهای تمیز و کاربردی Scala 3 را پوشش می دهد.
---
...
## خلاصه
اصطلاحات اسکالا تاکید دارند: تغییرناپذیری (`val`)، تطبیق الگو، انواع مهر و موم شده، گزینه/یا برای ایمنی، درک برای درک، مجموعه‌های عملکردی، و کلاس‌های نوع (در Scala 3 داده شده/استفاده می‌شود). راهنمای سبک اسکالا را دنبال کنید، از scalafmt برای قالب بندی و scalafix برای پرده استفاده کنید. نحو پاک‌تر Scala 3، enums، انواع غیر شفاف و روش‌های پسوند، زبان را در عین حفظ قدرت عملکردی خود، قابل دسترس‌تر می‌کند.