...
## خلاصه
اصطلاحات Clojure تاکید دارند: داده های تغییرناپذیر، ماکروهای رشته ای (`->`، `->>`)، ساختارشکنی، کلمات کلیدی به عنوان توابع، و مشخصات برای اعتبارسنجی. اصطلاحات رایج Lisp تاکید دارند:`with-open`برای منابع،`push`/`nreverse`برای ایجاد فهرست، و مقادیر متعدد. هر دو به homoiconicity و توسعه مبتنی بر REPL اهمیت می دهند.