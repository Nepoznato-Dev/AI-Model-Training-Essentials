...
## خلاصه
نحو Clojure به طور یکنواخت پرانتز شده است - هر فرم یک لیست است. این همسانی ماکروهای قدرتمندی را فعال می کند که کد را به عنوان داده تبدیل می کند. ساختارهای داده پایدار با به اشتراک گذاری ساختاری برای کارایی تغییرناپذیری را فراهم می کنند. ماکروهای Threading خطوط لوله داده قابل خواندن را ایجاد می کنند. همزمانی اولیه (اتم ها، refs، عامل ها، کانال ها) تغییرات حالت را با خیال راحت مدیریت می کنند. تأثیر Lisp/Clojure بر برنامه‌نویسی مدرن بسیار زیاد است - جمع‌آوری زباله، REPL، ماکروها و برنامه‌نویسی کاربردی همه به Lisp برمی‌گردند.