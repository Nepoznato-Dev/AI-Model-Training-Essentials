...
---
# جولیا - اشتباهات رایج و ضد الگوها
این سند رایج ترین اشتباهات، تله ها و ضد الگوها در جولیا را با اصلاحات فهرست می کند.
---

## 1. Instability را در توابع تایپ کنید
```julia
...
## 2. متغیرهای جهانی در کد عملکردی- بحرانی
```julia
...
## 4. عدم استفاده از ارسال چندگانه
```julia
...
## خلاصه
عملکرد جولیا به پایداری نوع بستگی دارد: از متغیرهای سراسری در کد داغ اجتناب کنید، از ارسال چندگانه به جای if/else در انواع استفاده کنید، آرایه‌ها را از قبل تخصیص دهید، از پخش برای عملیات عناصر استفاده کنید، و در صورت لزوم انواع را حاشیه‌نویسی کنید. جولیا به توسعه دهندگانی که کدهایی با ثبات تایپ می نویسند و از ارسال چندگانه استفاده می کنند، پاداش می دهد. ماکرو`@code_warntype`بهترین دوست شما برای یافتن ناپایداری نوع است.