...
## خلاصه
اصطلاحات فرترن مدرن تاکید دارند: `implicit none`، عملیات آرایه (از حلقه ها اجتناب کنید)، آرایه های شکل فرضی، انواع مشتق شده با رویه های نوع محدود، و`intent`برای همه آرگومان ها. برای قالب بندی fprettify را دنبال کنید. Fortran مدرن (2018+) با هم‌آرایه‌ها و DO CONCURRENT از محاسبات موازی به صورت بومی پشتیبانی می‌کند.