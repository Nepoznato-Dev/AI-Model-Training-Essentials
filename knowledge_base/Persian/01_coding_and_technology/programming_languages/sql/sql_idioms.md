...
-->
# SQL - الگوهای اصطلاحی و بهترین روش ها
این راهنما الگوهای اصطلاحی و بهترین شیوه ها برای نوشتن SQL تمیز و کارآمد را پوشش می دهد.
---
...
## خلاصه
اصطلاحات SQL تاکید دارند: نام ستون های صریح، قالب بندی ثابت، CTE ها برای خوانایی، توابع پنجره برای تجزیه و تحلیل، جستجوهای SARGable برای عملکرد، و`EXPLAIN ANALYZE`برای تنظیم. برای قالب بندی SQLFluff را دنبال کنید و همیشه از پرس و جوهای پارامتری برای جلوگیری از تزریق SQL استفاده کنید.