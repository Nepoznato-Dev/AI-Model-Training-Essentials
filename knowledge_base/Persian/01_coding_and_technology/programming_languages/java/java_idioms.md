...
## خلاصه
اصطلاحات جاوا مدرن تاکید دارند: رکوردهای داده ها، کلاس های مهر و موم شده برای سلسله مراتب، تطبیق الگو، عبارات سوئیچ، بلوک های متن، جریان ها برای پردازش مجموعه، اختیاری برای عدم وجود، تلاش با منابع برای پاکسازی، رشته های مجازی برای همزمانی، و تزریق وابستگی. راهنمای سبک جاوا Google را دنبال کنید، از`javafmt`یا`Spotless`برای قالب‌بندی و از Error Prone یا Checkstyle برای پرده‌بندی استفاده کنید. جاوای مدرن (17-21+) با سوابق، کلاس های مهر و موم شده، تطبیق الگو، و رشته های مجازی مختصر و رسا است - ویژگی های جدید را در بر می گیرد.