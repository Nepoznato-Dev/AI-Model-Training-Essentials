...
## خلاصه
Erlang و Elixir از ابرقدرت‌های BEAM VM بهره می‌برند: فرآیندهای سبک وزن، ارسال پیام و درخت‌های نظارتی مقاوم در برابر خطا. نحو ارلنگ حداقل و کاربردی است. Elixir سینتکس مدرن را با لوله ها، ماکروها و پروتکل ها اضافه می کند. رفتارهای OTP (GenServer، Supervisor، Application) الگوهای آزمایش شده نبرد را برای ساختن سیستم های قابل اعتماد ارائه می دهند. برای کاربردهای بلادرنگ، توزیع شده و مقاوم در برابر خطا، Erlang/Elixir بی بدیل باقی می ماند.