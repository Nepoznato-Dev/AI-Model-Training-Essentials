...
## خلاصه
اصطلاحات Swift تاکید دارند: ایمنی (اختیاری، محافظ)، انواع ارزش (ساختارها)، طراحی پروتکل محور، تطبیق الگو، همگام/انتظار، و تغییر ناپذیری (به طور پیش فرض `let`). دستورالعمل های طراحی Swift API را دنبال کنید، از SwiftLint برای کیفیت کد و SwiftFormat برای قالب بندی استفاده کنید. سوئیفت برای ایمنی و بیان ارزش قائل است - "اگر کامپایل شود، احتمالا درست است."