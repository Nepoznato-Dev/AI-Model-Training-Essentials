...
-->
# COBOL - مرجع نحو
این سند یک مرجع جامع و ساختارمند برای COBOL (2014+) ارائه می‌کند. این مرجع COBOL اصلی را با تمرکز بر الگوهای نحوی جامع، توضیحات داده ها، پردازش فایل و منطق تجاری تکمیل می کند.
---
...
## خلاصه
نحو COBOL از نظر طراحی پیچیده است - هر عبارت مانند انگلیسی خوانده می شود. توصیف داده ها با بندهای PIC دقیقاً فرمت های فیلد را تعریف می کند. ساختار چهار بخش جداسازی نگرانی ها را اعمال می کند. مدیریت فایل در زبان ساخته شده است. برای پردازش داده های کسب و کار، حساب اعشاری COBOL و ورودی/خروجی رکورد گرا بی همتا باقی می ماند. درک COBOL به معنای درک پایه و اساس محاسبات سازمانی است.