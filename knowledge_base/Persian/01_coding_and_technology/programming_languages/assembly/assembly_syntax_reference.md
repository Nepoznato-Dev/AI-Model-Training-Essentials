...
## خلاصه
نحو زبان اسمبلی توسط معماری پردازنده و اسمبلر (NASM، GAS، MASM) تعریف می شود. x86-64 16 رجیستر همه منظوره، حالت های آدرس دهی چندگانه، و صدها دستورالعمل شامل جابجایی داده، محاسبات، منطق، جریان کنترل، SIMD و فراخوانی های سیستم را ارائه می دهد. سینتکس NASM که در اینجا استفاده می شود رایج ترین برای توسعه Linux x86-64 است. تسلط بر اسمبلی مستلزم درک رجیسترها، پشته، قراردادهای فراخوانی و چگونگی ساخت نقشه سطح بالا به دستورالعمل‌های ماشین است.