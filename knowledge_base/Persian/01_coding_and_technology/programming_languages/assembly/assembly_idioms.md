...
---
# مجمع - الگوهای اصطلاحی و بهترین شیوه ها
این راهنما الگوهای اصطلاحی برای نوشتن کد اسمبلی تمیز و قابل نگهداری (فوکوس x86/x64 با نحو NASM) را پوشش می‌دهد.
---
...
## ثبت نام کنوانسیون ها و مقدمه / پایان
```nasm
...
## خلاصه
اصطلاحات اسمبلی تاکید دارند: ثابت‌های نام‌گذاری شده روی اعداد جادویی، ماکروها برای الگوهای تکراری، تعاریف ساختار برای چیدمان داده‌ها، مقدمه/پایه‌الوگ مطابق با ABI، برچسب‌های محلی برای خوانایی، اعتبارسنجی ورودی دفاعی، و`xor`/`lea`برای عملیات کارآمد. اسمبلی بیش از همه به وضوح پاداش می دهد - "اگر نمی توانید آن را بخوانید، نمی توانید آن را در ساعت 3 صبح رفع اشکال کنید."