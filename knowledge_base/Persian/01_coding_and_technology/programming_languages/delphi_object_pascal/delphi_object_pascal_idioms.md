...
## خلاصه
اصطلاحات دلفی تاکید می‌کنند:`try/finally`برای پاکسازی منابع قطعی،`Format`برای ساخت رشته، رابط‌ها برای اتصال شل، سوابق برای حامل‌های داده، مدیریت استثناهای خاص، و ویژگی‌های مدرن مانند ژنریک و روش‌های ناشناس. دلفی برای مدیریت منابع صریح ارزش قائل است - "آن را ایجاد کنید، از آن استفاده کنید، در نهایت آن را آزاد کنید."