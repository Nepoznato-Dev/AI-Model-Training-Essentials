...
-->
# Ada - الگوهای اصطلاحی و بهترین شیوه ها
این راهنما الگوهای اصطلاحی برای نوشتن کدهای پاک و ایمن Ada را پوشش می دهد.
---
...
## خلاصه
اصطلاحات آدا تاکید دارند: تایپ قوی، انواع خصوصی برای کپسوله‌سازی، قراردادها (شرایط پیش/پس از آن)، و ادعاها. راهنمای سبک Ada را دنبال کنید، از GNATprove برای تأیید رسمی استفاده کنید. آدا بیش از همه برای ایمنی و درستی ارزش قائل است.