...
-->
# TypeScript - مرجع نحو
این سند یک مرجع ساختارمند و جامع برای TypeScript ارائه می دهد. این مرجع اصلی TypeScript را با تمرکز بر سیستم نوع، ژنریک، انواع ابزار و برنامه نویسی سطح نوع پیشرفته تکمیل می کند.
---

## اصول سیستم را تایپ کنید
### انواع اولیه و داخلی
```typescript
// Primitives
...
## دکوراتورها (TC39 Stage 3 / TypeScript 5.0+)
```typescript
// Class decorator
...
## خلاصه
سیستم نوع TypeScript ویژگی تعیین کننده آن است و به طور قابل توجهی عمیق است. از حاشیه نویسی های اولیه تا ژنریک، انواع شرطی، انواع نقشه برداری، انواع تحت اللفظی الگو، و `infer`، سیستم نوع اساساً یک زبان کاربردی است که در زمان کامپایل کار می کند. درک تعامل بین`interface`در مقابل `type`، ژنریک در مقابل انواع ابزار، و تایپ ساختاری در مقابل اسمی، از نوشتن TypeScript که هم ایمن و هم ارگونومیک است، پشتیبانی می‌کند. این زبان همچنان به تکامل خود ادامه می‌دهد، با هر نسخه قدرت بیان بیشتری را در حالی که سازگاری کامل با جاوا اسکریپت حفظ می‌کند.