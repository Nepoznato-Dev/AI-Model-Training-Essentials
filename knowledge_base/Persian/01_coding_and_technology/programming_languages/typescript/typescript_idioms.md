...
---
# TypeScript - الگوهای اصطلاحی و بهترین روش ها
این راهنما الگوهای اصطلاحی و بهترین شیوه ها برای نوشتن کد TypeScript تمیز و ایمن را پوشش می دهد.
---
...
## خلاصه
اصطلاحات TypeScript تاکید دارند: بررسی دقیق نوع، رابط‌ها برای اشکال شیء، اتحادیه‌های متمایز برای حالت، محافظ‌های نوع برای باریک کردن، ژنریک‌ها با محدودیت،`readonly`برای تغییرناپذیری، و`as const`برای انواع تحت اللفظی. ESLint را با`typescript-eslint`دنبال کنید، برای قالب بندی زیباتر است، و همیشه`strict: true`را فعال کنید. جامعه TypeScript برای ایمنی نوع ارزش قائل است - اگر کامپایل شود، احتمالاً کار می کند.`interface`را برای اشکال شیء،`type`را برای اتحادیه ها و ابزارهای کاربردی ترجیح دهید و به هر قیمتی از`any`اجتناب کنید.