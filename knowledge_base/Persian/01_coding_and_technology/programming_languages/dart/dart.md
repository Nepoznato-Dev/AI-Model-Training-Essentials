...
## چرا دارت مهم است
- **Flutter**: زبان اصلی برای Flutter - یکی از فریمورک‌های متقابل پلتفرم با سریع‌ترین رشد.
- **پلتفرم متقابل**: پایگاه کد واحد برای iOS، اندروید، وب، ویندوز، macOS، لینوکس و دستگاه های جاسازی شده.
- **مولد**: بارگذاری مجدد داغ، کتابخانه غنی ویجت، و نحو رسا توسعه UI را سریع می کند.
- **ایمنی تهی صدا **: ایمنی پوچ در زمان کامپایل خطاهای مرجع تهی را حذف می کند.
- ** عملکرد **: به کد ARM بومی برای موبایل کامپایل می شود. نیازی به پل نیست
- **اکوسیستم در حال رشد**: اکوسیستم بسته فلاتر به سرعت در حال گسترش است.
## مبادلات
| محدودیت | جزئیات | راه حل معمولی |
|-----------|---------|-------------------|
| **فلاتر محور** | بیشترین استفاده از دارت فلاتر است. محدود خارج از آن | استفاده برای فلاتر؛ زبان های دیگر برای کار غیر UI |
| **اکوسیستم کوچکتر** | بسته های کمتر از React Native یا پلتفرم های بومی | رشد سریع؛ کانال های پلت فرم برای API های بومی |
| **عملکرد وب** | دارت کامپایل شده در WASM هنوز در حال بلوغ است | از رندر CanvasKit برای عملکرد ثابت استفاده کنید |
| **بازار کار** | نقش‌های فلاتر وجود دارند اما کمتر از تلفن همراه بومی | تقاضای رو به رشد برای توسعه دهندگان کراس پلتفرم |
| **برای باطن نیست** | ممکن است (دارت سمت سرور) اما مورد استفاده نیست | از Go، Node.js، Python برای Backend |
---
...
### الگوی 2: مدیریت ایالت ارائه دهنده
```dart
...
| حالت | هنگام استفاده | راه اندازی | زمان اجرا | مورد استفاده |
|------|-----------|---------|--------|----------|
...
## چه زمانی از دارت استفاده کنیم
| سناریو | چرا دارت (فلاتر) | جایگزین بهتر |
|------------------------------------------------------------------|
| برنامه های موبایل چند پلتفرمی | فلاتر عالی است | React Native، بومی سوئیفت/کاتلین |
| دسکتاپ کراس پلتفرم | فلاتر از آن پشتیبانی می کند | الکترون، سی شارپ، آوالونیا |
| برنامه های کاربردی وب | فلاتر وب وجود دارد | React، Vue، Angular برای برنامه های وب غنی تر |
| رابط های کاربری تعبیه شده | فلاتر برای تعبیه شده | C، LVGL |
...
## خلاصه
هدف دارت در زندگی فلاتر است. به عنوان یک زبان مستقل، شایسته است، اما قابل توجه نیست. به عنوان موتور پشت فلاتر، توسعه دهندگان را قادر می سازد تا برنامه های زیبا و با کارایی بالا را برای هر پلتفرم اصلی از یک پایگاه کد واحد بسازند. اگر در حال ساخت اپلیکیشن های چند پلتفرمی برای موبایل یا دسکتاپ هستید، Dart + Flutter یکی از بهترین گزینه های موجود است. برای هر چیز دیگری، زبان های دیگر مناسب تر هستند.