...
-->
# دارت - الگوهای اصطلاحی و بهترین شیوه ها
این راهنما الگوهای اصطلاحی و بهترین شیوه ها برای نوشتن کد دارت تمیز و اصطلاحی را پوشش می دهد.
---
...
## خلاصه
اصطلاحات دارت تأکید دارند: ایمنی پوچ، سازنده‌های const، رکوردها و تطبیق الگو (دارت 3)، روش‌های غیرهمگام/انتظار و گسترش. راهنمای Dart موثر را دنبال کنید، از`dart format`برای قالب بندی و`dart analyze`برای پرده زدن استفاده کنید. دارت برای ایمنی و بهره وری ارزش قائل است - با فلاتر «یک بار بنویس، هر جا بدو».