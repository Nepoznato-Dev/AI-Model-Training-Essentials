...
-->
# Haskell - الگوهای اصطلاحی و بهترین شیوه ها
این راهنما الگوهای اصطلاحی و بهترین شیوه‌ها برای نوشتن کد هسکل تمیز و اصطلاحی را پوشش می‌دهد.
---
...
## خلاصه
اصطلاحات هسکل بر این موارد تاکید دارند: انواع قوی، تطبیق الگو، موناد برای جلوه ها، عملکردهای خالص و ارزیابی تنبل (با سختگیری در صورت نیاز). راهنمای سبک Haskell را دنبال کنید، از`hlint`برای پیشنهادات و`fourmolu`برای قالب بندی استفاده کنید. هسکل به صحت و ترکیب ارزش می دهد - "حالت های غیرقانونی را غیرقابل بازنمایی کنید."