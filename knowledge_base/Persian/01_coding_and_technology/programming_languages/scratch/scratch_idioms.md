...
## خلاصه
اصطلاحات Scratch تاکید دارند: نام‌گذاری واضح sprite، یک مسئولیت در هر جن، پیام‌های پخش برای ارتباط، بلوک‌های سفارشی برای استفاده مجدد، شبیه‌سازی برای چندین نمونه، حلقه‌های بازی ساختاریافته، و "اجرای بدون بازخوانی صفحه" برای عملکرد. سازمان پاداش خراش - "یک جن با نام خوب نیمی از برنامه است."