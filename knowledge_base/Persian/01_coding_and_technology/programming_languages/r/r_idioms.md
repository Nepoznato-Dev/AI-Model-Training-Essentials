...
## خلاصه
اصطلاحات R تاکید دارند: بردارسازی (اجتناب از حلقه ها)، لوله های مرتب (`|>`)،`<-`برای انتساب، نامگذاری snake_case، و برنامه نویسی کاربردی با `purrr`. راهنمای سبک Tidyverse را دنبال کنید، از lintr برای پرده‌بندی و از styler برای قالب‌بندی استفاده کنید. R عملیات برداری و لوله را برای تبدیل داده های قابل خواندن ارزش گذاری می کند.