...
# ویژوال بیسیک - الگوهای اصطلاحی و بهترین شیوه ها
این راهنما الگوهای اصطلاحی برای نوشتن کدهای ویژوال بیسیک (.NET) تمیز را پوشش می دهد.
---

## گزینه Strict & Type Safety
```vb
...
## خلاصه
اصطلاحات ویژوال بیسیک تاکید دارند:`Option Strict On`برای ایمنی نوع، بلوک های`Using`برای مدیریت منابع، درون یابی رشته ها، LINQ برای مجموعه ها،`Async/Await`در سراسر، مدیریت استثناهای خاص، و ویژگی های مدرن مانند تطبیق الگو و عملگرهای شرطی تهی. VB خوانایی را ارزش گذاری می کند - "کد باید مانند یک مشخصات به خوبی سازماندهی شده خوانده شود."