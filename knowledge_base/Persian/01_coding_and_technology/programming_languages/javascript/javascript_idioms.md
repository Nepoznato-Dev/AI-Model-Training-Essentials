...
-->
# جاوا اسکریپت - الگوهای اصطلاحی و بهترین روش ها
این راهنما الگوهای اصطلاحی و بهترین شیوه ها برای نوشتن کدهای جاوا اسکریپت تمیز و مدرن (ES2024+) را پوشش می دهد.
---
...
## خلاصه
اصطلاحات جاوا اسکریپت مدرن تاکید دارند:`const`/`let`بیش از `var`، ساختارشکنی، توابع پیکان، الفاظ الگو، غیر همگام/انتظار، عملگرهای گسترش/استراحت، روش‌های آرایه (`map` / ماژول XQZQZMARKERZQZQES، XQZMARKERZQZQES، ماژول‌های XQZMARKERXQZQZQZXQZQZQES4. زنجیره اختیاری (`?.`)، ادغام بی اثر (`??`)، و فیلدهای کلاس با اعضای خصوصی. ESLint را برای کیفیت کد، زیباتر را برای قالب‌بندی دنبال کنید و الگوهای کاربردی را به حالت تغییرپذیر ترجیح دهید. جامعه جاوا اسکریپت برای مختصر بودن، ترکیب‌پذیری و ویژگی‌های مدرن ES2024+ ارزش قائل است.