...
| Técnica | Descrição |
|-----------|------------|
| **Lotes** | Agrupar várias solicitações em um único encaminhamento |
...
| **Interruptor de desligamento** | Reverta instantaneamente para o modelo anterior se forem detectados problemas |
