...
| **Previsão de links** | Prever se uma aresta existe (ou existirá) | Prever relacionamentos perdidos; recomendar conexões |
...
| Tarefa | Descrição |
|------|-------------|
| **Previsão de links** | Preveja fatos faltantes (por exemplo, "Paris é a capital de?") |
...
| **HÃ** | Rede Heterogênea de Atenção; atenção sobre diferentes tipos de nós e arestas |
