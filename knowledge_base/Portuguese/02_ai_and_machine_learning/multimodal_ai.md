...
| Etapa | Descrição |
|------|-------------|
| **1. Codificar imagem** | Um codificador de visão (ViT, SigLIP) converte a imagem em um conjunto de vetores de recursos |
...
### Principais modelos de visão-linguagem
