...
## Principais Arquiteturas Gerativas
...
### Modelos de Difusão
Os modelos de difusão são o estado da arte atual para geração de imagens e vídeos. Eles trabalham adicionando ruído gradualmente aos dados até que se torne um ruído aleatório puro e, em seguida, aprendendo a reverter o processo.
| Fase | O que acontece |
|-------|------------|
