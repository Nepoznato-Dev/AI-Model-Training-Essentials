...
|-----------|--------------|-----------|
| **Justiça** | A IA não deve discriminar grupos protegidos | Definir justiça matematicamente é surpreendentemente difícil; diferentes definições de justiça conflito |
...
## Resumo
A ética e a governança da IA ​​não são reflexões posteriores – são requisitos de engenharia. Preconceito, opacidade, custo ambiental e violações de privacidade não são apenas preocupações éticas; são insetos que causam danos reais a pessoas reais. O panorama da governação está a evoluir rapidamente, com a Lei da UE sobre IA a estabelecer o padrão global. Mas a regulamentação por si só não é suficiente. Todo desenvolvedor de IA precisa pensar em justiça, explicabilidade e responsabilidade como parte de seu trabalho diário. A questão não é se a IA deve ser governada – mas como construir sistemas que sejam dignos de confiança.