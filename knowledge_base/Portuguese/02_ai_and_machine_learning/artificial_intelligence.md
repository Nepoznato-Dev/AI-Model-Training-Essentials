...
|------|-------------|-------------|
| **Geração de texto** | Excelente — coerente, contextual, estilisticamente variado | Pode ter alucinações (gerar informações falsas com confiança) |
