...
| Etapa | Descrição |
|------|-------------|
| **1. Autocrítica** | O modelo avalia a sua própria resposta contra a constituição |
...
| **Mapas de saliência** | Mostrar quais regiões de entrada afetam mais a saída | Pode ser enganoso; não explique *por que* |
...
| **Mínimo** | Filtros de spam; jogos de vídeo | Não existem requisitos específicos |
---
