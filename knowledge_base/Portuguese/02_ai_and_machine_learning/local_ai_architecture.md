...
| FP16 | 2 | ~7,6GB | ~14GB | ~26GB | ~140 GB |
| INT8 (8 bits) | 1 | ~3,8GB | ~7GB | ~13 GB | ~70GB |
| INT4 (4 bits) | 0,5 | ~1,9GB | ~3,5GB | ~6,5GB | ~35GB |
**Diretrizes práticas:**
...
- **Q4_K_M** (4 bits): qualidade menor e aceitável para a maioria das tarefas.
...
- **Web**: Use WebLLM (roda em WebGPU via tempo de execução ONNX) ou transformers.js.
---
