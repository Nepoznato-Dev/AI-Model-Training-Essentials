...
### Quando usar Kafka
- **Streaming de eventos**: processamento de eventos em tempo real em escala.
...
|----------|----------|--------|
| **Fato** | Eventos mensuráveis ​​(métricas) | `orders`(order_id, product_id, customer_id, valor, data) |
| **Dimensão** | Atributos descritivos | `products`(id do produto, nome, categoria, preço),`customers`(id do cliente, nome, cidade) |
---
