...
# Folha de referências da sintaxe Python
Referência rápida para sintaxe e padrões comuns do Python 3.x.
---
...
- Use`"""triple quotes"""`para docstrings e strings multilinhas
- O recuo é importante (normalmente 4 espaços)
- Convenções de nomenclatura:`snake_case`para variáveis/funções,`PascalCase`para classes
-`__name__ == "__main__"`para verificar se o script é executado diretamente
- Use`virtualenv`ou`venv`para isolamento do projeto
- Instale pacotes com `pip install package_name`
---

*Última atualização: julho de 2026 | Python 3.x*