...
Os pipelines de integração contínua (CI) e implantação contínua (CD) automatizam o processo de construção, teste e implantação de software. Esta referência cobre os padrões de configuração para as plataformas CI/CD mais populares: GitHub Actions, GitLab CI e princípios gerais de design de pipeline.
---
