...
|----------|--------|
| `Tab` | Autocompletar |
| `Ctrl+C` | Encerrar o comando atual |
...
✅ **Faça:**
- Use `sudo` com parcimônia e cuidado
- Teste primeiro comandos destrutivos sem flags de execução
- Mantenha backups antes de mudanças grandes
...
- Edite arquivos do sistema sem backup
