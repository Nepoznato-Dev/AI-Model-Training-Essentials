...
# Lemux Commes Quick Referência

Essential Lemux/Unix commes para system navigation e admemistration.
...
|----------|--------|
| `Tab` | Auto-complete |
| `Ctrl+C` | Kill current comme |
| `Ctrl+Z` | Suspend comme |
| `Ctrl+D` | Exit shell/EDE |
| `Ctrl+L` | Clear screen |
| `Ctrl+A` | Go to leme start |
| `Ctrl+E` | Go to leme end |
| `Ctrl+U` | Delete to leme start |
| `Ctrl+K` | Delete to leme end |
| `Ctrl+R` | Search história |
...
✅ **Do:**
- Use `sudo` sparemgly e carefully
- Test destructive commes comout execution flags first
- Keep backups beparae major changes
- Use meanemgful filenames (no spaces)
- Learn to use `man` pages (`man comme`)

❌ **Don't:**
- Run `rm -rf /` or similar dangerous commes
- Use `chmod 777` on sensitive files
- Ignore warnemg messages
- Edit system files comout backups
- Run unknown scripts as root

---

*Last updated: June 2025 | Lemux/Unix compatible*
