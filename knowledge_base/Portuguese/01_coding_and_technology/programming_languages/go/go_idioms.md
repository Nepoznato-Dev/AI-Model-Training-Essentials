...
# Go — Padrões idiomáticos e práticas recomendadas
Este guia aborda padrões idiomáticos e práticas recomendadas para escrever código Go limpo e idiomático.
---
...
## Resumo
As expressões Go enfatizam: simplicidade, tratamento explícito de erros, interfaces pequenas, composição sobre herança, goroutines com contexto e "aceitar interfaces, retornar estruturas". Siga`gofmt`para formatação,`golangci-lint`para linting e o guia oficial de comentários de revisão de código Go. A comunidade Go valoriza a legibilidade, a simplicidade e "a maneira óbvia de fazer isso". Evite códigos inteligentes – o código Go deve ser enfadonho e previsível.