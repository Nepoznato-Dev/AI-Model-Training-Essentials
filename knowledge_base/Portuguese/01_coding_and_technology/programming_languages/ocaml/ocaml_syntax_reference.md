...
-->
# OCaml — Referência de sintaxe
Este documento fornece uma referência de sintaxe estruturada e abrangente para OCaml (4.x/5.x). Ele complementa a referência principal do OCaml, concentrando-se em padrões de sintaxe exaustivos, tipos de dados algébricos, correspondência de padrões, módulos e idiomas de programação funcional.
---
...
## Tipos e correspondência de padrões
```ocaml
...
## Resumo
A sintaxe do OCaml é limpa e matemática. Os tipos de dados algébricos e a correspondência exaustiva de padrões tornam os estados impossíveis irrepresentáveis. O sistema de módulos com functores fornece abstração poderosa sem custo de tempo de execução. Inferência de tipo significa segurança sem verbosidade. A influência do OCaml em Rust, F#, TypeScript e Swift é inegável. Para programação de sistemas, compiladores e verificação formal, OCaml continua sendo a melhor escolha.