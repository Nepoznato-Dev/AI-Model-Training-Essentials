...
## Resumo
A sintaxe do COBOL é detalhada por design — cada instrução é lida como em inglês. As descrições de dados com cláusulas PIC definem com precisão os formatos dos campos. A estrutura de quatro divisões impõe a separação de interesses. O manuseio de arquivos está embutido na linguagem. Para processamento de dados de negócios, a aritmética decimal do COBOL e a E/S orientada a registros permanecem incomparáveis. Compreender o COBOL significa compreender os fundamentos da computação empresarial.