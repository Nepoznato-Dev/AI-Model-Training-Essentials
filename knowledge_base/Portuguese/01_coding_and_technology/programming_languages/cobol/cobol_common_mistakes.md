...
---
# COBOL — Erros comuns e antipadrões
Este documento cataloga os erros, armadilhas e antipadrões mais comuns em COBOL com correções.
---

## 1. Não usar nomes de condições de 88 níveis
```cobol
* ❌ WRONG — magic numbers
...
## 4. EXECUTAR sem limites explícitos
```cobol
...
## 5. Não usar recursos COBOL modernos
```cobol
...
## Resumo
A sintaxe detalhada do COBOL esconde armadilhas: números mágicos sem nomes de condição de 88 níveis, estouro numérico de cláusulas PIC subdimensionadas, variáveis ​​não inicializadas e loops PERFORM ilimitados. O COBOL moderno (2002+) adiciona FUNCTION TRIM, PERFORM inline e outras melhorias. A maneira COBOL é: usar nomes de condições de 88 níveis, verificar ON SIZE ERROR, inicializar com VALUE e vincular todos os loops.