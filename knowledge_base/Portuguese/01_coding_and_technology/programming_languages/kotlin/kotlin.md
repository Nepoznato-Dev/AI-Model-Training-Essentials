...
---
#Kotlin
Kotlin é uma linguagem de programação compilada e de tipo estaticamente desenvolvida pela JetBrains e lançada pela primeira vez em 2011 (1.0 em 2016). Ele é executado na Java Virtual Machine (JVM) e é totalmente interoperável com Java – o que significa que você pode usar qualquer biblioteca Java do Kotlin e chamar o código Kotlin do Java sem nenhum wrapper. Em 2017, o Google anunciou o Kotlin como a linguagem preferida para o desenvolvimento do Android e, desde então, tornou-se a linguagem Android dominante.
