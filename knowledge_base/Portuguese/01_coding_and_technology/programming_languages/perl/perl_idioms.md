...
---
# Perl — Padrões Idiomáticos e Melhores Práticas
Este guia cobre padrões idiomáticos e práticas recomendadas para escrever código Perl (5.38+) limpo e moderno.
---
...
## Resumo
Os idiomas Perl modernos enfatizam:`use strict; use warnings;`, assinaturas, digamos, postderef e OOP moderno (palavra-chave de classe em 5.38+). Siga perlcritic para linting e perltidy para formatação. Perl valoriza TMTOWTDI (há mais de uma maneira de fazer isso) - mas o Perl moderno converge para padrões mais limpos e fáceis de manter.