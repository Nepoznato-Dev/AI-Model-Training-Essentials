...
---
# C# — Padrões Idiomáticos e Melhores Práticas
Este guia aborda padrões idiomáticos e práticas recomendadas para escrever código C# (12+) limpo e moderno.
---
...
## IDisposable e gerenciamento de recursos
```csharp
...
## Resumo
As expressões idiomáticas modernas do C# enfatizam: registros para dados, correspondência de padrões, segurança nula (tipos de referência anuláveis), LINQ para coleções, assíncrono/espera com CancellationToken, injeção de dependência, construtores primários, expressões de coleção e declarações `using`. Siga as convenções de codificação C#, use`dotnet format`para formatação e analisadores Roslyn para qualidade de código. O C# moderno (12+) é conciso e expressivo – abrange registros, correspondência de padrões e construtores primários.