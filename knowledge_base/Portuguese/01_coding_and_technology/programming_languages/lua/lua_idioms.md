...
---
# Lua — Padrões Idiomáticos e Melhores Práticas
Este guia aborda padrões idiomáticos e práticas recomendadas para escrever código Lua limpo e idiomático.
---
...
## Resumo
As expressões idiomáticas de Lua enfatizam: tabelas como estrutura de dados universal, variáveis ​​locais, fechamentos para estado, metatabelas para OOP e indexação baseada em 1. Siga luacheck para linting e stylua para formatação. Lua valoriza a simplicidade e o minimalismo — a linguagem é intencionalmente pequena, então padrões emergem da composição.