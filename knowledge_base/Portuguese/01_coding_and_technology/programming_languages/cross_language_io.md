...
-->
# Comparação entre idiomas - operações de E/S e arquivos
## Saída do console
| Idioma | Imprimir em stdout |
|----------|----------------|
| Pitão | `print("Hello")`|
| JavaScript | `console.log("Hello")`|
| Ferrugem | `println!("Hello")`|
| Vá | `fmt.Println("Hello")`|
...
| PHP | `echo "Hello\n"`|
| Datilografado | `console.log("Hello")`|
...
| COBOL | `DISPLAY 'Hello'`|
| Fortran | `print *, 'Hello'`|
| Montagem | `syscall`(gravar em fd 1) |
| Delfos | `WriteLn('Hello')`|
| Arranhar | `say [Hello]`|
| VB | `Console.WriteLine("Hello")`|
| Concha | `echo "Hello"`|
| SQL | N/A (retorna conjuntos de resultados) |
## Lendo um arquivo
```python
# Python
