...
---
# Linguagem Assembly - Referência de Sintaxe
Este documento fornece uma referência de sintaxe estruturada e abrangente para Assembly x86-64 (sintaxe NASM). Ele complementa a referência principal do Assembly, concentrando-se em categorias de instruções exaustivas, modos de endereçamento, convenções de estrutura de pilha e padrões de programação de sistema.
---

## Registros e tamanhos de dados
```nasm
...
## Resumo
A sintaxe da linguagem assembly é definida pela arquitetura do processador e pelo montador (NASM, GAS, MASM). O x86-64 fornece 16 registradores de uso geral, vários modos de endereçamento e centenas de instruções que abrangem movimentação de dados, aritmética, lógica, fluxo de controle, SIMD e chamadas de sistema. A sintaxe NASM usada aqui é a mais comum para desenvolvimento em Linux x86-64. Dominar a montagem requer a compreensão dos registradores, da pilha, das convenções de chamada e de como as construções de alto nível são mapeadas para as instruções da máquina.