...
---
# Swift – Padrões Idiomáticos e Melhores Práticas
Este guia cobre padrões idiomáticos e práticas recomendadas para escrever código Swift limpo.
---

## Opcionais e segurança
```swift
...
## Resumo
Os idiomas Swift enfatizam: segurança (opcionais, guarda), tipos de valor (estruturas), design orientado a protocolo, correspondência de padrões, assíncrono/espera e imutabilidade (`let`por padrão). Siga as diretrizes de design da API Swift, use SwiftLint para qualidade de código e SwiftFormat para formatação. Swift valoriza segurança e expressividade — “se compilar, provavelmente está correto”.