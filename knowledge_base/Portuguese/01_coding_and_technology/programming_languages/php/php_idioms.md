...
## Resumo
As expressões idiomáticas modernas do PHP enfatizam: declarações de tipo, propriedades somente leitura, enumerações, expressões de correspondência, promoção de construtor, operador nulo-seguro, argumentos nomeados e fibras. Siga PSR-12 para estilo, PHPStan para análise estática e Laravel Pint ou PHP-CS-Fixer para formatação. O PHP moderno (8.3+) é uma linguagem limpa e de tipo seguro – adote os novos recursos e evite padrões legados.