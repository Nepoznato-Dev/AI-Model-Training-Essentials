...
-->
# Ruby — Padrões Idiomáticos e Melhores Práticas
Este guia cobre padrões idiomáticos e práticas recomendadas para escrever código Ruby limpo.
---
...
## Correspondência de padrões (Ruby 3+)
```ruby
# ✅ Pattern matching
case user
in { name:, role: "admin" }
...
## Digitação e protocolos de pato
```ruby
...
## Resumo
As expressões idiomáticas do Ruby enfatizam: felicidade do desenvolvedor, convenção sobre configuração, blocos e iteradores, digitação de pato e sintaxe expressiva. Siga o Ruby Style Guide, use RuboCop para linting e StandardRB para formatação opinativa. Ruby valoriza a legibilidade - o código deve ser lido como o inglês. Prefira métodos enumeráveis ​​a loops manuais, use símbolos para identificadores e adote blocos para iteração e gerenciamento de recursos.