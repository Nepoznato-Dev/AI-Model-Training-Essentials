...
-->
# Erlang & Elixir — Referência de sintaxe
Este documento fornece uma referência de sintaxe estruturada e abrangente para Erlang e Elixir. Ele complementa a referência principal concentrando-se na correspondência de padrões, gerenciamento de processos, comportamentos OTP e padrões de sistema tolerantes a falhas.
---

## Erlang — Sintaxe Central
```erlang
% Variables (uppercase)
X = 42.
Name = "Alice".
...
## Processos e passagem de mensagens
```erlang
...
## Resumo
Erlang e Elixir compartilham os superpoderes da BEAM VM: processos leves, passagem de mensagens e árvores de supervisão tolerantes a falhas. A sintaxe de Erlang é mínima e funcional. Elixir adiciona sintaxe moderna com pipes, macros e protocolos. Os comportamentos OTP (GenServer, Supervisor, Application) fornecem padrões testados em batalha para a construção de sistemas confiáveis. Para aplicações distribuídas e tolerantes a falhas em tempo real, Erlang/Elixir permanece incomparável.