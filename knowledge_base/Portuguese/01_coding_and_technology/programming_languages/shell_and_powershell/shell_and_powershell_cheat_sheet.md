...
---
# Shell e PowerShell – Folha de dicas
...
## Fluxo de controle do PowerShell
```powershell
# If
if ($age -ge 18) {
    "adult"
...
## Tratamento de erros do PowerShell
```powershell
try {
