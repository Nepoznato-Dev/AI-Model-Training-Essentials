...
-->
#जाओ- सिंटेक्स संदर्भ
यह दस्तावेज़ गो के लिए एक व्यापक, संरचित वाक्यविन्यास संदर्भ प्रदान करता है। यह संपूर्ण सिंटैक्स पैटर्न, ऑपरेटर टेबल और गोरोइन, चैनल और इंटरफेस के आंतरिक यांत्रिकी पर ध्यान केंद्रित करके मुख्य गो संदर्भ को पूरक करता है।
---
...
| `-`| घटाव | `3 - 2`| `1`| |
| `*`| गुणन | `3 * 2`| `6`| |
| `/`| प्रभाग | `7 / 2`| `3`| Ints के लिए पूर्णांक विभाजन |
| `%`| शेष | `7 % 2`| `1`| चिह्न लाभांश से मेल खाता है |
| `&`| बिटवाइज़ और | `5 & 3`| `1`| |
| `\|`| बिटवाइज़ या | `5 \| 3`| `7`| |
| `^`| बिटवाइज़ XOR | `5 ^ 3`| `6`| इसके अलावा बिटवाइज़ पूरक (यूनरी) |
| `&^`| थोड़ा स्पष्ट (और नहीं) | `5 &^ 3`| `4`| जाने के लिए अनोखा |
| `<<`| वाम पारी | `5 << 1`| `10`| |
| `>>`| दायां शिफ्ट | `5 >> 1`| `2`| |
### तुलना संचालक
| ऑपरेटर | नाम | उदाहरण | नोट्स |
|-------|------|------|-------|
| `==`| बराबर | `x == y`| केवल तुलनीय प्रकार |
| `!=`| समान नहीं | `x != y`| |
| `<`,`>`,`<=`,`>=`| ऑर्डर देना | `x >= y`| स्ट्रिंग्स की तुलना शब्दावली से की गई |
### लॉजिकल ऑपरेटर्स
| ऑपरेटर | नाम | उदाहरण | नोट्स |
|-------|------|------|-------|
...
## सारांश
गो का सिंटैक्स जानबूझकर न्यूनतम है - कोई विरासत नहीं, कोई विधि ओवरलोडिंग नहीं, कोई अपवाद नहीं, कोई मैक्रोज़ नहीं। जो बचता है वह निर्माणों का एक साफ, ऑर्थोगोनल सेट है: संरचना के लिए संरचनाएं और इंटरफेस, समवर्तीता के लिए गोरोइन और चैनल, और विश्वसनीयता के लिए स्पष्ट त्रुटि प्रबंधन। भाषा की शक्ति जटिल वाक्यविन्यास से नहीं, बल्कि इसके सरल आदिमों की सुरुचिपूर्ण अंतःक्रिया से आती है। जेनेरिक (गो 1.18+) गो की विशिष्ट स्पष्टता से समझौता किए बिना प्रकार में लचीलापन जोड़ता है।