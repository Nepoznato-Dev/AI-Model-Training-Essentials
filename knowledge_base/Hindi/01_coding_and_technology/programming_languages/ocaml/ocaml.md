...
# मेटाडेटा
शीर्षक: "ओकैमल"
विवरण: "OCaml प्रोग्रामिंग भाषा के लिए व्यापक संदर्भ जिसमें अवलोकन, ट्रेड-ऑफ़, सिंटैक्स फंडामेंटल, इकोसिस्टम और इसका उपयोग कब करना है, शामिल है।"
...
#वर्गीकरण
टैग: [ओसीएएमएल, प्रोग्रामिंग-भाषा, सिंटैक्स, पारिस्थितिकी तंत्र, कोडिंग-और-प्रौद्योगिकी]
कठिनाई_स्तर: "उन्नत"
पूर्वावश्यकताएँ: []
...
| आदेश | विवरण |
|---------|-----------------|
|  __संरक्षित_0__ | नया प्रोजेक्ट बनाएं |
|  __संरक्षित_1__ | प्रोजेक्ट बनाएं |
|  __संरक्षित_2__ | निष्पादन योग्य चलाएँ |
|  __संरक्षित_3__ | परीक्षण चलाएँ |
|  __संरक्षित_4__ | स्वच्छ निर्मित कलाकृतियाँ |
|  __संरक्षित_5__ | लोड किए गए प्रोजेक्ट के साथ आरईपीएल प्रारंभ करें |
|  __संरक्षित_6__ | निर्भरताएँ स्थापित करें |
|  __संरक्षित_7__ | प्रारूप कोड |
|  __संरक्षित_8__ | OCaml 5.1 स्विच बनाएं |
---
...
|------|------|-------|
| **ocamlprof** | निष्पादन गिनती प्रोफाइलिंग |  __संरक्षित_0__ फिर __संरक्षित_1__ |
| **परफ** | लिनक्स सिस्टम प्रोफाइलर |  __संरक्षित_2__ |
| **स्पेसटाइम** | मेमोरी प्रोफाइलिंग (4.x) |  __संरक्षित_3__ |
| **बेंचमार्क** | माइक्रो-बेंचमार्किंग |  __संरक्षित_4__ पैकेज |
### अनुकूलन तकनीकें
```ocaml
