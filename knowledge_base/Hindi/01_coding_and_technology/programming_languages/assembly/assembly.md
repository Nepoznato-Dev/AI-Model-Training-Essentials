...
|------|----------------------|----------------|
| **तत्काल** | `mov eax, 42`| ऑपरेंड एक स्थिर मान है |
| **रजिस्टर** | `mov eax, ebx`| ऑपरेंड एक रजिस्टर में है |
| **प्रत्यक्ष** | `mov eax, [0x4000]`| ऑपरेंड एक निश्चित मेमोरी एड्रेस पर है |
| **अप्रत्यक्ष पंजीकरण** | `mov eax, [rbx]`| ऑपरेंड एक रजिस्टर में पते पर है |
| **आधार + विस्थापन** | `mov eax, [rbx + 8]`| पता = रजिस्टर + स्थिर ऑफसेट |
| **स्केल्ड इंडेक्स** | `mov eax, [rbx + rcx*4]`| पता = आधार + (सूचकांक × पैमाना) |
| **पूर्ण एसआईबी** | `mov eax, [rbx + rcx*4 + 16]`| आधार + (सूचकांक × स्केल) + विस्थापन |
```nasm
...
| **स्मृति संबोधन** | पते (`MOV EAX, [0x1000]`) के माध्यम से रैम तक पहुंच |
...
### Q1: आरआईएससी और सीआईएससी असेंबली के बीच क्या अंतर है?
**ए:** सीआईएससी (x86) में जटिल, परिवर्तनीय-लंबाई निर्देश हैं। आरआईएससी (एआरएम) में सरल, निश्चित लंबाई के निर्देश हैं:
```asm
...
### Q2: असेंबली में स्टैक कैसे काम करता है?
**ए:** ढेर नीचे की ओर बढ़ता है। `push`ने एसपी और स्टोर्स में कमी की; `pop`SP को लोड और बढ़ाता है:
```asm
...
### Q3: मैं असेंबली में फ़ंक्शन कैसे कॉल करूं?
**ए:** कॉलिंग परंपरा का पालन करें (लिनक्स पर सिस्टम वी एएमडी64, विंडोज़ पर विंडोज़ x64):
```asm
...
### Q4: जानने के लिए सबसे महत्वपूर्ण असेंबली निर्देश क्या हैं?
**ए:** डेटा मूवमेंट, अंकगणित, नियंत्रण प्रवाह और स्टैक ऑपरेशन कोर बनाते हैं।
### Q5: सुरक्षा अनुसंधान में असेंबली का उपयोग कैसे किया जाता है?
**ए:** रिवर्स इंजीनियरिंग, शोषण विकास, मैलवेयर विश्लेषण, और कंपाइलर आउटपुट को समझने के लिए असेंबली साक्षरता की आवश्यकता होती है।
---

## चेन-ऑफ़-थॉट समस्या का समाधान
### समस्या 1: असेंबली में एक लूप लागू करना
**चरण 1: समस्या को समझें**
1 से N तक के पूर्णांकों का योग.
**चरण 2: दृष्टिकोण को पहचानें**
एक काउंटर रजिस्टर और संचायक का उपयोग करें।
**चरण 3: कार्यान्वयन**```asm
; Sum 1 to N (N in ecx)
...
**चरण 4: अनुकूलन करें**
O(N) के बजाय O(1) के लिए सूत्र N*(N+1)/2 का उपयोग करें।
---
