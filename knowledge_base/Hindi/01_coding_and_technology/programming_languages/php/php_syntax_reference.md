...
| `+``-``*``/``%`| अंकगणित | `$a + $b`| |
| `**`| घातांक | `2 ** 10`| `1024`|
| `==``!=``===``!==` | समानता | `$a === $b`| `===`चेक प्रकार भी |
| `<=>`| अंतरिक्ष यान | `$a <=> $b`| रिटर्न -1, 0, या 1 |
| `<``>``<=``>=` | तुलना | `$a >= $b`| |
| `&&``\|\|``!`| तार्किक | `$a && $b`| शॉर्ट-सर्किट |
| `and``or``xor`| तार्किक (कम प्राथमिकता) | `$a and $b`| बचें -`&&`/`\|\|`| का उपयोग करें
| `??`| अशक्त संलयन | `$a ?? 'default'`| यदि`$a`शून्य है तो`'default'`लौटाता है |
| `??=`| अशक्त सहसंयोजन असाइन | `$a ??= 'default'`| केवल तभी असाइन किया जाता है जब`$a`शून्य हो |
| `?``:` | टर्नरी | `$a ? $b : $c`| |
| `.`| सम्मिलन | `$a . $b`| |
| `.=`| संयोजित कार्य | `$a .= $b`| |
| `=>`| सारणी असाइनमेंट | `['key' => 'value']`| |
| `->`| सदस्य पहुंच | `$obj->method()`| |
| `?->`| नलसेफ ऑपरेटर | `$obj?->method()`| यदि`$obj`शून्य है तो शून्य लौटता है |
| `::`| स्थैतिक पहुंच | `ClassName::method()`| |
| `instanceof`| चेक टाइप करें | `$obj instanceof ClassName`| |
| `clone`| ऑब्जेक्ट क्लोनिंग | `$copy = clone $obj`| डीप कॉपी के लिए`__clone()`की आवश्यकता है |
### बाजीगरी टाइप करें
```php
...
## सारांश
PHP का सिंटैक्स अपनी स्क्रिप्टिंग उत्पत्ति से एक आधुनिक, टाइप-सुरक्षित भाषा में नाटकीय रूप से विकसित हुआ है। PHP 8.x ने यूनियन प्रकार, इंटरसेक्शन प्रकार, एनम, फाइबर, रीडओनली क्लास, विशेषताएँ और प्रथम श्रेणी कॉलेबल्स की शुरुआत की - इसे एक ढीली टाइप की स्क्रिप्टिंग भाषा से एक ऐसी भाषा में बदल दिया जो कठोर सॉफ्टवेयर इंजीनियरिंग का समर्थन करती है। भाषा की ताकत इसका वेब फोकस बनी हुई है: लारवेल और सिम्फनी जैसे ढांचे, एक विशाल पारिस्थितिकी तंत्र और लगभग सार्वभौमिक होस्टिंग समर्थन के साथ, PHP का सिंटैक्स लाखों अनुप्रयोगों को सेवा प्रदान करता है। आधुनिक PHP उन डेवलपर्स को पुरस्कृत करता है जो इसके प्रकार के सिस्टम को अपनाते हैं, कंपोज़र-आधारित ऑटोलोडिंग का उपयोग करते हैं, और साफ़, ऑब्जेक्ट-ओरिएंटेड कोड लिखते हैं।