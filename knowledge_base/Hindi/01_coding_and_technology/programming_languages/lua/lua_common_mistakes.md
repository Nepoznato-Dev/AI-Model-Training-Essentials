...
-->
# लुआ - सामान्य गलतियाँ और विरोधी पैटर्न
यह दस्तावेज़ सुधार के साथ लुआ में सबसे आम गलतियों, जाल और विरोधी पैटर्न को सूचीबद्ध करता है।
---
...
## 2.`nil`बनाम`false`स्थितियों में
```lua
...
## 7. ओओपी के लिए मेटाटेबल्स का उपयोग नहीं करना
```lua
...
## सारांश
लुआ का अतिसूक्ष्मवाद जाल बनाता है: 1-आधारित अनुक्रमण, केवल`nil`और`false`मिथ्या हैं, तालिकाएँ संदर्भ हैं (मूल्य नहीं), चर डिफ़ॉल्ट रूप से वैश्विक हैं, और`pairs`अव्यवस्थित है जबकि`ipairs`का आदेश दिया गया है। लुआ तरीका है: हमेशा`local`का उपयोग करें, सरणियों के लिए`ipairs`का उपयोग करें और शब्दकोशों के लिए`pairs`का उपयोग करें, स्ट्रिंग बिल्डिंग के लिए`table.concat`का उपयोग करें, और OOP के लिए मेटाटेबल्स का उपयोग करें। लुआ की सादगी ही उसकी ताकत है - लेकिन किनारे के मामलों का सम्मान करें।