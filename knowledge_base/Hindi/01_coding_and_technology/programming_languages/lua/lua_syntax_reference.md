...
---
# लुआ - सिंटैक्स संदर्भ
यह दस्तावेज़ लुआ (5.4) के लिए एक व्यापक, संरचित वाक्यविन्यास संदर्भ प्रदान करता है। यह संपूर्ण सिंटैक्स पैटर्न, टेबल और मेटाटेबल्स, कॉरआउटिन और लुआ के अद्वितीय डिजाइन दर्शन पर ध्यान केंद्रित करके मुख्य लुआ संदर्भ को पूरक करता है।
---
...
| `//`| तल विभाजन | `7 // 2`| रिटर्न 3 (लुआ 5.3+) |
| `==``~=` | समानता | `a == b`| `~=`"बराबर नहीं" है |
| `<``>``<=``>=` | तुलना | `a >= b`| |
| `and``or``not`| तार्किक | `a and b`| ऑपरेंड लौटाता है, बूलियन नहीं |
| `..`| सम्मिलन | `"hello" .. " world"`| |
| `#`| लंबाई | `#t`| स्ट्रिंग या टेबल की लंबाई |
| `&``\|``~``<<``>>`| बिटवाइज़ | `a & b`| लुआ 5.3+ (पूर्णांक ऑप्स) |
### लॉजिकल ऑपरेटर्स - गैर-बूलियन रिटर्न
```lua
...
## सारांश
लुआ का वाक्यविन्यास जानबूझकर न्यूनतम है - पूरी भाषा का वर्णन एक ही पृष्ठ में किया जा सकता है। तालिकाएँ सार्वभौमिक डेटा संरचना (सरणी, शब्दकोश, ऑब्जेक्ट, मॉड्यूल) के रूप में कार्य करती हैं। मेटाटेबल्स भाषा की जटिलता के बिना विस्तारशीलता प्रदान करते हैं। कॉरआउट्स सहकारी मल्टीटास्किंग और सुरुचिपूर्ण इटरेटर पैटर्न को सक्षम करते हैं। भाषा की शक्ति इसकी एम्बेडेबिलिटी से आती है: लुआ को होस्ट अनुप्रयोगों के अंदर रहने के लिए डिज़ाइन किया गया है, जो न्यूनतम ओवरहेड के साथ स्क्रिप्टिंग क्षमताएं प्रदान करता है। खेल के विकास, कॉन्फ़िगरेशन और एम्बेडेड सिस्टम के लिए, लुआ की सादगी इसकी सबसे बड़ी ताकत है - एक छोटी भाषा जो वही करती है जो उसे चाहिए, और इससे अधिक कुछ नहीं।