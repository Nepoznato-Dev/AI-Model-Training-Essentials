...
|---|-----------------|
| पायथन | `print("Hello")`|
| जावास्क्रिप्ट | `console.log("Hello")`|
| जंग | `println!("Hello")`|
| जाओ | `fmt.Println("Hello")`|
| जावा | `System.out.println("Hello")`|
| सी | `printf("Hello\n")`|
| सी++ | `std::cout << "Hello" << std::endl`|
| सी# | `Console.WriteLine("Hello")`|
| रूबी | `puts "Hello"`|
| स्विफ्ट | `print("Hello")`|
| कोटलिन | `println("Hello")`|
| पीएचपी | `echo "Hello\n"`|
| टाइपस्क्रिप्ट | `console.log("Hello")`|
| हास्केल | `putStrLn "Hello"`|
| स्काला | `println("Hello")`|
| आर | `cat("Hello\n")`|
| जूलिया | `println("Hello")`|
| पर्ल | `say "Hello"`|
| लुआ | `print("Hello")`|
| मतलब | `disp('Hello')`|
| डार्ट | `print('Hello')`|
| प्रोलॉग | `write('Hello'), nl.`|
| लिस्प | `(format t "Hello~%")`|
| अमृत ​​| `IO.puts("Hello")`|
| एरलांग | `io:format("Hello~n")`|
| ओकैमल | `print_endline "Hello"`|
| अदा | `Put_Line("Hello")`|
| कोबोल | `DISPLAY 'Hello'`|
| फोरट्रान | `print *, 'Hello'`|
| सभा | `syscall`(fd 1 पर लिखें) |
| डेल्फ़ी | `WriteLn('Hello')`|
| स्क्रैच | `say [Hello]`|
| वीबी | `Console.WriteLine("Hello")`|
| शैल | `echo "Hello"`|
| एसक्यूएल | एन/ए (परिणाम सेट लौटाता है) |
## किसी फ़ाइल को पढ़ना
```python
# Python
