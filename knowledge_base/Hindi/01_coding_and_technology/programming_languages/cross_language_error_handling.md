...
| मॉडल | भाषाएँ | तंत्र |
|-------|----|----|
| **अपवाद (कोशिश करें/पकड़ें)** | जावा, सी++, सी#, पायथन, रूबी, पीएचपी, जावास्क्रिप्ट, टाइपस्क्रिप्ट, कोटलिन, स्विफ्ट, डार्ट, स्काला, वीबी, डेल्फ़ी | `try { } catch (e) { }`|
| **परिणाम/विकल्प प्रकार** | रस्ट, हास्केल, ओकैमल, स्काला (भी) | `Result<T, E>`,`Maybe a`|
| **एकाधिक वापसी मान** | जाओ, लुआ | `value, err := f()`|
| **त्रुटि कोड** | सी, फोरट्रान | त्रुटि कोड लौटाएं, मैन्युअल रूप से जांचें |
| **पैटर्न मिलान त्रुटियाँ** | अमृत, एरलांग | `{:ok, value}`/`{:error, reason}`|
| **शर्तें (पुनः आरंभ करने योग्य)** | सामान्य लिस्प | `restart-case`,`handler-bind`|
| **कोई त्रुटि प्रबंधन नहीं** | स्क्रैच, एसक्यूएल (बेसिक) | एन/ए |
| **अनुबंध** | एडा, एफिल | `Pre`,`Post`स्थितियाँ |
## अपवाद-आधारित त्रुटि प्रबंधन
```python
# Python
try:
    result = 10 / 0
...
## सारांश: प्रतिमानों को संभालने में त्रुटि
| प्रतिमान | दृष्टिकोण | पेशेवरों | विपक्ष |
|---|-------|------|------|
| **अपवाद** | फेंकना/पकड़ना | स्वच्छ सुखी पथ, ढेर के निशान | भुलाया जा सकता है, प्रवाह दुरुपयोग पर नियंत्रण रखें |
| **परिणाम प्रकार** | वापसी`Ok`/`Err`| स्पष्ट, त्रुटियों को नजरअंदाज नहीं कर सकते | वर्बोज़,`?`ऑपरेटर की आवश्यकता |
| **त्रुटि कोड** | वापसी int स्थिति | सरल, सी-संगत | नजरअंदाज करना आसान, कोई संदर्भ नहीं |
| **एकाधिक रिटर्न** | `value, err := f()`| स्पष्ट, मुहावरेदार |`err`| जांचना भूल सकते हैं
| **पैटर्न मिलान** | `{:ok, v}`/`{:error, r}`| संपूर्ण, कार्यात्मक |`with`के बिना वर्बोज़ |
| **शर्तें** | पुनरारंभ करने योग्य हैंडलर | सबसे शक्तिशाली, पुनर्प्राप्त करने योग्य | जटिल, शायद ही कभी समझा गया |