...
| `<``>``<=``>=` | तुलना | `a >= b`| |
| `.and.``.or.``.not.`| तार्किक | `a .and. b`| |
| `.eqv.``.neqv.` | तार्किक तुल्यता | `a .eqv. b`| |
| `//`| स्ट्रिंग संयोजन | `'hello' // ' world'`| |
---
...
## सारांश
आधुनिक फोरट्रान का सिंटैक्स स्वच्छ, संरचित और संख्यात्मक गणना के लिए अनुकूलित है। सारणी संचालन अधिकांश गणितीय कार्यों के लिए लूप को खत्म कर देता है। मॉड्यूल एनकैप्सुलेशन और नेमस्पेस प्रबंधन प्रदान करते हैं। OOP सुविधाएँ (व्युत्पन्न प्रकार, वंशानुक्रम, बहुरूपता) स्वच्छ कोड संगठन को सक्षम करती हैं। Coarrays बाहरी पुस्तकालयों के बिना देशी समानांतर प्रोग्रामिंग की पेशकश करता है। फोरट्रान की ताकतें - प्रदर्शन, सरणी संचालन और संख्यात्मक परिशुद्धता - वैज्ञानिक कंप्यूटिंग के लिए बेजोड़ हैं। एचपीसी, कम्प्यूटेशनल भौतिकी और इंजीनियरिंग सिमुलेशन के लिए, फोरट्रान एक पावरहाउस बना हुआ है।