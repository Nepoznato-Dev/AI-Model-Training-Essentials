...
-->
# रूबी - सिंटैक्स संदर्भ
यह दस्तावेज़ रूबी (3.x) के लिए एक व्यापक, संरचित वाक्यविन्यास संदर्भ प्रदान करता है। यह संपूर्ण सिंटैक्स पैटर्न, ब्लॉक और क्लोजर, मेटाप्रोग्रामिंग और रूबी मुहावरों पर ध्यान केंद्रित करके मुख्य रूबी संदर्भ को पूरक करता है।
---
...
| `==``!=``===``<=>` | समानता | `a == b`| `===`केस समानता है; `<=>`अंतरिक्ष यान है |
| `eql?`| मूल्य समानता | `a.eql?(b)`|`==`(चेक प्रकार) से अधिक सख्त |
| `equal?`| पहचान | `a.equal?(b)`| वही वस्तु? |
| `<``>``<=``>=` | तुलना | `a >= b`| |
| `&&``\|\|``!`| तार्किक | `a && b`| शार्ट सर्किट; अंतिम मूल्यांकित मान लौटाता है |
| `and``or``not`| तार्किक (कम प्राथमिकता) | `a and b`| बचें -`&&`/`\|\|`/`!`का उपयोग करें |
| `&``\|``^``~``<<``>>` | बिटवाइज़ | `a & b`| |
| `=~``!~` | रेगेक्स मैच | `str =~ /pattern/`| रिटर्न इंडेक्स या शून्य |
| `..``...` | रेंज | `1..10`| `..`सम्मिलित; `...`एक्सक्लूसिव |
| `?.`| सुरक्षित नेविगेशन | `user&.name`| यदि उपयोगकर्ता शून्य है तो शून्य लौटाता है |
| `[]``[]=` | तत्व पहुंच | `arr[0]`| |
### सत्यता
```ruby
...
## सारांश
रूबी का सिंटैक्स डेवलपर की खुशी के लिए डिज़ाइन किया गया है - यह अंग्रेजी की तरह पढ़ता है और अभिव्यक्ति को पुरस्कृत करता है। भाषा की शक्ति उसके ऑब्जेक्ट मॉडल (सबकुछ एक ऑब्जेक्ट है), ब्लॉक और क्लोजर, मेटाप्रोग्रामिंग क्षमताओं और एन्यूमरेबल मॉड्यूल से आती है जो एक समृद्ध संग्रह प्रसंस्करण एपीआई प्रदान करता है। रूबी 3.x ने भाषा के मूल दर्शन को बनाए रखते हुए पैटर्न मिलान, आरबीएस प्रकार के हस्ताक्षर और समवर्तीता के लिए रेक्टर जोड़ा है: प्रोग्रामर को उत्पादक और खुश बनाना।