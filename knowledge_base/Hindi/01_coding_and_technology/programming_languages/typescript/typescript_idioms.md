...
-->
# टाइपस्क्रिप्ट - मुहावरेदार पैटर्न और सर्वोत्तम अभ्यास
यह मार्गदर्शिका स्वच्छ, टाइप-सुरक्षित टाइपस्क्रिप्ट कोड लिखने के लिए मुहावरेदार पैटर्न और सर्वोत्तम प्रथाओं को शामिल करती है।
---
...
## सारांश
टाइपस्क्रिप्ट मुहावरे जोर देते हैं: सख्त प्रकार की जाँच, वस्तु आकृतियों के लिए इंटरफेस, राज्य के लिए भेदभावपूर्ण संघ, संकुचन के लिए टाइप गार्ड, बाधाओं के साथ जेनेरिक, अपरिवर्तनीयता के लिए `readonly`, और शाब्दिक प्रकारों के लिए `as const`।`typescript-eslint`के साथ ESLint का पालन करें, फ़ॉर्मेटिंग के लिए सुंदर, और हमेशा`strict: true`सक्षम करें। टाइपस्क्रिप्ट समुदाय प्रकार की सुरक्षा को महत्व देता है - यदि यह संकलित होता है, तो यह संभवतः काम करता है। ऑब्जेक्ट आकृतियों के लिए `interface`, यूनियनों और उपयोगिताओं के लिए`type`को प्राथमिकता दें और हर कीमत पर`any`से बचें।