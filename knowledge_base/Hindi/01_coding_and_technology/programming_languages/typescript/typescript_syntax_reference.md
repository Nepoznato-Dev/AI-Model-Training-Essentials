...
## टाइप सिस्टम फंडामेंटल
### आदिम एवं अंतर्निहित प्रकार
```typescript
// Primitives
...
## डेकोरेटर्स (TC39 स्टेज 3 / टाइपस्क्रिप्ट 5.0+)
```typescript
// Class decorator
...
## सारांश
टाइपस्क्रिप्ट का टाइप सिस्टम इसकी परिभाषित विशेषता है, और यह उल्लेखनीय रूप से गहरा है। जेनेरिक, सशर्त प्रकार, मैप किए गए प्रकार, टेम्पलेट शाब्दिक प्रकार और`infer`के माध्यम से बुनियादी एनोटेशन से, टाइप सिस्टम अनिवार्य रूप से संकलन समय पर काम करने वाली एक कार्यात्मक भाषा है।`interface`बनाम `type`, जेनेरिक बनाम उपयोगिता प्रकार, और संरचनात्मक बनाम नाममात्र टाइपिंग के बीच परस्पर क्रिया को समझना टाइपस्क्रिप्ट लिखने का समर्थन करता है जो सुरक्षित और एर्गोनोमिक दोनों है। भाषा का विकास जारी है, प्रत्येक रिलीज़ जावास्क्रिप्ट के साथ पूर्ण बैकवर्ड संगतता बनाए रखते हुए अधिक अभिव्यंजक शक्ति जोड़ती है।