...
-->
# टाइपस्क्रिप्ट - सामान्य गलतियाँ और विरोधी पैटर्न
यह दस्तावेज़ टाइपस्क्रिप्ट में सबसे आम गलतियों, जाल और विरोधी पैटर्न को सूचीबद्ध करता है। प्रत्येक प्रविष्टि गलत दृष्टिकोण दिखाती है, बताती है कि यह विफल क्यों होता है, और सही समाधान प्रदान करती है।
---

## 1.`any`का अत्यधिक उपयोग करना
```typescript
...
## 2. टाइप गार्ड के बजाय अभिकथन टाइप करें
```typescript
...
## 3. गैर-शून्य अभिकथन का दुरुपयोग
```typescript
...
## 6.`strict`मोड का उपयोग नहीं करना
```json
...
## 8. Async/प्रतीक्षा प्रकार की गलतियाँ
```typescript
...
## 9. एंटी-पैटर्न: दोहराए जाने वाले प्रकार (जेनेरिक का उपयोग नहीं करना)
```typescript
...
## 11.`namespace`(विरासत) का उपयोग करना
```typescript
...
## 12. भेदभावपूर्ण यूनियनों का लाभ न उठाना
```typescript
...
## सारांश
टाइपस्क्रिप्ट का टाइप सिस्टम शक्तिशाली है लेकिन इसके लिए अनुशासन की आवश्यकता होती है। मुख्य पाप`any`तक पहुंचना है - जब प्रकार वास्तव में अज्ञात हो, और प्रकार गार्ड के साथ संकीर्ण हो तो`unknown`का उपयोग करें। अपरिभाषित को ठीक से संभालकर गैर-शून्य दावे (`!`) से बचें। ऑब्जेक्ट आकृतियों, यूनियनों के प्रकारों और परिकलित प्रकारों के लिए इंटरफ़ेस का उपयोग करें। भेदभावपूर्ण यूनियनें बग के पूरे वर्ग को खत्म कर देती हैं। पहले दिन से`strict: true`सक्षम करें - रेट्रोफिटिंग सख्ती दर्दनाक है। लक्ष्य अवैध राज्यों को प्रकार के स्तर पर प्रतिनिधित्वहीन बनाना है।