...
# MATLAB - सिंटैक्स संदर्भ
यह दस्तावेज़ MATLAB (R2024+) के लिए एक व्यापक, संरचित वाक्यविन्यास संदर्भ प्रदान करता है। यह संपूर्ण सिंटैक्स पैटर्न, मैट्रिक्स संचालन, प्लॉटिंग और वैज्ञानिक कंप्यूटिंग मुहावरों पर ध्यान केंद्रित करके मुख्य MATLAB संदर्भ को पूरक करता है।
---
...
|-------|------|------|-------|
| `+``-``*``/``^`| अंकगणित | `A * B`| मैट्रिक्स गुणा |
| `.*``./``.^`| तत्त्वानुसार | `A .* B`| सारणी संचालन |
| `'`| स्थानांतरण | `A'`| संयुग्म स्थानांतरण |
| `.'`| असंयुग्मी स्थानान्तरण | `A.'`| |
| `\`| वाम विभाजन | `A \ b`| Ax = b | को हल करें
| `/`| सही विभाजन | `b / A`| xA = b | को हल करें
| `==``~=` | समानता | `A == B`| तत्त्वानुसार |
| `<``>``<=``>=` | तुलना | `A > 0`| तत्त्वानुसार |
| `&``\|``~`| तार्किक (तत्व-वार) | `A & B`| |
| `&&``\|\|` | शॉर्ट-सर्किट | `a && b`| केवल अदिश |
| `:`| कोलन/रेंज | `1:10`| `start:step:stop`|
| `;`| पंक्ति विभाजक/सप्रेस | `[1; 2; 3]`| |
| `,`| कॉलम विभाजक | `[1, 2, 3]`| |
---
...
## सारांश
MATLAB का सिंटैक्स मैट्रिक्स-प्रथम है - प्रत्येक चर एक सरणी है, और संचालन रैखिक बीजगणित के लिए अनुकूलित हैं। कोलन ऑपरेटर, लॉजिकल इंडेक्सिंग और वेक्टराइज्ड ऑपरेशंस अधिकांश संख्यात्मक कार्यों के लिए लूप को खत्म कर देते हैं। प्लॉटिंग प्रणाली न्यूनतम कोड के साथ प्रकाशन-गुणवत्ता वाले आंकड़े तैयार करती है। टूलबॉक्स प्रत्येक इंजीनियरिंग डोमेन में MATLAB का विस्तार करते हैं। जबकि पायथन ने कुछ क्षेत्र पर अतिक्रमण किया है, MATLAB इंजीनियरिंग गणना, सिमुलिंक-आधारित मॉडलिंग और रैपिड प्रोटोटाइप के लिए मानक बना हुआ है।