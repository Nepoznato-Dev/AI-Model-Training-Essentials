...
-->
# स्विफ्ट - सिंटैक्स संदर्भ
यह दस्तावेज़ स्विफ्ट (5.9+) के लिए एक व्यापक, संरचित वाक्यविन्यास संदर्भ प्रदान करता है। यह संपूर्ण सिंटैक्स पैटर्न, वैकल्पिक, प्रोटोकॉल-उन्मुख प्रोग्रामिंग और आधुनिक संगामिति पर ध्यान केंद्रित करके मुख्य स्विफ्ट संदर्भ को पूरक करता है।
---
...
|-------|------|------|-------|
| `+``-``*``/``%`| अंकगणित | `a + b`| |
| `..``...` | रेंज | `1...10`| `...`बंद; `..<`आधा खुला |
| `==``!=``<``>``<=``>=` | तुलना | `a == b`|`Equatable`/`Comparable`की आवश्यकता है |
| `===``!==` | पहचान | `a === b`| वही संदर्भ (केवल कक्षाएँ) |
| `&&``\|\|``!`| तार्किक | `a && b`| शॉर्ट-सर्किट |
| `??`| शून्य संलयन | `a ?? b`| यदि`a`शून्य है तो`b`लौटाता है |
| `?.`| वैकल्पिक श्रृखंला | `a?.b`| यदि`a`शून्य है तो शून्य लौटाता है |
| `!`| बलपूर्वक खोलना | `a!`| शून्य होने पर क्रैश - बचें |
| `&`| इनआउट पैरामीटर | `swap(&a, &b)`| संदर्भ से गुजरें |
### शून्य हैंडलिंग ऑपरेटर
```swift
...
## संपत्ति रैपर और परिणाम निर्माता
```swift
// Property wrapper
@propertyWrapper
struct Trimmed {
...
## सारांश
स्विफ्ट का वाक्य-विन्यास अभिव्यक्ति के साथ सुरक्षा को संतुलित करता है। वैकल्पिक शून्य क्रैश को खत्म करते हैं, प्रोटोकॉल इनहेरिटेंस के बिना लचीली संरचना को सक्षम करते हैं, और आधुनिक संगामिति (एसिंक/प्रतीक्षा, अभिनेता) सुरक्षित समवर्ती प्रोग्रामिंग को सुलभ बनाता है। भाषा पैरामीटर पैक, मैक्रोज़ और स्वामित्व जैसी सुविधाओं के साथ विकसित हो रही है - प्रत्येक अतिरिक्त स्विफ्ट को अपने मूल वादे को बनाए रखते हुए सुरक्षित और अधिक शक्तिशाली बनाता है: कोड जो निर्माण द्वारा सुरक्षित है।