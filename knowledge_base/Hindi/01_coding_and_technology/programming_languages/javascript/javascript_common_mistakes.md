...
---
# जावास्क्रिप्ट - सामान्य गलतियाँ और विरोधी पैटर्न
यह दस्तावेज़ जावास्क्रिप्ट में सबसे आम गलतियों, जाल और विरोधी पैटर्न को सूचीबद्ध करता है। प्रत्येक प्रविष्टि गलत दृष्टिकोण दिखाती है, बताती है कि यह विफल क्यों होता है, और सही समाधान प्रदान करती है।
---

## 1.`this`बाइंडिंग कन्फ्यूजन
```javascript
...
## 5. वादे ठुकराने को संभालना नहीं
```javascript
...
## 6. पुनरावृत्ति के दौरान वस्तुओं को संशोधित करना
```javascript
...
## 9. सारणी-जैसी वस्तुएँ सारणी नहीं हैं
```javascript
...
## 10. एंटी-पैटर्न: फ़ंक्शन पैरामीटर्स को बदलना
```javascript
...
## 11. इवेंट लूप और माइक्रोटास्क को न समझना
```javascript
...
## 12. एंटी-पैटर्न:`eval()`का उपयोग करना
```javascript
...
## 13. इवेंट श्रोताओं को साफ़ करना भूल जाना
```javascript
// ❌ WRONG — memory leak
class Component {
  mount() {
...
## सारांश
जावास्क्रिप्ट का लचीलापन जाल के साथ आता है:`this`बाइंडिंग कॉल साइट पर निर्भर करती है,`==`जबरदस्ती करता है, वादों के लिए त्रुटि प्रबंधन की आवश्यकता होती है, और इवेंट लूप ऑर्डरिंग (मैक्रोटास्क से पहले माइक्रोटास्क) गैर-स्पष्ट है। आधुनिक नियम सरल हैं:`const`/`let`का उपयोग कभी नहीं करें इन नियमों का पालन करने से अधिकांश जावास्क्रिप्ट बग समाप्त हो जाते हैं।