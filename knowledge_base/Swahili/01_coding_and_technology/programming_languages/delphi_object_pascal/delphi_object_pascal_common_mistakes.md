...
## 1. Kutoachilia Vitu (Kuvuja kwa Kumbukumbu)
```pascal
...
## 3. Uorodheshaji wa Mfuatano (Msingi 1)
```pascal
...
## 4. Kutotumia`inherited`katika Wajenzi
```pascal
...
## 5. Anti-Pattern: Mantiki ya Biashara katika Fomu
```pascal
...
## Muhtasari
Mitego ya Delphi: vitu visivyolipishwa kila mara kwa kujaribu/mwishowe, tofautisha`=`(kulinganisha) kutoka`:=`(mgawo), mifuatano imeonyeshwa 1, piga`inherited`katika wajenzi, na tenga mantiki ya biashara kutoka kwa UI. Mfumo wa VCL/FMX wa Delphi hutuza utengano safi wa wasiwasi.