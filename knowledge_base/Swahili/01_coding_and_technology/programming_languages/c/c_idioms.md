...
Mwongozo huu unashughulikia ruwaza za nahau na mbinu bora za kuandika msimbo safi na salama wa C.
---

## Walinzi wa Vichwa & Inajumuisha
```c
...
## Muhtasari
Nahau C zinasisitiza: usimamizi makini wa kumbukumbu, upangaji wa programu za ulinzi, miundo isiyo wazi ya usimbaji, makro yenye do-wakati, sehemu moja za kutoka na usafishaji wa goto, na vipengele vya kisasa vya C11/C23. Fuata`clang-format`kwa uumbizaji,`clang-tidy`kwa uwekaji, na kila wakati kusanya na`-Wall -Wextra -Werror`. Tumia sanitizers (ASan, UBSan) wakati wa majaribio. Jumuiya ya C inathamini urahisi, utendakazi, na udhibiti wazi - "mwamini kitengeneza programu."