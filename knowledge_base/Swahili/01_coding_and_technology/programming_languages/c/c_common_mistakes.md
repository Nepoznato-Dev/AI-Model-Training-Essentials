...
## 1. Bafa Inayofurika kwa`gets()`/ `strcpy()`
```c
...
## 9. Inachanganya`=`na`==`katika Masharti
```c
...
## 10. Kutoelewa Hesabu ya Kielekezi
```c
...
## 11. Anti-Pattern: Nambari za Uchawi
```c
...
## Muhtasari
Hatari za C zinajulikana sana lakini zipo kila wakati: kufurika kwa bafa, viashiria vinavyoning'inia, kufurika kamili, mashambulizi ya kamba za umbizo na uvujaji wa kumbukumbu. Nidhamu ni: kila mara angalia thamani za urejeshaji, bure kile unachotenga kila wakati, tumia vitendakazi vilivyo na mipaka kila wakati (`snprintf`,`strncpy`,`fgets`), usiwahi kutumia`gets()`, anzisha vigeu vyote, na utumie zana kama vile Valgrind na AddressSanitizer. C huwatuza watengenezaji programu makini kwa utendakazi na udhibiti usio na kifani - lakini huadhibu uzembe kwa tabia isiyobainishwa na udhaifu wa kiusalama.