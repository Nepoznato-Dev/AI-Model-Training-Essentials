...
# Java - Rejeleo la Sintaksia
Hati hii inatoa marejeleo ya kina, yenye muundo wa sintaksia ya Java. Inakamilisha marejeleo kuu ya Java kwa kuzingatia mifumo kamili ya sintaksia, majedwali ya waendeshaji, na ufundi wa ndani wa JVM, OOP, na upatanishi.
---
...
| `-`| Utoaji | `3 - 2`| `1`| |
| `*`| Kuzidisha | `3 * 2`| `6`| |
| `/`| Idara | `7 / 2`| `3`| Mgawanyiko kamili wa `int`; `3.5`ya`double`|
| `%`| Salio | `7 % 2`| `1`| |
...
|----------|------|---------|-------|
| `==`| Sawa | `x == y`| Usawa wa marejeleo kwa vitu |
| `!=`| Sio Sawa | `x != y`| |
| `<`,`>`,`<=`,`>=`| Mahusiano | `x >= y`| |
| `&&`| Mantiki NA | `a && b`| Mzunguko mfupi |
| `\|\|`| Mantiki AU | `a \|\| b`| Mzunguko mfupi |
| `!`| Mantiki SI | `!true`| `false`|
| `instanceof`| Andika Angalia | `obj instanceof String`| Pia muundo unaolingana (Java 16+) |
### Viendeshaji Bitwise
| Opereta | Jina | Mfano | Vidokezo |
|----------|------|---------|-------|
| `&`| NA | `5 & 3`| `1`|
...
| Utangulizi | Waendeshaji |
|------------|-----------|
| 1 (ya juu zaidi) | Marekebisho ya posta:`expr++``expr--` |
| 2 | Unary:`++expr``--expr``+expr``-expr``~``!` |
| 3 | Tuma:`(Type)expr`|
| 4 | Kuzidisha:`*``/``%`|
| 5 | Nyongeza:`+``-` |
| 6 | Shift:`<<``>>``>>>`|
| 7 | Uhusiano:`<``>``<=``>=``instanceof`|
| 8 | Usawa:`==``!=` |
| 9 | Bitwise NA:`&`|
| 10 | Bitwise XOR:`^`|
| 11 | Bitwise AU:`\|`|
...
### Lambdas & Violesura vya Utendaji
```java
// Lambda syntax
...
| Kiolesura | Utekelezaji | Imeagizwa | Lahaja-Salama ya Thread |
|-----------|------------------------------------------------------------------------
| `List`| `ArrayList`,`LinkedList`| Ndiyo | `CopyOnWriteArrayList`|
| `Set`| `HashSet`,`TreeSet`,`LinkedHashSet`| Inatofautiana | `CopyOnWriteArraySet`|
| `Map`| `HashMap`,`TreeMap`,`LinkedHashMap`| Inatofautiana | `ConcurrentHashMap`|
| `Queue`| `ArrayDeque`,`PriorityQueue`| Inatofautiana | `ConcurrentLinkedQueue`|
| `Deque`| `ArrayDeque`| Ncha zote mbili | `ConcurrentLinkedDeque`|
### Orodha
```java
// Creation
...
## Muhtasari
Sintaksia ya Java imebadilika sana kutoka asili yake ya 1995. Java ya kisasa (21+) ina rekodi, madarasa yaliyofungwa, kulinganisha muundo, nyuzi pepe na violezo vya kamba - kuifanya iwe fupi na ya kueleweka zaidi kuliko hapo awali. Sintaksia ya msingi inasalia kufahamika (kama C, imechapwa kwa nguvu, kulingana na darasa), lakini nyongeza za lambdas, API ya Mtiririko, na`var`zimepunguza kwa kiasi kikubwa boilerplate. Nguvu ya lugha iko katika mfumo wake mkubwa wa ikolojia, hakikisho za uoanifu zinazorudi nyuma, na uboreshaji wa utendaji wa JVM kupitia ujumuishaji wa JIT.