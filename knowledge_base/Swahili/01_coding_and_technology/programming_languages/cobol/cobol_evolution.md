...
# COBOL - Historia ya Toleo & Mageuzi
## Rekodi ya matukio
| Toleo | Mwaka | Mandhari Muhimu |
|---------|------|-----------|
| FLOW-MATIC | 1955 | Mtangulizi wa lugha ya biashara ya Grace Hopper |
| COBOL-60 | 1959 | **COBOL ya kwanza** (kamati ya CODASYL) |
| COBOL-61 | 1961 | Mwandishi wa Ripoti, maboresho ya`PERFORM`|
| COBOL-68 | 1968 | Kiwango cha kwanza cha ANSI (X3.1-1968) |
| COBOL-74 | 1974 | `IF`/`ELSE`,`EVALUATE`(switch), generalizations |
| COBOL-85 | 1985 | **Utayarishaji wa muundo**:`END-IF`,`END-PERFORM`, viondoa upeo |
| COBOL 2002 | 2002 | **OOP**: madarasa, mbinu, urithi,`FUNCTION`|
| COBOL 2014 | 2014 | **XML**,`JSON`(sehemu), aina ya`BOOLEAN`|
| COBOL 2023 | 2023 | **Mikusanyiko ya asili ya JSON**, UTF-8,`LIST`|
## Mafanikio Makuu
### Kuzaliwa kwa COBOL (1959)
- **1959**: CODASYL (Mkutano wa Lugha za Mifumo ya Data) huunda COBOL
**Ushawishi wa Grace Hopper**: "Lugha ya biashara inapaswa kuonekana kama Kiingereza"
- **Lengo**: Lugha ya biashara inayobebeka — hutumika kwenye kompyuta yoyote
- COBOL-60: Toleo la kwanza - utunzaji wa faili, ripoti, hesabu
### COBOL 68–74: Kusawazisha (1968–1974)
- **COBOL-68**: Kiwango cha kwanza cha ANSI
- **COBOL-74**:`EVALUATE`(taarifa ya kubadili), iliyoundwa`IF`/`ELSE`
- COBOL inakuwa lugha kuu ya biashara duniani kote
### COBOL 85: Structured COBOL (1985)
- **Visimamishaji vya upeo**:`END-IF`,`END-PERFORM`,`END-READ`
`EVALUATE` /`WHEN`(kubadili)
`PERFORM` /`END-PERFORM`(vitanzi vya ndani)
- Maboresho ya `SECTION`
- Hili ndio toleo la nambari ya COBOL iliyoandikwa zaidi
### COBOL 2002: Object-Oriented COBOL (2002)
- **Madarasa na mbinu** —`CLASS-ID`,`METHOD-ID`
- **Urithi** -`INHERITS`
- **Nyuso** -`IMPLEMENTS`
- Neno kuu la `FUNCTION`
Aina ya`BOOLEAN`(sehemu)
- Programu zilizowekwa
### COBOL 2014–2023: COBOL ya Kisasa (2014–sasa)
- **2014**: Msaada wa XML, aina ya JSON, `BOOLEAN`
- **2023**: **JSON asili** (PARSE JSON, GENERATE JSON), UTF-8,`LIST`mikusanyiko
- COBOL inaendelea kubadilika kwa enzi ya kisasa
