...
## Muhtasari
Nahau za kutu zinasisitiza: umiliki na ukopaji,`Result`/`Option`kwa kushughulikia makosa, enums na mbinu, sifa za uondoaji, upangaji wa minyororo ya kurudia, viashirio mahiri vya hali ya pamoja, na uondoaji wa gharama sifuri. Fuata`rustfmt`kwa uumbizaji,`clippy`kwa uwekaji, na Miongozo ya API ya kutu. Jumuiya ya Rust inathamini usalama, utendakazi na usahihi - "ikiwa itajumuisha, inafanya kazi." Pendelea`&str`kuliko`String`katika hoja za utendakazi, tumia`?`kwa uenezi wa hitilafu, na pata sifa zinazojulikana kwa`#[derive(Debug, Clone, ...)]`.