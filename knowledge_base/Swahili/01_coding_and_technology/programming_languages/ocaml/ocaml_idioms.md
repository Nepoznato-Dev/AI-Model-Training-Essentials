...
-->
# OCaml - Miundo ya Idiomatic & Mazoezi Bora
Mwongozo huu unashughulikia mifumo ya nahau ya kuandika msimbo safi, wa nahau wa OCaml.
---
...
## Muhtasari
Nahau za OCaml zinasisitiza: ulinganifu kamili wa muundo, moduli na vitendaji vya uondoaji, Matokeo/Chaguo la usalama, na opereta bomba-kwanza ( `|>`). Fuata`ocamlformat`kwa uumbizaji na`ocaml-lsp`kwa usaidizi wa IDE. OCaml inathamini aina ya usalama na usahihi wa kihesabu.