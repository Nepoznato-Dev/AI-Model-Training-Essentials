...
# Kotlin - Miundo ya Idiomatic & Mazoezi Bora
Mwongozo huu unashughulikia mifumo ya nahau na mbinu bora za kuandika msimbo safi, wa nahau wa Kotlin.
---
...
## Madarasa ya Data & Imetiwa Muhuri
```kotlin
...
## Muhtasari
Nahau za Kotlin zinasisitiza: usalama tupu, madarasa ya data, aina zilizofungwa, utendakazi wa upeo, utendaji wa kiendelezi, kanuni, na msimbo unaolenga kujieleza. Fuata Makubaliano ya Usimbaji ya Kotlin, tumia ktlint kwa uumbizaji, na detekt kwa uchanganuzi tuli. Kotlin inathamini ufupi na uwazi - andika sahani ndogo ya boiler, kumbatia maktaba ya kawaida, na utumie`val`kwa chaguo-msingi.