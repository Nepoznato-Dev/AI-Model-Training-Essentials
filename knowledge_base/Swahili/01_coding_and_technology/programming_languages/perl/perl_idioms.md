...
# Perl - Miundo ya Idiomatic & Mazoezi Bora
Mwongozo huu unashughulikia ruwaza za nahau na mbinu bora za kuandika msimbo safi, wa kisasa wa Perl (5.38+).
---
...
## Muhtasari
Nahau za kisasa za Perl zinasisitiza:`use strict; use warnings;`, saini, sema, postderef, na OOP ya kisasa (neno kuu la darasa katika 5.38+). Fuata perlcritic kwa uwekaji na perltidy kwa umbizo. Perl huthamini TMTOWTDI (Kuna Njia Zaidi ya Moja ya Kufanya) - lakini Perl ya kisasa hubadilika kwenye mifumo safi na inayoweza kudumishwa.