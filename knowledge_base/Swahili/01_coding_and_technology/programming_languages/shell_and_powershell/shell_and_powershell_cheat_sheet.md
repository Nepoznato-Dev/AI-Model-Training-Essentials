...
-->
# Shell & PowerShell - Karatasi ya Kudanganya
## Misingi ya Bash
```bash
# Variables
name="Alice"
...
## Mtiririko wa Udhibiti wa PowerShell
```powershell
# If
if ($age -ge 18) {
    "adult"
...
## Ushughulikiaji wa Hitilafu ya PowerShell
```powershell
try {
