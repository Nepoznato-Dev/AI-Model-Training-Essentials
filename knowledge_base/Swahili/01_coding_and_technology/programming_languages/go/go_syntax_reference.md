...
| `-`| Utoaji | `3 - 2`| `1`| |
| `*`| Kuzidisha | `3 * 2`| `6`| |
| `/`| Idara | `7 / 2`| `3`| Mgawanyiko kamili wa ints |
| `%`| Salio | `7 % 2`| `1`| Ishara zinazolingana na gawio |
| `&`| Bitwise NA | `5 & 3`| `1`| |
| `\|`| Bitwise AU | `5 \| 3`| `7`| |
| `^`| Bitwise XOR | `5 ^ 3`| `6`| Pia kijalizo kidogo (kidogo) |
| `&^`| Wazi kidogo (NA SIO) | `5 &^ 3`| `4`| Kipekee cha Kwenda |
| `<<`| Shift ya Kushoto | `5 << 1`| `10`| |
| `>>`| Shift ya kulia | `5 >> 1`| `2`| |
### Waendeshaji Kulinganisha
| Opereta | Jina | Mfano | Vidokezo |
|----------|------|---------|-------|
| `==`| Sawa | `x == y`| Aina zinazoweza kulinganishwa pekee |
| `!=`| Sio Sawa | `x != y`| |
| `<`,`>`,`<=`,`>=`| Kuagiza | `x >= y`| Mifuatano ililinganishwa kimsamiati |
### Viendeshaji Mantiki
| Opereta | Jina | Mfano | Vidokezo |
|----------|------|---------|-------|
...
## Muhtasari
Syntax ya Go ni ndogo kimakusudi - hakuna urithi, hakuna njia ya kupakia kupita kiasi, hakuna ubaguzi, hakuna macros. Kinachosalia ni muundo safi, ulio sawa: miundo na violesura vya utunzi, njia na mikondo ya upatanishi, na utunzaji wa hitilafu dhahiri kwa kutegemewa. Nguvu ya lugha haitokani na sintaksia changamano bali kutokana na mwingiliano wa kifahari wa viasili vyake rahisi. Jenetiki (Go 1.18+) huongeza unyumbulifu wa aina bila kuacha uwazi wa tabia ya Go.