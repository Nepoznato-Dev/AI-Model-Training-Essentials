...
## Aina Misingi ya Mfumo
### Aina za Awali na Zilizojengwa ndani
```typescript
// Primitives
...
## Aina za Huduma
### Aina za Huduma Zilizojengwa ndani
```typescript
interface User {
  id: string;
  name: string;
...
## Wapambaji (TC39 Hatua ya 3 / TypeScript 5.0+)
```typescript
// Class decorator
...
## Muhtasari
Mfumo wa aina ya TypeScript ndio hulka yake ya kufafanua, na ni ya kina sana. Kutoka kwa ufafanuzi wa kimsingi kupitia jenetiki, aina za masharti, aina zilizochorwa, aina halisi za violezo, na`infer`, mfumo wa aina kimsingi ni lugha inayofanya kazi inayofanya kazi wakati wa mkusanyiko. Kuelewa mwingiliano kati ya`interface`dhidi ya`type`, jenetiki dhidi ya aina za matumizi, na uchapaji wa muundo dhidi ya nominella inasaidia uandishi wa TypeScript ambayo ni salama na ergonomic. Lugha inaendelea kubadilika, na kila toleo linaongeza nguvu ya kujieleza huku ikidumisha upatanifu kamili wa nyuma na JavaScript.