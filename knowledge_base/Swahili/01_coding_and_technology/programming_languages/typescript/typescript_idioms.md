...
## Muhtasari
Nahau za TypeScript zinasisitiza: ukaguzi wa aina kali, violesura vya maumbo ya kitu, miungano iliyobaguliwa kwa serikali, aina ya walinzi wa kupunguza, jenetiki zenye vikwazo,`readonly`kwa kutobadilika, na`as const`kwa aina halisi. Fuata ESLint iliyo na`typescript-eslint`, Mzuri zaidi kwa uumbizaji, na uwashe`strict: true`kila wakati. Jamii ya TypeScript inathamini aina ya usalama - ikiwa itajumuisha, labda inafanya kazi. Pendelea`interface`kwa maumbo ya kitu,`type`kwa vyama vya wafanyakazi na huduma, na epuka`any`kwa gharama zote.