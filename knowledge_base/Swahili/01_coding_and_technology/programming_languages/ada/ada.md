...
## Kwa nini Ada ni Muhimu
- **Mifumo muhimu kwa usalama**: Iliyoundwa kutoka chini hadi kwa mifumo ambayo kushindwa sio chaguo.
- **Kuandika kwa nguvu**: Mfumo wa aina kali zaidi wa lugha yoyote kuu - hupata hitilafu wakati wa kukusanya ambapo lugha nyingine hukosa.
- **Upatanisho uliojumuishwa**: Kufanya Kazi (programu zinazofanana) ni sehemu ya lugha, si maktaba.
- **Uthibitishaji Rasmi**: Husaidia mbinu rasmi za kuthibitisha usahihi wa programu.
- **Vipengele vya kutegemewa**: Vighairi vilivyojumuishwa ndani, kandarasi (masharti ya awali/ya baada), na ukaguzi wa wakati wa utekelezaji.
- **Ada ya Kisasa**: Ada 2012 na Ada 2022 zimeongeza vipengele vya kisasa huku zikidumisha dhamana za usalama.
## Mapatano
| Kizuizi | Maelezo | Njia ya Kawaida |
|-----------|---------|-------------------|
| **Jumuiya ya Niche** | Msingi mdogo wa msanidi ikilinganishwa na C, Java, au Python | Jumuiya maalum lakini yenye ujuzi |
| **Sintaksia ya kitenzi** | Kitenzi zaidi kuliko C au Python | Kubali kama sehemu ya muundo unaolenga usalama |
| **Mfumo mdogo wa ikolojia** | Maktaba chache kuliko lugha kuu | Andika msimbo maalum; tumia maktaba ya kawaida |
| **Mwingo wa kujifunza** | Lugha changamano yenye vipengele vingi vya usalama | Anza na kitengo kidogo cha Ada cha "SPARK" kwa kazi muhimu ya usalama |
| **Upatikanaji wa mkusanyaji** | Chaguo chache za mkusanyaji (GNAT ndio kuu) | GNAT ni bure na imetunzwa vyema |
---
...
### Aina na Urithi zilizotambulishwa (OOP)
```ada
-- Abstract base type
package Shapes is
...
### Jenetiki (Compile-Time Polymorphism)
```ada
...
### Mikataba na Vipengele (Ada 2012)
```ada
...
### Vitu Vilivyolindwa (Data iliyoshirikiwa ya nyuzi-salama)
```ada
...
## Miundo ya Kubuni
### Mchoro wa 1: Mwangalizi aliye na Vipengee Vilivyolindwa
```ada
...
### Mchoro wa 2: Hali ya Mashine yenye Aina Zilizobaguliwa
```ada
...
### Mchoro wa 3: RAII yenye Aina Zilizodhibitiwa
```ada
...
## Usambazaji
### SPARK kwa Uidhinishaji Muhimu wa Usalama
```ada
...
## Wakati wa Kutumia Ada
| Hali | Kwanini Ada | Mbadala Bora |
|----------|---------|-------------------|
| Mifumo muhimu kwa usalama | Imeundwa kwa hili; usaidizi rasmi wa uthibitishaji | - |
| Usafiri wa anga / anga | Wakusanyaji walioidhinishwa; Uzingatiaji wa DO-178C | - |
| Mifumo ya ulinzi | urithi wa DoD; vipengele vya usalama | - |
| Reli / vifaa vya matibabu | Mahitaji ya uadilifu wa hali ya juu | - |
| Maendeleo ya maombi ya jumla | Overkill kwa mifumo isiyo ya muhimu | Python, Java, Nenda |
| Ukuzaji wa wavuti | Haifai | JavaScript, Chatu |
| Sayansi ya data / ML | Sio mfumo wa ikolojia | Chatu, R |
---

## Maswali na Majibu Yaliyoundwa
### Q1: Je, mfumo wa aina ya Ada huzuia vipi hitilafu wakati wa kukusanya?
**J:** Mfumo wa aina ya Ada ni miongoni mwa lugha kali kuliko lugha yoyote. Inapata makosa ambayo lugha zingine hukosa:
```ada
...
### Q2: Je, muundo wa kazi wa Ada ni upi na unalinganishwa vipi na miundo mingine ya sarafu?
**J:** Ada ina upatanishi wa ndani na vitu na kazi zinazolindwa:
```ada
...
### Q3: Je, ninatumiaje jeneriki katika Ada?
**Jibu:** Jeni za Ada ziko wazi na salama kwa aina:
```ada
generic
   type Element_Type is private;
...
### Q4: Ni nini hufanya Ada inafaa kwa mifumo muhimu ya usalama?
**J:** Ada hutoa:
- Sehemu ndogo ya SPARK kwa uthibitishaji rasmi (uthibitisho wa hisabati wa usahihi)
- Upangaji wa msingi wa mkataba (masharti ya awali / ya baada, aina tofauti)
- Hakuna mgao kamili wa kumbukumbu katika SPARK
- Uamuzi wa kuamua na upangaji
- Profaili ya Ravenscar kwa mifumo ya hali ya juu ya uadilifu
- Uhitimu wa Toolchain (DO-178C kwa avionics)
### Q5: Je, ninawezaje kujenga miradi ya Ada?
**J:** Tumia GPRBuild na faili za mradi za GPR:
```bash
gprbuild -P my_project.gpr
gprclean -P my_project.gpr
```
...
### Tatizo la 1: Utekelezaji wa Foleni ya Aina-salama
**Hatua ya 1: Elewa Tatizo**
Unda foleni iliyo na mipaka, isiyo na uzi kwa kuangalia saizi ya wakati.
**Hatua ya 2: Tambua Mbinu**
Tumia kitu kilicholindwa na bafa iliyo na mipaka.
**Hatua ya 3: Tekeleza**```ada
...
Kitu kilicholindwa kinahakikisha kutengwa kwa pande zote. Vizuizi vya kuingia huzuia kufurika/kuzidi.
### Tatizo la 2: Uthibitishaji Kulingana na Mkataba
**Hatua ya 1: Elewa Tatizo**
Tekeleza kitendakazi cha mzizi wa mraba na mikataba rasmi.
**Hatua ya 2: Tambua Mbinu**
Tumia kandarasi za Ada 2012 (masharti ya awali/ya posta).
**Hatua ya 3: Tekeleza**```ada
...
**Hatua ya 4: Thibitisha**
Ukaguzi wa wakati wa utekelezaji (madai) hupata ukiukaji. Katika SPARK, haya huwa majukumu ya uthibitisho.
---

## Muhtasari
Ada ni lugha iliyojengwa kwa usahihi. Mfumo wake madhubuti wa aina, upatanisho uliojumuishwa ndani, na usaidizi rasmi wa uthibitishaji hufanya iwe chaguo kwa mifumo ambapo kutofaulu hakukubaliki. Ingawa jumuiya yake ni ndogo ikilinganishwa na lugha kuu, Ada inasalia kuwa muhimu katika anga, ulinzi, nafasi, na maeneo mengine muhimu kwa usalama. Kwa programu hizi, mbinu kali ya Ada ya uhandisi wa programu sio kizuizi - ndio maana.