...
-->
# Scala - Miundo ya Idiomatic & Mazoezi Bora
Mwongozo huu unashughulikia mifumo ya nahau na mbinu bora za kuandika msimbo safi wa Scala 3.
---
...
## Muhtasari
Nahau za Scala zinasisitiza: kutobadilika (`val`), ulinganifu wa muundo, aina zilizofungwa, Chaguo/Aidha kwa usalama, ufahamu, mkusanyiko wa utendaji kazi, na aina za madarasa (zinazotolewa/kutumika katika Scala 3). Fuata Mwongozo wa Mtindo wa Scala, tumia scalafmt kwa uumbizaji, na scalafix kwa kuweka. Sintaksia safi ya Scala 3, enum, aina zisizo wazi, na mbinu za kiendelezi hufanya lugha iweze kufikiwa zaidi huku ikihifadhi nguvu yake ya utendaji.