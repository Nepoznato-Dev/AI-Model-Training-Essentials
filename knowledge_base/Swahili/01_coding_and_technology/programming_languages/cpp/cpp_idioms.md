...
# C++ — Miundo ya nahau na Mazoea Bora
Mwongozo huu unashughulikia mifumo ya nahau na mbinu bora za kuandika msimbo safi, wa kisasa wa C++ (20/23).
---

## RAII & Viashiria Mahiri
```cpp
...
## Muhtasari
Nahau za kisasa za C++ zinasisitiza: RAII na viashirio mahiri, semantiki za kusogeza,`auto`kwa upunguzaji wa aina, safu na algoriti (C++20), dhana za vizuizi vya violezo,`std::optional`/`std::expected`kwa kutokuwepo/makosa, Kanuni ya Sifuri kwa upatanishi wa muda wa sifuri, na XQZMA completation. Fuata`clang-format`kwa uumbizaji,`clang-tidy`kwa uwekaji, na uunge na`-Wall -Wextra -Werror`. Jumuiya ya C++ inathamini vifupisho vya bei sifuri na "usilipie usichotumia."