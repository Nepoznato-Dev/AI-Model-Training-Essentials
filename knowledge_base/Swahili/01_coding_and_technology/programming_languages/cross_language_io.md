...
# Ulinganisho wa Lugha Mtambuka — I/O & Uendeshaji wa Faili
## Toleo la Dashibodi
| Lugha | Chapisha hadi stdout |
|----------|----------------|
| Chatu | `print("Hello")`|
| JavaScript | `console.log("Hello")`|
| Kutu | `println!("Hello")`|
| Nenda | `fmt.Println("Hello")`|
...
| MATLAB | `disp('Hello')`|
| Dart | `print('Hello')`|
| Matangazo | `write('Hello'), nl.`|
| Lip | `(format t "Hello~%")`|
| Elixir | `IO.puts("Hello")`|
| Elang | `io:format("Hello~n")`|
| OCaml | `print_endline "Hello"`|
| Ada | `Put_Line("Hello")`|
| COBOL | `DISPLAY 'Hello'`|
| Fortran | `print *, 'Hello'`|
| Bunge | `syscall`(andika kwa fd 1) |
| Delphi | `WriteLn('Hello')`|
| Mwanga | `say [Hello]`|
| VB | `Console.WriteLine("Hello")`|
| Sheli | `echo "Hello"`|
| SQL | N/A (hurejesha seti za matokeo) |
## Kusoma Faili
```python
# Python
