...
## Sajili Mikataba & Dibaji/Epilogue
```nasm
...
## Shirika la Lebo na Misimbo ya Karibu
```nasm
...
## Muhtasari
Nahau za mkusanyiko zinasisitiza: viambishi vilivyopewa jina juu ya nambari za uchawi, makro kwa muundo unaorudiwa, ufafanuzi wa muundo wa mpangilio wa data, dibaji/epilojia inayotii ABI, lebo za ndani za kusomeka, uthibitishaji wa ingizo linda, na`xor`/`lea`kwa utendakazi bora. Mkutano huthawabisha uwazi zaidi kuliko yote — "ikiwa huwezi kukisoma, huwezi kusuluhisha saa 3 asubuhi."