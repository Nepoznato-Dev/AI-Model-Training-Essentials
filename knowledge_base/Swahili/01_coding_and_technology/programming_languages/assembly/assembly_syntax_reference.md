...
## Muhtasari
Sintaksia ya lugha ya mkutano inafafanuliwa na usanifu wa kichakataji na kiunganishi (NASM, GAS, MASM). x86-64 hutoa rejista 16 za madhumuni ya jumla, njia nyingi za kushughulikia, na mamia ya maagizo yanayohusu uhamishaji wa data, hesabu, mantiki, mtiririko wa udhibiti, SIMD na simu za mfumo. Sintaksia ya NASM inayotumika hapa ndiyo inayojulikana zaidi kwa ukuzaji wa Linux x86-64. Kusanyiko la ustadi kunahitaji rejista za kuelewa, rafu, mikusanyiko ya simu, na jinsi kiwango cha juu kinavyounda ramani kwa maagizo ya mashine.