...
# Linux Inaamuru Marejeleo ya Haraka
Amri muhimu za Linux/Unix kwa urambazaji wa mfumo na usimamizi.
---

## Uendeshaji wa Faili na Saraka
### Urambazaji```bash
...
|----------|--------|
| `Tab`| Kamilisha kiotomatiki |
| `Ctrl+C`| Ua amri ya sasa |
| `Ctrl+Z`| Sitisha amri |
| `Ctrl+D`| Ondoka kwenye ganda/EOF |
| `Ctrl+L`| Futa skrini |
| `Ctrl+A`| Nenda kwa mstari anza |
| `Ctrl+E`| Nenda mwisho wa mstari |
| `Ctrl+U`| Futa ili mstari kuanza |
| `Ctrl+K`| Futa hadi mwisho wa mstari |
| `Ctrl+R`| Historia ya utafutaji |
| `Ctrl+W`| Futa neno kabla ya kishale |
---

## Mbinu Bora
✅ **Fanya:**
- Tumia`sudo`kwa uangalifu na kwa uangalifu
- Jaribu amri za uharibifu bila bendera za utekelezaji kwanza
- Weka chelezo kabla ya mabadiliko makubwa
- Tumia majina ya faili yenye maana (hakuna nafasi)
- Jifunze kutumia kurasa za`man`(`man command`)
❌ **Usifanye:**
- Endesha`rm -rf /`au amri sawa hatari
- Tumia`chmod 777`kwenye faili nyeti
- Puuza ujumbe wa onyo
- Badilisha faili za mfumo bila chelezo
- Endesha hati zisizojulikana kama mzizi
---

*Ilisasishwa mara ya mwisho: Julai 2026 | Linux/Unix inaoana*