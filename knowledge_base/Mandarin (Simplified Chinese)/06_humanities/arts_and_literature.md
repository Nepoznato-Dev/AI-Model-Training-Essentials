...
- **科学 Fiction**: Speculative fiction exploring futuristic 技术, space exploration, time travel, parallel universes (e.g., "Dune" by Frank Herbert, "1984" by George Orwell)
- **Fantasy**: Magical worlds, mythical creatures, supernatural elements (e.g., "这 Lord 的 这 Rings" by J.R.R. Tolkien, "Harry Potter" by J.K. Rowling)
- **Mystery/Detective**: Crime-solving narratives 与 puzzles 和 investigations (e.g., Agatha Christie's Hercule Poirot series, Arthur Conan Doyle's Sherlock Holmes)
- **Horror**: Intended to frighten, unsettle, or create suspense (e.g., "这 Shining" by Stephen King, "Dracula" by Bram Stoker)
- **Romance**: Focus on romantic relationships 和 emotional journeys (e.g., Jane Austen's "Pride 和 Prejudice", Nicholas Sparks novels)
- **Historical Fiction**: Set 在 specific historical periods 与 accurate details (e.g., "这 Book Thief" by Markus Zusak, "Wolf Hall" by Hilary Mantel)
- **Magical Realism**: Realistic settings 与 magical elements treated as ordinary (e.g., "One Hundred Years 的 Solitude" by Gabriel García Márquez)

### Non-Fiction Genres
- **Biography/Autobiography**: Life stories 的 real people (e.g., "这 Diary 的 a Young Girl" by Anne Frank, "Becoming" by Michelle Obama)
...
- **Self-Help**: Personal 开发 和 improvement guides

### Poetry Forms
- **Sonnet**: 14-line poem 与 specific rhyme scheme (Shakespearean: ABAB CDCD EFEF GG; Petrarchan: ABBAABBA CDECDE)
- **Haiku**: Japanese form 与 5-7-5 syllable pattern
- **Limerick**: Five-line humorous poem 与 AABBA rhyme scheme
- **Free Verse**: No regular meter or rhyme pattern
- **Villanelle**: 19 lines 与 specific repetition pattern (e.g., "Do Not Go Gentle into That Good Night" by Dylan Thomas)
- **Ode**: Lyrical poem praising a person, event, or thing
- **Epic**: Long narrative poem about heroic deeds (e.g., "这 Odyssey" by Homer, "Beowulf")

## Major Literary Movements

### Historical Periods
- **Classical 文学** (8th century BCE - 5th century CE): Greek 和 Roman works emphasizing reason, order, 和 humanism
- **Medieval 文学** (5th - 15th century): Religious themes, chivalric romances, allegories (e.g., "这 Divine Comedy" by Dante)
...
- **性能 Art**: Live actions, body art, happenings
...
- **Melody 和 Counterpoint**: Thematic 开发, voice leading
...
- **Musical Theater**: Songs, dance, dialogue integrated (e.g., "Hamilton", "Les Misérables", "这 Phantom 的 这 Opera")
- **Experimental/Avant-Garde**: Non-traditional forms, audience participation

### Famous Playwrights
- William Shakespeare (英语, 1564-1616): "Hamlet", "Macbeth", "Romeo 和 Juliet"
- Anton Chekhov (Russian, 1860-1904): "这 Cherry Orchard", "Three Sisters"
- Tennessee Williams (American, 1911-1983): "A Streetcar Named Desire", "这 Glass Menagerie"
- Arthur Miller (American, 1915-2005): "Death 的 a Salesman", "这 Crucible"
- Samuel Beckett (Irish, 1906-1989): "Waiting 为 Godot", "Endgame"
...
- **科学 Fiction**: Futuristic 技术, space, time travel

### Film Movements
- **German Expressionism** (1920s): Distorted visuals, psychological themes ("这 Cabinet 的 Dr. Caligari")
...
### Classic 文学
- Homer: "这 Iliad", "这 Odyssey" (Ancient Greece)
- Dante Alighieri: "这 Divine Comedy" (Italy, 1308-1320)
...
- Fyodor Dostoevsky: "Crime 和 Punishment", "这 Brothers Karamazov" (Russia, 1860s-1880s)
...
- Virginia Woolf: "Mrs. Dalloway", "To 这 Lighthouse" (England, 1920s)
- Franz Kafka: "这 Metamorphosis", "这 Trial" (Czechoslovakia, 1910s-1920s)
- Gabriel García Márquez: "One Hundred Years 的 Solitude" (Colombia, 1967)
- Toni Morrison: "Beloved", "Song 的 Solomon" (USA, 1970s-1980s)
- Haruki Murakami: "Norwegian Wood", "Kafka on 这 Shore" (Japan, 1980s-present)
...
- **Imagery**: Descriptive 语言 appealing to senses
...
- **Foreshadowing**: Hints about 未来 事件
- **Flashback**: Scenes from earlier 在 这 story

### Structural Elements
- **Plot**: Exposition, rising action, climax, falling action, resolution
- **Character 开发**: Protagonist, antagonist, dynamic/static characters
- **Setting**: Time, place, social context
- **Theme**: Central message or underlying meaning
- **Tone**: Author's attitude toward subject
- **Mood**: Emotional atmosphere created 为 reader
...
- British Museum (London): Human 历史 和 文化
...
### Literary Awards
- Nobel Prize 在 文学: International recognition
- Pulitzer Prize (USA): Fiction, drama, 历史, poetry
- Booker Prize (UK/Commonwealth): Best original novel
- Hugo Award: 科学 fiction 和 fantasy
