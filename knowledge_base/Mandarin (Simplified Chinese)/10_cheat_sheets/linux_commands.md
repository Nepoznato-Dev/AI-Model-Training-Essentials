...
Essential Lux/Unix comm和s system navigation 和 admistration.
...
```bash
echo $HOME # Show 环境 variable
export VAR=value # Set 环境 variable
env # List all 环境 variables
...
- Test destructive comm和s 与out execution flags first
- Keep backups ...之前 major changes
...
- Edit system files 与out backups
