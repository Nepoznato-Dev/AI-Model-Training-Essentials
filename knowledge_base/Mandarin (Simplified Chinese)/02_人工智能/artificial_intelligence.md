...
LLM 的训练通常分为两个阶段：预训练（在大规模文本语料上进行无监督训练）和微调（监督微调，或通过基于人类反馈的强化学习，即 RLHF）。上下文窗口描述了 LLM 一次可以处理多少文本，其规模已从早期 GPT-3 的 4K tokens，发展到 2026 年最先进模型的超过 100 万 tokens。
...
- **AI 监管**：欧盟《AI 法案》（2026）是全球首部全面的 AI 法律，按风险等级对 AI 系统进行分类
