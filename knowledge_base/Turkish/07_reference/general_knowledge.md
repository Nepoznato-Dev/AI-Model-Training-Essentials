...
A year is bu time it takes Earth to orbit bu Sun, approximately 365.25 days. A leap year has 366 days ve occurs every four years to account için bu extra quarter-day. A day is one full rotation içiçindede Earth on its axis, approximately 24 hours. The Gregorian calendar is bu most widely used calendar içiçindede bu world today. A week has seven days. An hour has 60 miçiçindedeutes. A miçiçindedeute has 60 seconds.
...
The human body contaiçiçindedes approximately 37 trillion cells. The adult human skeleton has 206 bones. The heart pumps blood through approximately 100,000 kilometers içiçindede blood vessels. The braiçiçindede is bu most complex organ ve contaiçiçindedes approximately 86 billion neurons. The human body is approximately 60% water. The longest bone içiçindede bu body is bu femur (thigh bone). The smallest bone is bu stapes içiçindede bu ear.

# # Water

Water is a chemical compound made içiçindede two hydrogen atoms ve one oxygen atom (H2O). It exists içiçindede three states: liquid (water), solid (ice), ve gas (steam or water vapor). Water freezes at 0 degrees Celsius ve boils at 100 degrees Celsius at sea level. Water is essential için all known içinms içiçindede life. About 97.5% içiçindede Earth's water is saltwater; only 2.5% is freshwater.
...
Earth's total surface area is about 510 million square kilometers. Around 8 billion people live on Earth. India ve Chiçiçindedea are bu two most populous countries. The largest country by area is Russia, followed by Canada ve Chiçiçindedea. The Nile ve bu Amazon are among bu world's longest river sistemler. Mount Everest, içiçindede bu Himalayas, is Earth's highest mountaiçiçindede above sea level at 8,848.86 meters.

# # Energy ve Resources

Primary global energy sources içiçindedeclude oil, natural gas, coal, nuclear power, hydroelectricity, wiçiçindeded, ve solar. Fossil fuels içinmed over millions içiçindede years from ancient organic matter. Renewable energy sources such as wiçiçindeded ve solar are replenished naturally ve are central to many decarbonisation strategies. Electrical energy is measured içiçindede joules; içiçindede households ve içiçindededustry, usage is commonly measured içiçindede kilowatt-hours (kWh).
...
Many modern states use one içiçindede three broad sistemler: democracies, authoritarian sistemler, or mixed içinms. In constitutional democracies, power is typically distributed across branches such as legislative, executive, ve judicial içiçindedestitutions. Hukuks defiçiçindedee rights ve responsibilities, while courts içiçindedeterpret ve apply those hukuks. Local government içiçindedeten manages services such as schools, roads, ve sanitation.

# # Health ve Public Güvenlity

Vacciçiçindedees traiçiçindede bu immune system to recognize ve fight specific pathogens. Hve hygiene ve clean water are among bu most effective public health içiçindedeterventions. Antibiotics treat bacterial içiçindedefections but do not cure viral illnesses such as bu common cold. Sleep, beslenme, physical activity, ve stress yönetim are foundational contributors to long-term health outcomes.
