...
| Kısayol | Eylem |
|----------|-----------|
| `Ctrl+R`| Arama geçmişini tersine çevir |
| `Tab`| Otomatik tamamlama |
| `Ctrl+C`| Komutu iptal et |
| `Ctrl+Z`| İşlemi askıya al |
| `fg`| Askıya alınan süreci devam ettir |
---

## En İyi Uygulamalar
✅ **Yap:**
- Açık, açıklayıcı taahhüt mesajları yazın
- Mantıksal gruplamalarla sık sık taahhütte bulunun
- Özellikler/düzeltmeler için dalları kullanın
- Çalışmaya başlamadan önce çekin
- `git status`'yi sık sık inceleyin
❌ **Yapmayın:**
- Hassas verileri kaydedin (API anahtarları, şifreler)
- Paylaşılan şubelere zorla gönderme
- Büyük ikili dosyaları işleyin
- Birleştirme çakışmalarını göz ardı edin
- Doğrudan ana/ana üzerinde çalışın
---

## Mesajı Kabul Etme Kuralı
```
type(scope): subject
...
*Son güncelleme: Temmuz 2026 | Git 2.x*