...
# Linux Komutları Hızlı Başvurusu
Sistemde gezinme ve yönetim için temel Linux/Unix komutları.
---
...
| `Ctrl+D`| Kabuk/EOF'tan çık |
| `Ctrl+L`| Ekranı temizle |
| `Ctrl+A`| Satır başlangıcına git |
| `Ctrl+E`| Satır sonuna git |
| `Ctrl+U`| Satır başına kadar sil |
| `Ctrl+K`| Satır sonuna kadar sil |
| `Ctrl+R`| Arama geçmişi |
| `Ctrl+W`| İmleçten önceki kelimeyi sil |
---

## En İyi Uygulamalar
✅ **Yap:**
- `sudo`'yi dikkatli ve dikkatli kullanın
- Yıkıcı komutları önce yürütme bayrakları olmadan test edin
- Büyük değişikliklerden önce yedekleri saklayın
- Anlamlı dosya adları kullanın (boşluksuz)
-`man`sayfalarını (`man command`) kullanmayı öğrenin
❌ **Yapmayın:**
-`rm -rf /`veya benzeri tehlikeli komutları çalıştırın
- Hassas dosyalarda`chmod 777`kullanın
- Uyarı mesajlarını dikkate almayın
- Sistem dosyalarını yedeklemeden düzenleyin
- Bilinmeyen komut dosyalarını root olarak çalıştır
---

*Son güncelleme: Temmuz 2026 | Linux/Unix uyumlu*