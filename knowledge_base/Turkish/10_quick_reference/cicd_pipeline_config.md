...
| **Bileşik eylemler** | Birden fazla adımı tek bir eylemde birleştirin |
### Matris Stratejisi
```yaml
jobs:
  test:
...
| `when`| İşin yürütülmesini kontrol etme (başarılı olduğunda, başarısız olduğunda, manuel, her zaman) |
