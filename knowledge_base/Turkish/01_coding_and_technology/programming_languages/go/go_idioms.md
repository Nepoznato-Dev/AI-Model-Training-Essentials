...
# Go — Deyimsel Kalıplar ve En İyi Uygulamalar
Bu kılavuz, temiz, deyimsel Go kodu yazmaya yönelik deyim kalıplarını ve en iyi uygulamaları kapsar.
---
...
## Özet
Go deyimleri şunları vurgular: basitlik, açık hata yönetimi, küçük arayüzler, kalıtım üzerinden kompozisyon, bağlam içeren goroutinler ve "arayüzleri kabul et, yapıları döndür." Biçimlendirme için `gofmt`'yi, astarlama için `golangci-lint`'yi ve resmi Go Code İnceleme Yorumları kılavuzunu takip edin. Go topluluğu okunabilirliğe, basitliğe ve "bunu yapmanın bariz yoluna" değer verir. Akıllı kodlardan kaçının – Go kodu sıkıcı ve öngörülebilir olmalıdır.