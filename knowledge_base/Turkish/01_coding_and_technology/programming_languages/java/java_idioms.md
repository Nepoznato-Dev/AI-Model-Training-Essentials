...
## Özet
Modern Java deyimleri şunları vurgular: veri için kayıtlar, hiyerarşiler için mühürlü sınıflar, kalıp eşleştirme, anahtar ifadeleri, metin blokları, koleksiyon işleme için akışlar, yokluk için isteğe bağlı, temizleme için kaynaklarla deneme, eşzamanlılık için sanal iş parçacıkları ve bağımlılık enjeksiyonu. Google Java Stil Kılavuzu'nu izleyin, biçimlendirme için`javafmt`veya `Spotless`'yi ve astarlama için Error Prone veya Checkstyle'ı kullanın. Kayıtlar, mühürlü sınıflar, kalıp eşleştirme ve sanal iş parçacıkları içeren modern Java (17-21+) kısa ve özdür; yeni özellikleri benimseyin.