...
-->
# Swift — Deyimsel Kalıplar ve En İyi Uygulamalar
Bu kılavuz, temiz Swift kodu yazmaya yönelik deyimsel kalıpları ve en iyi uygulamaları kapsar.
---

## İsteğe Bağlı Seçenekler ve Güvenlik
```swift
...
## Özet
Swift deyimleri şunları vurgular: güvenlik (seçenekler, koruma), değer türleri (yapılar), protokol odaklı tasarım, desen eşleştirme, eşzamansız/beklemede ve değişmezlik (varsayılan olarak `let`). Swift API Tasarım Yönergelerini izleyin, kod kalitesi için SwiftLint'i ve biçimlendirme için SwiftFormat'ı kullanın. Swift güvenliğe ve ifade gücüne değer veriyor; "derlenirse muhtemelen doğrudur."