...
## Özet
Visual Basic deyimleri şunları vurgular: Tür güvenliği için `Option Strict On`, kaynak yönetimi için`Using`blokları, dize enterpolasyonu, koleksiyonlar için LINQ, baştan sona `Async/Await`, belirli istisna işleme ve kalıp eşleştirme ve boş koşullu operatörler gibi modern özellikler. VB okunabilirliğe değer verir - "kod iyi organize edilmiş bir spesifikasyon gibi okunmalıdır."