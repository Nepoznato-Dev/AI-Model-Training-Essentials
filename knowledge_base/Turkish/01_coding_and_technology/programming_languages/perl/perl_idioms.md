...
-->
# Perl — Deyimsel Kalıplar ve En İyi Uygulamalar
Bu kılavuz, temiz, modern Perl (5.38+) kodu yazmaya yönelik deyim kalıplarını ve en iyi uygulamaları kapsar.
---
...
## Özet
Modern Perl deyimleri şunu vurgular:`use strict; use warnings;`, imzalar, örneğin postderef ve modern OOP (5.38+ sürümünde sınıf anahtar sözcüğü). Linting için perlcritic'i ve biçimlendirme için perltidy'yi takip edin. Perl, TMTOWTDI'ye değer veriyor (Bunu Yapmanın Birden Fazla Yolu Var) - ancak modern Perl, daha temiz, daha sürdürülebilir kalıplara yaklaşıyor.