...
-->
# Scratch — Deyimsel Kalıplar ve En İyi Uygulamalar
Bu kılavuz temiz, iyi organize edilmiş Scratch projeleri yazmaya yönelik deyimsel kalıpları kapsar.
---
...
## Özet
Scratch deyimleri şunları vurgular: net sprite adlandırma, sprite başına bir sorumluluk, iletişim için yayın mesajları, yeniden kullanım için özel bloklar, birden fazla örnek için klonlama, yapılandırılmış oyun döngüleri ve performans için "ekran yenileme olmadan çalıştırma". Scratch ödül organizasyonu - "iyi isimlendirilmiş bir sprite programın yarısıdır."