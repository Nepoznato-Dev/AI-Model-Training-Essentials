...
## Blok Kategorilerine Genel Bakış
| Kategori | Renk | Blok Türleri | Amaç |
|----------|-----------|------------|-----------|
| **Hareket** | Mavi | Yığın | Karakterleri hareket ettirin, konumu ve yönü değiştirin |
| **Görünüş** | Mor | Yığın | Görünümü değiştir, söyle/düşün, göster/gizle |
| **Ses** | Pembe | Yığın | Sesleri çalın, ses seviyesini/perdeyi değiştirin |
| **Etkinlikler** | Sarı | Şapka | Komut dosyalarını başlatın, mesajları yayınlayın/alın |
| **Kontrol** | Altın | Yığın | Döngüler, koşul cümleleri, bekle, dur |
| **Algılama** | Açık Mavi | Muhabir | Çarpışmaları, girişi, zamanlayıcıyı, yanıtları algıla |
| **Operatörler** | Yeşil | Muhabir | Matematik, metin, karşılaştırma, mantık |
| **Değişkenler** | Turuncu | Yığın/Raporlayıcı | Verileri saklama, listeleme işlemleri |
| **Bloklarım** | Koyu Kırmızı | Yığın | Özel blok tanımları (işlevler) |
---
...
## Etkinlik Blokları (Şapka Blokları)
```
...
## Özet
Scratch'in blok tabanlı sözdizimi yazım hatalarını ortadan kaldırır ve programlama kavramlarını somut hale getirir. Her komut dosyası bir şapka bloğu (olay) ile başlar, ardından komut bloklarını (hareket, görünüm, ses, kontrol, algılama, operatörler, değişkenler) istifler ve değerler için raporlayıcı blokları (yuvarlak/oval şekiller) kullanır. Özel bloklar modüler programlamayı mümkün kılar. Klonlar nesne benzeri davranış sağlar. Mağaza koleksiyonlarını listeler. Kalem uzantısı yaratıcı çizime olanak sağlar. Scratch, genç öğrenciler için programlama mantığına, olaya dayalı tasarıma ve kod yoluyla yaratıcı ifadeye eksiksiz bir giriş sağlar.