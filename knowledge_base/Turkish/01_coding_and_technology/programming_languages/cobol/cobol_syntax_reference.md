...
---
# COBOL — Sözdizimi Referansı
Bu belge, COBOL (2014+) için kapsamlı, yapılandırılmış bir sözdizimi referansı sağlar. Kapsamlı sözdizimi kalıplarına, veri açıklamalarına, dosya işlemeye ve iş mantığına odaklanarak ana COBOL referansını tamamlar.
---
...
## Özet
COBOL'un sözdizimi tasarımı gereği ayrıntılıdır; her ifade İngilizce gibi okunur. PIC cümleleriyle veri açıklamaları alan formatlarını tam olarak tanımlar. Dört bölümlü yapı, endişelerin ayrılmasını zorunlu kılar. Dosya işleme dilin içine yerleştirilmiştir. Ticari veri işleme için COBOL'un ondalık aritmetiği ve kayıt odaklı I/O'su benzersiz kalır. COBOL'u anlamak, kurumsal bilişimin temelini anlamak anlamına gelir.