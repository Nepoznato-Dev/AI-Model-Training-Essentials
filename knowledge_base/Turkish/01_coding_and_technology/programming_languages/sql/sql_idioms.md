...
## Özet
SQL deyimleri şunları vurgular: açık sütun adları, tutarlı biçimlendirme, okunabilirlik için CTE'ler, analitik için pencere işlevleri, performans için SARGable sorguları ve ayarlama için `EXPLAIN ANALYZE`. Biçimlendirme için SQLFluff'u izleyin ve SQL enjeksiyonunu önlemek için her zaman parametreli sorgular kullanın.