...
-->
# Fortran — Deyimsel Kalıplar ve En İyi Uygulamalar
Bu kılavuz, temiz, modern Fortran (2018+) kodu yazmaya yönelik deyim kalıplarını ve en iyi uygulamaları kapsar.
---
...
## Özet
Modern Fortran deyimleri şunları vurgular:`implicit none`, dizi işlemleri (döngülerden kaçının), varsayılan şekilli diziler, türe bağlı prosedürlerle türetilmiş türler ve tüm argümanlar için `intent`. Biçimlendirme için fprettify'ı takip edin. Coarray'ler ve DO CONCURRENT içeren modern Fortran (2018+), paralel hesaplamayı yerel olarak destekler.