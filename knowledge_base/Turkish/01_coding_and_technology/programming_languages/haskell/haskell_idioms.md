...
## Özet
Haskell deyimleri şunları vurgular: güçlü türler, kalıp eşleştirme, efektler için monadlar, saf işlevler ve tembel değerlendirme (gerektiğinde katılıkla). Haskell Stil Kılavuzunu izleyin, öneriler için `hlint`'yi ve biçimlendirme için `fourmolu`'yi kullanın. Haskell doğruluğa ve kompozisyona değer verir - "yasadışı devletleri temsil edilemez hale getirir."