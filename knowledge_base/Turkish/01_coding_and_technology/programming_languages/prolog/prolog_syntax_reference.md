...
-->
# Prolog — Sözdizimi Referansı
Bu belge Prolog için kapsamlı, yapılandırılmış bir sözdizimi referansı sağlar. Kapsamlı sözdizimi kalıplarına, birleştirmeye, geri izlemeye, DCG'lere ve mantıksal programlama deyimlerine odaklanarak ana Prolog referansını tamamlar.
---
...
## Özet
Prolog'un sözdizimi minimum düzeydedir; gerçekler, kurallar ve sorgular. Güç, dili mantıksal çözümler için bir arama motoruna dönüştüren birleştirme ve geri izlemeden gelir. DCG'ler zarif ayrıştırıcı üretimi sağlar. Listeler baş/kuyruk deseni eşleşmesini kullanır. Kısıtlama tatmini, uzman sistemler ve sembolik hesaplama için Prolog'un bildirimsel yaklaşımı, emir dillerinde ayrıntılı olan sorunları çözer.