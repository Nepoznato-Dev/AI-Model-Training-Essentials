...
Bu kılavuz, temiz, modern C# (12+) kodu yazmaya yönelik deyim kalıplarını ve en iyi uygulamaları kapsar.
---
...
## Tek Kullanımlık ve Kaynak Yönetimi
```csharp
...
## Özet
Modern C# deyimleri şunları vurgular: veri kayıtları, model eşleştirme, boş güvenlik (null yapılabilir referans türleri), koleksiyonlar için LINQ, CancellationToken ile eşzamansız/beklemede, bağımlılık enjeksiyonu, birincil yapıcılar, koleksiyon ifadeleri ve`using`bildirimleri. C# Kodlama Kurallarını izleyin, biçimlendirme için `dotnet format`'yi ve kod kalitesi için Roslyn analizörlerini kullanın. Modern C# (12+) özlü ve etkileyicidir; kayıtları, kalıp eşleştirmeyi ve birincil oluşturucuları kapsar.