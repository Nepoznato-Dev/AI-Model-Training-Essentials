...
## Özet
Scala deyimleri şunları vurgular: değişmezlik (`val`), desen eşleştirme, mühürlü türler, güvenlik için Seçenek/Ya da, kavrama için, işlevsel koleksiyonlar ve tür sınıfları (Scala 3'te verilir/kullanılır). Scala Stil Kılavuzunu takip edin, biçimlendirme için scalafmt'yi ve linting için scalafix'i kullanın. Scala 3'ün daha temiz sözdizimi, numaralandırmaları, opak türleri ve uzantı yöntemleri, işlevsel gücünü korurken dili daha ulaşılabilir hale getirir.