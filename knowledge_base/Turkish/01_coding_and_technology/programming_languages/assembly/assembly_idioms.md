...
## Adlandırılmış Sabitler ve Makrolar
```nasm
...
## Sözleşmeleri ve Giriş/Sonsöz'ü kaydedin
```nasm
...
## Yerel Etiketler ve Kod Organizasyonu
```nasm
...
## Özet
Derleme deyimleri şunları vurgular: sihirli sayılar üzerinde adlandırılmış sabitler, tekrarlanan modeller için makrolar, veri düzeni için yapı tanımları, ABI uyumlu önsöz/sonsöz, okunabilirlik için yerel etiketler, savunma amaçlı giriş doğrulaması ve verimli işlemler için`xor`/ `lea`. Montaj her şeyden önce netliği ödüllendirir - "okuyamıyorsanız, sabah 3'te hata ayıklayamazsınız."