...
## Özet
Lua deyimleri şunu vurgular: evrensel veri yapısı olarak tablolar, yerel değişkenler, durum için kapanışlar, OOP için metatablolar ve 1 tabanlı indeksleme. Linting için luacheck'i ve biçimlendirme için kalemi takip edin. Lua sadeliğe ve minimalizme değer veriyor; dil kasıtlı olarak küçük olduğundan desenler kompozisyondan ortaya çıkıyor.