...
## Özet
Clojure'un sözdizimi aynı şekilde parantez içine alınmıştır; her form bir listedir. Bu homoikoniklik, kodu veriye dönüştüren güçlü makrolara olanak tanır. Kalıcı veri yapıları, verimlilik için yapısal paylaşımla değişmezlik sağlar. İş parçacığı makroları okunabilir veri ardışık düzenleri oluşturur. Eşzamanlılık temelleri (atomlar, referanslar, aracılar, kanallar) durum değişikliklerini güvenli bir şekilde yönetir. Lisp/Clojure'un modern programlama üzerindeki etkisi çok büyüktür; çöp toplama, REPL'ler, makrolar ve işlevsel programlamanın tümü Lisp'e dayanmaktadır.