...
## Model Kayıtları
Model kaydı, makine öğrenimi modellerinin (sürümleri, meta verileri, ölçümleri ve dağıtım durumları) yönetilmesine yönelik merkezi bir depodur.
| Yetenek | Açıklama |
|-----------|----------------|
...
| Araç | Açıklama |
|------|-----------------|
| **MLflow** | Açık kaynak; model kaydı + deneme takibi |
...
|------|-----------------|
| **MLflow** | Açık kaynaklı, kendi kendine barındırılan, parametreleri/ölçümleri/yapıları izler |
...
| Kategori | Örnekler |
|----------|-----------|
| **Parametreler** | Öğrenme oranı, parti büyüklüğü, model mimarisi, dönem sayısı |
...
| **Ortam sabitleme** | `requirements.txt`,`conda env`, Tam sürümleriyle Docker görüntüleri |
...
Özellik bayrakları, yeniden konuşlandırmaya gerek kalmadan hangi model sürümünün hangi kullanıcılara hizmet vereceğini kontrol etmenize olanak tanır.
