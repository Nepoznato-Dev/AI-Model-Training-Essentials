...
**Bağlamla birlikte:**
> "Kıdemli bir Python geliştiricisisiniz. Sözlüklerin listesini belirli bir anahtara göre sıralamak için bir işlev yazın. Tür ipuçlarını kullanın ve uç durumları ele alın. Hedef kitle, kıdemsiz geliştiricilerdir."
...
Modelin akıl yürütmeyi araç çağrılarıyla bir araya getirmesine izin verin. Düşünebilir, sonra harekete geçebilir (ör. internette arama yapabilir, kod çalıştırabilir), sonra sonuca göre yeniden düşünebilir.
**Bilgi istemi yapısı:**
