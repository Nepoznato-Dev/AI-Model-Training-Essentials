...
Phi-3-mini, Microsoft Research tarafından geliştirilen ve Nisan 2024'da piyasaya sürülen küçük bir dil modelidir (SLM). Tanımlayıcı özellikleri şunlardır:
...
- **Mobil dağıtım** — Microsoft, iPhone 14 Pro'te Phi-3-mini'nin çalıştığını gösterdi
...
*Kaynak: Microsoft Phi-3 Teknik Raporu (Nisan 2024)*
---
...
## Diğer Önemli Yerel Modeller (2024)
### Lama 3 (Meta, 2024)
...
## 2024'te Yerel Yapay Zeka Modeli Pazarı
Yerel ve bulut modelleri arasındaki fark 2024'da önemli ölçüde daraldı:
