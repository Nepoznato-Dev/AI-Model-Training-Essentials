...
| **Kelime kaldırmayı durdur** | Yaygın sözcükleri kaldırın (the, is, at) | "kedi oturdu" → "kedi oturdu" |
| **Köklenme** | Kelime sonlarını doğrayın (kaba) | "çalışıyor" → "koşuyor" |
| **Lemmatizasyon** | Sözlük biçimine düşürün (bağlama duyarlı) | "daha iyi" → "iyi" |
...
|-----------|---------------|----------|-----------|
| **Yalnızca kodlayıcı** | Metni anlar | Sınıflandırma, NER, duygu analizi | BERT, RoBERTa, DeBERTa |
