...
| **Büyütme** | Eğitim verilerini yapay olarak genişletme (döndürme, çevirme, renk değişimi, kırpma) |
---
...
Kitaplıklar:`torchvision.transforms`,`albumentations`,`imgaug`,`tf.keras.preprocessing`.
---
