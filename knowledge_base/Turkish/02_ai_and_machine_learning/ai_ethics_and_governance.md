...
|-----------|-----------------|-----------|
| **Adillik** | Yapay Zeka, korunan gruplara karşı ayrımcılık yapmamalı | Adaleti matematiksel olarak tanımlamak şaşırtıcı derecede zordur; farklı adalet tanımları çatışması |
...
| **İnsan gözetimi** | İnsanlar anlamlı kontrolü elinde tutmalıdır | Otomasyon önyargısı, insanların yapay zekaya uyması anlamına gelir; gözetim, damgalama haline geldi |
---
...
| **Etiket önyargısı** | İnsan yorumcular önyargılarını empoze ediyor | Açıklayıcılar tarafından daha düşük puan alan "kadın" adlarına sahip özgeçmişler |
...
| **Eşitleştirilmiş oranlar** | Doğru pozitif oranı ve yanlış pozitif oranı gruplar arasında eşittir | Eşit hata oranları istediğinizde |
...
| Sayı | Açıklama | Durum |
|----------|----------------|-----------|
| **Telif hakkıyla korunan eserlere ilişkin eğitim** | Modeller izinsiz olarak kitaplar, makaleler, görseller üzerinde eğitildi | Aktif davalar; adil kullanım tartışması |
...
| **Opt-out mekanizmaları** | Bazı sağlayıcılar içerik oluşturucuların eğitime katılmamalarına izin veriyor | robots.txt; içerik filtreleme |
---
...
| **Filigranlama** | Yapay Zeka tarafından oluşturulan içeriğe onu tanımlamak için görünmez işaretleyiciler yerleştirme |
---
...
| **Etki değerlendirmeleri** | Dağıtımdan önce olası zararları değerlendirin |
...
## Özet
Yapay zeka etiği ve yönetişim sonradan akla gelen düşünceler değildir; bunlar mühendislik gereksinimleridir. Önyargı, şeffaflık, çevresel maliyet ve mahremiyet ihlalleri yalnızca etik kaygılar değildir; bunlar gerçek insanlara gerçekten zarar veren böceklerdir. Yönetişim ortamı hızla gelişiyor ve AB Yapay Zeka Yasası küresel standardı belirliyor. Ancak düzenleme tek başına yeterli değildir. Her yapay zeka geliştiricisinin günlük çalışmalarının bir parçası olarak adalet, açıklanabilirlik ve hesap verebilirlik konularını düşünmesi gerekir. Sorun yapay zekanın yönetilip yönetilmeyeceği değil, güvenilmeye değer sistemlerin nasıl oluşturulacağıdır.