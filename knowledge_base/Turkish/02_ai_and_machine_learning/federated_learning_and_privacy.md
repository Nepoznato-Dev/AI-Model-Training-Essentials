...
|-----------|---------------|-----------|
| **FedOrtalama** | Cihazlar arasındaki ortalama model ağırlıkları | Basit; IID verileri için iyi çalışır |
| **FedProx** | Yerel eğitime yakın bir terim ekler | IID olmayan veriler için daha iyi |
| **İSKELE** | Veri heterojenliğini düzeltmek için kontrol değişkenlerini kullanır | IID olmayan verilerde daha hızlı yakınsama |
| **FedSGD** | FedAvg gibi ancak tur başına bir degrade adımla | Tur başına daha düşük iletişim maliyeti |
...
Birden çok taraf, bireysel girdilerini açıklamadan, birleştirilmiş verileri üzerinden bir işlevi hesaplar.
| Özellik | Açıklama |
|-----------|------------|
...
| **TensorFlow Federe** | TensorFlow modelleri için Google'ın FL çerçevesi |
