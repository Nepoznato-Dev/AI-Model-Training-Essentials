...
| Konsept | Açıklama |
|-----------|------------|
| **Konu** | Bir mesaj kategorisi (örneğin,`orders`,`user-events`) |
| **Bölme** | Konular paralellik için bölümlere ayrılmıştır |
...
| **dbt testleri** | Ambar verileri için yerleşik testler (benzersiz, boş değil, ilişkiler) |
