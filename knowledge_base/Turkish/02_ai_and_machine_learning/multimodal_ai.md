...
| **Havlama** (Suno) | Trafo bazlı | Çok dilli; konuşma dışı sesleri içerir |
...
| **Kling** | Metinden videoya | Uzun biçimli video oluşturma |
### Videoyu Anlama Zorlukları
| Mücadelesi | Açıklama |
|-----------|----------------|
| **Zamansal akıl yürütme** | Zaman içinde ortaya çıkan olayları anlamak |
| **Uzun içerik** | Videolar saatlerce sürebilir; tüm çerçevelerin işlenmesi pahalıdır |
...
CLIP'in paylaşımlı yerleştirme alanı, sıfır atışla modlar arası veri alımına olanak sağlar:
| Adım | Açıklama |
|------|-----------------|
...
| **Ekto** | Açık kaynaklı robot politikası | Çeşitli robot verileri üzerine eğitim verildi |
