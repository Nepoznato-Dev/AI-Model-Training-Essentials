...
Antropik yaklaşımı: Yalnızca insanların geri bildirimlerine güvenmek yerine, modele bir dizi ilke ("anayasa") verin ve onun kendi çıktılarını eleştirmesini ve revize etmesini sağlayın.
| Adım | Açıklama |
|------|-----------------|
...
| **Hız sınırlama** | API çağrılarını sınırlayarak kötüye kullanımı önleyin |
