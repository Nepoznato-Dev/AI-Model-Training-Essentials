...
|-----------|----------|----------|
| **Mel spektrogramı** | Zaman içindeki frekans içeriği, insanın işitme algısıyla eşleştirildi | Konuşma tanıma, müzik sınıflandırması |
...
| **Noktalama işaretleri ve biçimlendirme** | ASR çıktısı genellikle noktalama işaretsizdir; son işlem gerekiyor |
...
| **Havlama** (Suno) | Trafo bazlı | Çok dilli; konuşma dışı sesler (kahkahalar, müzik) |
