...
Büyük bir yapay zeka modelini eğitmek etkileyicidir ancak mühendisliğin çoğunun gerçekleştiği yer onu verimli bir şekilde dağıtmaktır. Yanıt vermesi 10 saniye süren veya sekiz A100 GPU gerektiren bir model çoğu gerçek uygulama için işe yaramaz. Model optimizasyonu, kaliteden çok fazla ödün vermeden modelleri daha küçük, daha hızlı ve daha ucuz hale getirme sanatı ve bilimidir. Bu dosya niceleme, budama, damıtma ve modellerin üretime alınmasına yönelik pratik araçları kapsar.
---
...
| **INT8** | 8 | 7GB | Çok küçük kalite kaybı |
| **INT4** | 4 | 3,5GB | Orta kalite kaybı; hala kullanılabilir |
| **INT3 / INT2** | 3-2 | 2,6-1,75GB | Önemli kalite kaybı; araştırma aşaması |
### Niceleme Yöntemleri
| Yöntem | Ne Zaman Olur | Nasıl Çalışır | Kalite |
|----------|-----|-------------|-----------|
| **Eğitim Sonrası Niceleme (PTQ)** | Eğitim tamamlandıktan sonra | Modeli küçük bir veri kümesi üzerinde kalibre edin; en uygun ölçekleri bulun | INT8 için iyi; INT4'te bozulur |
| **GPTQ** | Eğitimden sonra | Yaklaşık ikinci derece bilgileri kullanan GPU dostu INT4 nicelemesi | INT4'te kaliteli |
| **AWQ** (Etkinleştirme Farkında Ağırlık Niceleme) | Eğitimden sonra | Aktivasyon büyüklüklerine göre göze çarpan ağırlıkları koruyun | INT4'te GPTQ'dan daha iyi |
...
|----------|-----------|-----------|------------|---------------|
| **LLaMA 7B** | 14GB | 3,5GB | 2-4x | Karşılaştırmalı değerlendirmelerde ~%1-2 |
| **LLaMA 70B** | 140GB | 35GB | 2-3x | Karşılaştırmalı değerlendirmelerde ~%2-3 |
---

## Budama
Budama, eğitimli bir modelden gereksiz ağırlıkları veya nöronları kaldırır.
...
| 2 | Büyük model, tüm K tokenlarını tek ileri geçişte doğrular |
