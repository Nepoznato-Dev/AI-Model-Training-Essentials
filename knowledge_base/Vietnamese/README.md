...
**Tổ chức:** 10 thư mục chuyên đề + 34 tài liệu tham khảo về ngôn ngữ lập trình
---
...
| [embedded_systems_and_iot.md](01_coding_and_technology/embedded_systems_and_iot.md)| Bộ vi điều khiển, cảm biến, RTOS, giao thức IoT, điện toán biên |
...
| Đi | `programming_languages/go/`| | rỉ sét | `programming_languages/rust/`|
...
| Nhanh | `programming_languages/swift/`| | Kotlin | `programming_languages/kotlin/`|
| R | `programming_languages/r/`| | Trực quan cơ bản | `programming_languages/visual_basic/`|
| Phi tiêu | `programming_languages/dart/`| | Scala | `programming_languages/scala/`|
...
| Erlang/Thuốc tiên | `programming_languages/erlang_and_elixir/`| | OCaml | `programming_languages/ocaml/`|
| Prolog | `programming_languages/prolog/`| | Lisp/Clojure | `programming_languages/lisp_and_clojure/`|
| Ada | `programming_languages/ada/`| | Hội | `programming_languages/assembly/`|
| MATLAB | `programming_languages/matlab/`| | Fortran | `programming_languages/fortran/`|
| COBOL | `programming_languages/cobol/`| | Vỏ/PowerShell | `programming_languages/shell_and_powershell/`|
| Delphi/Pascal | `programming_languages/delphi_object_pascal/`| | Cào | `programming_languages/scratch/`|
### 02 — AI & Học máy
| Tập tin | Mô tả |
|------|-------------|
...
| [data_ethics_and_privacy.md](03_data_science_and_analytics/data_ethics_and_privacy.md)| GDPR, sự đồng ý về dữ liệu, xu hướng thuật toán, mô hình đen tối, ẩn danh |
| [ensemble_methods.md](03_data_science_and_analytics/ensemble_methods.md)| Đóng gói, tăng cường, xếp chồng, bỏ phiếu, rừng ngẫu nhiên, XGBoost |
| [feature_engineering.md](03_data_science_and_analytics/feature_engineering.md)| Chuyển đổi, mã hóa, lựa chọn tính năng, giảm kích thước |
| [geospatial_analysis.md](03_data_science_and_analytics/geospatial_analysis.md)| Hệ tọa độ, hoạt động không gian, GeoPandas, phân tích raster |
### 04 — Khoa học tự nhiên
| Tập tin | Mô tả |
|------|-------------|
...
| Tập tin | Mô tả |
|------|-------------|
| [business_and_economics.md](05_business_and_economics/business_and_economics.md)| Cơ cấu doanh nghiệp, tiếp thị, kinh tế, khởi nghiệp |
| [finance_and_investing.md](05_business_and_economics/finance_and_investing.md)| Tài chính cá nhân, đầu tư, thị trường, nghỉ hưu |
| [law_and_legal_systems.md](05_business_and_economics/law_and_legal_systems.md)| Hệ thống pháp luật, hợp đồng, tra tấn, sở hữu trí tuệ, việc làm |
| [marketing_and_digital_strategy.md](05_business_and_economics/marketing_and_digital_strategy.md)| 4P, kênh kỹ thuật số, SEO/SEM, phân tích, chiến lược thương hiệu |
| [management_and_project_methodologies.md](05_business_and_economics/management_and_project_methodologies.md)| Lãnh đạo, Agile/Scrum/Kanban, OKRs, quản lý rủi ro |
| [behavioural_economics.md](05_business_and_economics/behavioural_economics.md)| Những thành kiến ​​​​nhận thức, lý thuyết triển vọng, phương pháp phỏng đoán, cú hích, kiến ​​trúc lựa chọn |
| [game_theory.md](05_business_and_economics/game_theory.md)| Cân bằng Nash, thế tiến thoái lưỡng nan của người tù, thiết kế cơ chế, đấu giá |
| [intellectual_property_and_innovation.md](05_business_and_economics/intellectual_property_and_innovation.md)| Bằng sáng chế, bản quyền, nhãn hiệu, bí mật thương mại, cấp phép nguồn mở |
| [organisational_design_and_culture.md](05_business_and_economics/organisational_design_and_culture.md)| Cấu trúc tổ chức, loại hình văn hóa, quản lý thay đổi, động lực nhóm |
| [supply_chain_and_operations.md](05_business_and_economics/supply_chain_and_operations.md)| Quản lý hàng tồn kho, sản xuất tinh gọn, hậu cần, hiệu ứng bullwhip |
...
| Tập tin | Mô tả |
|------|-------------|
| [dictionary.md](07_general_reference/dictionary.md)| Định nghĩa từ toàn diện (A-Z) |
| [general_knowledge.md](07_general_reference/general_knowledge.md)| Hệ mặt trời, cơ thể con người, địa lý, năng lượng |
| [technology_and_computing.md](07_general_reference/technology_and_computing.md)| Khái niệm cơ bản về máy tính, internet, cơ sở dữ liệu, đám mây, bảo mật |
| [safe_communication.md](07_general_reference/safe_communication.md)| Hướng dẫn truyền thông và thực tiễn tốt nhất |
| [learning_science_and_pedagogy.md](07_general_reference/learning_science_and_pedagogy.md)| Thực hành truy hồi, lặp lại cách nhau, phân loại Bloom, thiết kế học tập |
| [research_methodology.md](07_general_reference/research_methodology.md)| Phương pháp khoa học, lấy mẫu, tính giá trị, thiết kế thử nghiệm, bình duyệt |
| [writing_and_communication.md](07_general_reference/writing_and_communication.md)| Nguyên tắc kim tự tháp, thuyết trình, thuyết phục, viết kinh doanh |
...
| Tập tin | Mô tả |
|------|-------------|
| [ai_llm_failures.md](09_lessons_from_failures/ai_llm_failures.md)| Ảo giác, thiên vị, thất bại trong việc căn chỉnh |
| [code_quality_issues.md](09_lessons_from_failures/code_quality_issues.md)| Các lỗi mã hóa phổ biến và phản mẫu |
| [cognitive_logical_issues.md](09_lessons_from_failures/cognitive_logical_issues.md)| Lỗi lý luận và thành kiến ​​nhận thức |
| [rag_vector_search.md](09_lessons_from_failures/rag_vector_search.md)| Cạm bẫy tìm kiếm RAG và vector |
| [security_vulnerabilities.md](09_lessons_from_failures/security_vulnerabilities.md)| Lỗ hổng bảo mật phổ biến |
| [system_reliability.md](09_lessons_from_failures/system_reliability.md)| Lỗi hệ thống và mô hình độ tin cậy |
| [api_design_and_integration_failures.md](09_lessons_from_failures/api_design_and_integration_failures.md)| Chống mẫu API, thay đổi vi phạm, lỗi phiên bản, lỗi xếp tầng |
| [data_pipeline_and_etl_failures.md](09_lessons_from_failures/data_pipeline_and_etl_failures.md)| Lược đồ trôi dạt, dữ liệu trùng lặp, khoảng trống xác thực, giám sát đường ống |
| [ml_project_failures.md](09_lessons_from_failures/ml_project_failures.md)| Rò rỉ dữ liệu, kỳ vọng không khớp, triển khai thất bại, phân rã mô hình |
### 10 — Tham khảo nhanh
| Tập tin | Mô tả |
|------|-------------|
...
4. Chọn ngôn ngữ trong `01_coding_and_technology/programming_languages/python/`
...
### Dành cho Chuyên gia Kinh doanh
...
- **Thông tin y tế:** Nội dung trong`medicine_and_healthcare.md`chỉ nhằm mục đích giáo dục và không thay thế lời khuyên y tế chuyên nghiệp.
- **Thông tin pháp lý:** Nội dung trong`law_and_legal_systems.md`mang tính chất cung cấp thông tin và không cấu thành tư vấn pháp lý.
- **Thông tin tài chính:** Nội dung trong`finance_and_investing.md`mang tính giáo dục và không được coi là lời khuyên tài chính.
- **Dự đoán trong tương lai:** Nội dung trong`08_future_and_trends/`chứa thông tin suy đoán và dự đoán có thể thay đổi.
---

## Hướng dẫn sử dụng
### Dành cho hệ thống AI
- Tất cả các tệp đều sử dụng các tiêu đề phân cấp rõ ràng (tiêu đề `#`, các phần `##`, các phần phụ `###`)
- Bảng được sử dụng để so sánh có cấu trúc trong suốt
- Ví dụ mã bao gồm đánh dấu cú pháp
- Tham chiếu chéo sử dụng liên kết đánh dấu tương đối
### Dành cho người đọc
- Các tập tin được viết với giọng điệu đàm thoại, trung tính
- Bảng và so sánh có cấu trúc được sử dụng thay vì các đoạn văn dày đặc
- Các ví dụ và sự tương tự trong thế giới thực giúp làm nền tảng cho các khái niệm trừu tượng
- Mỗi file đều có phần tóm tắt
---

## Đóng góp & Siêu dữ liệu
Mọi tệp nội dung trong cơ sở kiến ​​thức này (mọi thứ ngoại trừ`README.md`này) đều mở bằng khối tiền đề YAML. Nó tuân theo cùng một mẫu theo dõi người đóng góp được sử dụng bởi [skills](../../skills/skill-creator.md), do đó quyền tác giả, các chỉnh sửa và đánh giá vẫn có thể theo dõi được trên cả hai bộ sưu tập. Để biết quy trình đóng góp chung — rẽ nhánh, phân nhánh, yêu cầu kéo, sắp xếp tệp và quy ước đặt tên — hãy xem[CONTRIBUTING.md](../../CONTRIBUTING.md)gốc.
### Lược đồ Frontmatter
Mỗi tệp bắt đầu bằng khối này (giữa các dấu phân cách `---`), được chia thành năm phần nhận xét:
```yaml
---
# Metadata
...
| Lĩnh vực | Nguồn / Mục đích |
|---|---|
| `title`| Được lấy từ tiêu đề`#`đầu tiên của tệp |
| `description`| Tóm tắt một dòng; các tệp chủ đề sử dụng lại mục nhập từ chỉ mục của README này, các tệp ngôn ngữ lập trình sử dụng mô tả được tạo |
| `category`/`reviewed_by`| Bắt nguồn từ thư mục mẹ (`01_coding_and_technology`→ "Mã hóa và Công nghệ" / "Nhóm Cơ sở Kiến thức Công nghệ & Mã hóa") |
| `version`| Phiên bản ngữ nghĩa; va chạm vào mỗi lần chỉnh sửa (xem bên dưới) |
| `authors`/`contributors`| Tác giả gốc cộng với bất kỳ ai đã chỉnh sửa tệp |
| `changelog`| Danh sách các thay đổi chỉ nối thêm, mới nhất trước |
| `review_date`/`next_review`| ~ nhịp 6 tháng và ~ 1 năm, phản ánh lịch trình đánh giá kỹ năng |
| `tags`| Mã thông báo tên tệp cộng với từ khóa danh mục rõ ràng (ví dụ:`coding-and-technology`) |
| `difficulty_level`| Đặt theo danh mục, với phần ghi đè theo từng ngôn ngữ (ví dụ: Haskell/Assembly →`advanced`, Scratch →`beginner`) |
| `estimated_reading_time`| Tính từ số dòng |
### Chỉnh sửa tệp
Khi bạn thay đổi tệp cơ sở kiến ​​thức, hãy đồng bộ hóa phần đầu của nó:
1. **Bump`version`** theo sau[SemVer](https://semver.org/):
   - Bản vá (`1.0.x`): lỗi chính tả, định dạng, sửa lỗi nhỏ
   - Tiểu phần (`1.x.0`): phần mới, nội dung mở rộng, ví dụ mới
   - Major (`x.0.0`): viết lại hoặc tái cấu trúc hoàn chỉnh
2. **Thêm mục nhật ký thay đổi** (mới nhất trước tiên) mô tả những gì bạn đã thay đổi:   ```yaml
   changelog:
     - version: "1.1.0"
       date: "2026-08-05"
       author: "Your Name"
     ...
     - version: "1.0.0"
       ...
       changes: "Added YAML frontmatter metadata for contributor tracking"
   ```
3. **Cập nhật`last_modified`** đến ngày bạn thay đổi
4. **Thêm chính bạn vào`contributors`** nếu đây là lần chỉnh sửa đầu tiên của bạn đối với tệp:   ```yaml
   contributors:
     - name: "Your Name"
...
Trước khi gửi tệp cơ sở kiến ​​thức mới hoặc đã chỉnh sửa, hãy xác minh:
- [ ] YAML frontmatter đã hoàn chỉnh và hợp lệ (có tất cả năm phần, giữa các dấu phân cách `---`)
- [ ]`title`,`description`,`category`,`version`,`status`được đặt
- [ ] Ít nhất một tác giả được liệt kê trong`authors`
- [ ]`changelog`có một mục ghi lại sự thay đổi (mới nhất trước)
- [ ]`last_modified`phản ánh ngày hôm nay
- [ ]`tags`bao gồm 3-6 từ khóa liên quan cộng với từ khóa danh mục rõ ràng
- []`difficulty_level`được đặt (sơ cấp/trung cấp/cao cấp)
- [ ]`estimated_reading_time`mang tính thực tế về độ dài nội dung
- [ ] Nội dung cơ bản tuân theo[Usage Guidelines](#usage-guidelines)ở trên
- [] Không có tham chiếu chéo bị hỏng
---

*Cơ sở kiến ​​thức này là một bộ sưu tập tài liệu sống, được cải tiến và mở rộng liên tục.*