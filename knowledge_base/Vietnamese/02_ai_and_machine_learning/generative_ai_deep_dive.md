...
VAE tìm hiểu cách biểu diễn dữ liệu có cấu trúc, được nén (không gian tiềm ẩn), sau đó tạo các mẫu mới bằng cách lấy mẫu từ không gian đó.
| Thành phần | Vai trò |
|----------||------|
| **Bộ mã hóa** | Ánh xạ dữ liệu đầu vào tới một phân phối trong không gian tiềm ẩn (trung bình và phương sai) |
...
| Có thể nội suy giữa các ví dụ | Kém sắc nét hơn so với đầu ra khuếch tán hoặc GAN |
...
### CLIP (Đào tạo trước ngôn ngữ-hình ảnh tương phản)
