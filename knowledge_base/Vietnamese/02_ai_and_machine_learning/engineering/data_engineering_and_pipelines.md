...
|--------|-------------|------|------|
| **Sao** | Bảng dữ kiện trung tâm được bao quanh bởi các bảng chiều không chuẩn hóa | Truy vấn đơn giản, đọc nhanh | Dự phòng dữ liệu |
...
| **Cửa hàng trực tuyến** | Tính năng có độ trễ thấp phục vụ cho suy luận theo thời gian thực |
