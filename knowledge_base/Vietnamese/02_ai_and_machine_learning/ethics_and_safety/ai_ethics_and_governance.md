...
|----------||--------------|----------|
| **Công bằng** | AI không nên phân biệt đối xử với các nhóm được bảo vệ | Định nghĩa sự công bằng về mặt toán học là điều khó khăn; định nghĩa công bằng khác nhau có thể xung đột |
...
**Định lý bất khả thi**: nhìn chung bạn không thể thỏa mãn nhiều định nghĩa về tính công bằng cùng một lúc. Việc lựa chọn thước đo công bằng nào để sử dụng bản thân nó đã là một đánh giá về giá trị.
...
| **Đánh giá tác động** | Đánh giá tác hại tiềm tàng trước khi triển khai |
...
## Bản tóm tắt
Đạo đức và quản trị AI là những yêu cầu kỹ thuật. Thành kiến, thiếu minh bạch, chi phí môi trường và vi phạm quyền riêng tư không chỉ là những lo ngại về mặt đạo đức; chúng là những khiếm khuyết gây ra tác hại thực sự. Bối cảnh quản trị đang phát triển nhanh chóng, với Đạo luật AI của EU đặt ra tiêu chuẩn toàn cầu. Chỉ quy định thôi thì chưa đủ - tính công bằng, khả năng giải thích và trách nhiệm giải trình phải được tích hợp vào công việc hàng ngày của mọi nhà phát triển AI. Câu hỏi trọng tâm là làm thế nào để xây dựng được những hệ thống đáng tin cậy.