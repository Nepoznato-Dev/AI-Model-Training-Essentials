...
### Trang bị quá mức
Mô hình hoạt động tốt trên dữ liệu huấn luyện nhưng kém về xác thực/kiểm tra.
...
- **Giảm nhẹ:** Sử dụng mô hình phức tạp hơn, thêm tính năng hoặc giảm tính chính quy.
