...
| **Dừng xóa từ** | Xóa các từ phổ biến (the, is, at) | "con mèo ngồi" → "con mèo ngồi" |
| **Có cuống** | Chặt đuôi từ (thô) | "chạy" → "chạy" |
| **Từ ngữ** | Rút gọn về dạng từ điển (nhận biết ngữ cảnh) | "tốt hơn" → "tốt" |
| **Bình thường hóa** | Sửa mã hóa, loại bỏ các ký tự đặc biệt, mở rộng các ký tự rút gọn | “không” → “không” |
...
| **TF-IDF** | Trọng số các từ theo tần suất trong tài liệu × độ hiếm trên toàn bộ kho văn bản | Vẫn bỏ qua thứ tự và bối cảnh |
### Nhúng từ
