...
Việc đào tạo một mô hình AI lớn là điều rất ấn tượng nhưng việc triển khai nó một cách hiệu quả mới là lúc hầu hết các công việc kỹ thuật diễn ra. Một mô hình mất 10 giây để phản hồi hoặc yêu cầu 8 GPU A100 sẽ vô dụng đối với hầu hết các ứng dụng thực tế. Tối ưu hóa mô hình là nghệ thuật và khoa học nhằm tạo ra các mô hình nhỏ hơn, nhanh hơn và rẻ hơn — mà không phải hy sinh quá nhiều chất lượng. Tệp này bao gồm lượng tử hóa, cắt tỉa, chưng cất và các công cụ thực tế để đưa mô hình vào sản xuất.
---
...
|--------|-------|--------------------|----------|
| **FP32** | 32 | 28GB | Đường cơ sở (chính xác hoàn toàn) |
| **FP16 / BF16** | 16 | 14GB | Gần giống với FP32 |
...
|-------|----------|-------------|----------|-------------|
| **LLaMA 7B** | 14GB | 3,5 GB | 2-4x | ~1-2% trên điểm chuẩn |
