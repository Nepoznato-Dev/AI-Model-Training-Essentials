...
### Biểu đồ Mel
Biểu diễn âm thanh phổ biến nhất cho deep learning. Nó chuyển đổi âm thanh thành định dạng giống như hình ảnh 2D:
| Trục | Đại diện |
|------|-------------|
| **Trục X** | Thời gian |
| **Trục Y** | Tần suất (theo thang Mel - cách đều nhau) |
