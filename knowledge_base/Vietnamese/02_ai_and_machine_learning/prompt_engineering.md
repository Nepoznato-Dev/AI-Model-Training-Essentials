...
- **Thông báo hỗ trợ**: Các phản hồi trước đó của mô hình (được sử dụng để đảm bảo tính liên tục).
...
## Điều chỉnh tham số
- **Nhiệt độ** (0,0 – 1,0+): Kiểm soát tính ngẫu nhiên. Thấp hơn = quyết đoán hơn, cao hơn = sáng tạo hơn. Sử dụng 0,0–0,3 cho các câu trả lời thực tế; 0,7–1,0 cho bài viết sáng tạo.
