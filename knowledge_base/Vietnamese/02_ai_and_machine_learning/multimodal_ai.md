...
|-------------|-------------|----------|
| **Bộ mã hóa kép** | Bộ mã hóa riêng cho hình ảnh và văn bản; kết hợp ở giai đoạn sau | CLIP, CĂN HỘ |
...
| **Chương trình giảng dạy** | Bắt đầu với những ví dụ dễ dàng; tăng độ khó | Cải thiện sự hội tụ |
