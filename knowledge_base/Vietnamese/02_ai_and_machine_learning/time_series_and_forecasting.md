...
| **Tính thời vụ** | Các mẫu đều đặn, có thể dự đoán được theo các khoảng thời gian cố định | Doanh số bán lẻ tăng đột biến vào tháng 12 |
...
| **6. Người mẫu** | Hãy thử các phương pháp cổ điển (ARIMA, Prophet), sau đó là phương pháp ML |
...
## Bản tóm tắt
Dự báo chuỗi thời gian kết hợp thống kê cổ điển với học máy hiện đại. Các phương pháp cổ điển (ARIMA, làm mịn hàm mũ, Tiên tri) có thể hiểu được, nhanh chóng và thường chính xác một cách đáng ngạc nhiên. Các phương pháp học sâu (LSTM, Transformers) nắm bắt các mẫu phức tạp nhưng yêu cầu nhiều dữ liệu và điều chỉnh hơn. Các nguyên tắc chính vẫn giữ nguyên bất kể phương pháp nào: hiểu cấu trúc dữ liệu của bạn (xu hướng, tính thời vụ, độ nhiễu), luôn so sánh với đường cơ sở đơn giản, đánh giá bằng số liệu phù hợp và nhớ rằng tương lai không bao giờ là sự lặp lại hoàn hảo của quá khứ.