...
- **Triển khai trên thiết bị di động** — Microsoft trình diễn Phi-3-mini chạy trên iPhone 14
...
Kinh nghiệm của Phi minh họa một số bài học quan trọng:### 1. Phân phối dữ liệu đào tạo là vấn đề quan trọng nhất
...
Mô hình 3,8B không thể lưu trữ nhiều dữ kiện như mô hình 70B trong trọng lượng của nó. Tuy nhiên, nó vẫn có thể suy luận tốt nếu nó được huấn luyện để sử dụng khả năng lý luận có cấu trúc hơn là ghi nhớ sự kiện. Các điểm chuẩn như GSM8K kiểm tra khả năng suy luận số học nhiều bước — một kỹ năng có thể được dạy một cách hiệu quả.
...
Sử dụng mô hình giáo viên lớn (GPT-4) để tạo ra dữ liệu đào tạo chất lượng cao cho mô hình học sinh nhỏ là một hình thức chắt lọc kiến thức. Cách tiếp cận "học hỏi từ những gì tốt nhất, triển khai với chi phí thấp nhất" ngày càng phổ biến trong ngành.
...
- Ollama, LM Studio và llama.cpp đã giúp những người dùng không rành về kỹ thuật có thể tiếp cận việc triển khai mô hình cục bộ
