...
# Đi - Các mô hình thành ngữ & các phương pháp hay nhất
Hướng dẫn này bao gồm các mẫu thành ngữ và các phương pháp hay nhất để viết mã Go rõ ràng, thành ngữ.
---
...
## Bản tóm tắt
Thành ngữ Go nhấn mạnh: sự đơn giản, xử lý lỗi rõ ràng, giao diện nhỏ, kết hợp kế thừa, goroutines với ngữ cảnh và "chấp nhận giao diện, trả về cấu trúc". Theo dõi`gofmt`để định dạng,`golangci-lint`để tìm lỗi mã nguồn và hướng dẫn Nhận xét đánh giá mã Go chính thức. Cộng đồng Go đánh giá cao tính dễ đọc, tính đơn giản và "cách thức rõ ràng để thực hiện điều đó". Tránh viết mã thông minh — Mã Go phải nhàm chán và dễ đoán.