...
# Perl — Các mẫu thành ngữ & các phương pháp hay nhất
Hướng dẫn này bao gồm các mẫu thành ngữ và các phương pháp hay nhất để viết mã Perl (5.38+) hiện đại, rõ ràng.
---
...
## Bản tóm tắt
Các thành ngữ Perl hiện đại nhấn mạnh:`use strict; use warnings;`, chữ ký, ví dụ, postderef và OOP hiện đại (từ khóa lớp trong 5.38+). Theo dõi perlcritic để biết linting và perltidy để định dạng. Giá trị Perl TMTOWTDI (Có nhiều cách để thực hiện) - nhưng Perl hiện đại hội tụ các mẫu rõ ràng hơn, dễ bảo trì hơn.