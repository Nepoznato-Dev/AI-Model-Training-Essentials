...
## Bản tóm tắt
Cú pháp của Clojure được đặt trong ngoặc đơn thống nhất — mọi biểu mẫu đều là một danh sách. Tính đồng nhất này cho phép các macro mạnh mẽ chuyển đổi mã thành dữ liệu. Cấu trúc dữ liệu liên tục cung cấp tính bất biến với việc chia sẻ cấu trúc để mang lại hiệu quả. Các macro phân luồng tạo ra các đường dẫn dữ liệu có thể đọc được. Nguyên thủy đồng thời (nguyên tử, giới thiệu, tác nhân, kênh) xử lý các thay đổi trạng thái một cách an toàn. Ảnh hưởng của Lisp/Clojure đối với lập trình hiện đại là rất lớn - thu thập rác, REPL, macro và lập trình chức năng đều có nguồn gốc từ Lisp.