...
-->
# Ada — Các mẫu thành ngữ & các phương pháp hay nhất
Hướng dẫn này bao gồm các mẫu thành ngữ để viết mã Ada an toàn và sạch sẽ.
---
...
## Bản tóm tắt
Thành ngữ Ada nhấn mạnh: gõ mạnh, kiểu riêng để đóng gói, hợp đồng (điều kiện trước/sau) và xác nhận. Làm theo Hướng dẫn về Phong cách Ada, sử dụng GNATprove để xác minh chính thức. Ada coi trọng sự an toàn và đúng đắn trên hết.