...
-->
# Delphi / Object Pascal — Các mẫu thành ngữ & các phương pháp hay nhất
Hướng dẫn này bao gồm các mẫu thành ngữ để viết mã Delphi và Object Pascal rõ ràng.
---

## Quản lý tài nguyên bằng thử/cuối cùng
```delphi
...
## Bản tóm tắt
Thành ngữ Delphi nhấn mạnh:`try/finally`để dọn dẹp tài nguyên xác định,`Format`để xây dựng chuỗi, giao diện cho khớp nối lỏng lẻo, bản ghi cho vật mang dữ liệu, xử lý ngoại lệ cụ thể và các tính năng hiện đại như phương thức tổng quát và ẩn danh. Delphi đánh giá cao việc quản lý tài nguyên rõ ràng - "tạo ra nó, sử dụng nó, giải phóng nó cuối cùng."