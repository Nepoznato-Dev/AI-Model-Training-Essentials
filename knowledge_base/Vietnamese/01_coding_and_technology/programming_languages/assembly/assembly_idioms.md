...
## Các hằng số và macro được đặt tên
```nasm
...
## Đăng ký Quy ước & Mở đầu/Kết thúc
```nasm
...
## Bản tóm tắt
Thành ngữ hội nhấn mạnh: các hằng số được đặt tên trên các số ma thuật, macro cho các mẫu lặp lại, định nghĩa cấu trúc cho bố cục dữ liệu, phần mở đầu/kết thúc tuân thủ ABI, nhãn cục bộ để dễ đọc, xác thực đầu vào phòng thủ và`xor`/`lea`để vận hành hiệu quả. Hội đánh giá cao sự rõ ràng - "nếu bạn không thể đọc nó, bạn không thể gỡ lỗi vào lúc 3 giờ sáng."