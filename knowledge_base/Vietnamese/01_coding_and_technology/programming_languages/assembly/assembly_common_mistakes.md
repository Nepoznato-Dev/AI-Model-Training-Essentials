...
---
# Hợp ngữ — Những lỗi thường gặp và phản mẫu
Tài liệu này liệt kê các lỗi, bẫy và mẫu chống phổ biến nhất trong Hội x86-64 với các bản sửa lỗi.
---

## 1. Không lưu giữ các thanh ghi
```asm
...
## 3. Off-by-One trong hoạt động chuỗi
```asm
...
## 5. Vòng lặp vô hạn do thiếu điều kiện thoát
```asm
...
## Bản tóm tắt
Bẫy hội: bảo toàn các thanh ghi đã lưu callee, duy trì căn chỉnh ngăn xếp 16 byte, bao gồm các đầu cuối null trong chuỗi, rõ ràng về kích thước toán hạng và luôn cung cấp các điều kiện thoát vòng lặp. Lập trình hợp ngữ yêu cầu hiểu biết về phần cứng ở mức thấp nhất - mọi lệnh đều có hậu quả đối với các thanh ghi, bộ nhớ và cờ.