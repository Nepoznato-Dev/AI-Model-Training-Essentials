...
-->
# Fortran — Tham khảo cú pháp
Tài liệu này cung cấp tài liệu tham khảo cú pháp có cấu trúc, toàn diện cho Modern Fortran (2008/2018). Nó bổ sung cho tham chiếu Fortran chính bằng cách tập trung vào các mẫu cú pháp đầy đủ, hoạt động mảng, mô-đun, OOP và điện toán hiệu năng cao.
---
...
| `<``>``<=``>=` | So sánh | `a >= b`| |
| `.and.``.or.``.not.`| Hợp lý | `a .and. b`| |
| `.eqv.``.neqv.` | Tương đương logic | `a .eqv. b`| |
...
## Bản tóm tắt
Cú pháp của Fortran hiện đại rõ ràng, có cấu trúc và được tối ưu hóa cho tính toán số. Hoạt động mảng loại bỏ các vòng lặp cho hầu hết các nhiệm vụ toán học. Các mô-đun cung cấp khả năng đóng gói và quản lý không gian tên. Các tính năng OOP (kiểu dẫn xuất, kế thừa, đa hình) cho phép tổ chức mã sạch. Coarrays cung cấp chương trình song song nguyên bản mà không cần thư viện bên ngoài. Điểm mạnh của Fortran — hiệu suất, hoạt động mảng và độ chính xác về số — vẫn chưa từng có đối với máy tính khoa học. Đối với HPC, vật lý tính toán và mô phỏng kỹ thuật, Fortran tiếp tục là một cường quốc.