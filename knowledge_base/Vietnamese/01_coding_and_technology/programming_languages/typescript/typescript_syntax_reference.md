...
## Loại nguyên tắc cơ bản của hệ thống
### Loại nguyên thủy & tích hợp
```typescript
// Primitives
...
## Công cụ trang trí (TC39 Giai đoạn 3 / TypeScript 5.0+)
```typescript
// Class decorator
...
## Bản tóm tắt
Hệ thống kiểu chữ của TypeScript là tính năng nổi bật của nó và đặc biệt là nó rất sâu. Từ các chú thích cơ bản đến các kiểu tổng quát, các kiểu có điều kiện, các kiểu được ánh xạ, các kiểu chữ mẫu và `infer`, hệ thống kiểu về cơ bản là một ngôn ngữ chức năng hoạt động tại thời gian biên dịch. Hiểu được sự tương tác giữa`interface`với `type`, kiểu gõ chung và kiểu tiện ích, kiểu gõ cấu trúc và kiểu danh nghĩa hỗ trợ viết TypeScript vừa an toàn vừa tiện dụng. Ngôn ngữ tiếp tục phát triển, với mỗi bản phát hành sẽ bổ sung thêm sức mạnh biểu cảm trong khi vẫn duy trì khả năng tương thích ngược hoàn toàn với JavaScript.