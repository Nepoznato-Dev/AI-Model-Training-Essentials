...
# Lua — Các mẫu thành ngữ & các phương pháp hay nhất
Hướng dẫn này bao gồm các mẫu thành ngữ và các phương pháp thực hành tốt nhất để viết mã Lua thuần túy, thuần túy.
---
...
## Bản tóm tắt
Thành ngữ Lua nhấn mạnh: các bảng là cấu trúc dữ liệu phổ quát, các biến cục bộ, các bao đóng cho trạng thái, các siêu dữ liệu cho OOP và lập chỉ mục dựa trên 1. Thực hiện theo luacheck để biết linting và bút stylus để định dạng. Lua coi trọng sự đơn giản và tối giản — ngôn ngữ có chủ đích nhỏ gọn, do đó các mẫu hình xuất hiện từ bố cục.