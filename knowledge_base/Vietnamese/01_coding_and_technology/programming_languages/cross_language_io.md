...
# So sánh đa ngôn ngữ - Hoạt động I/O & Tệp
## Đầu ra bảng điều khiển
| Ngôn ngữ | In ra thiết bị xuất chuẩn |
|----------|-------|
| Python | `print("Hello")`|
| JavaScript | `console.log("Hello")`|
| rỉ sét | `println!("Hello")`|
| Đi | `fmt.Println("Hello")`|
...
| Lua | `print("Hello")`|
| MATLAB | `disp('Hello')`|
| Phi tiêu | `print('Hello')`|
| Prolog | `write('Hello'), nl.`|
| Nói ngọng | `(format t "Hello~%")`|
| Thuốc tiên | `IO.puts("Hello")`|
| Erlang | `io:format("Hello~n")`|
| OCaml | `print_endline "Hello"`|
| Ada | `Put_Line("Hello")`|
| COBOL | `DISPLAY 'Hello'`|
| Fortran | `print *, 'Hello'`|
| Hội | `syscall`(ghi vào fd 1) |
| Delphi | `WriteLn('Hello')`|
| Cào | `say [Hello]`|
| VB | `Console.WriteLine("Hello")`|
| Vỏ | `echo "Hello"`|
| SQL | N/A (trả về tập kết quả) |
##Đọc một tập tin
```python
# Python
