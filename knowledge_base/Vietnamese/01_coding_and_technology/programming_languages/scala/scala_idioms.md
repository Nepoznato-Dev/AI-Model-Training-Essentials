...
# Scala — Các mẫu thành ngữ & các phương pháp hay nhất
Hướng dẫn này bao gồm các mẫu thành ngữ và các phương pháp hay nhất để viết mã Scala 3 rõ ràng, đầy đủ chức năng.
---
...
## Bản tóm tắt
Thành ngữ Scala nhấn mạnh: tính bất biến (`val`), khớp mẫu, loại kín, Tùy chọn/Hoặc để đảm bảo an toàn, dễ hiểu, bộ sưu tập chức năng và các lớp loại (được cung cấp/sử dụng trong Scala 3). Làm theo Hướng dẫn về Phong cách Scala, sử dụng scalafmt để định dạng và scalafix để linting. Cú pháp, enum, kiểu mờ và phương thức mở rộng rõ ràng hơn của Scala 3 làm cho ngôn ngữ dễ tiếp cận hơn trong khi vẫn giữ được sức mạnh chức năng của nó.