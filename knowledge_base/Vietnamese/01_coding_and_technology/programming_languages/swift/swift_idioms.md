...
-->
# Swift — Các mẫu thành ngữ & các phương pháp hay nhất
Hướng dẫn này bao gồm các mẫu thành ngữ và các phương pháp hay nhất để viết mã Swift rõ ràng.
---
...
## Bản tóm tắt
Thành ngữ Swift nhấn mạnh: an toàn (tùy chọn, bảo vệ), loại giá trị (cấu trúc), thiết kế hướng giao thức, khớp mẫu, không đồng bộ/chờ đợi và tính bất biến (`let`theo mặc định). Tuân theo Nguyên tắc thiết kế API Swift, sử dụng SwiftLint để đảm bảo chất lượng mã và SwiftFormat để định dạng. Swift coi trọng sự an toàn và tính biểu cảm — "nếu nó biên dịch, nó có thể đúng."