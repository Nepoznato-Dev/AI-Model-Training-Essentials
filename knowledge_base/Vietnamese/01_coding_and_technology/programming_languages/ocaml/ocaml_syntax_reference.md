...
-->
# OCaml — Tham khảo cú pháp
Tài liệu này cung cấp tham chiếu cú ​​pháp có cấu trúc, toàn diện cho OCaml (4.x/5.x). Nó bổ sung cho tham chiếu OCaml chính bằng cách tập trung vào các mẫu cú pháp đầy đủ, các kiểu dữ liệu đại số, khớp mẫu, mô-đun và các thành ngữ lập trình chức năng.
---
...
## Bản tóm tắt
Cú pháp của OCaml rõ ràng và mang tính toán học. Các kiểu dữ liệu đại số và khớp mẫu toàn diện làm cho các trạng thái không thể biểu diễn được. Hệ thống mô-đun với các hàm chức năng cung cấp khả năng trừu tượng hóa mạnh mẽ mà không tốn chi phí thời gian chạy. Kiểu suy luận có nghĩa là an toàn mà không dài dòng. Không thể phủ nhận tầm ảnh hưởng của OCaml đối với Rust, F#, TypeScript và Swift. Đối với lập trình hệ thống, trình biên dịch và xác minh chính thức, OCaml vẫn là lựa chọn hàng đầu.