...
## Tổng quan về danh mục khối
| Danh mục | Màu sắc | Các loại khối | Mục đích |
|----------|--------|-------------|--------|
| **Chuyển động** | Màu xanh | Ngăn xếp | Di chuyển sprite, thay đổi vị trí, hướng |
| **Trông** | Màu tím | Ngăn xếp | Thay đổi diện mạo, nói/suy nghĩ, hiển thị/ẩn |
| **Âm thanh** | Hồng | Ngăn xếp | Phát âm thanh, thay đổi âm lượng/cao độ |
| **Sự kiện** | Vàng | Mũ | Bắt đầu tập lệnh, phát/nhận tin nhắn |
| **Kiểm soát** | Vàng | Ngăn xếp | Vòng lặp, điều kiện, chờ, dừng |
| **Cảm biến** | Xanh nhạt | Phóng viên | Phát hiện va chạm, đầu vào, hẹn giờ, trả lời |
| **Người vận hành** | Xanh | Phóng viên | Toán, văn bản, so sánh, logic |
| **Biến** | Cam | Ngăn xếp/Phóng viên | Lưu trữ dữ liệu, liệt kê các thao tác |
| **Khối của tôi** | Đỏ sẫm | Ngăn xếp | Định nghĩa khối tùy chỉnh (chức năng) |
---
...
## Bản tóm tắt
Cú pháp dựa trên khối của Scratch giúp loại bỏ lỗi đánh máy và làm cho các khái niệm lập trình trở nên rõ ràng. Mọi tập lệnh đều bắt đầu bằng một khối mũ (sự kiện), sau đó xếp chồng các khối lệnh (chuyển động, giao diện, âm thanh, điều khiển, cảm biến, toán tử, biến) và sử dụng các khối trình báo cáo (hình tròn/hình bầu dục) cho các giá trị. Khối tùy chỉnh cho phép lập trình mô-đun. Bản sao cung cấp hành vi giống như đối tượng. Liệt kê các bộ sưu tập cửa hàng. Phần mở rộng bút cho phép vẽ sáng tạo. Đối với những người học trẻ tuổi, Scratch cung cấp phần giới thiệu đầy đủ về logic lập trình, thiết kế theo sự kiện và cách thể hiện sáng tạo thông qua mã.