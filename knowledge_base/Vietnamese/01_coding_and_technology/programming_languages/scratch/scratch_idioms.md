...
## Bản tóm tắt
Thành ngữ Scratch nhấn mạnh: đặt tên sprite rõ ràng, mỗi sprite chịu trách nhiệm một lần, phát đi thông điệp để liên lạc, các khối tùy chỉnh để tái sử dụng, sao chép cho nhiều phiên bản, vòng lặp trò chơi có cấu trúc và "chạy mà không làm mới màn hình" để đạt được hiệu suất. Tổ chức phần thưởng Scratch - "một sprite được đặt tên tốt là một nửa chương trình."