...
## Bản tóm tắt
Thành ngữ Kotlin nhấn mạnh: an toàn null, lớp dữ liệu, loại kín, hàm phạm vi, hàm mở rộng, coroutine và mã hướng biểu thức. Tuân theo Quy ước mã hóa Kotlin, sử dụng ktlint để định dạng và detekt để phân tích tĩnh. Kotlin coi trọng tính ngắn gọn và tính biểu cảm — viết ít bản soạn sẵn hơn, sử dụng thư viện tiêu chuẩn và sử dụng`val`theo mặc định.