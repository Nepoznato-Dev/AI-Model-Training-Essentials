...
# Ruby — Các mẫu thành ngữ & các phương pháp hay nhất
Hướng dẫn này bao gồm các mẫu thành ngữ và các phương pháp hay nhất để viết mã Rubyish rõ ràng.
---
...
## Bản tóm tắt
Thành ngữ Ruby nhấn mạnh: sự hài lòng của nhà phát triển, quy ước về cấu hình, khối và trình vòng lặp, kiểu gõ vịt và cú pháp biểu cảm. Làm theo Hướng dẫn về Phong cách Ruby, sử dụng RuboCop để tìm lỗi mã nguồn và StandardRB để định dạng theo ý kiến. Ruby coi trọng khả năng đọc - mã nên đọc giống tiếng Anh. Ưu tiên các phương thức Enumerable hơn các vòng lặp thủ công, sử dụng các ký hiệu cho mã định danh và bao gồm các khối để lặp lại và quản lý tài nguyên.