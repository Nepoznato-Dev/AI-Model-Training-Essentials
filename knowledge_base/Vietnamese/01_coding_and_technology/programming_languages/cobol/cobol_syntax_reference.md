...
## Bản tóm tắt
Cú pháp của COBOL được thiết kế dài dòng — mọi câu lệnh đều đọc giống như tiếng Anh. Mô tả dữ liệu với mệnh đề PIC xác định chính xác các định dạng trường. Cấu trúc bốn bộ phận thực thi việc phân tách các mối quan tâm. Xử lý tập tin được tích hợp vào ngôn ngữ. Để xử lý dữ liệu kinh doanh, số học thập phân và I/O theo định hướng bản ghi của COBOL vẫn chưa từng có. Hiểu COBOL có nghĩa là hiểu nền tảng của điện toán doanh nghiệp.