...
- **Sự kiện**: Nhấp, gửi, bàn phím, sự kiện tùy chỉnh, ủy quyền sự kiện
...
- **Parcel**: Bộ gói không có cấu hình
- **Rollup**: Được tối ưu hóa cho thư viện
...
- **Jenkins**: Máy chủ tự động mở rộng
