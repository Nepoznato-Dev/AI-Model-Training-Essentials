...
### Chia theo thời gian
Đối với dữ liệu chuỗi thời gian, hãy phân chia theo thứ tự thời gian (huấn luyện trong quá khứ, kiểm tra trong tương lai) thay vì ngẫu nhiên.
...
## Điều chỉnh siêu tham số- **Tìm kiếm lưới**: Thử triệt để tất cả các kết hợp của một tập hợp siêu tham số được xác định trước. Đơn giản nhưng tốn kém về mặt tính toán.
...
6. **Phân tích lỗi**: Xem các ví dụ mà mô hình sai. Xác định các mẫu (ví dụ: các lớp hiếm, đầu vào không rõ ràng) và cung cấp thông tin chi tiết về quá trình chuẩn bị dữ liệu hoặc kỹ thuật tính năng.
