...
| **Tự động mở rộng quy mô** | Nhóm tự động mở rộng quy mô | Bộ cân máy ảo | Nhóm phiên bản |
...
| **Vùng chứa không có máy chủ** | Cổng xa | Ứng dụng vùng chứa | Chạy trên nền tảng đám mây |
...
| **Khối lượng công việc nặng về chính phủ / tuân thủ** | AWS hoặc Azure | Hầu hết các chứng nhận tuân thủ; Khu vực GovCloud |
