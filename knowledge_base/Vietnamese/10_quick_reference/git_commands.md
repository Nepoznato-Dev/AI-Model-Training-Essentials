...
Các lệnh Git cần thiết để kiểm soát phiên bản.
---
...
| Phím tắt | Hành động |
|----------|--------|
|  __BẢO VỆ_0__ | Lịch sử tìm kiếm ngược |
|  __BẢO VỆ_1__ | Tự động hoàn thành |
|  __BẢO VỆ_2__ | Hủy lệnh |
|  __BẢO VỆ_3__ | Đình chỉ quá trình |
|  __BẢO VỆ_4__ | Tiếp tục quá trình bị đình chỉ |
---

## Các phương pháp hay nhất
✅ **Làm:**
- Viết thông điệp cam kết rõ ràng, mang tính mô tả
- Cam kết thường xuyên với các nhóm hợp lý
- Sử dụng các nhánh cho các tính năng/sửa lỗi
- Kéo trước khi bắt đầu công việc
- Đánh giá`git status`thường xuyên
❌ **Không:**
- Cam kết dữ liệu nhạy cảm (khóa API, mật khẩu)
- Buộc đẩy tới các nhánh chia sẻ
- Cam kết các tệp nhị phân lớn
- Bỏ qua xung đột hợp nhất
- Làm việc trực tiếp trên main/master
---

## Quy ước về tin nhắn cam kết
```
type(scope): subject
...
*Cập nhật lần cuối: Tháng 7 năm 2026 | Git 2.x*