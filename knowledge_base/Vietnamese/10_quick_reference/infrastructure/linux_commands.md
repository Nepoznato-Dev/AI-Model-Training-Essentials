...
-->
# Tham khảo nhanh các lệnh Linux
Các lệnh Linux/Unix cần thiết để điều hướng và quản trị hệ thống.
---
...
| `Ctrl+C`| Giết lệnh hiện tại |
| `Ctrl+Z`| Lệnh đình chỉ |
| `Ctrl+D`| Thoát shell/EOF |
| `Ctrl+L`| Xóa màn hình |
| `Ctrl+A`| Tới dòng bắt đầu |
| `Ctrl+E`| Tới cuối dòng |
| `Ctrl+U`| Xóa để bắt đầu dòng |
| `Ctrl+K`| Xóa đến cuối dòng |
| `Ctrl+R`| Lịch sử tìm kiếm |
| `Ctrl+W`| Xóa từ trước con trỏ |
---

## Các phương pháp hay nhất
✅ **Làm:**
- Sử dụng`sudo`một cách tiết kiệm và cẩn thận
- Kiểm tra các lệnh phá hủy mà không có cờ thực thi trước
- Giữ bản sao lưu trước những thay đổi lớn
- Sử dụng tên file có ý nghĩa (không có dấu cách)
- Học cách sử dụng các trang`man`(`man command`)
❌ **Không:**
- Chạy`rm -rf /`hoặc các lệnh nguy hiểm tương tự
- Sử dụng`chmod 777`trên các tệp nhạy cảm
- Bỏ qua các thông báo cảnh báo
- Chỉnh sửa tập tin hệ thống mà không cần sao lưu
- Chạy các tập lệnh không xác định với quyền root
---

*Cập nhật lần cuối: Tháng 7 năm 2026 | Tương thích với Linux/Unix*