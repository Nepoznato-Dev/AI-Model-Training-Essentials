...
# Bảng tóm tắt cú pháp Python
Tham khảo nhanh về cú pháp Python 3.x và các mẫu phổ biến.
---

## Cú pháp cơ bản
### Biến và kiểu dữ liệu```python
...
## Mẹo nhanh
- Sử dụng`#`cho nhận xét một dòng
- Sử dụng`"""triple quotes"""`cho chuỗi tài liệu và chuỗi nhiều dòng
- Vấn đề thụt lề (thường là 4 dấu cách)
- Quy ước đặt tên:`snake_case`cho biến/hàm,`PascalCase`cho lớp
-`__name__ == "__main__"`để kiểm tra xem script có chạy trực tiếp không
- Sử dụng`virtualenv`hoặc`venv`để cách ly dự án
- Cài đặt gói với `pip install package_name`
---

*Cập nhật lần cuối: Tháng 7 năm 2026 | Python 3.x*