...
| **Vật liệu tổng hợp** | Sự kết hợp của hai lớp trở lên | Thuộc tính phù hợp; cường độ cao theo trọng lượng | Sợi carbon; sợi thủy tinh; bê tông |
...
| Tài sản | Ảnh hưởng của cấu trúc tinh thể |
|----------|------------------------------|
...
## Tính chất cơ học
### Các số liệu chính
| Tài sản | Định nghĩa | Đơn vị | Giá trị tiêu biểu |
|----------|----------||-------|-------|
...
| **Austenite (γ)** | Lên tới 2,14% | Sắt FCC | Không có từ tính; có thể định hình |
