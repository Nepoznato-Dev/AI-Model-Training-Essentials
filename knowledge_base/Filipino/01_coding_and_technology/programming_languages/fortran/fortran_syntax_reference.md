...
| `<``>``<=``>=` | Paghahambing | `a >= b`| |
| `.and.``.or.``.not.`| Lohikal | `a .and. b`| |
| `.eqv.``.neqv.` | Lohikal na pagkakapareho | `a .eqv. b`| |
| `//`| Pagsasama-sama ng string | `'hello' // ' world'`| |
---
...
## Buod
Ang syntax ng Modern Fortran ay malinis, nakaayos, at na-optimize para sa numerical computation. Ang mga operasyon ng array ay nag-aalis ng mga loop para sa karamihan ng mga gawaing pangmatematika. Nagbibigay ang mga module ng encapsulation at pamamahala ng namespace. Ang mga feature ng OOP (mga derived na uri, inheritance, polymorphism) ay nagbibigay-daan sa malinis na code organization. Nag-aalok ang Coarrays ng native parallel programming nang walang mga panlabas na library. Ang mga lakas ng Fortran — pagganap, mga operasyon ng array, at katumpakan ng numero — ay nananatiling walang kaparis para sa siyentipikong pag-compute. Para sa HPC, computational physics, at engineering simulation, ang Fortran ay patuloy na isang powerhouse.