...
-->
# Perl — Mga Idiomatic Pattern at Pinakamahuhusay na Kasanayan
Sinasaklaw ng gabay na ito ang mga idiomatic pattern at pinakamahuhusay na kagawian para sa pagsusulat ng malinis, modernong Perl (5.38+) na code.
---
...
## Buod
Binibigyang-diin ng mga modernong idyoma ng Perl ang:`use strict; use warnings;`, mga lagda, say, postderef, at modernong OOP (class keyword sa 5.38+). Sundin ang perlcritic para sa linting at perltidy para sa pag-format. Pinahahalagahan ng Perl ang TMTOWTDI (May Higit sa Isang Paraan Upang Gawin Ito) — ngunit ang modernong Perl ay nagtatagpo sa mas malinis, mas mapanatili na mga pattern.