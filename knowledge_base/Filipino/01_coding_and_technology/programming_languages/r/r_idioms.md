...
-->
# R — Mga Idiomatic Pattern at Pinakamahuhusay na Kasanayan
Sinasaklaw ng gabay na ito ang mga idiomatic pattern at pinakamahuhusay na kagawian para sa pagsusulat ng malinis, idiomatic na R code.
---
...
## Buod
Binibigyang-diin ng mga R idiom ang: vectorization (iwasan ang mga loop), tidyverse pipe (`|>`),`<-`para sa pagtatalaga, pagpapangalan sa snake_case, at functional programming na may`purrr`. Sundin ang Tidyverse Style Guide, gumamit ng lintr para sa linting, at styler para sa pag-format. Pinahahalagahan ng R ang mga vectorized na operasyon at ang pipe para sa nababasang pagbabago ng data.