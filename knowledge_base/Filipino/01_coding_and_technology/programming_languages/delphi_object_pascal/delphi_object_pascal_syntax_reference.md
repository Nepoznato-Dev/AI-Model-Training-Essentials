...
Ang dokumentong ito ay nagbibigay ng isang komprehensibo, structured syntax reference para sa Delphi/Object Pascal. Kinukumpleto nito ang pangunahing sanggunian ng Delphi sa pamamagitan ng pagtutok sa mga kumpletong pattern ng syntax, mga tampok ng OOP, generic, mga talaan, at mga idyoma ng wika.
---
...
| | `-`| Pagbabawas | `A - B`|
| | `*`| Multiplikasyon | `A * B`|
| | `/`| Tunay na dibisyon | `A / B`(laging nagbabalik ng Real) |
| | `div`| Integer division | `A div B`(ibinabalik ang Integer) |
| | `mod`| Modulus | `A mod B`|
...
| **Lohikal** | `and`| Lohikal AT | `A and B`|
| | `or`| Lohikal O | `A or B`|
| | `not`| Lohikal HINDI | `not A`|
| | `xor`| Eksklusibo O | `A xor B`|
| **String** | `+`| Pagsasama-sama | `'Hello' + ' ' + 'World'`|
| **Itakda** | `in`| Membership | `X in [1, 2, 3]`|
| | `+`| Unyon | `SetA + SetB`|
| | `-`| Pagkakaiba | `SetA - SetB`|
| | `*`| Intersection | `SetA * SetB`|
| **Takdang-aralin** | `:=`| Magtalaga ng halaga | `X := 42`|
| **Address** | `@`| Address-ng | `P := @X`|
| | `^`| Dereference | `P^`|
---
...
## Buod
Pinagsasama ng Delphi/Object Pascal ang malinis, nababasang syntax na may malalakas na feature ng OOP. Ang mga klase, interface, generic, at talaan ay nagbibigay ng buong toolkit para sa pagbuo ng application. Ginagawa itong madaling lapitan dahil sa tahasang pagsisimula/pagtatapos na mga bloke ng wika, mga na-type na variable, at mga identifier na walang case-sensitive. Pinapalawak ng VCL/FMX frameworks ang wika na may mga visual component library para sa mabilis na pagbuo ng application. Para sa mga enterprise Windows application at database front-end, ang Delphi ay nananatiling isang produktibong pagpipilian.