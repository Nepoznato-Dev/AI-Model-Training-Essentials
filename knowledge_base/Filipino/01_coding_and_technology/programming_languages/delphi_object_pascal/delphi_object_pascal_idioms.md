...
# Delphi / Object Pascal — Mga Idiomatic Pattern at Pinakamahuhusay na Kasanayan
Sinasaklaw ng gabay na ito ang mga idiomatic pattern para sa pagsulat ng malinis na Delphi at Object Pascal code.
---

## Pamamahala ng Resource na may pagsubok/sa wakas
```delphi
...
## Disenyo at Mga Interface ng Klase
```delphi
...
## Buod
Binibigyang-diin ng mga idiom ng Delphi ang:`try/finally`para sa deterministikong paglilinis ng mapagkukunan,`Format`para sa pagbuo ng string, mga interface para sa maluwag na pagkakabit, mga tala para sa mga carrier ng data, partikular na paghawak ng exception, at mga modernong tampok tulad ng mga generic at hindi kilalang pamamaraan. Pinahahalagahan ng Delphi ang tahasang pamamahala ng mapagkukunan — "lumikha ito, gamitin ito, palayain ito sa wakas."