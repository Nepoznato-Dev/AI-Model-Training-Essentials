...
---
# Haskell — Mga Karaniwang Pagkakamali at Anti-Pattern
Kino-catalog ng dokumentong ito ang mga pinakakaraniwang pagkakamali, traps, at anti-pattern sa Haskell na may mga pagwawasto.
---

## 1. Mga Walang-hanggan na Listahan at Mga Sorpresa sa Katamaran
```haskell
...
## 3. Hindi Pag-unawa sa mga Batas ng Monad
```haskell
...
## 5. Hindi Paggamit ng Record Syntax nang Wasto
```haskell
...
## 7. Anti-Pattern: Sobrang Paggamit ng `IO`
```haskell
...
## Buod
Ang kadalisayan at katamaran ng Haskell ay lumilikha ng mga kakaibang pitfalls: ang space leaks mula sa tamad na pagsusuri, mga partial function na nag-crash sa runtime, pagkalito sa pagitan ng String/Text/ByteString, at sobrang paggamit ng IO. Ang paraan ng Haskell ay: gumamit ng mahigpit na pagsusuri para sa mga nagtitipon (`foldl'`, BangPatterns), iwasan ang mga partial function (`head`,`read`,`!!`), gumamit ng`Maybe`/ XQZMARKER5XQX para sa paghawak ng error, at panatilihing minimal ang IQZMARKER5XQZ. Ang uri ng system ng compiler ay ang iyong pinakadakilang kakampi — hayaan itong gabayan ka patungo sa kabuuan, dalisay na mga function.