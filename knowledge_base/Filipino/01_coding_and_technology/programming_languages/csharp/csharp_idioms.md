...
Sinasaklaw ng gabay na ito ang mga idiomatic pattern at pinakamahuhusay na kagawian para sa pagsusulat ng malinis, modernong C# (12+) code.
---
...
## Idisposable at Pamamahala ng Mapagkukunan
```csharp
...
## Buod
Binibigyang-diin ng mga modernong C# na idiom ang: mga tala para sa data, pagtutugma ng pattern, null na kaligtasan (nullable na mga uri ng sanggunian), LINQ para sa mga koleksyon, async/naghihintay sa CancellationToken, dependency injection, pangunahing mga konstruktor, mga expression ng koleksyon, at mga deklarasyon ng `using`. Sundin ang C# Coding Conventions, gamitin ang`dotnet format`para sa pag-format, at Roslyn analyzers para sa kalidad ng code. Ang modernong C# (12+) ay maigsi at nagpapahayag — yakapin ang mga talaan, pagtutugma ng pattern, at mga pangunahing konstruktor.