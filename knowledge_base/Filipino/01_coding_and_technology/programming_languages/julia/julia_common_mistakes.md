...
## 1. I-type ang Kawalang-tatag sa Mga Pag-andar
```julia
...
## 2. Mga Global Variable sa Performance-Critical Code
```julia
...
## 4. Hindi Gumagamit ng Maramihang Dispatch
```julia
...
## 7. Anti-Pattern: Hindi Paggamit ng Broadcasting
```julia
...
## Buod
Ang pagganap ni Julia ay nakadepende sa uri ng katatagan: iwasan ang mga global na variable sa mainit na code, gumamit ng maramihang dispatch sa halip na kung/iba sa mga uri, paunang maglaan ng mga array, gumamit ng pagsasahimpapawid para sa mga pagpapatakbong matalino sa elemento, at mag-annotate ng mga uri kapag kinakailangan. Ginagantimpalaan ni Julia ang mga developer na nagsusulat ng type-stable na code at gumagamit ng maramihang dispatch. Ang`@code_warntype`macro ay ang iyong matalik na kaibigan para sa paghahanap ng uri ng kawalang-tatag.