...
---
# Assembly Language — Mga Karaniwang Pagkakamali at Anti-Pattern
Kino-catalog ng dokumentong ito ang mga pinakakaraniwang pagkakamali, traps, at anti-pattern sa x86-64 Assembly na may mga pagwawasto.
---

## 1. Hindi Pagpapanatili ng mga Rehistro
```asm
...
## 3. Off-by-One sa String Operations
```asm
...
## 4. Hindi Pag-clear ng Upper Bits
```asm
...
## 5. Infinite Loops mula sa Nawawalang Kondisyon sa Paglabas
```asm
...
## Buod
Assembly traps: panatilihin ang mga rehistrong na-save ng callee, panatilihin ang 16-byte na stack alignment, isama ang mga null terminator sa mga string, maging tahasan ang tungkol sa mga laki ng operand, at palaging magbigay ng mga kundisyon sa paglabas ng loop. Ang assembly programming ay nangangailangan ng pag-unawa sa hardware sa pinakamababang antas — bawat pagtuturo ay may mga kahihinatnan para sa mga rehistro, memorya, at mga flag.