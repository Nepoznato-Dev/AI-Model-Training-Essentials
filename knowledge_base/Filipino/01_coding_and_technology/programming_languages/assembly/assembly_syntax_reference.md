...
## Mga Function at Calling Convention
```nasm
...
## Macros at Kondisyon na Assembly
```nasm
; === NASM Macros ===
...
## Buod
Ang syntax ng wika ng assembly ay tinukoy ng arkitektura ng processor at ng assembler (NASM, GAS, MASM). Ang x86-64 ay nagbibigay ng 16 na pangkalahatang layunin na rehistro, maramihang mga mode ng pag-address, at daan-daang mga tagubilin na sumasaklaw sa paggalaw ng data, arithmetic, logic, control flow, SIMD, at mga system call. Ang NASM syntax na ginamit dito ay ang pinakakaraniwan para sa Linux x86-64 development. Ang pag-master ng assembly ay nangangailangan ng pag-unawa sa mga register, stack, calling convention, at kung paano ang mga high-level na konstruksyon ay nagmamapa sa mga tagubilin sa makina.