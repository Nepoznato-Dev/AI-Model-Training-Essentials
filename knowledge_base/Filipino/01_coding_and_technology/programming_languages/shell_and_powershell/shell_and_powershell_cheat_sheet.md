...
-->
# Shell at PowerShell — Cheat Sheet
## Mga Pangunahing Kaalaman sa Bash
```bash
# Variables
name="Alice"
age=30
...
## Mga Function at Pattern ng Bash
```bash
# Function
greet() {
    local name="$1"
...
## Mga Pangunahing Kaalaman sa PowerShell
```powershell
# Variables
$name = "Alice"
$age = 30
...
## Daloy ng Kontrol ng PowerShell
```powershell
# If
if ($age -ge 18) {
    "adult"
...
## Paghawak ng Error sa PowerShell
```powershell
try {
