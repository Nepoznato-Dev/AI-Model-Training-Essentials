...
-->
# Cross-Language Comparison — I/O at File Operations
## Output ng Console
| Wika | I-print sa stdout |
|----------|----------------|
| Python | `print("Hello")`|
| JavaScript | `console.log("Hello")`|
| kalawang | `println!("Hello")`|
| Pumunta | `fmt.Println("Hello")`|
...
| COBOL | `DISPLAY 'Hello'`|
| Fortran | `print *, 'Hello'`|
| Assembly | `syscall`(sumulat sa fd 1) |
| Delphi | `WriteLn('Hello')`|
| scratch | `say [Hello]`|
| VB | `Console.WriteLine("Hello")`|
| Shell | `echo "Hello"`|
| SQL | N/A (nagbabalik ng mga set ng resulta) |
## Pagbabasa ng File
```python
# Python
