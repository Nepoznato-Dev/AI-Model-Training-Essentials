...
## Buod
Binibigyang-diin ng mga idyoma ng Kotlin ang: null na kaligtasan, mga klase ng data, mga selyadong uri, mga function ng saklaw, mga function ng extension, coroutine, at code na nakatuon sa expression. Sundin ang Kotlin Coding Conventions, gumamit ng ktlint para sa pag-format, at detekt para sa static na pagsusuri. Pinahahalagahan ng Kotlin ang pagiging maikli at pagpapahayag — magsulat ng mas kaunting boilerplate, yakapin ang karaniwang library, at gamitin ang`val`bilang default.