...
## 2. Hindi Paggamit ng Cut (`!`) nang Tama
```prolog
...
## 4. Nangyayari ang Hindi Pag-unawa Suriin
```prolog
...
## 5. Ilista ang mga Operasyon na Walang Mga Accumulator
```prolog
...
## Buod
Ang logic programming paradigm ng Prolog ay lumilikha ng mga kakaibang bitag: nakalilito`=`(unification),`==`(equality), at`is`(aritmetika); maling pagkakalagay ng hiwa; walang katapusang recursion nang walang binisita na pagsubaybay; at ang nangyayari check. Ang Prolog na paraan ay: unawain nang malalim ang unification, gumamit ng cut nang matipid at tama, gumamit ng mga accumulator para sa mahusay na pagbuo ng listahan, at palaging isaalang-alang ang pagwawakas.