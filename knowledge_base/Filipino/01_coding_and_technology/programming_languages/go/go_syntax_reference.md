...
| `/`| Dibisyon | `7 / 2`| `3`| Integer division para sa ints |
| `%`| Natitira | `7 % 2`| `1`| Lagdaan ang mga tugmang dibidendo |
| `&`| Bitwise AT | `5 & 3`| `1`| |
| `\|`| Bitwise O | `5 \| 3`| `7`| |
| `^`| Bitwise XOR | `5 ^ 3`| `6`| Gayundin bitwise complement (unary) |
| `&^`| Medyo malinaw (AT HINDI) | `5 &^ 3`| `4`| Natatanging Pumunta |
| `<<`| Kaliwa Shift | `5 << 1`| `10`| |
| `>>`| Pakanan Shift | `5 >> 1`| `2`| |
### Mga Operator ng Paghahambing
| Operator | Pangalan | Halimbawa | Mga Tala |
|----------|------|---------|-------|
| `==`| Pantay | `x == y`| Mga maihahambing na uri lamang |
| `!=`| Hindi Katumbas | `x != y`| |
| `<`,`>`,`<=`,`>=`| Pag-order | `x >= y`| Ang mga string ay inihambing sa lexicographically |
...
## Buod
Ang syntax ni Go ay sadyang minimal — walang inheritance, walang method na overloading, walang exception, walang macros. Ang nananatili ay isang malinis at orthogonal na hanay ng mga konstruksyon: mga istruktura at interface para sa komposisyon, mga goroutine at mga channel para sa concurrency, at tahasang paghawak ng error para sa pagiging maaasahan. Ang kapangyarihan ng wika ay hindi nagmumula sa kumplikadong syntax ngunit mula sa eleganteng interaksyon ng mga simpleng primitive nito. Ang Generics (Go 1.18+) ay nagdaragdag ng uri ng flexibility nang hindi sinasakripisyo ang katangiang kalinawan ni Go.