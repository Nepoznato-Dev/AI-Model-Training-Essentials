...
Mabilis na Sanggunian ang # Linux Commands
Mahahalagang Linux/Unix command para sa system navigation at administration.
---
...
## Mga Variable ng Shell at Kapaligiran
```bash
...
|----------|--------|
| `Tab`| Auto-complete |
| `Ctrl+C`| Patayin ang kasalukuyang utos |
| `Ctrl+Z`| Suspindihin ang utos |
| `Ctrl+D`| Lumabas sa shell/EOF |
| `Ctrl+L`| I-clear ang screen |
| `Ctrl+A`| Pumunta sa pagsisimula ng linya |
| `Ctrl+E`| Pumunta sa dulo ng linya |
| `Ctrl+U`| Tanggalin sa simula ng linya |
| `Ctrl+K`| Tanggalin sa dulo ng linya |
| `Ctrl+R`| Kasaysayan ng paghahanap |
| `Ctrl+W`| Tanggalin ang salita bago ang cursor |
---

## Pinakamahuhusay na Kasanayan
✅ **Gawin:**
- Gamitin ang`sudo`nang matipid at maingat
- Subukan ang mga mapanirang utos nang walang mga flag ng pagpapatupad muna
- Panatilihin ang mga backup bago ang mga malalaking pagbabago
- Gumamit ng makabuluhang mga filename (walang mga puwang)
- Matutong gumamit ng mga pahina ng`man`(`man command`)
❌ **Huwag:**
- Patakbuhin ang`rm -rf /`o mga katulad na mapanganib na utos
- Gamitin ang`chmod 777`sa mga sensitibong file
- Huwag pansinin ang mga mensahe ng babala
- I-edit ang mga file ng system nang walang mga backup
- Patakbuhin ang mga hindi kilalang script bilang ugat
---

*Huling na-update: Hulyo 2026 | Linux/Unix compatible*