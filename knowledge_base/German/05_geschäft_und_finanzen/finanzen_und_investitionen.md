...
## Personal Finanzen Grundlagen

### Financial Planning Grundlagen
- **Budgeting**: Track income und expenses, 50/30/20 rule (needs/wants/savings)
- **Emergency Fund**: 3-6 months von living expenses in liquid account
- **Net Worth**: Assets minus liabilities, track over time
- **Cash Flow Verwaltung**: Money in vs. money out, positive cash flow essential
...
- **Certificates von Deposit (CDs)**: Fixed term, fixed rate, early withdrawal penalty
- **High-Yield Savings**: Online banks, competitive rates

### Credit und Debt
- **Credit Score**: FICO (300-850), factors: payment Geschichte, utilization, length, mix, inquiries
...
- **Sectors**: Technologie, Gesundheitswesen, financials, consumer, industrial, energy, utilities, materials, real estate, Kommunikation services
...
- **Hedge Funds**: Active Verwaltung, diverse strategies
...
- Priced at end-von-day NAV
- Active or passive Verwaltung
...
- Beispiele: SPY (S&P 500), QQQ (Nasdaq), VTI (total market)

#### Index Funds
- Passive Verwaltung tracking specific index
- Low costs, broad diversification
- Beispiele: Total stock market, S&P 500, international
...
- **Efficient Frontier**: Maximum return für given risk level
- **Correlation**: How assets move relative to each other

### Investment Approaches
- **Passive Investieren**: Index funds, buy-und-hold, low costs
- **Active Investieren**: Stock picking, market timing, higher costs
- **Dollar-Cost Averaging**: Invest fixed amounts regularly regardless von price
- **Value Investieren**: Buy undervalued securities (Warren Buffett approach)
- **Growth Investieren**: Focus on companies mit above-average growth
- **Income Investieren**: Prioritize dividends und interest payments
- **ESG Investieren**: Umwelt, social, governance factors
...
- Tax-free growth und withdrawals
- No RMDs during lifetime
- Income limits für eligibility
...
- Vesting schedules für employer contributions

#### Other Plans
- **403(b)**: Non-profit organizations
- **457**: Government employees
- **SEP IRA**: Self-employed, small Geschäft
- **Solo 401(k)**: Self-employed mit no employees

### Retirement Planning Concepts
- **Replacement Ratio**: 70-80% von pre-retirement income typically needed
- **Social Sicherheit**: Government benefit, claim between 62-70
- **Pension Plans**: Defined benefit (employer guarantees payout)
- **Withdrawal Strategies**: 4% rule, dynamic spending, bucket strategy
- **Gesundheitswesen Costs**: Medicare, supplemental insurance, long-term care
...
### Trading Concepts
- **Bid-Ask Spread**: Difference between buying und selling price
- **Volume**: Number von shares traded
- **Liquidity**: Ease von buying/selling without affecting price
...
- **Cash Flow Statement**: Operating, Investieren, financing activities
...
### Qualitative Factors
- **Verwaltung Quality**: Track record, alignment mit shareholders
...
### Chart Patterns
- **Reversal Patterns**: Head und shoulders, double top/bottom
...
- **HSA (Health Savings Account)**: Triple tax advantage für medical expenses
- **529 Plans**: Tax-advantaged education savings

### Tax Efficiency Strategies
- Asset location (which accounts hold which investments)
- Hold investments long-term für preferential rates
- Use tax-efficient funds (ETFs, index funds)
- Consider municipal bonds für taxable accounts
...
- **Manufacturing Daten**: PMI, industrial production

### Federal Reserve und Monetary Policy
...
- **Overconfidence**: Overestimate knowledge und abilities
- **Anchoring**: Rely too heavily on first piece von information
- **Herd Mentality**: Follow crowd behavior
- **Recency Bias**: overweight recent Ereignisse
- **Endowment Effect**: Value owned items more highly
- **Sunk Cost Fallacy**: Continue based on past investment, not Zukunft prospects

### Emotional Investieren Pitfalls
...
### Thematic Investieren
- **Technologie**: AI, cloud Datenverarbeitung, cybersecurity, semiconductors
- **Gesundheitswesen**: Biotechnology, genomics, telemedicine
...
### Demographic Trends
- Aging population (Gesundheitswesen, retirement services)
- Millennial/Gen Z preferences (Nachhaltigkeit, Technologie)
- Urbanization (real estate, infrastructure)
- Emerging markets middle class growth

### Sustainable Investieren
- **ESG Integration**: Umwelt, social, governance factors
- **Impact Investieren**: Generate positive social/Umwelt impact
- **Green Bonds**: Fund Umwelt projects
- **Carbon Credits**: Trade emissions allowances

## Financial Advisors und Services

### Types von Advisors
- **Registered Investment Advisor (RIA)**: Fiduciary standard, fee-based
- **Broker-Dealer**: Suitability standard, commission-based
- **Robo-Advisors**: Automated Investieren, lower costs
- **Financial Planner**: Comprehensive planning, may be fee-only or commission

### Compensation Models
- **Fee-Only**: Percentage von assets, hourly, flat fee (no commissions)
- **Commission**: Paid on product sales
- **Fee-Based**: Combination von fees und commissions
- **Assets Under Verwaltung (AUM)**: Typically 0.5%-1.5% annually

### Choosing an Advisor
- Verify credentials (CFP, CFA, CPA)
- Understand compensation structure
- Check regulatory Geschichte (SEC, FINRA BrokerCheck)
- Ensure fiduciary duty
- Assess Kommunikation style und compatibility
