...
## 1. Unendliche Listen und Faulheitsüberraschungen
```haskell
...
## 3. Monadengesetze nicht verstehen
```haskell
...
## 5. Datensatzsyntax nicht richtig verwenden
```haskell
...
## 7. Anti-Pattern: Überbeanspruchung von `IO`
```haskell
...
## Zusammenfassung
Haskells Reinheit und Faulheit schaffen einzigartige Fallstricke: Speicherplatzlecks durch verzögerte Auswertung, Teilfunktionen, die zur Laufzeit abstürzen, Verwechslung zwischen String/Text/ByteString und übermäßige Nutzung von E/A. Der Haskell-Weg ist: Verwenden Sie eine strikte Auswertung für Akkumulatoren (`foldl'`, BangPatterns), vermeiden Sie Teilfunktionen (`head`, Das Typsystem des Compilers ist Ihr größter Verbündeter – lassen Sie sich von ihm zu vollständigen, reinen Funktionen führen.