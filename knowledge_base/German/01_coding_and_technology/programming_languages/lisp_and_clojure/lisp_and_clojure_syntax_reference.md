...
# Lisp & Clojure – Syntaxreferenz
Dieses Dokument bietet eine umfassende, strukturierte Syntaxreferenz für Common Lisp und Clojure. Es ergänzt die Hauptreferenz zu Lisp/Clojure, indem es sich auf S-Ausdrücke, Makros, persistente Datenstrukturen und funktionale Programmiermuster konzentriert.
---
...
## Zusammenfassung
Die Syntax von Clojure ist einheitlich in Klammern gesetzt – jede Form ist eine Liste. Diese Homoikonizität ermöglicht leistungsstarke Makros, die Code in Daten umwandeln. Persistente Datenstrukturen sorgen für Unveränderlichkeit und strukturelle gemeinsame Nutzung für mehr Effizienz. Threading-Makros erstellen lesbare Datenpipelines. Parallelitätsprimitive (Atome, Referenzen, Agenten, Kanäle) verarbeiten Zustandsänderungen sicher. Der Einfluss von Lisp/Clojure auf die moderne Programmierung ist enorm – Garbage Collection, REPLs, Makros und funktionale Programmierung gehen alle auf Lisp zurück.