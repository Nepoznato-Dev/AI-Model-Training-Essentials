...
## Übersicht über Blockkategorien
| Kategorie | Farbe | Blocktypen | Zweck |
|----------|--------|-------------|---------|
| **Antrag** | Blau | Stapel | Sprites verschieben, Position und Richtung ändern |
| **Sieht aus** | Lila | Stapel | Aussehen ändern, sagen/denken, anzeigen/verstecken |
| **Ton** | Rosa | Stapel | Töne abspielen, Lautstärke/Tonhöhe ändern |
| **Veranstaltungen** | Gelb | Hut | Skripte starten, Nachrichten senden/empfangen |
| **Kontrolle** | Gold | Stapel | Schleifen, Bedingungen, warten, stoppen |
| **Erkennung** | Hellblau | Reporter | Kollisionen, Eingaben, Timer, Antworten erkennen |
| **Operatoren** | Grün | Reporter | Mathematik, Text, Vergleich, Logik |
| **Variablen** | Orange | Stapel/Reporter | Daten speichern, Vorgänge auflisten |
| **Meine Blöcke** | Dunkelrot | Stapel | Benutzerdefinierte Blockdefinitionen (Funktionen) |
---
...
## Zusammenfassung
Die blockbasierte Syntax von Scratch eliminiert Tippfehler und macht Programmierkonzepte greifbar. Jedes Skript beginnt mit einem Hutblock (Ereignis), stapelt dann Befehlsblöcke (Bewegung, Aussehen, Ton, Steuerung, Wahrnehmung, Operatoren, Variablen) und verwendet Reporterblöcke (runde/ovale Formen) für Werte. Benutzerdefinierte Blöcke ermöglichen eine modulare Programmierung. Klone sorgen für objektähnliches Verhalten. Listet Store-Kollektionen auf. Die Stiftverlängerung ermöglicht kreatives Zeichnen. Für junge Lernende bietet Scratch eine umfassende Einführung in Programmierlogik, ereignisgesteuertes Design und kreativen Ausdruck durch Code.