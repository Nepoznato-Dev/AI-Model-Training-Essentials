...
# Scratch – Häufige Fehler und Anti-Patterns
Dieses Dokument listet die häufigsten Fehler und Fallstricke in Scratch mit Korrekturen auf.
---

## 1. „Stopp“ nicht zum Beenden von Skripten verwenden
```
...
## 5. Endlosschleifen ohne Ausbeute
```
...
## Zusammenfassung
Scratch-Traps: Verwenden Sie immer „Stop“, um Spiele zu beenden, trennen Sie die Klonlogik von der ursprünglichen Sprite-Logik, verwenden Sie „Broadcast and Wait“ für synchrone Kommunikation, verwenden Sie bei Bedarf Sprite-spezifische Variablen und fügen Sie Wartezeiten in Endlosschleifen hinzu, um ein Einfrieren zu verhindern. Scratch vermittelt grundlegende Konzepte – respektieren Sie das ereignisgesteuerte Modell.