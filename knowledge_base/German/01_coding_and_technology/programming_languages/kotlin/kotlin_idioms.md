...
-->
# Kotlin – Idiomatische Muster und Best Practices
Dieser Leitfaden behandelt idiomatische Muster und Best Practices zum Schreiben von sauberem, idiomatischem Kotlin-Code.
---
...
## Zusammenfassung
Kotlin-Redewendungen betonen Folgendes: Nullsicherheit, Datenklassen, versiegelte Typen, Bereichsfunktionen, Erweiterungsfunktionen, Coroutinen und ausdrucksorientierter Code. Befolgen Sie die Kotlin-Codierungskonventionen, verwenden Sie ktlint zur Formatierung und detekt für die statische Analyse. Kotlin legt Wert auf Prägnanz und Ausdruckskraft – schreiben Sie weniger Textbausteine, nutzen Sie die Standardbibliothek und verwenden Sie standardmäßig `val`.