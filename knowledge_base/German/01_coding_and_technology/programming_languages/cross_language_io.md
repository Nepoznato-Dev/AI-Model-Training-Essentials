...
-->
# Sprachübergreifender Vergleich – E/A- und Dateioperationen
## Konsolenausgabe
| Sprache | Auf Standardausgabe drucken |
|----------|----------------|
| Python | `print("Hello")`|
| JavaScript | `console.log("Hello")`|
| Rost | `println!("Hello")`|
| Geh | `fmt.Println("Hello")`|
...
| Lispeln | `(format t "Hello~%")`|
| Elixier | `IO.puts("Hello")`|
| Erlang | `io:format("Hello~n")`|
| OCaml | `print_endline "Hello"`|
| Ada | `Put_Line("Hello")`|
| COBOL | `DISPLAY 'Hello'`|
| Fortran | `print *, 'Hello'`|
| Montage | `syscall`(in fd 1 schreiben) |
| Delphi | `WriteLn('Hello')`|
| Kratzer | `say [Hello]`|
| VB | `Console.WriteLine("Hello")`|
| Schale | `echo "Hello"`|
| SQL | N/A (gibt Ergebnismengen zurück) |
## Eine Datei lesen
```python
# Python
