...
# Prolog – Syntaxreferenz
Dieses Dokument bietet eine umfassende, strukturierte Syntaxreferenz für Prolog. Es ergänzt die Hauptreferenz von Prolog, indem es sich auf ausführliche Syntaxmuster, Vereinheitlichung, Backtracking, DCGs und logische Programmiersprachen konzentriert.
---
...
## Vereinheitlichung und Zuordnung
```prolog
...
## Zusammenfassung
Die Syntax von Prolog ist minimal – Fakten, Regeln und Abfragen. Die Kraft liegt in der Vereinheitlichung und dem Backtracking, die die Sprache in eine Suchmaschine für logische Lösungen verwandeln. DCGs bieten eine elegante Parser-Generierung. Listen verwenden den Kopf-/Schwanzmustervergleich. Für die Erfüllung von Einschränkungen, Expertensysteme und symbolische Berechnungen löst der deklarative Ansatz von Prolog Probleme, die in imperativen Sprachen ausführlich sind.