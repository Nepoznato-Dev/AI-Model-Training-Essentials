...
---
# Go – Idiomatische Muster und Best Practices
Dieser Leitfaden behandelt idiomatische Muster und Best Practices zum Schreiben von sauberem, idiomatischem Go-Code.
---
...
## Zusammenfassung
Go-Redewendungen betonen: Einfachheit, explizite Fehlerbehandlung, kleine Schnittstellen, Komposition über Vererbung, Goroutinen mit Kontext und „Schnittstellen akzeptieren, Strukturen zurückgeben“. Folgen Sie`gofmt`für die Formatierung,`golangci-lint`für Linting und dem offiziellen Go Code Review Comments-Leitfaden. Die Go-Community legt Wert auf Lesbarkeit, Einfachheit und „den offensichtlichen Weg, es zu tun“. Vermeiden Sie cleveren Code – Go-Code sollte langweilig und vorhersehbar sein.