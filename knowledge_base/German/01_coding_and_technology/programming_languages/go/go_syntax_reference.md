...
---
# Go – Syntaxreferenz
Dieses Dokument bietet eine umfassende, strukturierte Syntaxreferenz für Go. Es ergänzt die Hauptreferenz von Go, indem es sich auf umfassende Syntaxmuster, Operatortabellen und interne Mechanismen von Goroutinen, Kanälen und Schnittstellen konzentriert.
---
...
| `/`| Abteilung | `7 / 2`| `3`| Ganzzahldivision für Ganzzahlen |
| `%`| Rest | `7 % 2`| `1`| Vorzeichen entspricht Dividende |
| `&`| Bitweises UND | `5 & 3`| `1`| |
| `\|`| Bitweises ODER | `5 \| 3`| `7`| |
| `^`| Bitweises XOR | `5 ^ 3`| `6`| Auch bitweises Komplement (unär) |
| `&^`| Etwas klar (UND NICHT) | `5 &^ 3`| `4`| Einzigartig zum Mitnehmen |
| `<<`| Linksverschiebung | `5 << 1`| `10`| |
| `>>`| Rechtsverschiebung | `5 >> 1`| `2`| |
### Vergleichsoperatoren
| Betreiber | Name | Beispiel | Notizen |
|----------|------|---------|-------|
| `==`| Gleich | `x == y`| Nur vergleichbare Typen |
| `!=`| Nicht gleich | `x != y`| |
|  `<`, `>`, `<=`,`>=`| Bestellen | `x >= y`| Strings lexikografisch verglichen |
### Logische Operatoren
| Betreiber | Name | Beispiel | Notizen |
|----------|------|---------|-------|
...
## Zusammenfassung
Die Syntax von Go ist absichtlich minimal – keine Vererbung, keine Methodenüberladung, keine Ausnahmen, keine Makros. Was übrig bleibt, ist ein sauberer, orthogonaler Satz von Konstrukten: Strukturen und Schnittstellen für die Komposition, Goroutinen und Kanäle für Parallelität und explizite Fehlerbehandlung für Zuverlässigkeit. Die Leistungsfähigkeit der Sprache beruht nicht auf einer komplexen Syntax, sondern auf dem eleganten Zusammenspiel ihrer einfachen Grundelemente. Generics (Go 1.18+) erhöhen die Flexibilität des Typs, ohne die charakteristische Klarheit von Go zu beeinträchtigen.