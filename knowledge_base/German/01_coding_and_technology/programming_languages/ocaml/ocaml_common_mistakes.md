...
---
# OCaml – Häufige Fehler und Anti-Patterns
Dieses Dokument katalogisiert die häufigsten Fehler, Fallen und Anti-Patterns in OCaml mit Korrekturen.
---

## 1. Nicht erschöpfender Mustervergleich
```ocaml
(* ❌ WRONG — missing cases *)
...
## 4.`Option`nicht richtig verwenden
```ocaml
...
## 5. Veränderlicher Zustand in rekursiven Funktionen
```ocaml
...
## Zusammenfassung
OCaml-Traps: nicht erschöpfender Mustervergleich (Compiler-Warnung),`=`ist strukturelle Gleichheit, während`==`physikalisch ist, Ganzzahldivision schneidet ab, verwendet`Option`anstelle von Ausnahmen und vermeidet veränderliche Zustände zugunsten von Schwanzrekursion und Faltungen. Der Compiler von OCaml ist Ihr Verbündeter – beachten Sie seine Warnungen.