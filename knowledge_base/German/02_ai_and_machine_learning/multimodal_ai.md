...
|------|-------------|
| **1. Bild kodieren** | Ein Vision-Encoder (ViT, SigLIP) wandelt das Bild in einen Satz Merkmalsvektoren um |
...
|-----------|-------------|
| **Zeitliche Begründung** | Ereignisse verstehen, die sich im Laufe der Zeit abspielen |
...
| **HELM** | Text + Audio | Multimodale Langkontextbewertung |
