...
### Mel-Spektrogramm
Die gebräuchlichste Audiodarstellung für Deep Learning. Es wandelt den Ton in ein 2D-bildähnliches Format um:
| Achse | Stellt | dar
|------|-----------|
| **X-Achse** | Zeit |
