...
Anstatt explizite Regeln zu programmieren, speist maschinelles Lernen Daten in Algorithmen ein, die selbstständig Muster finden.
...
| **Planung und Werkzeugeinsatz** | Emerging (Agenten) | Bei komplexen mehrstufigen Aufgaben ohne menschliche Aufsicht immer noch unzuverlässig |
...
- **Garantie der sachlichen Richtigkeit** – Halluzination bleibt ein ungelöstes Problem
...
- **Humanoide Roboter** (Tesla Optimus, Figure AI) – im Entstehen; Allgemeine körperliche Aufgaben sind immer noch sehr schwierig
