...
Der moderne Ansatz ist das **Lakehouse**: Kombinieren Sie die günstige, flexible Lagerung eines Sees mit den Management- und Leistungsmerkmalen eines Lagerhauses. Delta Lake, Apache Iceberg und Apache Hudi sind hier die Schlüsseltechnologien.
---
...
| **Mikrobatch** | Kleine Chargen in sehr kurzen Abständen | Sekunden | Nahezu in Echtzeit mit Batch-Einfachheit |
...
|-----------|----------|---------|
| **Fakt** | Messbare Ereignisse (Metriken) | `orders`(Bestell-ID, Produkt-ID, Kunden-ID, Menge, Datum) |
