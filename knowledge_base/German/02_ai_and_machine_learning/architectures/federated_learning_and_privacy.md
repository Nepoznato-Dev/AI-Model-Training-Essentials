...
| **Einhaltung gesetzlicher Vorschriften** | DSGVO, HIPAA und andere Vorschriften schränken den Datenaustausch ein | Banken können zusammenarbeiten, ohne Kundendaten weiterzugeben |
...
| **FedSGD** | Wie FedAvg, aber mit einem Gradientenschritt pro Runde | Geringere Kommunikationskosten pro Runde |
| **Personalisierte FL** | Jedes Gerät verfügt neben dem globalen Modell über ein personalisiertes Modell | Bessere Leistung pro Gerät |
...
|---------|-------------|
| **Wie es funktioniert** | Die Daten werden in Anteile aufgeteilt, die über die Parteien verteilt werden. Berechnung erfolgt auf Aktien |
...
| **Hardware-Heterogenität** | Unterschiedliche Geräte verfügen über unterschiedliche Rechenkapazitäten |
---
