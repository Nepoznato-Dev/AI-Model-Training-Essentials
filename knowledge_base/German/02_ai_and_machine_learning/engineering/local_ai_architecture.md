...
- **IQ4_XS** / **IQ3_XS**: Verbesserte Quantisierung mit besserer Verwirrung bei 4/3 Bit.
...
### Hybride Edge-Cloud
Das lokale Modell verarbeitet häufige Abfragen. Rückgriff auf ein Cloud-Modell für komplexe Fragestellungen. Dies bietet das Beste aus beiden Welten – Geschwindigkeit/Privatsphäre für die meisten, Funktionalität für Randfälle.
...
- **Tool-Nutzung**: Agentische Arbeitsabläufe (Funktionsaufrufe) sind bei kleinen Modellen möglicherweise weniger zuverlässig.
