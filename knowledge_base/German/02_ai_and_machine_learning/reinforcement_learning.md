...
| **Rabattfaktor** | γ (Gamma) | Wie hoch ist der Wert zukünftiger Belohnungen im Vergleich zu unmittelbaren (0 zu 1) |
...
| **Sicherheit** | Eingeschränkter RL: Unsichere Aktionen während des Trainings bestrafen |
| **Teilweise Beobachtbarkeit** | Trainieren Sie mit verrauschten Sensoren und verzögerten Beobachtungen |
Unternehmen wie Boston Dynamics und Tesla nutzen Simulationen in großem Umfang, doch die Lücke zwischen simulierter und physischer Leistung bleibt eine der größten Herausforderungen in diesem Bereich.
---
