...
|-----------|--------------|-----------|
| **Fairness** | KI sollte geschützte Gruppen nicht diskriminieren | Es ist überraschend schwierig, Fairness mathematisch zu definieren. Unterschiedliche Fairnessdefinitionen stehen im Konflikt |
