...
| **LSTM** | RNN mit Gates (Forget, Input, Output) zur Steuerung des Informationsflusses | Besser bei langfristigen Abhängigkeiten | Immer noch sequentiell; langsam zu trainieren |
...
| **Stimmungsanalyse** | Bestimmen Sie den emotionalen Ton | Fein abgestimmtes BERT oder Zero-Shot-LLM |
