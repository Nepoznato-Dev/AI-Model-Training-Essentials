...
-->
# Kurzreferenz zu Linux-Befehlen
Wichtige Linux/Unix-Befehle für die Systemnavigation und -verwaltung.
---
...
- Testen Sie zunächst destruktive Befehle ohne Ausführungsflags
- Bewahren Sie vor größeren Änderungen Backups auf
- Verwenden Sie aussagekräftige Dateinamen (keine Leerzeichen)
- Lernen Sie, `man`-Seiten zu verwenden (`man command`)
❌ **Nicht:**
- Führen Sie`rm -rf /`oder ähnliche gefährliche Befehle aus
- Verwenden Sie`chmod 777`für vertrauliche Dateien
- Warnmeldungen ignorieren
- Bearbeiten Sie Systemdateien ohne Backups
- Führen Sie unbekannte Skripte als Root aus
---

*Letzte Aktualisierung: Juli 2026 | Linux/Unix-kompatibel*