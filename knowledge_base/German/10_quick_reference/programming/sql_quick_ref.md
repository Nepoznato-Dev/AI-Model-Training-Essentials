...
---
# SQL-Kurzanleitung
Grundlegende SQL-Befehle für Datenbankoperationen.
---
...
### Vollständiger äußerer Join```sql
...
-`DECIMAL(p,s)`– Exakte Dezimalzahl (Genauigkeit, Skalierung)
-`FLOAT`– Ungefährer Gleitkommawert
-`DOUBLE`– Schwimmer mit doppelter Präzision
### Zeichenfolge
-`CHAR(n)`– Zeichenfolge mit fester Länge
-`VARCHAR(n)`– Zeichenfolge variabler Länge
-`TEXT`– Großer Text
...
-`YEAR`– Jahreswert
### Boolescher Wert
-`BOOLEAN`oder`BOOL`– Richtig/Falsch
### Binär
-`BLOB`– Binäres großes Objekt
-`BINARY`– Binärdatei korrigiert
-`VARBINARY`– Variable Binärdatei
---

## Nützliche Funktionen
### String-Funktionen```sql
...
- Daten entsprechend normalisieren
– Verwenden Sie vorbereitete Anweisungen, um SQL-Injection zu verhindern
❌ **Nicht:**
– Verwenden Sie Funktionen für indizierte Spalten in WHERE-Klauseln
- Erstellen Sie zu viele Indizes (verlangsamt Schreibvorgänge)
- Verwenden Sie`SELECT DISTINCT`unnötig
...
*Letzte Aktualisierung: Juli 2026 | SQL-Standard (MySQL/PostgreSQL-kompatibel)*