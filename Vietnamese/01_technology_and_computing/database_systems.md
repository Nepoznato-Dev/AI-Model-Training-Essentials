...
- **SELF THAM GIA**: Bảng được nối với chính nó
...
- **4NF**: Không có phụ thuộc nhiều giá trị
...
- **SQLite**: Được nhúng, không có máy chủ, nhẹ
...
- Công cụ: GIẢI THÍCH, GIẢI THÍCH PHÂN TÍCH### Kỹ thuật tối ưu hóa
...
- **Bản sao đã đọc**: Giảm tải lưu lượng đọc
...
- **Ủy quyền**: Cấp quyền (GRANT, REVOKE)
