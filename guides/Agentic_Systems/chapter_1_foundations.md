...
class CalculatorAgent:
    ...
    def perceive(self, user_input: str) -> Dict[str, Any]:
        ...
        elif any(op in input_lower for op in ['divide', '/', 'divided']):
        ...
        elif 'recall' in input_lower or 'what is' in input_lower:
...
if __name__ == "__main__":
    ...
    test_commands = [
        ...
        "Store my_age as 30",
        "What is my_age?",
        "Add my_age and 5"  # Using stored variable!
    ]
