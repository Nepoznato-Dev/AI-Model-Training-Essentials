---
# Metadata
title: "Programming Fundamentals Skill"
description: "Core concepts and practices that form the foundation of software development"
...
# Classification
tags: [programming, fundamentals, clean-code, best-practices, software-engineering]
...
5. **Learn Multiple Paradigms**: OOP, functional, procedural — each has its strengths
...
- [Algorithm Design](algorithm_design.md) - Efficient algorithm implementation
- [Debugging](../behavior-skills/debugging.md) - Finding and fixing code defects
- [Unit Testing](../testing-skills/unit_testing.md) - Verifying code correctness
- [Code Review](../collaboration-skills/code_review.md) - Improving code quality with peers
