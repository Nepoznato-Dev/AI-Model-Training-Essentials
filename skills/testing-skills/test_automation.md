...
description: "Using software tools to execute pre-scripted tests on applications before production release to increase efficiency, coverage, and reliability."
...
# Classification
tags: [test-automation, testing-frameworks, ci-cd, regression-testing]
