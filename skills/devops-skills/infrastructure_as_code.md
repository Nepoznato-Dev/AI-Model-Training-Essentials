...
description: "Managing and provisioning infrastructure through machine-readable definition files for version control, automation, and consistency."
...
# Classification
tags: [iac, terraform, cloudformation, infrastructure, automation]
...
- [CI/CD](ci_cd.md) - Pipeline automation for infrastructure
