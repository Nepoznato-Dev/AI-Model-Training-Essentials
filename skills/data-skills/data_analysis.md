...
description: "Inspect, clean, transform, and model data to discover useful information, draw conclusions, and support decision-making."
...
# Classification
tags: [data-analysis, statistics, visualization, insights, decision-making]
...
- [Database Design](database_design.md) - Structuring data for analysis
- [Critical Thinking](../research-skills/critical_thinking.md) - Evaluating evidence and arguments
- [Algorithm Design](../technical-skills/algorithm_design.md) - Efficient data processing
